...
def run_caida_traffic(dataset_category_list=['caida_specify_time/', ], date_list=[20180517, 20180621, 20180816], pcap_count=5, actual_row = 3,
                        ...
                        for epoch in epoch_list:
                            for seed in seed_list:
                                for sketch_name in sketch_list:
                                    ...
                                    output_pkl_dir = os.path.join(os.getenv('error_estimator'), "QuerySketch", sketch_name, pcap_file_name, flowkey, str)
...
def run_online_traffic(dataset_category='online_traffic/', date_list=[20180816], pcap_count=5, actual_row = 3,
                       flowkey_list=["srcIP",], width_list=[8192, 16384, 32768, 65536, 131072], epoch_list=[30], seed_list=[1, 2, 3],
                       sketch_list=["cm", "cs"], level=1, row=3, is_count_packet=1, lcount=0, helper=ParallelRunHelper(30)):
    for date in date_list:  # 5
...
run_caida_traffic(dataset_category_list=dataset_category_list, date_list=date_list, pcap_count=pcap_count, actual_row=actual_row,
...
# run_online_traffic(dataset_category='online_traffic/', date_list=[20180816], pcap_count=pcap_count, actual_row=actual_row,
#                    flowkey_list=flowkey_list, width_list=width_list, epoch_list=epoch_list, seed_list=seed_list,
#                    sketch_list=sketch_list, level=level, row=row, is_count_packet=is_count_packet, lcount=0, helper=helper)
