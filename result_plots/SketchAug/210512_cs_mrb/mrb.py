...
#     ax.plot(x_label, p6, label='Total', color="C4", marker=markerst, linestyle=linest)
#     ax.plot(x_label, p1, label='P1. delayed read', color="C0", marker=markerst, linestyle=linest)
#     ax.plot(x_label, p2, label='P2. delayed reset', color="C1", marker=markerst, linestyle=linest)
#     ax.plot(x_label, p3, label='P3. non-atomic read', color="C2", marker=markerst, linestyle=linest)
#     ax.plot(x_label, p4, label='P4. non-atomic reset', color="C3", marker=markerst, linestyle=linest)
