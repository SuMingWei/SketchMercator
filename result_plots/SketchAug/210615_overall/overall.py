...
def main():
    ...
    for sketch_name in sketch_list:
        ...
        print()
    print("\\textbf{\\unoptshort} & %d/%.0f\\%% & %d/%.0f\\%% & %dK/%.0f\\%% & %dK/%.0f\\%% & %dK/%.0f\\%% \\\\ \\hline" %
    ...
    print("\\textbf{\\evalsoltwoshort} & $\\times$ & $\\times$ & %dK/%.0f\\%% & %dK/%.0f\\%% & %dK/%.0f\\%% \\\\ " %
    ...
    print("\\textbf{\\evalsolthreeshort} & %d/%.0f\\%% & %d/%.0f\\%% & %dK/%.0f\\%% & %dK/%.0f\\%% & %dK/%.0f\\%% \\\\ \\bottomrule" %
                                          ...
                                          result_dict["cs"]["sol3cpp"]["wrong_sum"]/1000,
                                          result_dict["cs"]["sol3cpp"]["diff_rate"],
                                          result_dict["cm"]["sol3cpp"]["wrong_sum"]/1000,
                                          result_dict["cm"]["sol3cpp"]["diff_rate"],
                                          result_dict["univmon"]["sol3cpp"]["wrong_sum"]/1000,
