...
def bf_plot_again():
    ...
    # plt.plot(label, three_hash_9, marker='.', markersize=10, color='C3', label="Miss rate 10 $\textasciicircum$ (-9)$\%$ ")
    # plt.plot(label, three_hash_6, marker='.', markersize=10, color='C4', label="Miss rate 10 $\textasciicircum$ (-6)$\%$ ")
    # plt.plot(label, three_hash_3, marker='.', markersize=10, color='C5', label="Miss rate 10 $\textasciicircum$ (-3)$\%$ ")
