...
def pipeline_stages_levels_r3():
    ...
    cs_base = 3
    univmon = [5/cs_base, 10/cs_base, 15/cs_base, 19/cs_base, 24/cs_base]
    rhhh = [5/cs_base, 9/cs_base, 13/cs_base, 17/cs_base, 21/cs_base]
