...
ax.set_xlabel('Number of sketches', fontsize=16)

plt.tick_params(labelsize=16)
# plt.legend(bbox_to_anchor = (1.0, 1.4), ncol=2)
# plt.legend(fontsize=14, loc="lower left", bbox_to_anchor = (-0.2, 1), ncol=2)
plt.legend(fontsize=14, loc="lower left", bbox_to_anchor = (-0.4, 0.98), ncol=2)
fig.tight_layout()
# plt.show()
# plt.savefig("bottleneck.pdf", bbox_inches='tight')
plt.savefig("/Users/hnamkung/hun-latex/multi-dim-latex/sigcomm22/figures/3_bottleneck/bottleneck.pdf", bbox_inches='tight')
