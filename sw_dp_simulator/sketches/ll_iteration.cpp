#include "ll_iteration.h"

llIteration::llIteration()
{
}

void llIteration::init(parameters &params)
{
...
void llIteration::load_hash(parameters &params) {
...
void llIteration::iteration(packet_summary &p, parameters &params)
{
    flowkey_t flowkey;
...
void llIteration::file_print(parameters &params)
{
    hll_file_print(hll_level, *sampling_hash, params, packetMap.size());
}

void llIteration::clear(parameters &params)
{
    hll_level[0].clear();
    packetMap.clear();
}
