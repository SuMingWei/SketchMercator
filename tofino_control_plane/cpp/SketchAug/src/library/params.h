...
struct parameters
{
    ...
    const bfrt::BfRtTable *register_table_1_0;
    const bfrt::BfRtTable *register_table_2_0;
    const bfrt::BfRtTable *register_table_3_0;
    const bfrt::BfRtTable *register_table_4_0;

    const bfrt::BfRtTable *register_table_1_1;
    const bfrt::BfRtTable *register_table_2_1;
    const bfrt::BfRtTable *register_table_3_1;
    const bfrt::BfRtTable *register_table_4_1;
};
