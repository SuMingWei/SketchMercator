                ...
                for epoch in epoch_list:
                    for seed in seed_list:
                        for sketch_name in sketch_list:
                            ...
                            # print(str)
                            output_dir = os.path.join(os.getenv('pattern_detection'), "lstm", "SketchProfilePadding", sketch_name, pcap_file_name, flowkey, str)
                            print(output_dir)

                            str = f"row_{actual_row}_width_{width}_level_{level}_epoch_{epoch}_count_{is_count_packet}_seed_{seed}"
                            output_pkl_dir = os.path.join(os.getenv('pattern_detection'), "lstm", "SketchProfileQuery", sketch_name, pcap_file_name, flowkey, str)
