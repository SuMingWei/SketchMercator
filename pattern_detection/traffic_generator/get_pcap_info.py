...
def handle_dataset(date_list, dataset_category_list, flowkey, pcap_count):
    # Iterate over pcap files and parse them
    cmd = "%s/traffic_generator/pcap_parser " % os.getenv("pattern_detection")
