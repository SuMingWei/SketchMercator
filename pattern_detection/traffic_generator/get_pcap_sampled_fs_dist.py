...
def handle_dataset(data_list, dataset_category_list, flowkey, pcap_count, topk):
    # Iterate over pcap files and parse them
    cmd = "%s/traffic_generator/pcap_randomk_sampler " % os.getenv("pattern_detection")
        ...
        for date in date_list:
            ...
            for key in flowkey:
                ...
                for (pcap_full_path, pcap_folder_path, pcap_file_name) in pcap_list:
                    ...
                    single_cmd = cmd + pcap_full_path + " " + str(topk) + " " + pcap_file_name[:-5]
...
if __name__ == "__main__":
    ...
    handle_dataset(date_list, dataset_category_list, flowkey, pcap_count, topk)