...
def run_online_traffic(dataset_category='online_traffic/', date_list=[20180816], pcap_count=5,
    ...
    for date in date_list:  # 5
        pcap_list = get_online_traffic_pcap_list(date, "10s", pcap_count, dataset_category)
        print(pcap_list)
...
run_online_traffic(dataset_category='online_traffic/', date_list=[20180816], pcap_count=1,
