...
def apply_salu_reuse(inst_list, strict=False):
    ...
    return o2a_inst_list
        ...
        #     # before : individual resource usage of O2 instances
        #     # after : merged instances

        #     data["hash_reuse"] = [before["hashcall"] - after["hashcall"] - global_objective_function(sum, 0, 0, 0), 0, 0]
        #     data["hash_xor"] = [0, 0, 0]

        #     # sum: # of reduce hash calls by O2
        #     data["salu_reuse"] = [global_objective_function(sum, 0, 0, 0), \
