...
control SwitchIngress(
    ...
    apply {
        ...
        T3_RUN_HH_4_KEY_1( 9, DSTIP, 1)
        T2_RUN_HH_2_KEY_1(10, DSTIP, 1)
        T2_RUN_HH_2_KEY_1(11, DSTIP, 1)
        T3_RUN_HH_2_KEY_2(12, SRCIP, SRCPORT, 1)
        ...
        T5_RUN_1_KEY_5(21, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
