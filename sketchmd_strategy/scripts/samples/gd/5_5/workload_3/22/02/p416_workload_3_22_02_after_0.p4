...
control SwitchIngress(
    ...
    // apply O2
        ...
        T1_KEY_UPDATE_100_524288(32w0x30243f0b) update_5_2;
        T1_KEY_UPDATE_100_524288(32w0x30243f0b) update_5_3;
    // 
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T2_KEY_UPDATE_100_16384(32w0x30243f0b) update_9_3;
    ...
    T2_INIT_HH_4(19, 220, 8192)
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ABOVE_THRESHOLD_CONSTANT_3(100) d_22_above_threshold;
        COMPUTE_HASH_221_32_32(32w0x30244f0b) d_22_hash_call;
        TCAM_LPM_HLLPCSA() d_22_tcam_lpm;
        GET_BITMASK() d_22_get_bitmask;
        T2_T5_KEY_UPDATE_221_8192(32w0x30243f0b) update_22_1;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_9_1.apply(DSTIP, 1, ig_md.d_9_res_hash[1:1], 1, ig_md.d_9_est_1);
            update_9_2.apply(DSTIP, 1, ig_md.d_9_res_hash[2:2], 1, ig_md.d_9_est_2);
            update_9_3.apply(DSTIP, 1, ig_md.d_9_res_hash[3:3], 1, ig_md.d_9_est_3);
        ...
        T3_RUN_AFTER_2_KEY_2(12, SRCIP, SRCPORT, 1)
        T2_RUN_AFTER_3_KEY_2(13, SRCIP, SRCPORT, 1)
        T2_RUN_AFTER_3_KEY_2(14, SRCIP, SRCPORT, 1)
        T2_RUN_AFTER_5_KEY_2(15, DSTIP, DSTPORT, 1)
        // UnivMon for inst 16
        ...
        T2_RUN_AFTER_1_KEY_4(20, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_AFTER_4_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_22_tcam_lpm.apply(ig_md.d_21_sampling_hash_32, ig_md.d_22_level);
            d_22_get_bitmask.apply(ig_md.d_22_level, ig_md.d_22_bitmask);
            update_22_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_22_bitmask, ig_md.d_22_est_1);
