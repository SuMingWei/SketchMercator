...
control SwitchIngress(
    ...
    // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row) 
        COMPUTE_HASH_110_16_16(32w0x30244f0b) d_12_sampling_hash_call;
        COMPUTE_HASH_110_16_11(32w0x30244f0b) d_12_index_hash_call_1;
        LPM_OPT_MRAC_2() d_12_tcam_lpm_2;
        T2_T2_INDEX_UPDATE_32768() update_12;
    // 

    T1_INIT_1(14, 110, 524288)

    // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row) 
        COMPUTE_HASH_110_16_8(32w0x30244f0b) d_15_sampling_hash_call;
        COMPUTE_HASH_110_16_11(32w0x30244f0b) d_15_index_hash_call_1;
        LPM_OPT_MRAC_2() d_15_tcam_lpm_2;
        T2_T2_INDEX_UPDATE_16384() update_15;
    // 

    T1_INIT_2(17, 220, 262144)
    ...
    apply {
        ...
        // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row)
        d_15_tcam_lpm_2.apply(ig_md.d_15_sampling_hash_16, ig_md.d_15_base_16_1024, ig_md.d_15_base_16_2048);
        d_15_index_hash_call_1.apply(DSTIP, DSTPORT, ig_md.d_15_index1_16);
        update_15.apply(ig_md.d_15_base_16_2048, ig_md.d_15_index1_16);
        // 
