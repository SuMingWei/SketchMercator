...
control SwitchIngress(
    ...
    // O1 hash init
        ...
        COMPUTE_HASH_100_32_32(32w0x30244f0b) d_9_auto_sampling_hash_call;
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_100_8192(32w0x30243f0b) update_4_1;
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_110_8192(32w0x30243f0b) update_17_1;
        T2_KEY_UPDATE_110_4096(32w0x30243f0b) update_17_2;
        T2_KEY_UPDATE_110_4096(32w0x30243f0b) update_17_3;
    //
    ...
    apply {
        // O1 hash run
            ...
            d_9_auto_sampling_hash_call.apply(DSTIP, ig_md.d_9_sampling_hash_32);
        ...
        T3_RUN_AFTER_3_KEY_1( 6, SRCIP, 1)
        T2_RUN_AFTER_4_KEY_1( 7, SRCIP, 1)
        T3_RUN_AFTER_5_KEY_1( 5, SRCIP, 1)
        ...
        // HLL for inst 9
            ...
            update_9.apply(DSTIP, ig_md.d_9_level);
        //
