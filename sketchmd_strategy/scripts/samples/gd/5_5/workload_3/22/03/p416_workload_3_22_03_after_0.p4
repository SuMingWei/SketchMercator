...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T2_KEY_UPDATE_100_16384(32w0x30243f0b) update_3_4;
        T3_T2_KEY_UPDATE_100_16384(32w0x30243f0b) update_3_5;
    //
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_10_index_hash_call_2;
        T3_INDEX_UPDATE_32768() update_10_2;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_10_index_hash_call_3;
        T3_INDEX_UPDATE_32768() update_10_3;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_10_index_hash_call_4;
        T3_INDEX_UPDATE_32768() update_10_4;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_10_index_hash_call_5;
        T3_INDEX_UPDATE_32768() update_10_5;
    // 

    T2_INIT_1(11, 200, 8192)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T2_KEY_UPDATE_110_16384(32w0x30243f0b) update_12_3;
    //
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_21_1;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_3_4.apply(SRCIP, 1, ig_md.d_3_res_hash[4:4], 1, ig_md.d_3_est_4);
            update_3_5.apply(SRCIP, 1, ig_md.d_3_res_hash[5:5], 1, ig_md.d_3_est_5);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_5_5.apply(DSTIP, 1, ig_md.d_5_est_5);
        ...
        d_10_index_hash_call_5.apply(DSTIP, ig_md.d_10_index5_16);
        ...
        T2_RUN_1_KEY_2(11, SRCIP, DSTIP, 1)
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            d_12_res_hash_call.apply(SRCIP, SRCPORT, ig_md.d_12_res_hash);
            update_12_1.apply(SRCIP, SRCPORT, 1, 1, ig_md.d_12_est_1);
            d_14_above_threshold.apply(ig_md.d_12_est_1, ig_md.d_14_above_threshold);
            update_12_2.apply(SRCIP, SRCPORT, 1, ig_md.d_12_res_hash[2:2], 1, ig_md.d_12_est_2);
            update_12_3.apply(SRCIP, SRCPORT, 1, ig_md.d_12_res_hash[3:3], 1, ig_md.d_12_est_3);
            d_13_above_threshold.apply(ig_md.d_12_est_2, ig_md.d_12_est_3, ig_md.d_13_above_threshold);
        //
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_21_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, 1, ig_md.d_21_est_1);
            update_21_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_21_est_2);
