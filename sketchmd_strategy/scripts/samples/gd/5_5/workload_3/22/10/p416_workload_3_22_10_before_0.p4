...
control SwitchIngress(
    ...
    T1_INIT_4( 9, 200, 524288)
    T1_INIT_1(10, 200, 262144)
    T2_INIT_5(11, 200, 16384)
    T2_INIT_HH_2(12, 200, 4096)
    UM_INIT_4(13, 200, 11, 32768)
    T2_INIT_1(14, 110, 8192)
    T3_INIT_HH_1(15, 110, 4096)
    T5_INIT_1(16, 110, 16384)
    UM_INIT_2(17, 110, 11, 32768)
    T2_INIT_2(18, 220, 8192)
    T2_INIT_3(19, 221, 8192)
    ...
    apply {
        ...
        T2_RUN_1_KEY_2(14, SRCIP, SRCPORT, 1)
        T3_RUN_HH_1_KEY_2(15, SRCIP, SRCPORT, 1)
        T5_RUN_1_KEY_2(16, DSTIP, DSTPORT)
        UM_RUN_2_KEY_2(17, DSTIP, DSTPORT, 1)
        T2_RUN_2_KEY_4(18, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_3_KEY_5(19, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
