...
control SwitchIngress(
    ...
    T1_INIT_2(17, 220, 131072)
    T1_INIT_3(16, 220, 131072)
    MRAC_INIT_1(18, 220, 8192, 10,  8)
    T1_INIT_1(20, 221, 262144)

    // apply O2
        T1_KEY_UPDATE_221_262144(32w0x30243f0b) update_19_1;
        T1_KEY_UPDATE_221_131072(32w0x30243f0b) update_19_2;
        T1_KEY_UPDATE_221_131072(32w0x30243f0b) update_19_3;
    // 
    ...
    apply {
        ...
        update_11_5.apply(ig_md.d_11_base_16_2048, ig_md.d_11_index5_16, ig_md.d_11_res_hash[5:5], 1, ig_md.d_11_est_5);
