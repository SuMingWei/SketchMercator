...
control SwitchIngress(
    ...
    T2_INIT_5(13, 220, 16384)
    T2_INIT_4(14, 220, 16384)
    MRAC_INIT_1(15, 220, 16384, 11,  8)
    UM_INIT_2(16, 220, 11, 32768)
    T2_INIT_2(17, 221, 4096)
    ...
    apply {
        ...
        T2_RUN_5_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_4_KEY_4(14, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        MRAC_RUN_1_KEY_4(15, SRCIP, DSTIP, SRCPORT, DSTPORT)
        UM_RUN_2_KEY_4(16, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
