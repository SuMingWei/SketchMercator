...
control SwitchIngress(
    ...
    T1_INIT_5( 9, 200, 524288)
    T3_INIT_HH_4(10, 200, 16384)
    UM_INIT_4(11, 110, 10, 16384)
    T1_INIT_2(12, 110, 524288)
    T2_INIT_HH_2(14, 110, 4096)
    T2_INIT_HH_4(13, 110, 8192)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        COMPUTE_HASH_220_16_16(32w0x30244f0b) d_15_res_hash_call;
        ABOVE_THRESHOLD_CONSTANT_2(100) d_16_above_threshold;
        T3_T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_15_1;
        T3_T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_15_2;
    ...
    apply {
        ...
        T3_RUN_AFTER_4_KEY_2(10, SRCIP, DSTIP, 1)
        // UnivMon for inst 11
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_15_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_15_res_hash[1:1], 1, ig_md.d_15_est_1);
            update_15_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_15_res_hash[2:2], 1, ig_md.d_15_est_2);
