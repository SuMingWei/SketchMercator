...
control SwitchIngress(
    ...
    T2_INIT_2( 1, 110, 16384)
    UM_INIT_5( 2, 110, 11, 32768)
    ...
    apply {
        ...
        T2_RUN_2_KEY_2( 1, DSTIP, DSTPORT, 1)
        // UnivMon for inst 2
            ...
            d_2_index_hash_call_4.apply(DSTIP, DSTPORT, ig_md.d_2_index4_16); 
            d_2_index_hash_call_5.apply(DSTIP, DSTPORT, ig_md.d_2_index5_16); 
