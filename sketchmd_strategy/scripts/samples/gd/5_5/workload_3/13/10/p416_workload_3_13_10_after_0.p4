...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_7_5;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_7_4.apply(SRCIP, SRCPORT, 1, 1, ig_md.d_7_est_4);
            update_7_5.apply(SRCIP, SRCPORT, 1, 1, ig_md.d_7_est_5);
            d_8_above_threshold.apply(ig_md.d_7_est_1, ig_md.d_7_est_2, ig_md.d_7_est_3, ig_md.d_7_est_4, ig_md.d_7_est_5, ig_md.d_8_above_threshold);
        //
