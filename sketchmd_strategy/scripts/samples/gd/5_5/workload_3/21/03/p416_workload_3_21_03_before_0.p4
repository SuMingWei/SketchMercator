...
control SwitchIngress(
    ...
    T2_INIT_5(17, 220, 16384)
    T2_INIT_HH_3(18, 220, 16384)
    T5_INIT_1(19, 221, 16384)
    T2_INIT_3(20, 221, 16384)
    ...
    apply {
        ...
        UM_RUN_2_KEY_2(13, SRCIP, SRCPORT, 1)
        ...
        T2_RUN_3_KEY_5(20, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
