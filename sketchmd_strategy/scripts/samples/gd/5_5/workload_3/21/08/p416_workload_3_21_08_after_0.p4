...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_20_3;
        T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_20_4;
        T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_20_5;
    //
    ...
    apply {
        ...
        T2_RUN_AFTER_2_KEY_4(12, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_AFTER_2_KEY_4(14, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T3_RUN_AFTER_4_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        // MRAC for inst 15
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_19_tcam_lpm.apply(ig_md.d_17_sampling_hash_32, ig_md.d_19_level);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_20_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, 1, ig_md.d_20_est_1);
            update_20_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, 1, ig_md.d_20_est_2);
            update_20_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, 1, ig_md.d_20_est_3);
            update_20_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_20_est_4);
            update_20_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_20_est_5);
