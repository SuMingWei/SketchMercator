...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T5_KEY_UPDATE_220_8192(32w0x30243f0b) update_18_1;
        T3_KEY_UPDATE_220_8192(32w0x30243f0b) update_18_2;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_18_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_18_res_hash[1:1], ig_md.d_18_bitmask, ig_md.d_18_est_1);
            update_18_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_18_res_hash[2:2], ig_md.d_18_est_2);
        ...
        T2_RUN_AFTER_4_KEY_5(21, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        if(
