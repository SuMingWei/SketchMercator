...
control SwitchIngress(
    ...
    UM_INIT_4( 4, 110, 11, 32768)
    UM_INIT_5( 5, 110, 11, 32768)
    T1_INIT_1( 6, 110, 524288)
    MRAC_INIT_1( 7, 220, 16384, 10, 16)
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_2_2.apply(DSTIP, 1, ig_md.d_2_res_hash[2:2], 1, ig_md.d_2_est_2);
            update_2_3.apply(DSTIP, 1, ig_md.d_2_res_hash[3:3], 1, ig_md.d_2_est_3);
            d_3_above_threshold.apply(ig_md.d_2_est_2, ig_md.d_2_est_3, ig_md.d_3_above_threshold);
        ...
        // UnivMon for inst 5
            ...
            d_5_index_hash_call_5.apply(SRCIP, SRCPORT, ig_md.d_5_index5_16); 
