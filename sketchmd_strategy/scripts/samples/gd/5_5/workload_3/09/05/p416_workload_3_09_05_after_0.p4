...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_5_5;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_5_1.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_5_est_1);
            update_5_2.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_5_est_2);
            update_5_3.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_5_est_3);
