...
control SwitchIngress(
    ...
    UM_INIT_5( 7, 110, 10, 16384)
    T1_INIT_5( 8, 220, 131072)
    T2_INIT_HH_2( 9, 220, 16384)
    UM_INIT_2(10, 220, 11, 32768)
    T5_INIT_1(11, 221, 4096)
    UM_INIT_2(12, 221, 10, 16384)
    apply {
        T2_RUN_1_KEY_1( 1, DSTIP, 1)
        ...
        UM_RUN_3_KEY_2( 6, SRCIP, SRCPORT, 1)
        UM_RUN_5_KEY_2( 7, DSTIP, DSTPORT, 1)
        ...
        UM_RUN_2_KEY_5(12, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
    }
}
