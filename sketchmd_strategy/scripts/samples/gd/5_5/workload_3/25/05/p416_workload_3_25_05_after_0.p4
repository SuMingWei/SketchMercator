...
control SwitchIngress(
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_220_16_11(32w0x30244f0b) d_21_index_hash_call_5;
        T3_INDEX_UPDATE_32768() update_21_5;
    // 

    T1_INIT_4(22, 221, 262144)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        COMPUTE_HASH_221_16_16(32w0x30244f0b) d_23_res_hash_call;
        ABOVE_THRESHOLD_CONSTANT_2(100) d_24_above_threshold;
        T3_T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_23_1;
        T3_T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_23_2;
        T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_23_3;
        T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_23_4;
        T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_23_5;
    //

    UM_INIT_2(25, 221, 10, 16384)
    ...
    apply {
        ...
        T2_RUN_4_KEY_1( 8, DSTIP, 1)
        T1_RUN_5_KEY_2( 9, SRCIP, DSTIP) if (ig_md.d_9_est1_1 == 0 || ig_md.d_9_est1_2 == 0 || ig_md.d_9_est1_3 == 0 || ig_md.d_9_est1_4 == 0 || ig_md.d_9_est1_5 == 0) { /* process_new_flow() */ }
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_14_1.apply(SRCIP, SRCPORT, 1, ig_md.d_14_res_hash[1:1], ig_md.d_14_bitmask, ig_md.d_14_est_1);
            update_14_2.apply(SRCIP, SRCPORT, 1, ig_md.d_14_res_hash[2:2], ig_md.d_14_est_2);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_2(14)
        //

        T3_RUN_AFTER_5_KEY_2(15, SRCIP, SRCPORT, 1)
        // MRAC for inst 16
        ...
        update_21_4.apply(ig_md.d_21_base_16_2048, ig_md.d_21_index4_16, ig_md.d_21_res_hash[4:4], 1, ig_md.d_21_est_4);
        d_21_index_hash_call_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_21_index5_16);
        update_21_5.apply(ig_md.d_21_base_16_2048, ig_md.d_21_index5_16, ig_md.d_21_res_hash[5:5], 1, ig_md.d_21_est_5);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_23_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_23_res_hash[1:1], 1, ig_md.d_23_est_1);
            update_23_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_23_res_hash[2:2], 1, ig_md.d_23_est_2);
            d_24_above_threshold.apply(ig_md.d_23_est_1, ig_md.d_23_est_2, ig_md.d_24_above_threshold);
            ...
            update_23_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_23_est_5);
        //
        ...
        // UnivMon for inst 25
            ...
            UM_RUN_END_2(25, ig_md.d_25_res_hash, 1) 
