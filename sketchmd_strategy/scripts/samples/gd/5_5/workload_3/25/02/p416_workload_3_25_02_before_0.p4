...
control SwitchIngress(
    ...
    T5_INIT_1(18, 110, 8192)
    T2_INIT_HH_4(19, 110, 16384)
    UM_INIT_1(20, 110, 11, 32768)
    T1_INIT_1(21, 220, 131072)
    T5_INIT_1(22, 220, 4096)
    T3_INIT_HH_1(23, 220, 8192)
    T2_INIT_5(24, 221, 4096)
    T3_INIT_HH_4(25, 221, 8192)
    apply {
        T5_RUN_1_KEY_1( 1, SRCIP)
        T2_RUN_3_KEY_1( 2, SRCIP, 1)
        T2_RUN_HH_2_KEY_1( 3, SRCIP, 1)
        T3_RUN_HH_1_KEY_1( 4, SRCIP, 1)
        T3_RUN_HH_4_KEY_1( 5, SRCIP, 1)
        T4_RUN_1_KEY_1( 6, DSTIP)
        ...
        UM_RUN_2_KEY_2(14, SRCIP, SRCPORT, 1)
        ...
        T2_RUN_HH_4_KEY_2(19, DSTIP, DSTPORT, 1)
        UM_RUN_1_KEY_2(20, DSTIP, DSTPORT, 1)
        T1_RUN_1_KEY_4(21, SRCIP, DSTIP, SRCPORT, DSTPORT)
        T5_RUN_1_KEY_4(22, SRCIP, DSTIP, SRCPORT, DSTPORT)
        T3_RUN_HH_1_KEY_4(23, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_5_KEY_5(24, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T3_RUN_HH_4_KEY_5(25, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
    }
}
