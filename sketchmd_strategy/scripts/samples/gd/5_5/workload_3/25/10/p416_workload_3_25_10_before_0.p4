...
control SwitchIngress(
    ...
    T2_INIT_4(19, 220, 16384)
    T3_INIT_HH_1(20, 220, 8192)
    T2_INIT_HH_3(21, 220, 16384)
    T3_INIT_HH_1(22, 221, 16384)
    T2_INIT_HH_4(23, 221, 4096)
    MRAC_INIT_1(24, 221, 8192, 10,  8)
    UM_INIT_4(25, 221, 10, 16384)
    apply {
        ...
        T3_RUN_HH_4_KEY_2(11, SRCIP, SRCPORT, 1)
        ...
        T2_RUN_4_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T3_RUN_HH_1_KEY_4(20, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_HH_3_KEY_4(21, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T3_RUN_HH_1_KEY_5(22, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T2_RUN_HH_4_KEY_5(23, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        MRAC_RUN_1_KEY_5(24, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        UM_RUN_4_KEY_5(25, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
    }
}
