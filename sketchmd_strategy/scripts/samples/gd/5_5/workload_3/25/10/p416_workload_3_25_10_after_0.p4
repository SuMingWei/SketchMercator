...
control SwitchIngress(
    ...
    T3_INIT_HH_1(22, 221, 16384)
    T2_INIT_HH_4(23, 221, 4096)
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_221_16_10(32w0x30244f0b) d_25_index_hash_call_4;
    ...
    apply {
        ...
        // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row)
        d_16_tcam_lpm_2.apply(ig_md.d_15_sampling_hash_16, ig_md.d_16_base_16_1024, ig_md.d_16_base_16_2048);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_19_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_19_res_hash[1:1], 1, ig_md.d_19_est_1);
        ...
        T3_RUN_AFTER_1_KEY_5(22, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T2_RUN_AFTER_4_KEY_5(23, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        ...
        update_25_4.apply(ig_md.d_25_base_16_1024, ig_md.d_25_index4_16, ig_md.d_25_res_hash[4:4], 1, ig_md.d_25_est_4);
