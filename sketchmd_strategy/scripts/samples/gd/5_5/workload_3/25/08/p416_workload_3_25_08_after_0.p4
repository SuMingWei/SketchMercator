...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T2_KEY_UPDATE_100_16384(32w0x30243f0b) update_1_3;
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_100_8192(32w0x30243f0b) update_5_4;
        T2_T2_KEY_UPDATE_100_8192(32w0x30243f0b) update_5_5;
    //

    UM_INIT_2( 7, 100, 10, 16384)
    T2_INIT_HH_1( 9, 200, 8192)
    ...
    // apply O2
        ...
        T2_KEY_UPDATE_200_16384(32w0x30243f0b) update_8_5;
    ...
    MRAC_INIT_1(15, 110, 8192, 10,  8)
    T1_INIT_1(18, 220, 262144)
    T1_INIT_3(16, 220, 262144)
    T4_INIT_1(17, 220, 32768)
    T2_INIT_3(19, 220, 8192)
    UM_INIT_2(20, 220, 10, 16384)
    T1_INIT_1(21, 221, 131072)
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ABOVE_THRESHOLD_CONSTANT_3(100) d_23_above_threshold;
        T2_T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_23_1;
        T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_23_2;
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_1_2.apply(SRCIP, 1, ig_md.d_1_res_hash[2:2], 1, ig_md.d_1_est_2);
            update_1_3.apply(SRCIP, 1, ig_md.d_1_res_hash[3:3], 1, ig_md.d_1_est_3);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_5_3.apply(DSTIP, 1, 1, ig_md.d_5_est_3);
            update_5_4.apply(DSTIP, 1, 1, ig_md.d_5_est_4);
            update_5_5.apply(DSTIP, 1, 1, ig_md.d_5_est_5);
        ...
        // apply O2
        T2_RUN_AFTER_2_KEY_2(11, SRCIP, SRCPORT, 1)
        // 

        T2_RUN_AFTER_1_KEY_2(13, DSTIP, DSTPORT, 1)
        T2_RUN_AFTER_1_KEY_2(14, DSTIP, DSTPORT, 1)
        // MRAC for inst 15
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_23_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_23_est_2);
            update_23_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_23_est_3);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_3(23)
        //
        ...
        update_25_1.apply(ig_md.d_25_base_16_1024, ig_md.d_25_index1_16, ig_md.d_25_res_hash[1:1], 1, ig_md.d_25_est_1);
        d_25_index_hash_call_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_25_index2_16);
        update_25_2.apply(ig_md.d_25_base_16_1024, ig_md.d_25_index2_16, ig_md.d_25_res_hash[2:2], 1, ig_md.d_25_est_2);
        d_25_index_hash_call_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_25_index3_16);
        update_25_3.apply(ig_md.d_25_base_16_1024, ig_md.d_25_index3_16, ig_md.d_25_res_hash[3:3], 1, ig_md.d_25_est_3);
