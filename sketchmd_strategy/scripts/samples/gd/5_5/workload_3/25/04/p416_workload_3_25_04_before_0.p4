...
control SwitchIngress(
    ...
    apply {
        ...
        T3_RUN_HH_5_KEY_2(17, DSTIP, DSTPORT, 1)
        T2_RUN_HH_1_KEY_2(18, DSTIP, DSTPORT, 1)
        MRB_RUN_1_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT)
        T5_RUN_1_KEY_4(20, SRCIP, DSTIP, SRCPORT, DSTPORT)
        T2_RUN_4_KEY_4(21, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T3_RUN_HH_2_KEY_4(22, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
