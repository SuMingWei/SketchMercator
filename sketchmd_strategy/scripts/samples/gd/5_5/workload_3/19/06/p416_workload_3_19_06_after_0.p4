...
control SwitchIngress(
    ...
    // apply O2
        T1_KEY_UPDATE_200_524288(32w0x30243f0b) update_6_1;
        T1_KEY_UPDATE_200_262144(32w0x30243f0b) update_6_2;
        T1_KEY_UPDATE_200_262144(32w0x30243f0b) update_6_3;
    // 

    T2_INIT_5( 8, 200, 8192)
    T5_INIT_1( 9, 110, 16384)
    UM_INIT_3(10, 110, 10, 16384)
    T3_INIT_HH_2(11, 110, 8192)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T5_KEY_UPDATE_220_16384(32w0x30243f0b) update_12_1;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_12_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_12_res_hash[1:1], ig_md.d_12_bitmask, ig_md.d_12_est_1);
            d_14_above_threshold.apply(ig_md.d_12_est_1, ig_md.d_14_above_threshold);
        //

        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_15_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_15_est_1);
