...
control SwitchIngress(
    ...
    apply {
        ...
        update_11_5.apply(ig_md.d_11_base_16_1024, ig_md.d_11_index5_16, ig_md.d_11_res_hash[5:5], 1, ig_md.d_11_est_5);
        ...
        update_12_1.apply(ig_md.d_12_base_16_1024, ig_md.d_12_index1_16, ig_md.d_12_res_hash[1:1], 1, ig_md.d_12_est_1);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_15_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_15_est_2);
            update_15_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_15_est_3);
            update_15_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_15_est_4);
