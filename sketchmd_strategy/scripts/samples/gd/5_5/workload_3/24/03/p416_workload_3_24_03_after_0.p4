...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_110_4096(32w0x30243f0b) update_10_1;
        T2_T2_KEY_UPDATE_110_4096(32w0x30243f0b) update_10_2;
    ...
    apply {
        ...
        T3_RUN_AFTER_3_KEY_5(22, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        // MRAC for inst 24
