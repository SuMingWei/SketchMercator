...
control SwitchIngress(
    ...
    UM_INIT_1(19, 220, 10, 16384)
    T1_INIT_1(20, 221, 262144)
    T1_INIT_1(21, 221, 524288)
    T3_INIT_HH_3(22, 221, 8192)
    ...
    apply {
        ...
        T1_RUN_1_KEY_5(20, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO) if (ig_md.d_20_est1_1 == 0) { /* process_new_flow() */ }
        T1_RUN_1_KEY_5(21, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        T3_RUN_HH_3_KEY_5(22, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
