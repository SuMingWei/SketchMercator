...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_4_KEY_1( 4, SRCIP, 1)
        T2_RUN_HH_1_KEY_1( 5, SRCIP, 1)
        ...
        T2_RUN_2_KEY_2(12, SRCIP, SRCPORT, 1)
        T2_RUN_5_KEY_2(13, SRCIP, SRCPORT, 1)
        T2_RUN_HH_2_KEY_2(14, SRCIP, SRCPORT, 1)
        MRAC_RUN_1_KEY_2(15, SRCIP, SRCPORT)
        UM_RUN_2_KEY_2(16, SRCIP, SRCPORT, 1)
        T2_RUN_HH_5_KEY_2(17, DSTIP, DSTPORT, 1)
        MRAC_RUN_1_KEY_2(18, DSTIP, DSTPORT)
        MRAC_RUN_1_KEY_2(19, DSTIP, DSTPORT)
        UM_RUN_4_KEY_2(20, DSTIP, DSTPORT, 1)
        T3_RUN_HH_3_KEY_4(21, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
