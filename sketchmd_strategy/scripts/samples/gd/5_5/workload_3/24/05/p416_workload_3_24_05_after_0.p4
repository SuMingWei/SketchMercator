...
control SwitchIngress(
    ...
    T1_INIT_3(13, 110, 131072)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ABOVE_THRESHOLD_CONSTANT_3(100) d_15_above_threshold;
        T2_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_14_1;
        T2_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_14_2;
        T2_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_14_3;
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        COMPUTE_HASH_221_32_32(32w0x30244f0b) d_23_hash_call;
        TCAM_LPM_HLLPCSA() d_23_tcam_lpm;
        GET_BITMASK() d_23_get_bitmask;
        T2_T5_KEY_UPDATE_221_16384(32w0x30243f0b) update_23_1;
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_23_2;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            d_1_above_threshold.apply(ig_md.d_2_est_1, ig_md.d_2_est_2, ig_md.d_2_est_3, ig_md.d_2_est_4, ig_md.d_1_above_threshold);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_14_3.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_14_est_3);
        ...
        // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row)
        d_19_tcam_lpm_2.apply(ig_md.d_16_sampling_hash_16, ig_md.d_19_base_16_1024, ig_md.d_19_base_16_2048);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_23_tcam_lpm.apply(ig_md.d_22_sampling_hash_32, ig_md.d_23_level);
            d_23_get_bitmask.apply(ig_md.d_23_level, ig_md.d_23_bitmask);
            update_23_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_23_bitmask, ig_md.d_23_est_1);
            update_23_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_23_est_2);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_2(23)
        //
