...
control SwitchIngress(
    ...
    apply {
        ...
        T5_RUN_1_KEY_1( 7, DSTIP)
        T3_RUN_HH_4_KEY_1( 8, DSTIP, 1)
        T3_RUN_HH_2_KEY_1( 9, DSTIP, 1)
        T2_RUN_HH_4_KEY_1(10, DSTIP, 1)
        T2_RUN_HH_5_KEY_1(11, DSTIP, 1)
        ...
        T4_RUN_1_KEY_5(20, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        MRB_RUN_1_KEY_5(21, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        T3_RUN_HH_4_KEY_5(22, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
