...
control SwitchIngress(
    ...
    T1_INIT_4( 8, 220, 262144)
    T1_INIT_3( 9, 220, 262144)
    T5_INIT_1(10, 220, 4096)
    T2_INIT_3(11, 220, 4096)
    UM_INIT_2(12, 220, 11, 32768)
    T3_INIT_HH_4(13, 221, 4096)
    T3_INIT_HH_3(14, 221, 8192)
    ...
    apply {
        ...
        MRAC_RUN_1_KEY_2( 5, SRCIP, DSTIP)
        ...
        T2_RUN_3_KEY_4(11, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        UM_RUN_2_KEY_4(12, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T3_RUN_HH_4_KEY_5(13, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T3_RUN_HH_3_KEY_5(14, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
