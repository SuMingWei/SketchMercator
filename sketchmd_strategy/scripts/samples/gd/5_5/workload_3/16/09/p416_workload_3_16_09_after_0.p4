...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_110_16384(32w0x30243f0b) update_12_2;
        T3_KEY_UPDATE_110_16384(32w0x30243f0b) update_12_3;
        T3_KEY_UPDATE_110_16384(32w0x30243f0b) update_12_4;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_12_1.apply(DSTIP, DSTPORT, 1, ig_md.d_12_res_hash[1:1], 1, ig_md.d_12_est_1);
            update_12_2.apply(DSTIP, DSTPORT, 1, ig_md.d_12_res_hash[2:2], ig_md.d_12_est_2);
            update_12_3.apply(DSTIP, DSTPORT, 1, ig_md.d_12_res_hash[3:3], ig_md.d_12_est_3);
            update_12_4.apply(DSTIP, DSTPORT, 1, ig_md.d_12_res_hash[4:4], ig_md.d_12_est_4);
