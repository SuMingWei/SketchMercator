...
control SwitchIngress(
    ...
    UM_INIT_5( 5, 100, 10, 16384)
    T3_INIT_HH_5( 6, 200, 4096)
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_14_1;
    ...
    apply {
        ...
        T3_RUN_AFTER_5_KEY_2( 6, SRCIP, DSTIP, 1)
        ...
        // HLL for inst 10
            ...
            update_10.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_10_level);
        //
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_14_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_14_est_2);
