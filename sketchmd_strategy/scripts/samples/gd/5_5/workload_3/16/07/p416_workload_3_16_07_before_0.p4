...
control SwitchIngress(
    ...
    apply {
        ...
        UM_RUN_5_KEY_1( 5, DSTIP, 1)
        T3_RUN_HH_5_KEY_2( 6, SRCIP, DSTIP, 1)
        ...
        UM_RUN_3_KEY_5(16, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
    }
}
