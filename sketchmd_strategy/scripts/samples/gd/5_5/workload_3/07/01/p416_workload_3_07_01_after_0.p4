...
control SwitchIngress(
    ...
    UM_INIT_5( 1, 200, 10, 16384)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        COMPUTE_HASH_110_16_16(32w0x30244f0b) d_2_res_hash_call;
        ABOVE_THRESHOLD_CONSTANT_4(100) d_3_above_threshold;
        T3_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_2_1;
        T3_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_2_2;
        T3_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_2_3;
        T3_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_2_4;
    //

    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        TCAM_LPM_HLLPCSA() d_5_tcam_lpm;
        GET_BITMASK() d_5_get_bitmask;
        T5_T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_5_1;
    ...
    apply {
        ...
        // UnivMon for inst 1
            d_1_res_hash_call.apply(SRCIP, DSTIP, ig_md.d_1_res_hash); 
            ...
            d_1_index_hash_call_2.apply(SRCIP, DSTIP, ig_md.d_1_index2_16); 
            d_1_index_hash_call_3.apply(SRCIP, DSTIP, ig_md.d_1_index3_16); 
            d_1_index_hash_call_4.apply(SRCIP, DSTIP, ig_md.d_1_index4_16); 
            d_1_index_hash_call_5.apply(SRCIP, DSTIP, ig_md.d_1_index5_16); 
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_2_1.apply(DSTIP, DSTPORT, 1, ig_md.d_2_res_hash[1:1], 1, ig_md.d_2_est_1);
            update_2_2.apply(DSTIP, DSTPORT, 1, ig_md.d_2_res_hash[2:2], 1, ig_md.d_2_est_2);
            update_2_3.apply(DSTIP, DSTPORT, 1, ig_md.d_2_res_hash[3:3], 1, ig_md.d_2_est_3);
            update_2_4.apply(DSTIP, DSTPORT, 1, ig_md.d_2_res_hash[4:4], 1, ig_md.d_2_est_4);
        ...
        T1_RUN_1_KEY_5( 6, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO) if (ig_md.d_6_est1_1 == 0) { /* process_new_flow() */ }
        // MRAC for inst 7
