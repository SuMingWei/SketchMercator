...
control SwitchIngress(
    ...
    T2_INIT_2( 6, 220, 8192)
    UM_INIT_5( 7, 221, 11, 32768)
    ...
    apply {
        ...
        // UnivMon for inst 7
            ...
            d_7_index_hash_call_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_7_index4_16); 
            d_7_index_hash_call_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_7_index5_16); 
