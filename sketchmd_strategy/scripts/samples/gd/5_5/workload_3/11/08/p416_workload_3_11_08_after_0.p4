...
control SwitchIngress(
    ...
    // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row) 
        COMPUTE_HASH_100_16_16(32w0x30244f0b) d_2_sampling_hash_call;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_2_index_hash_call_1;
        LPM_OPT_MRAC_2() d_2_tcam_lpm_2;
        T2_T2_INDEX_UPDATE_32768() update_2;
    // 

    UM_INIT_3( 5, 200, 10, 16384)
    UM_INIT_5( 4, 200, 10, 16384)
    T1_INIT_1( 6, 110, 524288)
    T1_INIT_1( 7, 110, 524288)
    T3_INIT_HH_1( 8, 110, 4096)
    T1_INIT_1( 9, 220, 524288)
    UM_INIT_4(10, 220, 10, 16384)
    T2_INIT_5(11, 221, 8192)
    ...
    apply {
        ...
        // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row)
        d_2_tcam_lpm_2.apply(ig_md.d_2_sampling_hash_16, ig_md.d_2_base_16_1024, ig_md.d_2_base_16_2048);
        d_2_index_hash_call_1.apply(SRCIP, ig_md.d_2_index1_16);
        update_2.apply(ig_md.d_2_base_16_2048, ig_md.d_2_index1_16);
        // 
        ...
        T3_RUN_AFTER_1_KEY_2( 8, DSTIP, DSTPORT, 1)
        ...
        T2_RUN_5_KEY_5(11, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        if(
