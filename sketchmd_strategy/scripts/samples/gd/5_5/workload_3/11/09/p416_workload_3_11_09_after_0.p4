...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_110_8192(32w0x30243f0b) update_8_2;
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_3_5.apply(DSTIP, 1, ig_md.d_3_res_hash[5:5], 1, ig_md.d_3_est_5);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_8_1.apply(SRCIP, SRCPORT, 1, ig_md.d_8_bitmask, ig_md.d_8_est_1);
            update_8_2.apply(SRCIP, SRCPORT, 1, ig_md.d_8_bitmask, ig_md.d_8_est_2);
