...
control SwitchIngress(
    ...
    T1_INIT_3( 6, 100, 262144)
    T1_INIT_1( 7, 200, 131072)
    T2_INIT_HH_4( 8, 200, 16384)
    UM_INIT_4( 9, 200, 11, 32768)
    ...
    apply {
        ...
        T1_RUN_3_KEY_1( 6, DSTIP) if (ig_md.d_6_est1_1 == 0 || ig_md.d_6_est1_2 == 0 || ig_md.d_6_est1_3 == 0) { /* process_new_flow() */ }
        T1_RUN_1_KEY_2( 7, SRCIP, DSTIP)
        T2_RUN_HH_4_KEY_2( 8, SRCIP, DSTIP, 1)
        UM_RUN_4_KEY_2( 9, SRCIP, DSTIP, 1)
        ...
        T3_RUN_HH_1_KEY_2(15, DSTIP, DSTPORT, 1)
        ...
        UM_RUN_1_KEY_5(19, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
