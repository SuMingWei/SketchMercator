...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T5_KEY_UPDATE_110_16384(32w0x30243f0b) update_17_1;
        T3_KEY_UPDATE_110_4096(32w0x30243f0b) update_17_2;
        T3_KEY_UPDATE_110_4096(32w0x30243f0b) update_17_3;
        T3_KEY_UPDATE_110_4096(32w0x30243f0b) update_17_4;
    //

    UM_INIT_1(18, 110, 11, 32768)
    T2_INIT_5(19, 221, 4096)
    UM_INIT_2(20, 221, 10, 16384)
    ...
    apply {
        // O1 hash run
            ...
            d_16_auto_sampling_hash_call.apply(SRCIP, SRCPORT, ig_md.d_16_sampling_hash_32);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_17_1.apply(SRCIP, SRCPORT, 1, ig_md.d_17_res_hash[1:1], ig_md.d_17_bitmask, ig_md.d_17_est_1);
            update_17_2.apply(SRCIP, SRCPORT, 1, ig_md.d_17_res_hash[2:2], ig_md.d_17_est_2);
            update_17_3.apply(SRCIP, SRCPORT, 1, ig_md.d_17_res_hash[3:3], ig_md.d_17_est_3);
            update_17_4.apply(SRCIP, SRCPORT, 1, ig_md.d_17_res_hash[4:4], ig_md.d_17_est_4);
        ...
        T2_RUN_5_KEY_5(19, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        // UnivMon for inst 20
