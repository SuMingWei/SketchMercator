...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_100_16384(32w0x30243f0b) update_5_3;
        T2_KEY_UPDATE_100_16384(32w0x30243f0b) update_5_4;
    //

    UM_INIT_2( 8, 100, 10, 16384)
    T1_INIT_2( 9, 200, 262144)
    ...
    MRB_INIT_1(17, 220, 262144, 14, 16)
    UM_INIT_3(18, 220, 10, 16384)
    T2_INIT_1(19, 221, 8192)
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            d_6_above_threshold.apply(ig_md.d_5_est_2, ig_md.d_5_est_3, ig_md.d_6_above_threshold);
        ...
        T2_RUN_3_KEY_2(10, SRCIP, DSTIP, 1)
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            d_11_res_hash_call.apply(SRCIP, SRCPORT, ig_md.d_11_res_hash);
            update_11_1.apply(SRCIP, SRCPORT, 1, ig_md.d_11_res_hash[1:1], 1, ig_md.d_11_est_1);
            update_11_2.apply(SRCIP, SRCPORT, 1, ig_md.d_11_res_hash[2:2], 1, ig_md.d_11_est_2);
            update_11_3.apply(SRCIP, SRCPORT, 1, ig_md.d_11_res_hash[3:3], 1, ig_md.d_11_est_3);
