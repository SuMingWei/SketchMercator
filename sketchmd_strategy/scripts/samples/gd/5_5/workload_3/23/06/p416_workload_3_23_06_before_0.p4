...
control SwitchIngress(
    ...
    T5_INIT_1(19, 221, 4096)
    T2_INIT_HH_1(20, 221, 8192)
    T3_INIT_HH_2(21, 221, 4096)
    ...
    apply {
        ...
        T3_RUN_HH_2_KEY_5(21, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
