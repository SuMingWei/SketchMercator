...
control SwitchIngress(
    ...
    T2_INIT_2(17, 110, 16384)
    T2_INIT_HH_5(18, 110, 8192)
    T3_INIT_HH_5(19, 110, 8192)
    T2_INIT_3(20, 220, 16384)
    T1_INIT_4(21, 221, 262144)
    T2_INIT_4(22, 221, 16384)
    T3_INIT_HH_3(23, 221, 8192)
    apply {
        ...
        T2_RUN_HH_5_KEY_2(18, DSTIP, DSTPORT, 1)
        T3_RUN_HH_5_KEY_2(19, DSTIP, DSTPORT, 1)
