...
control SwitchIngress(
    ...
    apply {
        ...
        T3_RUN_AFTER_3_KEY_2( 3, SRCIP, SRCPORT, 1)
        // MRAC for inst 4
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_11_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, 1, ig_md.d_11_est_1);
            update_11_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, 1, ig_md.d_11_est_2);
        //
