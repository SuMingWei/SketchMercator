...
control SwitchIngress(
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_200_16_11(32w0x30244f0b) d_8_index_hash_call_5;
        T3_INDEX_UPDATE_32768() update_8_5;
    // 

    T1_INIT_1( 9, 110, 131072)
    MRAC_INIT_1(10, 110, 32768, 11, 16)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        T2_T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_13_1;
        T2_T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_13_2;
        T2_T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_13_3;
        T2_T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_13_4;
        T2_T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_13_5;
    //

    T2_INIT_3(14, 220, 16384)
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_13_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_13_est_1);
            update_13_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_13_est_2);
            update_13_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_13_est_3);
            update_13_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_13_est_4);
            update_13_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_13_est_5);
        //

        T2_RUN_3_KEY_4(14, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        if(
