...
control SwitchIngress(
    ...
    T3_INIT_HH_1( 1, 110, 8192)
    T2_INIT_HH_4( 2, 110, 4096)

    // apply SALUMerge; big - UnivMon / small - many MRACs 
        UM_INIT_SETUP(4, 110)
        ABOVE_THRESHOLD_3() d_4_above_threshold;
        COMPUTE_HASH_110_16_11(32w0x30244f0b) d_4_index_hash_call_1;
        T3_T2_INDEX_UPDATE_32768() update_4_1;
        COMPUTE_HASH_110_16_11(32w0x30244f0b) d_4_index_hash_call_2;
        T3_INDEX_UPDATE_32768() update_4_2;
        COMPUTE_HASH_110_16_11(32w0x30244f0b) d_4_index_hash_call_3;
    ...
    apply {
        ...
        T3_RUN_AFTER_1_KEY_2( 1, DSTIP, DSTPORT, SIZE)
        T2_RUN_AFTER_4_KEY_2( 2, DSTIP, DSTPORT, SIZE)
