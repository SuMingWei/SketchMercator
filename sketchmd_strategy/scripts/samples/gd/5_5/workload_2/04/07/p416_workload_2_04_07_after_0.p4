...
control SwitchIngress(
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            d_3_above_threshold.apply(ig_md.d_2_est_2, ig_md.d_3_above_threshold);
            update_2_3.apply(SRCIP, SIZE, 1, ig_md.d_2_est_3);
            update_2_4.apply(SRCIP, SIZE, 1, ig_md.d_2_est_4);
            d_4_above_threshold.apply(ig_md.d_2_est_3, ig_md.d_2_est_4, ig_md.d_4_above_threshold);
        //
