...
control SwitchIngress(
    ...
    apply {
        ...
        // HLL for inst 2
            ...
            update_2.apply(DSTIP, DSTPORT, ig_md.d_2_level);
        //

        T2_RUN_AFTER_1_KEY_2( 4, DSTIP, DSTPORT, SIZE)
        T3_RUN_AFTER_1_KEY_2( 7, DSTIP, DSTPORT, SIZE)
        T2_RUN_AFTER_1_KEY_2( 8, DSTIP, DSTPORT, 1)
        T3_RUN_AFTER_2_KEY_2( 6, DSTIP, DSTPORT, SIZE)
        T2_RUN_AFTER_3_KEY_2( 3, DSTIP, DSTPORT, 1)
        T2_RUN_AFTER_3_KEY_2( 5, DSTIP, DSTPORT, SIZE)
