...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T5_KEY_UPDATE_110_8192(32w0x30243f0b) update_1_1;
    //
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_110_16384(32w0x30243f0b) update_4_3;
    //

    T2_INIT_HH_3( 5, 110, 8192)

    // apply O2
        T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_3_1;
        T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_3_2;
        T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_3_3;
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_1_1.apply(SRCIP, SRCPORT, SIZE, ig_md.d_1_bitmask, ig_md.d_1_est_1);
            d_7_above_threshold.apply(ig_md.d_1_est_1, ig_md.d_7_above_threshold);
        //

        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_4_res_hash_call.apply(SRCIP, SRCPORT, ig_md.d_4_res_hash);
            update_4_1.apply(SRCIP, SRCPORT, SIZE, ig_md.d_4_res_hash[1:1], SIZE, ig_md.d_4_est_1);
        ...
        // apply O2
        T2_RUN_AFTER_5_KEY_2(3, SRCIP, SRCPORT, SIZE)
        // 
