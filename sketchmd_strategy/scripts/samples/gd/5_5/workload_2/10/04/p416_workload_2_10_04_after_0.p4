...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T2_KEY_UPDATE_100_16384(32w0x30243f0b) update_4_1;
        T3_T2_KEY_UPDATE_100_16384(32w0x30243f0b) update_4_2;
        T3_T2_KEY_UPDATE_100_16384(32w0x30243f0b) update_4_3;
        T3_T2_KEY_UPDATE_100_16384(32w0x30243f0b) update_4_4;
        T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_4_5;
    //
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_100_16_10(32w0x30244f0b) d_10_index_hash_call_1;
        T3_T2_INDEX_UPDATE_16384() update_10_1;
        COMPUTE_HASH_100_16_10(32w0x30244f0b) d_10_index_hash_call_2;
        T3_INDEX_UPDATE_16384() update_10_2;
        COMPUTE_HASH_100_16_10(32w0x30244f0b) d_10_index_hash_call_3;
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_9_index_hash_call_2;
        T3_INDEX_UPDATE_32768() update_9_2;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_9_index_hash_call_3;
        T3_INDEX_UPDATE_32768() update_9_3;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_9_index_hash_call_4;
    ...
    apply {
        ...
        T2_RUN_AFTER_2_KEY_1( 6, SRCIP, 1)
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            d_4_res_hash_call.apply(SRCIP, ig_md.d_4_res_hash);
            update_4_1.apply(SRCIP, SIZE, ig_md.d_4_res_hash[1:1], SIZE, ig_md.d_4_est_1);
            update_4_2.apply(SRCIP, SIZE, ig_md.d_4_res_hash[2:2], SIZE, ig_md.d_4_est_2);
            update_4_3.apply(SRCIP, SIZE, ig_md.d_4_res_hash[3:3], SIZE, ig_md.d_4_est_3);
            update_4_4.apply(SRCIP, SIZE, ig_md.d_4_res_hash[4:4], SIZE, ig_md.d_4_est_4);
            d_5_above_threshold.apply(ig_md.d_4_est_1, ig_md.d_4_est_2, ig_md.d_4_est_3, ig_md.d_4_est_4, ig_md.d_5_above_threshold);
            update_4_5.apply(SRCIP, SIZE, ig_md.d_4_est_5);
        //
        ...
        d_10_index_hash_call_2.apply(SRCIP, ig_md.d_10_index2_16);
        update_10_2.apply(ig_md.d_10_base_16_1024, ig_md.d_10_index2_16, ig_md.d_10_res_hash[2:2], 1, ig_md.d_10_est_2);
        d_10_index_hash_call_3.apply(SRCIP, ig_md.d_10_index3_16);
        ...
        d_9_index_hash_call_2.apply(SRCIP, ig_md.d_9_index2_16);
        update_9_2.apply(ig_md.d_9_base_16_2048, ig_md.d_9_index2_16, ig_md.d_9_res_hash[2:2], 1, ig_md.d_9_est_2);
        d_9_index_hash_call_3.apply(SRCIP, ig_md.d_9_index3_16);
        update_9_3.apply(ig_md.d_9_base_16_2048, ig_md.d_9_index3_16, ig_md.d_9_res_hash[3:3], 1, ig_md.d_9_est_3);
        d_9_index_hash_call_4.apply(SRCIP, ig_md.d_9_index4_16);
        update_9_4.apply(ig_md.d_9_base_16_2048, ig_md.d_9_index4_16, ig_md.d_9_res_hash[4:4], 1, ig_md.d_9_est_4);
