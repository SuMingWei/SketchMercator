...
control SwitchIngress(
    ...
    T2_INIT_5( 8, 220, 4096)
    T2_INIT_1( 9, 220, 8192)
    ...
    apply {
        ...
        T2_RUN_5_KEY_4( 8, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_1_KEY_4( 9, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        ...
        T3_RUN_HH_2_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        ...
        UM_RUN_1_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        UM_RUN_2_KEY_4(20, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
    }
}
