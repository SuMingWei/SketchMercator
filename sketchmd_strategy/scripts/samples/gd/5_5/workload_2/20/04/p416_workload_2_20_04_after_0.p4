...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T2_KEY_UPDATE_200_4096(32w0x30243f0b) update_9_1;
        T2_T2_KEY_UPDATE_200_4096(32w0x30243f0b) update_9_2;
        T2_T2_KEY_UPDATE_200_4096(32w0x30243f0b) update_9_3;
    ...
    // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row) 
        COMPUTE_HASH_200_16_16(32w0x30244f0b) d_17_sampling_hash_call;
    ...
    // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row) 
        COMPUTE_HASH_200_16_8(32w0x30244f0b) d_19_sampling_hash_call;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_12_tcam_lpm.apply(ig_md.d_6_sampling_hash_32, ig_md.d_12_level);
        ...
        // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row)
        d_17_tcam_lpm_2.apply(ig_md.d_5_sampling_hash_16, ig_md.d_17_base_16_1024, ig_md.d_17_base_16_2048);
