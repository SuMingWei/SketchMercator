...
control SwitchIngress(
    ...
    // apply SALUMerge; HLL (row1) - HLL (row1) 
        ...
        T4_T4_KEY_UPDATE_100_32768(32w0x30243f0b) update_4_1;
    //
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_100_4096(32w0x30243f0b) update_14_1;
        T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_14_2;
        T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_14_3;
    //
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_100_16384(32w0x30243f0b) update_9_2;
    ...
    T2_INIT_HH_1(15, 100, 8192)
    T3_INIT_HH_2(10, 100, 4096)
    T3_INIT_HH_2(11, 100, 16384)
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ABOVE_THRESHOLD_CONSTANT_5(100) d_12_above_threshold;
        T2_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_12_1;
        T2_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_12_2;
        T2_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_12_3;
        T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_12_4;
        T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_12_5;
    //

    T2_INIT_HH_5(13, 100, 16384)
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_100_16_10(32w0x30244f0b) d_20_index_hash_call_2;
        T3_T2_INDEX_UPDATE_16384() update_20_2;
        COMPUTE_HASH_100_16_10(32w0x30244f0b) d_20_index_hash_call_3;
        T3_INDEX_UPDATE_16384() update_20_3;
        COMPUTE_HASH_100_16_10(32w0x30244f0b) d_20_index_hash_call_4;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_14_tcam_lpm.apply(ig_md.d_6_sampling_hash_32, ig_md.d_14_level);
            d_14_get_bitmask.apply(ig_md.d_14_level, ig_md.d_14_bitmask);
            update_14_1.apply(DSTIP, SIZE, ig_md.d_14_bitmask, ig_md.d_14_est_1);
            update_14_2.apply(DSTIP, SIZE, ig_md.d_14_est_2);
            update_14_3.apply(DSTIP, SIZE, ig_md.d_14_est_3);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_3(14)
        //

        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_9_res_hash_call.apply(DSTIP, ig_md.d_9_res_hash);
            update_9_1.apply(DSTIP, 1, ig_md.d_9_res_hash[1:1], SIZE, ig_md.d_9_est_1);
            update_9_2.apply(DSTIP, 1, ig_md.d_9_res_hash[2:2], ig_md.d_9_est_2);
            update_9_3.apply(DSTIP, 1, ig_md.d_9_res_hash[3:3], ig_md.d_9_est_3);
            update_9_4.apply(DSTIP, 1, ig_md.d_9_res_hash[4:4], ig_md.d_9_est_4);
            update_9_5.apply(DSTIP, 1, ig_md.d_9_res_hash[5:5], ig_md.d_9_est_5);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_5(9)
        //

        T2_RUN_AFTER_1_KEY_1(15, DSTIP, SIZE)
        T3_RUN_AFTER_2_KEY_1(10, DSTIP, SIZE)
        T3_RUN_AFTER_2_KEY_1(11, DSTIP, SIZE)
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_12_1.apply(DSTIP, 1, 1, ig_md.d_12_est_1);
            update_12_2.apply(DSTIP, 1, 1, ig_md.d_12_est_2);
            update_12_3.apply(DSTIP, 1, 1, ig_md.d_12_est_3);
            update_12_4.apply(DSTIP, 1, ig_md.d_12_est_4);
            update_12_5.apply(DSTIP, 1, ig_md.d_12_est_5);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_5(12)
        //

        T2_RUN_AFTER_5_KEY_1(13, DSTIP, 1)
