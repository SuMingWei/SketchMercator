...
control SwitchIngress(
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            d_11_above_threshold.apply(ig_md.d_7_est_1, ig_md.d_11_above_threshold);
            update_7_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, 1, ig_md.d_7_est_2);
            update_7_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, 1, ig_md.d_7_est_3);
            update_7_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, 1, ig_md.d_7_est_4);
            d_13_above_threshold.apply(ig_md.d_7_est_2, ig_md.d_7_est_3, ig_md.d_7_est_4, ig_md.d_13_above_threshold);
        //
        ...
        T2_RUN_AFTER_5_KEY_5(12, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
