...
control SwitchIngress(
    ...
    T1_INIT_4( 4, 221, 131072)
    T4_INIT_1( 5, 221, 32768)
    MRB_INIT_1( 6, 221, 262144, 14, 16)
    T2_INIT_4( 7, 221, 8192)
    T2_INIT_4( 8, 221, 8192)
    T2_INIT_4( 9, 221, 16384)
    T2_INIT_HH_3(10, 221, 16384)
    T3_INIT_HH_1(11, 221, 8192)
    T2_INIT_HH_5(12, 221, 16384)
    ...
    UM_INIT_1(18, 221, 11, 32768)
    UM_INIT_2(19, 221, 11, 32768)
    ...
    apply {
        ...
        T2_RUN_4_KEY_5( 8, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T2_RUN_4_KEY_5( 9, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T2_RUN_HH_3_KEY_5(10, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T3_RUN_HH_1_KEY_5(11, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T2_RUN_HH_5_KEY_5(12, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T2_RUN_HH_3_KEY_5(13, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T2_RUN_HH_2_KEY_5(14, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T2_RUN_HH_1_KEY_5(15, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        MRAC_RUN_1_KEY_5(16, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        MRAC_RUN_1_KEY_5(17, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        UM_RUN_1_KEY_5(18, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        UM_RUN_2_KEY_5(19, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        UM_RUN_5_KEY_5(20, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
    }
}
