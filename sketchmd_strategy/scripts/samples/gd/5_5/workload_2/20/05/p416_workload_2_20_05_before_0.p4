...
control SwitchIngress(
    ...
    UM_INIT_4(19, 110, 10, 16384)
    UM_INIT_4(20, 110, 10, 16384)
    apply {
        ...
        T5_RUN_1_KEY_2( 5, DSTIP, DSTPORT)
        T2_RUN_4_KEY_2( 6, DSTIP, DSTPORT, 1)
        T2_RUN_2_KEY_2( 7, DSTIP, DSTPORT, SIZE)
        T2_RUN_HH_5_KEY_2( 8, DSTIP, DSTPORT, 1)
        T2_RUN_HH_2_KEY_2( 9, DSTIP, DSTPORT, 1)
        T3_RUN_HH_1_KEY_2(10, DSTIP, DSTPORT, 1)
        T2_RUN_HH_1_KEY_2(11, DSTIP, DSTPORT, 1)
        ...
        UM_RUN_4_KEY_2(18, DSTIP, DSTPORT, 1)
        UM_RUN_4_KEY_2(19, DSTIP, DSTPORT, SIZE)
