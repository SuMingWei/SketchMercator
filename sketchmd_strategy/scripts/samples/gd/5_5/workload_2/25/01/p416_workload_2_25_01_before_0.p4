...
control SwitchIngress(
    ...
    T5_INIT_1( 5, 220, 16384)
    T2_INIT_5( 6, 220, 4096)
    T2_INIT_4( 7, 220, 8192)
    T2_INIT_2( 8, 220, 4096)
    T2_INIT_5( 9, 220, 16384)
    T2_INIT_4(10, 220, 8192)
    T2_INIT_HH_2(11, 220, 16384)
    T3_INIT_HH_3(12, 220, 16384)
    T3_INIT_HH_1(13, 220, 8192)
    T3_INIT_HH_3(14, 220, 16384)
    ...
    UM_INIT_3(23, 220, 11, 32768)
    UM_INIT_5(24, 220, 10, 16384)
    UM_INIT_4(25, 220, 10, 16384)
    apply {
        ...
        T5_RUN_1_KEY_4( 5, SRCIP, DSTIP, SRCPORT, DSTPORT)
        T2_RUN_5_KEY_4( 6, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_4_KEY_4( 7, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_2_KEY_4( 8, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_5_KEY_4( 9, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_4_KEY_4(10, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_HH_2_KEY_4(11, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T3_RUN_HH_3_KEY_4(12, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T3_RUN_HH_1_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T3_RUN_HH_3_KEY_4(14, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_HH_3_KEY_4(15, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_HH_3_KEY_4(16, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        ...
        UM_RUN_3_KEY_4(23, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        UM_RUN_5_KEY_4(24, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        UM_RUN_4_KEY_4(25, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
    }
}
