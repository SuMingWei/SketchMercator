...
control SwitchIngress(
    ...
    T2_INIT_2( 7, 110, 16384)
    T2_INIT_4( 8, 110, 8192)
    ...
    apply {
        ...
        T2_RUN_4_KEY_2( 8, DSTIP, DSTPORT, 1)
        T2_RUN_5_KEY_2( 9, DSTIP, DSTPORT, SIZE)
        T2_RUN_HH_1_KEY_2(10, DSTIP, DSTPORT, 1)
        ...
        T2_RUN_HH_5_KEY_2(19, DSTIP, DSTPORT, SIZE)
        MRAC_RUN_1_KEY_2(20, DSTIP, DSTPORT)
        MRAC_RUN_1_KEY_2(21, DSTIP, DSTPORT)
        UM_RUN_2_KEY_2(22, DSTIP, DSTPORT, 1)
        UM_RUN_4_KEY_2(23, DSTIP, DSTPORT, 1)
        UM_RUN_3_KEY_2(24, DSTIP, DSTPORT, SIZE)
