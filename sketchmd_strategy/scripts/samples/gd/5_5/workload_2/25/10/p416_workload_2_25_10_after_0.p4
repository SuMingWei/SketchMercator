...
control SwitchIngress(
    ...
    // apply O2
        T1_KEY_UPDATE_221_524288(32w0x30243f0b) update_2_1;
    // 


    // apply O2
        T1_KEY_UPDATE_221_262144(32w0x30243f0b) update_1_1;
        T1_KEY_UPDATE_221_131072(32w0x30243f0b) update_1_2;
    // 

    T1_INIT_3( 3, 221, 131072)
    T4_INIT_1( 4, 221, 65536)
    T3_INIT_HH_1(14, 221, 16384)
    ...
    // apply O2
        ...
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_7_4;
        ABOVE_THRESHOLD_CONSTANT_4(100) d_7_above_threshold;
    // 

    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ABOVE_THRESHOLD_CONSTANT_5(100) d_13_above_threshold;
        T2_T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_13_1;
        T2_T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_13_2;
        T2_T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_13_3;
        T2_T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_13_4;
        T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_13_5;
    //

    T3_INIT_HH_4(16, 221, 16384)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        COMPUTE_HASH_221_16_16(32w0x30244f0b) d_8_res_hash_call;
        ABOVE_THRESHOLD_CONSTANT_5(100) d_15_above_threshold;
        T3_T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_8_1;
        T3_T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_8_2;
        T3_T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_8_3;
        T3_T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_8_4;
        T3_T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_8_5;
    //
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        ABOVE_THRESHOLD_3() d_25_above_threshold;
        COMPUTE_HASH_221_16_10(32w0x30244f0b) d_25_index_hash_call_1;
        ...
        COMPUTE_HASH_221_16_10(32w0x30244f0b) d_25_index_hash_call_3;
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_221_16_10(32w0x30244f0b) d_24_index_hash_call_1;
        T3_T2_INDEX_UPDATE_16384() update_24_1;
        COMPUTE_HASH_221_16_10(32w0x30244f0b) d_24_index_hash_call_2;
        T3_T2_INDEX_UPDATE_16384() update_24_2;
        COMPUTE_HASH_221_16_11(32w0x30244f0b) d_24_index_hash_call_3;
        T3_T2_INDEX_UPDATE_32768() update_24_3;
    // 
    ...
    apply {
        ...
        T3_RUN_AFTER_1_KEY_5(14, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T2_RUN_AFTER_3_KEY_5(17, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)

        // apply O2
        T2_RUN_AFTER_4_KEY_5(7, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        // 

        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_13_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, SIZE, ig_md.d_13_est_1);
            update_13_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, SIZE, ig_md.d_13_est_2);
            update_13_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, SIZE, ig_md.d_13_est_3);
            update_13_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, SIZE, ig_md.d_13_est_4);
            update_13_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_13_est_5);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_5(13)
        //

        T3_RUN_AFTER_4_KEY_5(16, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            d_8_res_hash_call.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_8_res_hash);
            update_8_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_8_res_hash[1:1], 1, ig_md.d_8_est_1);
            update_8_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_8_res_hash[2:2], 1, ig_md.d_8_est_2);
            update_8_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_8_res_hash[3:3], 1, ig_md.d_8_est_3);
            update_8_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_8_res_hash[4:4], 1, ig_md.d_8_est_4);
            update_8_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_8_res_hash[5:5], 1, ig_md.d_8_est_5);
            d_15_above_threshold.apply(ig_md.d_8_est_1, ig_md.d_8_est_2, ig_md.d_8_est_3, ig_md.d_8_est_4, ig_md.d_8_est_5, ig_md.d_15_above_threshold);
        //


        // apply O2
        T2_RUN_AFTER_5_KEY_5(9, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        // 
        ...
        update_24_2.apply(ig_md.d_24_base_16_1024, ig_md.d_24_index2_16, ig_md.d_24_res_hash[2:2], 1, ig_md.d_24_est_2);
