...
control SwitchIngress(
    ...
    T1_INIT_3( 3, 110, 262144)

    // apply O2
        T1_KEY_UPDATE_110_262144(32w0x30243f0b) update_4_1;
        ...
        T1_KEY_UPDATE_110_262144(32w0x30243f0b) update_4_5;
    // 
    ...
    // apply O2
        T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_11_1;
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_8_4;
        T2_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_8_5;
    //
    ...
    // apply SALUMerge; big - MRAC (1 row) / small - UnivMon (1 row) 
        ...
        COMPUTE_HASH_110_16_11(32w0x30244f0b) d_21_index_hash_call_1;
    ...
    // apply SALUMerge; big - MRAC (1 row) / small - UnivMon (1 row) 
        ...
        COMPUTE_HASH_110_16_11(32w0x30244f0b) d_22_index_hash_call_1;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_10_1.apply(DSTIP, DSTPORT, SIZE, ig_md.d_10_bitmask, ig_md.d_10_est_1);
            update_10_2.apply(DSTIP, DSTPORT, SIZE, ig_md.d_10_est_2);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_2(10)
        //


        // apply O2
        T2_RUN_AFTER_3_KEY_2(11, DSTIP, DSTPORT, SIZE)
        // 

        T3_RUN_AFTER_4_KEY_2(14, DSTIP, DSTPORT, 1)
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_8_1.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_8_est_1);
            update_8_2.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_8_est_2);
            update_8_3.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_8_est_3);
            update_8_4.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_8_est_4);
            update_8_5.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_8_est_5);
            d_16_above_threshold.apply(ig_md.d_8_est_1, ig_md.d_8_est_2, ig_md.d_8_est_3, ig_md.d_8_est_4, ig_md.d_8_est_5, ig_md.d_16_above_threshold);
        //
