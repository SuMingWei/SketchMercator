...
control SwitchIngress(
    ...
    T2_INIT_2( 7, 221, 4096)
    T2_INIT_4( 8, 221, 16384)
    T2_INIT_3( 9, 221, 16384)
    T2_INIT_2(10, 221, 16384)
    T2_INIT_HH_3(11, 221, 4096)
    T2_INIT_HH_1(12, 221, 4096)
    T2_INIT_HH_3(13, 221, 8192)
    T3_INIT_HH_2(14, 221, 16384)
    T3_INIT_HH_3(15, 221, 16384)
    T2_INIT_HH_5(16, 221, 8192)
    T2_INIT_HH_2(17, 221, 8192)
    ...
    apply {
        ...
        T2_RUN_4_KEY_5( 8, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T2_RUN_3_KEY_5( 9, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T2_RUN_2_KEY_5(10, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T2_RUN_HH_3_KEY_5(11, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T2_RUN_HH_1_KEY_5(12, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T2_RUN_HH_3_KEY_5(13, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T3_RUN_HH_2_KEY_5(14, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T3_RUN_HH_3_KEY_5(15, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T2_RUN_HH_5_KEY_5(16, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T2_RUN_HH_2_KEY_5(17, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        ...
        UM_RUN_4_KEY_5(24, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        UM_RUN_2_KEY_5(25, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
    }
}
