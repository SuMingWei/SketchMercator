...
control SwitchIngress(
    ...
    // apply O2
        T1_KEY_UPDATE_220_262144(32w0x30243f0b) update_2_1;
        T1_KEY_UPDATE_220_131072(32w0x30243f0b) update_2_2;
    // 

    T1_INIT_2( 4, 220, 262144)
    T1_INIT_4( 3, 220, 262144)
    T1_INIT_5( 1, 220, 262144)
    MRB_INIT_1( 6, 220, 524288, 15, 16)
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_9_5;
    //

    T3_INIT_HH_1(13, 220, 4096)
    ...
    // apply O2
        ...
        T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_8_4;
        T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_8_5;
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_220_16_11(32w0x30244f0b) d_25_index_hash_call_1;
        T3_T2_INDEX_UPDATE_32768() update_25_1;
        COMPUTE_HASH_220_16_11(32w0x30244f0b) d_25_index_hash_call_2;
        T3_T2_INDEX_UPDATE_32768() update_25_2;
        COMPUTE_HASH_220_16_11(32w0x30244f0b) d_25_index_hash_call_3;
        T3_T2_INDEX_UPDATE_32768() update_25_3;
        COMPUTE_HASH_220_16_11(32w0x30244f0b) d_25_index_hash_call_4;
        T3_INDEX_UPDATE_32768() update_25_4;
        COMPUTE_HASH_220_16_11(32w0x30244f0b) d_25_index_hash_call_5;
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_220_16_10(32w0x30244f0b) d_24_index_hash_call_1;
        T3_T2_INDEX_UPDATE_16384() update_24_1;
        COMPUTE_HASH_220_16_10(32w0x30244f0b) d_24_index_hash_call_2;
        T3_INDEX_UPDATE_16384() update_24_2;
        COMPUTE_HASH_220_16_10(32w0x30244f0b) d_24_index_hash_call_3;
        T3_INDEX_UPDATE_16384() update_24_3;
        COMPUTE_HASH_220_16_10(32w0x30244f0b) d_24_index_hash_call_4;
        T3_INDEX_UPDATE_16384() update_24_4;
        COMPUTE_HASH_220_16_10(32w0x30244f0b) d_24_index_hash_call_5;
    ...
    apply {
        ...
        T1_RUN_2_KEY_4( 4, SRCIP, DSTIP, SRCPORT, DSTPORT) if (ig_md.d_4_est1_1 == 0 || ig_md.d_4_est1_2 == 0) { /* process_new_flow() */ }
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_9_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_9_est_5);
        ...
        // apply O2
        T2_RUN_AFTER_2_KEY_4(10, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        // 
        ...
        T2_RUN_AFTER_4_KEY_4(17, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)

        // apply O2
        T2_RUN_AFTER_5_KEY_4(8, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        // 
        ...
        update_25_3.apply(ig_md.d_25_base_16_2048, ig_md.d_25_index3_16, ig_md.d_25_res_hash[3:3], SIZE, ig_md.d_25_est_3);
        d_25_index_hash_call_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_25_index4_16);
        update_25_4.apply(ig_md.d_25_base_16_2048, ig_md.d_25_index4_16, ig_md.d_25_res_hash[4:4], SIZE, ig_md.d_25_est_4);
        d_25_index_hash_call_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_25_index5_16);
        update_25_5.apply(ig_md.d_25_base_16_2048, ig_md.d_25_index5_16, ig_md.d_25_res_hash[5:5], SIZE, ig_md.d_25_est_5);
