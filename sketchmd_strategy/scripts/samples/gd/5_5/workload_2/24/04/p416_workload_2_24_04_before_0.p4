...
control SwitchIngress(
    ...
    MRAC_INIT_1(21, 200, 16384, 10, 16)
    MRAC_INIT_1(22, 200, 16384, 11,  8)
    UM_INIT_2(23, 200, 10, 16384)
    UM_INIT_2(24, 200, 11, 32768)
    apply {
        ...
        T3_RUN_HH_2_KEY_2(14, SRCIP, DSTIP, 1)
        T3_RUN_HH_2_KEY_2(15, SRCIP, DSTIP, SIZE)
        T2_RUN_HH_1_KEY_2(16, SRCIP, DSTIP, 1)
        T2_RUN_HH_5_KEY_2(17, SRCIP, DSTIP, 1)
        T2_RUN_HH_1_KEY_2(18, SRCIP, DSTIP, 1)
        T2_RUN_HH_1_KEY_2(19, SRCIP, DSTIP, SIZE)
        T2_RUN_HH_1_KEY_2(20, SRCIP, DSTIP, SIZE)
        MRAC_RUN_1_KEY_2(21, SRCIP, DSTIP)
        MRAC_RUN_1_KEY_2(22, SRCIP, DSTIP)
        UM_RUN_2_KEY_2(23, SRCIP, DSTIP, 1)
        UM_RUN_2_KEY_2(24, SRCIP, DSTIP, SIZE)
    }
}
