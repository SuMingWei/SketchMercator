...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T2_KEY_UPDATE_110_16384(32w0x30243f0b) update_6_2;
    //
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_110_16_11(32w0x30244f0b) d_21_index_hash_call_2;
        T3_INDEX_UPDATE_32768() update_21_2;
        COMPUTE_HASH_110_16_11(32w0x30244f0b) d_21_index_hash_call_3;
    ...
    apply {
        ...
        T2_RUN_AFTER_1_KEY_2(16, DSTIP, DSTPORT, SIZE)
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
