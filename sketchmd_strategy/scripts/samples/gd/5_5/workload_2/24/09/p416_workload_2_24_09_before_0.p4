...
control SwitchIngress(
    ...
    T2_INIT_5( 7, 100, 16384)
    T2_INIT_1( 8, 100, 16384)
    T2_INIT_2( 9, 100, 16384)
    T2_INIT_3(10, 100, 8192)
    ...
    T2_INIT_HH_1(17, 100, 4096)
    T2_INIT_HH_2(18, 100, 8192)
    T2_INIT_HH_4(19, 100, 4096)
    MRAC_INIT_1(20, 100, 16384, 10, 16)
    ...
    apply {
        ...
        MRB_RUN_1_KEY_1( 6, DSTIP)
        T2_RUN_5_KEY_1( 7, DSTIP, 1)
        T2_RUN_1_KEY_1( 8, DSTIP, 1)
        T2_RUN_2_KEY_1( 9, DSTIP, SIZE)
        T2_RUN_3_KEY_1(10, DSTIP, SIZE)
        T2_RUN_3_KEY_1(11, DSTIP, SIZE)
        T2_RUN_HH_2_KEY_1(12, DSTIP, 1)
        T2_RUN_HH_3_KEY_1(13, DSTIP, 1)
        T2_RUN_HH_2_KEY_1(14, DSTIP, SIZE)
        T3_RUN_HH_2_KEY_1(15, DSTIP, SIZE)
        T3_RUN_HH_2_KEY_1(16, DSTIP, SIZE)
        T2_RUN_HH_1_KEY_1(17, DSTIP, 1)
        T2_RUN_HH_2_KEY_1(18, DSTIP, 1)
        T2_RUN_HH_4_KEY_1(19, DSTIP, SIZE)
        MRAC_RUN_1_KEY_1(20, DSTIP)
        MRAC_RUN_1_KEY_1(21, DSTIP)
        MRAC_RUN_1_KEY_1(22, DSTIP)
        UM_RUN_2_KEY_1(23, DSTIP, 1)
        UM_RUN_4_KEY_1(24, DSTIP, 1)
    }
}
