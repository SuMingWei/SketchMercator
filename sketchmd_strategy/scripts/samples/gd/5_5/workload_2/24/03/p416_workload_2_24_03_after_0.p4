...
control SwitchIngress(
    ...
    // O1 hash init
        ...
        COMPUTE_HASH_221_32_32(32w0x30244f0b) d_7_auto_sampling_hash_call;
    ...
    T1_INIT_4( 4, 221, 524288)
    T1_INIT_5( 1, 221, 131072)
    T4_INIT_1( 5, 221, 32768)
    MRB_INIT_1( 6, 221, 131072, 14,  8)
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ABOVE_THRESHOLD_CONSTANT_5(100) d_8_above_threshold;
        COMPUTE_HASH_221_32_32(32w0x30244f0b) d_8_hash_call;
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_11_2;
        T3_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_11_3;
        T3_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_11_4;
    //
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        ABOVE_THRESHOLD_5() d_24_above_threshold;
        ...
        COMPUTE_HASH_221_16_10(32w0x30244f0b) d_24_index_hash_call_4;
        T3_T2_INDEX_UPDATE_16384() update_24_4;
        COMPUTE_HASH_221_16_10(32w0x30244f0b) d_24_index_hash_call_5;
        T3_INDEX_UPDATE_16384() update_24_5;
    // 
    ...
    apply {
        // O1 hash run
            ...
            d_7_auto_sampling_hash_call.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_7_sampling_hash_32);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_8_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_8_bitmask, ig_md.d_8_est_1);
            update_8_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_8_est_2);
            update_8_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_8_est_3);
            update_8_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_8_est_4);
            update_8_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_8_est_5);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_5(8)
        //

        T3_RUN_AFTER_1_KEY_5(17, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)

        // apply O2
        T2_RUN_AFTER_2_KEY_5(15, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        // 

        T3_RUN_AFTER_2_KEY_5(16, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_11_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_11_res_hash[1:1], SIZE, ig_md.d_11_est_1);
            update_11_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_11_res_hash[2:2], SIZE, ig_md.d_11_est_2);
            update_11_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_11_res_hash[3:3], SIZE, ig_md.d_11_est_3);
            update_11_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_11_res_hash[4:4], SIZE, ig_md.d_11_est_4);
            d_18_above_threshold.apply(ig_md.d_11_est_1, ig_md.d_11_est_2, ig_md.d_11_est_3, ig_md.d_11_est_4, ig_md.d_18_above_threshold);
        //


        // apply O2
        T2_RUN_AFTER_5_KEY_5(9, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        // 
        ...
        update_24_5.apply(ig_md.d_24_base_16_1024, ig_md.d_24_index5_16, ig_md.d_24_res_hash[5:5], 1, ig_md.d_24_est_5);
