...
control SwitchIngress(
    ...
    T2_INIT_HH_4(16, 200, 4096)
    T2_INIT_HH_2(17, 200, 8192)
    MRAC_INIT_1(18, 200, 16384, 11,  8)
    MRAC_INIT_1(19, 200, 32768, 11, 16)
    MRAC_INIT_1(20, 200, 32768, 11, 16)
    MRAC_INIT_1(21, 200, 16384, 11,  8)
    UM_INIT_3(22, 200, 11, 32768)
    UM_INIT_2(23, 200, 11, 32768)
    ...
    apply {
        ...
        UM_RUN_3_KEY_2(22, SRCIP, DSTIP, 1)
        UM_RUN_2_KEY_2(23, SRCIP, DSTIP, 1)
        UM_RUN_5_KEY_2(24, SRCIP, DSTIP, SIZE)
    }
}
