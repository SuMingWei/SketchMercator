...
control SwitchIngress(
    ...
    T2_INIT_HH_5(17, 200, 8192)
    T2_INIT_HH_2(18, 200, 4096)
    T2_INIT_HH_4(19, 200, 8192)
    MRAC_INIT_1(20, 200, 32768, 11, 16)
    ...
    apply {
        ...
        T2_RUN_2_KEY_2( 6, SRCIP, DSTIP, 1)
        T2_RUN_4_KEY_2( 7, SRCIP, DSTIP, 1)
        T2_RUN_2_KEY_2( 8, SRCIP, DSTIP, SIZE)
        T2_RUN_HH_1_KEY_2( 9, SRCIP, DSTIP, SIZE)
        T2_RUN_HH_1_KEY_2(10, SRCIP, DSTIP, SIZE)
        T3_RUN_HH_3_KEY_2(11, SRCIP, DSTIP, 1)
        T2_RUN_HH_3_KEY_2(12, SRCIP, DSTIP, 1)
        T2_RUN_HH_1_KEY_2(13, SRCIP, DSTIP, 1)
        T2_RUN_HH_3_KEY_2(14, SRCIP, DSTIP, 1)
        T2_RUN_HH_1_KEY_2(15, SRCIP, DSTIP, 1)
        T2_RUN_HH_2_KEY_2(16, SRCIP, DSTIP, SIZE)
        T2_RUN_HH_5_KEY_2(17, SRCIP, DSTIP, SIZE)
        T2_RUN_HH_2_KEY_2(18, SRCIP, DSTIP, SIZE)
        T2_RUN_HH_4_KEY_2(19, SRCIP, DSTIP, SIZE)
        MRAC_RUN_1_KEY_2(20, SRCIP, DSTIP)
        MRAC_RUN_1_KEY_2(21, SRCIP, DSTIP)
        MRAC_RUN_1_KEY_2(22, SRCIP, DSTIP)
        UM_RUN_3_KEY_2(23, SRCIP, DSTIP, 1)
        UM_RUN_4_KEY_2(24, SRCIP, DSTIP, SIZE)
    }
}
