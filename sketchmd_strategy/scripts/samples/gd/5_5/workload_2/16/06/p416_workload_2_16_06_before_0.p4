...
control SwitchIngress(
    ...
    apply {
        ...
        T3_RUN_HH_5_KEY_2( 7, DSTIP, DSTPORT, 1)
        T2_RUN_HH_1_KEY_2( 8, DSTIP, DSTPORT, 1)
        ...
        UM_RUN_5_KEY_2(15, DSTIP, DSTPORT, SIZE)
        UM_RUN_3_KEY_2(16, DSTIP, DSTPORT, SIZE)
    }
}
