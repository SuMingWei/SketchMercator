...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T5_KEY_UPDATE_110_8192(32w0x30243f0b) update_4_1;
    //
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T2_KEY_UPDATE_110_16384(32w0x30243f0b) update_5_2;
        T3_T2_KEY_UPDATE_110_16384(32w0x30243f0b) update_5_3;
        T3_T2_KEY_UPDATE_110_16384(32w0x30243f0b) update_5_4;
        T3_T2_KEY_UPDATE_110_16384(32w0x30243f0b) update_5_5;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            d_8_above_threshold.apply(ig_md.d_4_est_1, ig_md.d_8_above_threshold);
        //
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_5_3.apply(DSTIP, DSTPORT, 1, ig_md.d_5_res_hash[3:3], 1, ig_md.d_5_est_3);
            update_5_4.apply(DSTIP, DSTPORT, 1, ig_md.d_5_res_hash[4:4], 1, ig_md.d_5_est_4);
            update_5_5.apply(DSTIP, DSTPORT, 1, ig_md.d_5_res_hash[5:5], 1, ig_md.d_5_est_5);
