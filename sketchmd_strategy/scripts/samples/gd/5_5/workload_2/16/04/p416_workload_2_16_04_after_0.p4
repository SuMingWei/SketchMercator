...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_7_2;
        T3_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_7_3;
        T3_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_7_4;
    //

    T3_INIT_HH_3( 8, 100, 4096)
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_16_index_hash_call_4;
        T3_T2_INDEX_UPDATE_32768() update_16_4;
    // 
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_7_1.apply(SRCIP, 1, ig_md.d_7_res_hash[1:1], 1, ig_md.d_7_est_1);
            update_7_2.apply(SRCIP, 1, ig_md.d_7_res_hash[2:2], 1, ig_md.d_7_est_2);
            update_7_3.apply(SRCIP, 1, ig_md.d_7_res_hash[3:3], 1, ig_md.d_7_est_3);
            update_7_4.apply(SRCIP, 1, ig_md.d_7_res_hash[4:4], 1, ig_md.d_7_est_4);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_4(7)
        //

        T3_RUN_AFTER_3_KEY_1( 8, SRCIP, 1)

        // apply O2
        T2_RUN_AFTER_4_KEY_1(6, SRCIP, SIZE)
        // 
        ...
        T2_RUN_AFTER_5_KEY_1(10, SRCIP, SIZE)
        ...
        d_16_index_hash_call_4.apply(SRCIP, ig_md.d_16_index4_16);
        update_16_4.apply(ig_md.d_16_base_16_2048, ig_md.d_16_index4_16, ig_md.d_16_res_hash[4:4], SIZE, ig_md.d_16_est_4);
