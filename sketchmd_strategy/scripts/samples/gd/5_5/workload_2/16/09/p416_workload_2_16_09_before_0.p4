...
control SwitchIngress(
    ...
    MRAC_INIT_1(13, 220, 16384, 10, 16)
    ...
    apply {
        ...
        T2_RUN_2_KEY_4( 6, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_4_KEY_4( 7, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_1_KEY_4( 8, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_HH_2_KEY_4( 9, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T3_RUN_HH_4_KEY_4(10, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        ...
        UM_RUN_1_KEY_4(14, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        UM_RUN_1_KEY_4(15, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        UM_RUN_5_KEY_4(16, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
    }
}
