...
control SwitchIngress(
    ...
    T3_INIT_HH_1( 6, 110, 16384)
    T3_INIT_HH_4( 7, 110, 4096)
    T3_INIT_HH_1( 8, 110, 16384)
    ...
    apply {
        ...
        T5_RUN_1_KEY_2( 3, SRCIP, SRCPORT)
        T2_RUN_4_KEY_2( 4, SRCIP, SRCPORT, SIZE)
        T2_RUN_2_KEY_2( 5, SRCIP, SRCPORT, SIZE)
        T3_RUN_HH_1_KEY_2( 6, SRCIP, SRCPORT, 1)
        T3_RUN_HH_4_KEY_2( 7, SRCIP, SRCPORT, SIZE)
        T3_RUN_HH_1_KEY_2( 8, SRCIP, SRCPORT, SIZE)
        ...
        UM_RUN_4_KEY_2(16, SRCIP, SRCPORT, SIZE)
    }
}
