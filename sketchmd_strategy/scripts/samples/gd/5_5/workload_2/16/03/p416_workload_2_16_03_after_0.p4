...
control SwitchIngress(
    ...
    // apply O2
        ...
        T1_KEY_UPDATE_110_524288(32w0x30243f0b) update_1_4;
        T1_KEY_UPDATE_110_524288(32w0x30243f0b) update_1_5;
    // 
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T5_KEY_UPDATE_110_8192(32w0x30243f0b) update_3_1;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_3_1.apply(SRCIP, SRCPORT, SIZE, ig_md.d_3_bitmask, ig_md.d_3_est_1);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_4_2.apply(SRCIP, SRCPORT, SIZE, ig_md.d_4_res_hash[2:2], SIZE, ig_md.d_4_est_2);
            d_8_above_threshold.apply(ig_md.d_4_est_2, ig_md.d_8_above_threshold);
            update_4_3.apply(SRCIP, SRCPORT, SIZE, SIZE, ig_md.d_4_est_3);
            update_4_4.apply(SRCIP, SRCPORT, SIZE, SIZE, ig_md.d_4_est_4);
            d_5_above_threshold.apply(ig_md.d_4_est_3, ig_md.d_4_est_4, ig_md.d_5_above_threshold);
        //
