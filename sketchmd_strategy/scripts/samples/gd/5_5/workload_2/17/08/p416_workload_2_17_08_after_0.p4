...
control SwitchIngress(
    ...
    T1_INIT_1( 2, 220, 524288)
    T1_INIT_4( 1, 220, 131072)
    T1_INIT_5( 3, 220, 262144)
    T4_INIT_1( 4, 220, 65536)
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_9_2;
        T3_T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_9_3;
        T3_T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_9_4;
    //

    T2_INIT_HH_1( 8, 220, 4096)
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        T3_T2_INDEX_UPDATE_16384() update_16_3;
    // 

    UM_INIT_2(17, 220, 11, 32768)
    UM_INIT_5(15, 220, 11, 32768)
    ...
    apply {
        ...
        // HLL for inst 4
            ...
            update_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_4_level);
        //
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_9_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_9_res_hash[2:2], SIZE, ig_md.d_9_est_2);
            update_9_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_9_res_hash[3:3], SIZE, ig_md.d_9_est_3);
            update_9_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_9_res_hash[4:4], SIZE, ig_md.d_9_est_4);
        ...
        // apply O2
        T2_RUN_AFTER_4_KEY_4(6, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        // 
        ...
        // UnivMon for inst 15
            ...
            d_15_index_hash_call_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_15_index5_16); 
