...
control SwitchIngress(
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            d_12_above_threshold.apply(ig_md.d_4_est_1, ig_md.d_12_above_threshold);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_5_3.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_5_est_3);
            update_5_4.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_5_est_4);
            update_5_5.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_5_est_5);
            d_11_above_threshold.apply(ig_md.d_5_est_3, ig_md.d_5_est_4, ig_md.d_5_est_5, ig_md.d_11_above_threshold);
        //
