...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_5_3;
        T3_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_5_4;
        T3_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_5_5;
    //
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        T3_T2_INDEX_UPDATE_32768() update_16_2;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_4_1.apply(DSTIP, DSTPORT, 1, ig_md.d_4_bitmask, ig_md.d_4_est_1);
            update_4_2.apply(DSTIP, DSTPORT, 1, ig_md.d_4_est_2);
            update_4_3.apply(DSTIP, DSTPORT, 1, ig_md.d_4_est_3);
            update_4_4.apply(DSTIP, DSTPORT, 1, ig_md.d_4_est_4);
            update_4_5.apply(DSTIP, DSTPORT, 1, ig_md.d_4_est_5);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_5_2.apply(DSTIP, DSTPORT, 1, SIZE, ig_md.d_5_est_2);
            d_7_above_threshold.apply(ig_md.d_5_est_1, ig_md.d_5_est_2, ig_md.d_7_above_threshold);
            update_5_3.apply(DSTIP, DSTPORT, 1, ig_md.d_5_res_hash[3:3], SIZE, ig_md.d_5_est_3);
            update_5_4.apply(DSTIP, DSTPORT, 1, ig_md.d_5_res_hash[4:4], SIZE, ig_md.d_5_est_4);
            update_5_5.apply(DSTIP, DSTPORT, 1, ig_md.d_5_res_hash[5:5], SIZE, ig_md.d_5_est_5);
            d_8_above_threshold.apply(ig_md.d_5_est_3, ig_md.d_5_est_4, ig_md.d_5_est_5, ig_md.d_8_above_threshold);
        //
        ...
        update_16_3.apply(ig_md.d_16_base_16_2048, ig_md.d_16_index3_16, ig_md.d_16_res_hash[3:3], 1, ig_md.d_16_est_3);
