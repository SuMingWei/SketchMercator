...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T5_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_5_1;
    ...
    // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row) 
        COMPUTE_HASH_110_16_8(32w0x30244f0b) d_11_sampling_hash_call;
        COMPUTE_HASH_110_16_11(32w0x30244f0b) d_11_index_hash_call_1;
        LPM_OPT_MRAC_2() d_11_tcam_lpm_2;
        T2_T2_INDEX_UPDATE_16384() update_11;
    // 
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_5_1.apply(DSTIP, DSTPORT, 1, ig_md.d_5_bitmask, ig_md.d_5_est_1);
            update_5_2.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_5_est_2);
            update_5_3.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_5_est_3);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_6_2.apply(DSTIP, DSTPORT, SIZE, SIZE, ig_md.d_6_est_2);
            update_6_3.apply(DSTIP, DSTPORT, SIZE, SIZE, ig_md.d_6_est_3);
            update_6_4.apply(DSTIP, DSTPORT, SIZE, SIZE, ig_md.d_6_est_4);
            update_6_5.apply(DSTIP, DSTPORT, SIZE, SIZE, ig_md.d_6_est_5);
        ...
        // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row)
        d_11_tcam_lpm_2.apply(ig_md.d_11_sampling_hash_16, ig_md.d_11_base_16_1024, ig_md.d_11_base_16_2048);
        d_11_index_hash_call_1.apply(DSTIP, DSTPORT, ig_md.d_11_index1_16);
        update_11.apply(ig_md.d_11_base_16_2048, ig_md.d_11_index1_16);
        // 
