...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T5_KEY_UPDATE_110_16384(32w0x30243f0b) update_3_1;
    //

    T3_INIT_HH_3( 6, 110, 16384)
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_110_8192(32w0x30243f0b) update_7_5;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_3_1.apply(DSTIP, DSTPORT, SIZE, ig_md.d_3_bitmask, ig_md.d_3_est_1);
            d_8_above_threshold.apply(ig_md.d_3_est_1, ig_md.d_8_above_threshold);
        //

        T3_RUN_AFTER_3_KEY_2( 6, DSTIP, DSTPORT, 1)
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_7_5.apply(DSTIP, DSTPORT, SIZE, ig_md.d_7_res_hash[5:5], ig_md.d_7_est_5);
