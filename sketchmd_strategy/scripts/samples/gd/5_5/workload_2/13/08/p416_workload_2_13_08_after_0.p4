...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_7_1;
        T3_KEY_UPDATE_220_16384(32w0x30243f0b) update_7_2;
        T3_KEY_UPDATE_220_16384(32w0x30243f0b) update_7_3;
        T3_KEY_UPDATE_220_16384(32w0x30243f0b) update_7_4;
    //

    T2_INIT_HH_1( 9, 220, 4096)
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ABOVE_THRESHOLD_CONSTANT_3(100) d_3_above_threshold;
        T2_T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_3_1;
        T2_T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_3_2;
        T2_T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_3_3;
    //


    // apply O2
        T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_2_1;
        T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_2_2;
        T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_2_3;
        T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_2_4;
        T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_2_5;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_7_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_7_res_hash[1:1], SIZE, ig_md.d_7_est_1);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_3_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, SIZE, ig_md.d_3_est_1);
            update_3_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, SIZE, ig_md.d_3_est_2);
            update_3_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, SIZE, ig_md.d_3_est_3);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_3(3)
        //


        // apply O2
        T2_RUN_AFTER_5_KEY_4(2, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        // 
