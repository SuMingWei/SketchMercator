...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_4_2;
        T2_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_4_3;
        T2_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_4_4;
        T2_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_4_5;
    //
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_6_4;
        T3_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_6_5;
    //


    // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row) 
        COMPUTE_HASH_110_16_8(32w0x30244f0b) d_10_sampling_hash_call;
        COMPUTE_HASH_110_16_11(32w0x30244f0b) d_10_index_hash_call_1;
        LPM_OPT_MRAC_2() d_10_tcam_lpm_2;
        T2_T2_INDEX_UPDATE_16384() update_10;
    // 


    // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row) 
        COMPUTE_HASH_110_16_8(32w0x30244f0b) d_12_sampling_hash_call;
        COMPUTE_HASH_110_16_10(32w0x30244f0b) d_12_index_hash_call_1;
        LPM_OPT_MRAC_2() d_12_tcam_lpm_2;
        T2_T2_INDEX_UPDATE_8192() update_12;
    // 
    ...
    apply {
        ...
        T1_RUN_1_KEY_2( 1, DSTIP, DSTPORT) if (ig_md.d_1_est1_1 == 0) { /* process_new_flow() */ }
        // MRB for inst 2
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_7_1.apply(DSTIP, DSTPORT, SIZE, ig_md.d_7_bitmask, ig_md.d_7_est_1);
            update_7_2.apply(DSTIP, DSTPORT, SIZE, ig_md.d_7_est_2);
            update_7_3.apply(DSTIP, DSTPORT, SIZE, ig_md.d_7_est_3);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_4_4.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_4_est_4);
            update_4_5.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_4_est_5);
        //
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_6_2.apply(DSTIP, DSTPORT, 1, ig_md.d_6_res_hash[2:2], SIZE, ig_md.d_6_est_2);
            update_6_3.apply(DSTIP, DSTPORT, 1, ig_md.d_6_res_hash[3:3], SIZE, ig_md.d_6_est_3);
            update_6_4.apply(DSTIP, DSTPORT, 1, ig_md.d_6_res_hash[4:4], SIZE, ig_md.d_6_est_4);
            update_6_5.apply(DSTIP, DSTPORT, 1, ig_md.d_6_res_hash[5:5], SIZE, ig_md.d_6_est_5);
            d_8_above_threshold.apply(ig_md.d_6_est_1, ig_md.d_6_est_2, ig_md.d_6_est_3, ig_md.d_6_est_4, ig_md.d_6_est_5, ig_md.d_8_above_threshold);
        //


        // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row)
        d_10_tcam_lpm_2.apply(ig_md.d_2_sampling_hash_16, ig_md.d_10_base_16_1024, ig_md.d_10_base_16_2048);
