...
control SwitchIngress(
    ...
    // apply O2
        T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_3_1;
        T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_3_2;
        T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_3_3;
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_7_4;
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        T3_T2_INDEX_UPDATE_32768() update_13_3;
    ...
    apply {
        ...
        // apply O2
        T2_RUN_AFTER_4_KEY_4(3, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        // 
