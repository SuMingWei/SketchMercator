...
control SwitchIngress(
    ...
    // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row) 
        ...
        T2_T2_INDEX_UPDATE_8192() update_11;
    // 
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_6_2.apply(SRCIP, SRCPORT, SIZE, SIZE, ig_md.d_6_est_2);
            d_5_above_threshold.apply(ig_md.d_6_est_1, ig_md.d_6_est_2, ig_md.d_5_above_threshold);
            update_6_3.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_6_est_3);
            update_6_4.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_6_est_4);
            update_6_5.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_6_est_5);
            d_4_above_threshold.apply(ig_md.d_6_est_3, ig_md.d_6_est_4, ig_md.d_6_est_5, ig_md.d_4_above_threshold);
        //
        ...
        // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row)
        d_11_tcam_lpm_2.apply(ig_md.d_3_sampling_hash_16, ig_md.d_11_base_16_1024, ig_md.d_11_base_16_2048);
        d_11_index_hash_call_1.apply(SRCIP, SRCPORT, ig_md.d_11_index1_16);
        update_11.apply(ig_md.d_11_base_16_1024, ig_md.d_11_index1_16);
        // 
