...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_221_16384(32w0x30243f0b) update_6_5;
    //
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        T3_T2_INDEX_UPDATE_32768() update_12_3;
        COMPUTE_HASH_221_16_11(32w0x30244f0b) d_12_index_hash_call_4;
        T3_INDEX_UPDATE_32768() update_12_4;
        COMPUTE_HASH_221_16_11(32w0x30244f0b) d_12_index_hash_call_5;
    ...
    apply {
        ...
        T3_RUN_AFTER_1_KEY_5( 5, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_6_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_6_res_hash[5:5], ig_md.d_6_est_5);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_5(6)
        //

        T3_RUN_AFTER_4_KEY_5( 4, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T3_RUN_AFTER_5_KEY_5( 7, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T2_RUN_AFTER_5_KEY_5( 8, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
