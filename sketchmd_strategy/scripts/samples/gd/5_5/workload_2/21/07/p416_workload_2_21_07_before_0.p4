...
control SwitchIngress(
    ...
    T2_INIT_1( 4, 200, 4096)
    T2_INIT_1( 5, 200, 16384)
    T2_INIT_4( 6, 200, 4096)
    T2_INIT_2( 7, 200, 4096)
    T2_INIT_4( 8, 200, 4096)
    T2_INIT_HH_5( 9, 200, 8192)
    T2_INIT_HH_2(10, 200, 16384)
    T2_INIT_HH_3(11, 200, 8192)
    T2_INIT_HH_2(12, 200, 8192)
    T2_INIT_HH_1(13, 200, 16384)
    T2_INIT_HH_2(14, 200, 8192)
    MRAC_INIT_1(15, 200, 16384, 11,  8)
    MRAC_INIT_1(16, 200, 32768, 11, 16)
    MRAC_INIT_1(17, 200, 16384, 11,  8)
    MRAC_INIT_1(18, 200, 8192, 10,  8)
    UM_INIT_2(19, 200, 11, 32768)
    UM_INIT_3(20, 200, 10, 16384)
    UM_INIT_4(21, 200, 11, 32768)
    apply {
        ...
        T2_RUN_1_KEY_2( 5, SRCIP, DSTIP, 1)
        ...
        T2_RUN_HH_2_KEY_2(14, SRCIP, DSTIP, SIZE)
        ...
        UM_RUN_2_KEY_2(19, SRCIP, DSTIP, SIZE)
        UM_RUN_3_KEY_2(20, SRCIP, DSTIP, SIZE)
        UM_RUN_4_KEY_2(21, SRCIP, DSTIP, SIZE)
    }
}
