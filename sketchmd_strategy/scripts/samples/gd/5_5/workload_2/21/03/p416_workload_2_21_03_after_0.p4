...
control SwitchIngress(
    ...
    // apply SALUMerge; HLL (row1) - HLL (row1) 
        ...
        T4_T4_KEY_UPDATE_221_16384(32w0x30243f0b) update_3_1;
    //
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_221_4096(32w0x30243f0b) update_7_1;
        ...
        T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_7_5;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_7_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_7_est_5);
        ...
        // apply O2
        T2_RUN_AFTER_3_KEY_5(9, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        // 

        T2_RUN_AFTER_4_KEY_5(11, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T3_RUN_AFTER_4_KEY_5(13, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
