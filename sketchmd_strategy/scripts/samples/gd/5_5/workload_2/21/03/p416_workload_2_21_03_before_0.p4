...
control SwitchIngress(
    ...
    T1_INIT_1( 5, 221, 524288)
    T5_INIT_1( 6, 221, 4096)
    T2_INIT_1( 7, 221, 4096)
    T2_INIT_1( 8, 221, 8192)
    T2_INIT_HH_2( 9, 221, 16384)
    T2_INIT_HH_5(10, 221, 4096)
    T2_INIT_HH_4(11, 221, 4096)
    T2_INIT_HH_5(12, 221, 4096)
    ...
    apply {
        ...
        T2_RUN_HH_5_KEY_5(12, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T3_RUN_HH_4_KEY_5(13, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
