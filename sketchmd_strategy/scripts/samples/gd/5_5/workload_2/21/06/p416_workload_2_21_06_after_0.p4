...
control SwitchIngress(
    ...
    T3_INIT_HH_1(10, 100, 4096)
    T3_INIT_HH_1(12, 100, 16384)

    // apply O2
        T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_4_1;
    ...
    // apply O2
        T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_7_1;
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_21_index_hash_call_2;
        T3_T2_INDEX_UPDATE_32768() update_21_2;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_21_index_hash_call_3;
        T3_INDEX_UPDATE_32768() update_21_3;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_21_index_hash_call_4;
        T3_INDEX_UPDATE_32768() update_21_4;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_21_index_hash_call_5;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_8_1.apply(DSTIP, SIZE, ig_md.d_8_bitmask, ig_md.d_8_est_1);
            update_8_2.apply(DSTIP, SIZE, ig_md.d_8_est_2);
            update_8_3.apply(DSTIP, SIZE, ig_md.d_8_est_3);
            update_8_4.apply(DSTIP, SIZE, ig_md.d_8_est_4);
            update_8_5.apply(DSTIP, SIZE, ig_md.d_8_est_5);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_5(8)
        //

        T3_RUN_AFTER_1_KEY_1(10, DSTIP, 1)
        ...
        T3_RUN_AFTER_2_KEY_1(11, DSTIP, 1)
        ...
        // apply SALUMerge; big - UnivMon / small - many MRACs 
        d_21_res_hash_call.apply(DSTIP, ig_md.d_21_res_hash);
