...
control SwitchIngress(
    ...
    // apply SALUMerge; HLL (row1) - HLL (row1) 
        ...
        T4_T4_KEY_UPDATE_221_32768(32w0x30243f0b) update_5_1;
    //
    ...
    // apply O2
        ...
        T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_10_5;
    ...
    apply {
        ...
        // apply SALUMerge; HLL (row1) - HLL (row1)  
            ...
            update_5_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_5_level);
        //

        T3_RUN_AFTER_1_KEY_5(11, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T3_RUN_AFTER_2_KEY_5(12, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T2_RUN_AFTER_2_KEY_5(13, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_8_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, SIZE, ig_md.d_8_est_2);
            update_8_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, SIZE, ig_md.d_8_est_3);
            update_8_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, SIZE, ig_md.d_8_est_4);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_4(8)
        //


        // apply O2
        T2_RUN_AFTER_5_KEY_5(10, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        // 
        ...
        update_21_2.apply(ig_md.d_21_base_16_1024, ig_md.d_21_index2_16, ig_md.d_21_res_hash[2:2], SIZE, ig_md.d_21_est_2);
