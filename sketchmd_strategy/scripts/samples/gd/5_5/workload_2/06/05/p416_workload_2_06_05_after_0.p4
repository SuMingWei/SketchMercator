...
control SwitchIngress(
    ...
    // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row) 
        COMPUTE_HASH_200_16_16(32w0x30244f0b) d_3_sampling_hash_call;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_2_1.apply(SRCIP, DSTIP, SIZE, SIZE, ig_md.d_2_est_1);
            update_2_2.apply(SRCIP, DSTIP, SIZE, SIZE, ig_md.d_2_est_2);
            update_2_3.apply(SRCIP, DSTIP, SIZE, SIZE, ig_md.d_2_est_3);
