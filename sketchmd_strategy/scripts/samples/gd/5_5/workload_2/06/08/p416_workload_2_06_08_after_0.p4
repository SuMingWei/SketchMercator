...
control SwitchIngress(
    ...
    T2_INIT_HH_2( 4, 221, 8192)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ABOVE_THRESHOLD_CONSTANT_4(100) d_5_above_threshold;
        T2_T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_3_1;
        T2_T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_3_2;
        T2_T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_3_3;
        T2_T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_3_4;
        T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_3_5;
    //

    UM_INIT_2( 6, 221, 10, 16384)
    ...
    apply {
        ...
        T1_RUN_1_KEY_5( 2, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        ...
        T2_RUN_AFTER_2_KEY_5( 4, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_3_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, 1, ig_md.d_3_est_4);
