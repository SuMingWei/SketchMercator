...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_4_3;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_4_1.apply(DSTIP, SIZE, ig_md.d_4_res_hash[1:1], 1, ig_md.d_4_est_1);
            update_4_2.apply(DSTIP, SIZE, ig_md.d_4_res_hash[2:2], 1, ig_md.d_4_est_2);
            update_4_3.apply(DSTIP, SIZE, ig_md.d_4_res_hash[3:3], 1, ig_md.d_4_est_3);
            update_4_4.apply(DSTIP, SIZE, ig_md.d_4_res_hash[4:4], ig_md.d_4_est_4);
