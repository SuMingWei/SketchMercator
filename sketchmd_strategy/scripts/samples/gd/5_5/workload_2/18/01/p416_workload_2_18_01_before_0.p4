...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_2_KEY_1( 4, SRCIP, 1)
        T2_RUN_2_KEY_1( 5, SRCIP, SIZE)
        T2_RUN_HH_3_KEY_1( 6, SRCIP, 1)
        T2_RUN_HH_3_KEY_1( 7, SRCIP, SIZE)
        T2_RUN_HH_3_KEY_1( 8, SRCIP, 1)
        T2_RUN_HH_2_KEY_1( 9, SRCIP, 1)
        T2_RUN_HH_2_KEY_1(10, SRCIP, SIZE)
        T2_RUN_HH_5_KEY_1(11, SRCIP, SIZE)
        MRAC_RUN_1_KEY_1(12, SRCIP)
        MRAC_RUN_1_KEY_1(13, SRCIP)
        UM_RUN_4_KEY_1(14, SRCIP, 1)
        UM_RUN_4_KEY_1(15, SRCIP, 1)
        UM_RUN_3_KEY_1(16, SRCIP, SIZE)
        UM_RUN_2_KEY_1(17, SRCIP, SIZE)
        UM_RUN_1_KEY_1(18, SRCIP, SIZE)
    }
}
