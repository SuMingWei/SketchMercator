...
control SwitchIngress(
    ...
    T1_INIT_4( 3, 221, 131072)
    T1_INIT_4( 4, 221, 262144)
    MRB_INIT_1( 5, 221, 131072, 14,  8)

    // apply O2
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_6_1;
        T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_6_2;
        ABOVE_THRESHOLD_CONSTANT_2(100) d_6_above_threshold;
    // 

    T3_INIT_HH_2(10, 221, 4096)
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ABOVE_THRESHOLD_CONSTANT_5(100) d_12_above_threshold;
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_12_1;
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_12_2;
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_12_3;
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_12_4;
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_12_5;
    //

    T2_INIT_HH_3(16, 221, 16384)
    ...
    // apply O2
        ...
        T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_7_5;
    ...
    apply {
        ...
        T3_RUN_AFTER_2_KEY_5(10, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_12_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, SIZE, ig_md.d_12_est_3);
        ...
        T2_RUN_AFTER_3_KEY_5(16, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        ...
        update_18_3.apply(ig_md.d_18_base_16_2048, ig_md.d_18_index3_16, ig_md.d_18_res_hash[3:3], 1, ig_md.d_18_est_3);
        d_18_index_hash_call_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_18_index4_16);
        update_18_4.apply(ig_md.d_18_base_16_2048, ig_md.d_18_index4_16, ig_md.d_18_res_hash[4:4], 1, ig_md.d_18_est_4);
