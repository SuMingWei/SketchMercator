...
control SwitchIngress(
    ...
    // apply O2
        T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_6_1;
    ...
    // apply O2
        ...
        T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_4_5;
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_5_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_5_est_2);
            d_13_above_threshold.apply(ig_md.d_5_est_1, ig_md.d_5_est_2, ig_md.d_13_above_threshold);
        //
        ...
        // apply O2
        T2_RUN_AFTER_5_KEY_4(4, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        // 

        T2_RUN_AFTER_5_KEY_4( 8, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T3_RUN_AFTER_5_KEY_4(10, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
