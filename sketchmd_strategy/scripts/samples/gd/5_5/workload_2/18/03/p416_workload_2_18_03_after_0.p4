...
control SwitchIngress(
    ...
    // apply O2
        ...
        T1_KEY_UPDATE_220_262144(32w0x30243f0b) update_3_2;
    // 
    ...
    // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row) 
        COMPUTE_HASH_220_16_8(32w0x30244f0b) d_17_sampling_hash_call;
    ...
    apply {
        ...
        // apply O2
        T2_RUN_AFTER_3_KEY_4(5, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        // 


        // apply O2
        T2_RUN_AFTER_3_KEY_4(6, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        // 
        ...
        // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row)
        d_17_tcam_lpm_2.apply(ig_md.d_16_sampling_hash_16, ig_md.d_17_base_16_1024, ig_md.d_17_base_16_2048);
