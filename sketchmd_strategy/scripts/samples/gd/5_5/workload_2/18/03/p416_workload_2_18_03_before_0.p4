...
control SwitchIngress(
    ...
    T1_INIT_2( 1, 220, 524288)
    T1_INIT_4( 2, 220, 131072)
    T1_INIT_2( 3, 220, 262144)
    T1_INIT_1( 4, 220, 131072)
    T2_INIT_2( 5, 220, 8192)
    T2_INIT_1( 6, 220, 8192)
    T2_INIT_HH_1( 7, 220, 16384)
    T2_INIT_HH_5( 8, 220, 4096)
    T3_INIT_HH_4( 9, 220, 4096)
    T3_INIT_HH_1(10, 220, 8192)
    ...
    apply {
        ...
        T2_RUN_HH_1_KEY_4( 7, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_HH_5_KEY_4( 8, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T3_RUN_HH_4_KEY_4( 9, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T3_RUN_HH_1_KEY_4(10, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        ...
        T2_RUN_HH_4_KEY_4(15, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
