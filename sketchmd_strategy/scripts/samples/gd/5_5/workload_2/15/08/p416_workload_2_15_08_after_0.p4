...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_221_4096(32w0x30243f0b) update_8_1;
    ...
    T3_INIT_HH_1( 5, 221, 4096)
    T2_INIT_HH_1( 7, 221, 4096)
    T2_INIT_HH_3( 9, 221, 8192)
    T2_INIT_HH_4( 6, 221, 16384)
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        T3_T2_INDEX_UPDATE_16384() update_14_2;
        COMPUTE_HASH_221_16_10(32w0x30244f0b) d_14_index_hash_call_3;
        T3_T2_INDEX_UPDATE_16384() update_14_3;
    ...
    apply {
        ...
        T3_RUN_AFTER_1_KEY_5( 5, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        ...
        update_14_5.apply(ig_md.d_14_base_16_1024, ig_md.d_14_index5_16, ig_md.d_14_res_hash[5:5], SIZE, ig_md.d_14_est_5);
