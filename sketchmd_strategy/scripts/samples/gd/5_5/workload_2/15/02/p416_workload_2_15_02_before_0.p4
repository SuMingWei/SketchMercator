...
control SwitchIngress(
    ...
    T2_INIT_3( 5, 220, 16384)
    T2_INIT_5( 6, 220, 4096)
    T2_INIT_1( 7, 220, 4096)
    T2_INIT_2( 8, 220, 8192)
    ...
    apply {
        ...
        T2_RUN_3_KEY_4( 5, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        ...
        T3_RUN_HH_1_KEY_4(11, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        ...
        UM_RUN_3_KEY_4(15, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
    }
}
