...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_8_1;
        T2_T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_8_2;
        T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_8_3;
    //
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        T3_T2_INDEX_UPDATE_16384() update_15_2;
    // 
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_8_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, 1, ig_md.d_8_est_2);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_4_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, 1, ig_md.d_4_est_1);
            update_4_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, 1, ig_md.d_4_est_2);
            update_4_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, 1, ig_md.d_4_est_3);
            update_4_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, 1, ig_md.d_4_est_4);
            update_4_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, 1, ig_md.d_4_est_5);
            d_7_above_threshold.apply(ig_md.d_4_est_1, ig_md.d_4_est_2, ig_md.d_4_est_3, ig_md.d_4_est_4, ig_md.d_4_est_5, ig_md.d_7_above_threshold);
        //
