...
control SwitchIngress(
    ...
    T3_INIT_HH_5( 8, 200, 8192)
    T3_INIT_HH_2( 9, 200, 8192)
    ...
    apply {
        ...
        T2_RUN_1_KEY_2( 6, SRCIP, DSTIP, SIZE)
        T2_RUN_HH_2_KEY_2( 7, SRCIP, DSTIP, SIZE)
        T3_RUN_HH_5_KEY_2( 8, SRCIP, DSTIP, 1)
        T3_RUN_HH_2_KEY_2( 9, SRCIP, DSTIP, 1)
