...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_200_8192(32w0x30243f0b) update_8_5;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_8_1.apply(SRCIP, DSTIP, 1, ig_md.d_8_res_hash[1:1], SIZE, ig_md.d_8_est_1);
            ...
            update_8_5.apply(SRCIP, DSTIP, 1, ig_md.d_8_res_hash[5:5], ig_md.d_8_est_5);
