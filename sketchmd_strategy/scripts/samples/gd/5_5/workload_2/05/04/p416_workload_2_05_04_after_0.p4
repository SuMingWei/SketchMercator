...
control SwitchIngress(
    ...
    apply {
        ...
        // HLL for inst 1
            ...
            update_1.apply(SRCIP, DSTIP, ig_md.d_1_level);
        //

        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_2_1.apply(SRCIP, DSTIP, 1, SIZE, ig_md.d_2_est_1);
            update_2_2.apply(SRCIP, DSTIP, 1, SIZE, ig_md.d_2_est_2);
            d_4_above_threshold.apply(ig_md.d_2_est_1, ig_md.d_2_est_2, ig_md.d_4_above_threshold);
        //
