...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_2_1;
        T3_T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_2_2;
        T3_KEY_UPDATE_220_8192(32w0x30243f0b) update_2_3;
        T3_KEY_UPDATE_220_8192(32w0x30243f0b) update_2_4;
    //
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_220_16_10(32w0x30244f0b) d_5_index_hash_call_1;
        T3_T2_INDEX_UPDATE_16384() update_5_1;
        COMPUTE_HASH_220_16_11(32w0x30244f0b) d_5_index_hash_call_2;
        T3_T2_INDEX_UPDATE_32768() update_5_2;
        COMPUTE_HASH_220_16_10(32w0x30244f0b) d_5_index_hash_call_3;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_2_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_2_res_hash[1:1], 1, ig_md.d_2_est_1);
            update_2_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_2_res_hash[2:2], 1, ig_md.d_2_est_2);
            update_2_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_2_res_hash[3:3], ig_md.d_2_est_3);
            update_2_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_2_res_hash[4:4], ig_md.d_2_est_4);
        ...
        d_5_index_hash_call_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_5_index3_16);
