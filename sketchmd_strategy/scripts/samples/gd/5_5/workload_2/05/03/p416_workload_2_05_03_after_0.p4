...
control SwitchIngress(
    ...
    T2_INIT_3( 3, 220, 16384)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ABOVE_THRESHOLD_CONSTANT_4(100) d_4_above_threshold;
        T2_T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_2_1;
        T2_T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_2_2;
        T2_T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_2_3;
        T2_T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_2_4;
    //

    UM_INIT_1( 5, 220, 11, 32768)
    ...
    apply {
        ...
        T2_RUN_3_KEY_4( 3, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_2_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_2_est_1);
            update_2_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_2_est_2);
            update_2_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_2_est_3);
            update_2_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_2_est_4);
            d_4_above_threshold.apply(ig_md.d_2_est_1, ig_md.d_2_est_2, ig_md.d_2_est_3, ig_md.d_2_est_4, ig_md.d_4_above_threshold);
        //
