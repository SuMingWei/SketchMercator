...
control SwitchIngress(
    ...
    // apply O2
        T2_KEY_UPDATE_100_8192(32w0x30243f0b) update_11_1;
        T2_KEY_UPDATE_100_8192(32w0x30243f0b) update_11_2;
    ...
    T2_INIT_HH_4(16, 100, 8192)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        COMPUTE_HASH_100_16_16(32w0x30244f0b) d_9_res_hash_call;
        ABOVE_THRESHOLD_CONSTANT_5(100) d_14_above_threshold;
        T3_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_9_1;
        T3_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_9_2;
        T3_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_9_3;
        T3_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_9_4;
        T3_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_9_5;
    //
    ...
    // apply SALUMerge; big - MRAC (1 row) / small - UnivMon (1 row) 
        ...
        COMPUTE_HASH_100_16_10(32w0x30244f0b) d_20_index_hash_call_1;
        T3_T2_INDEX_UPDATE_16384() update_20_1;
    // 

    MRAC_INIT_1(21, 100, 16384, 10, 16)
    ...
    apply {
        ...
        // apply O2
        T2_RUN_AFTER_2_KEY_1(7, SRCIP, 1)
        // 
        ...
        // apply O2
        T2_RUN_AFTER_3_KEY_1(8, SRCIP, SIZE)
        // 


        // apply O2
        T2_RUN_AFTER_3_KEY_1(10, SRCIP, SIZE)
        // 

        T2_RUN_AFTER_4_KEY_1(16, SRCIP, 1)
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_9_3.apply(SRCIP, 1, ig_md.d_9_res_hash[3:3], SIZE, ig_md.d_9_est_3);
            update_9_4.apply(SRCIP, 1, ig_md.d_9_res_hash[4:4], SIZE, ig_md.d_9_est_4);
            update_9_5.apply(SRCIP, 1, ig_md.d_9_res_hash[5:5], SIZE, ig_md.d_9_est_5);
            d_14_above_threshold.apply(ig_md.d_9_est_1, ig_md.d_9_est_2, ig_md.d_9_est_3, ig_md.d_9_est_4, ig_md.d_9_est_5, ig_md.d_14_above_threshold);
        //


        // apply SALUMerge; big - MRAC (1 row) / small - UnivMon (1 row)
        d_20_res_hash_call.apply(SRCIP, ig_md.d_20_res_hash);
        ...
        // MRAC for inst 21
            d_21_tcam_lpm.apply(ig_md.d_5_sampling_hash_16, ig_md.d_21_base_16);
            d_21_index_hash_call_1.apply(SRCIP, ig_md.d_21_index1_16);
