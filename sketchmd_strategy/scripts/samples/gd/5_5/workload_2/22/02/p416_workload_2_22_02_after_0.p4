...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        COMPUTE_HASH_100_32_32(32w0x30244f0b) d_18_hash_call;
        TCAM_LPM_HLLPCSA() d_18_tcam_lpm;
        GET_BITMASK() d_18_get_bitmask;
        T2_T5_KEY_UPDATE_100_8192(32w0x30243f0b) update_18_1;
        T2_KEY_UPDATE_100_8192(32w0x30243f0b) update_18_2;
    //
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_KEY_UPDATE_100_16384(32w0x30243f0b) update_9_4;
    //

    T3_INIT_HH_2(16, 100, 8192)
    T2_INIT_HH_3(12, 100, 8192)
    T3_INIT_HH_3(15, 100, 8192)
    T3_INIT_HH_3(17, 100, 4096)
    ...
    // apply O2
        T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_10_1;
        T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_10_2;
        T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_10_3;
        T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_10_4;
    ...
    // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row) 
        COMPUTE_HASH_100_16_16(32w0x30244f0b) d_21_sampling_hash_call;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_21_index_hash_call_1;
        LPM_OPT_MRAC_2() d_21_tcam_lpm_2;
        T2_T2_INDEX_UPDATE_32768() update_21;
    // 
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_18_1.apply(DSTIP, 1, ig_md.d_18_bitmask, ig_md.d_18_est_1);
            update_18_2.apply(DSTIP, 1, ig_md.d_18_est_2);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_2(18)
        //

        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_9_1.apply(DSTIP, SIZE, SIZE, ig_md.d_9_est_1);
            update_9_2.apply(DSTIP, SIZE, SIZE, ig_md.d_9_est_2);
            update_9_3.apply(DSTIP, SIZE, ig_md.d_9_est_3);
            update_9_4.apply(DSTIP, SIZE, ig_md.d_9_est_4);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_4(9)
        //

        T3_RUN_AFTER_2_KEY_1(16, DSTIP, 1)
        T2_RUN_AFTER_3_KEY_1(12, DSTIP, 1)
        T3_RUN_AFTER_3_KEY_1(15, DSTIP, 1)
        T3_RUN_AFTER_3_KEY_1(17, DSTIP, SIZE)
