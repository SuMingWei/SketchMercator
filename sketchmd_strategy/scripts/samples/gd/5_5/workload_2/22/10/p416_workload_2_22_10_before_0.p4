...
control SwitchIngress(
    ...
    apply {
        ...
        T3_RUN_HH_4_KEY_2( 9, SRCIP, DSTIP, SIZE)
        T3_RUN_HH_5_KEY_2(10, SRCIP, DSTIP, SIZE)
        T2_RUN_HH_3_KEY_2(11, SRCIP, DSTIP, 1)
        T2_RUN_HH_3_KEY_2(12, SRCIP, DSTIP, 1)
        T2_RUN_HH_5_KEY_2(13, SRCIP, DSTIP, 1)
        T2_RUN_HH_2_KEY_2(14, SRCIP, DSTIP, 1)
        T2_RUN_HH_5_KEY_2(15, SRCIP, DSTIP, SIZE)
        T2_RUN_HH_5_KEY_2(16, SRCIP, DSTIP, SIZE)
        ...
        UM_RUN_5_KEY_2(22, SRCIP, DSTIP, 1)
    }
}
