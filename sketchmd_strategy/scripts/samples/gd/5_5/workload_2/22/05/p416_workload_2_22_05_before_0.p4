...
control SwitchIngress(
    ...
    T2_INIT_5( 3, 200, 8192)
    T2_INIT_5( 4, 200, 16384)
    T2_INIT_3( 5, 200, 8192)
    T2_INIT_HH_4( 6, 200, 4096)
    ...
    UM_INIT_1(21, 200, 10, 16384)
    UM_INIT_5(22, 200, 10, 16384)
    apply {
        ...
        T2_RUN_3_KEY_2( 5, SRCIP, DSTIP, SIZE)
        T2_RUN_HH_4_KEY_2( 6, SRCIP, DSTIP, SIZE)
        T3_RUN_HH_2_KEY_2( 7, SRCIP, DSTIP, 1)
        T3_RUN_HH_4_KEY_2( 8, SRCIP, DSTIP, SIZE)
        ...
        T2_RUN_HH_3_KEY_2(15, SRCIP, DSTIP, SIZE)
        ...
        UM_RUN_1_KEY_2(21, SRCIP, DSTIP, 1)
