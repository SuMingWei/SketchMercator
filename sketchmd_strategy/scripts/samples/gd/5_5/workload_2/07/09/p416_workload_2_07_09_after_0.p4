...
control SwitchIngress(
    ...
    // apply O2
        T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_1_1;
        T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_1_2;
        T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_1_3;
        T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_1_4;
    ...
    apply {
        ...
        T2_RUN_AFTER_1_KEY_5( 5, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T2_RUN_AFTER_3_KEY_5( 3, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)

        // apply O2
        T2_RUN_AFTER_4_KEY_5(1, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        // 
