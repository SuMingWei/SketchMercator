...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_110_8192(32w0x30243f0b) update_5_1;
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T5_T2_KEY_UPDATE_110_16384(32w0x30243f0b) update_4_1;
        ABOVE_THRESHOLD_CONSTANT_3(100) d_6_above_threshold;
        T2_T2_KEY_UPDATE_110_16384(32w0x30243f0b) update_4_2;
        T2_T2_KEY_UPDATE_110_16384(32w0x30243f0b) update_4_3;
        T2_T2_KEY_UPDATE_110_16384(32w0x30243f0b) update_4_4;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_5_1.apply(DSTIP, DSTPORT, SIZE, ig_md.d_5_bitmask, ig_md.d_5_est_1);
            update_5_2.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_5_est_2);
            update_5_3.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_5_est_3);
            update_5_4.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_5_est_4);
            update_5_5.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_5_est_5);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_4_2.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_4_est_2);
            update_4_3.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_4_est_3);
            update_4_4.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_4_est_4);
            d_6_above_threshold.apply(ig_md.d_4_est_2, ig_md.d_4_est_3, ig_md.d_4_est_4, ig_md.d_6_above_threshold);
        //
