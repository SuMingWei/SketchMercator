...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_4_4;
        T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_4_5;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_4_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_4_est_3);
            update_4_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_4_est_4);
            update_4_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_4_est_5);
        //
