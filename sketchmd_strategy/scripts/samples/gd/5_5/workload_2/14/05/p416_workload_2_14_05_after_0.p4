...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_100_4096(32w0x30243f0b) update_6_1;
    ...
    UM_INIT_1(14, 100, 10, 16384)
    UM_INIT_3(12, 100, 10, 16384)
    UM_INIT_4(11, 100, 10, 16384)
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_6_2.apply(SRCIP, 1, ig_md.d_6_est_2);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_3_4.apply(SRCIP, 1, SIZE, ig_md.d_3_est_4);
            update_3_5.apply(SRCIP, 1, SIZE, ig_md.d_3_est_5);
        ...
        T2_RUN_AFTER_5_KEY_1( 9, SRCIP, SIZE)
        ...
        // UnivMon for inst 11
            ...
            d_11_index_hash_call_4.apply(SRCIP, ig_md.d_11_index4_16); 
