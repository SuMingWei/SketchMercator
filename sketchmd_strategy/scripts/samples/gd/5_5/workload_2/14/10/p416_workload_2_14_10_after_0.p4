...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_100_8192(32w0x30243f0b) update_3_5;
    //
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        UM_INIT_SETUP(13, 100)
        ABOVE_THRESHOLD_4() d_13_above_threshold;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_13_index_hash_call_1;
        T3_T2_INDEX_UPDATE_32768() update_13_1;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_13_index_hash_call_2;
        T3_INDEX_UPDATE_32768() update_13_2;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_13_index_hash_call_3;
        T3_INDEX_UPDATE_32768() update_13_3;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_13_index_hash_call_4;
    ...
    apply {
        // O1 hash run
            d_14_auto_sampling_hash_call.apply(DSTIP, ig_md.d_14_sampling_hash_16);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_3_1.apply(DSTIP, SIZE, SIZE, ig_md.d_3_est_1);
            update_3_2.apply(DSTIP, SIZE, SIZE, ig_md.d_3_est_2);
            update_3_3.apply(DSTIP, SIZE, SIZE, ig_md.d_3_est_3);
            update_3_4.apply(DSTIP, SIZE, SIZE, ig_md.d_3_est_4);
            update_3_5.apply(DSTIP, SIZE, SIZE, ig_md.d_3_est_5);
        ...
        // apply SALUMerge; big - UnivMon / small - many MRACs 
        d_14_res_hash_call.apply(DSTIP, ig_md.d_14_res_hash);
        ...
        d_14_index_hash_call_2.apply(DSTIP, ig_md.d_14_index2_16);
        update_14_2.apply(ig_md.d_14_base_16_2048, ig_md.d_14_index2_16, ig_md.d_14_res_hash[2:2], SIZE, ig_md.d_14_est_2);
        d_14_index_hash_call_3.apply(DSTIP, ig_md.d_14_index3_16);
        ...
        // apply SALUMerge; big - UnivMon / small - many MRACs 
        d_13_res_hash_call.apply(DSTIP, ig_md.d_13_res_hash);
