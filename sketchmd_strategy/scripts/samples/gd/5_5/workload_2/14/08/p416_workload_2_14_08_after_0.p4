...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_110_4096(32w0x30243f0b) update_7_1;
    ...
    T3_INIT_HH_4( 6, 110, 16384)
    T2_INIT_HH_4( 8, 110, 4096)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ABOVE_THRESHOLD_CONSTANT_5(100) d_5_above_threshold;
        T2_T2_KEY_UPDATE_110_16384(32w0x30243f0b) update_4_1;
        T2_T2_KEY_UPDATE_110_16384(32w0x30243f0b) update_4_2;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_7_tcam_lpm.apply(ig_md.d_2_sampling_hash_32, ig_md.d_7_level);
        ...
        // apply O2
        T2_RUN_AFTER_4_KEY_2(3, DSTIP, DSTPORT, SIZE)
        // 

        T3_RUN_AFTER_4_KEY_2( 6, DSTIP, DSTPORT, SIZE)
        T2_RUN_AFTER_4_KEY_2( 8, DSTIP, DSTPORT, 1)
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_4_1.apply(DSTIP, DSTPORT, SIZE, SIZE, ig_md.d_4_est_1);
            update_4_2.apply(DSTIP, DSTPORT, SIZE, SIZE, ig_md.d_4_est_2);
            update_4_3.apply(DSTIP, DSTPORT, SIZE, SIZE, ig_md.d_4_est_3);
            update_4_4.apply(DSTIP, DSTPORT, SIZE, SIZE, ig_md.d_4_est_4);
            update_4_5.apply(DSTIP, DSTPORT, SIZE, SIZE, ig_md.d_4_est_5);
            d_5_above_threshold.apply(ig_md.d_4_est_1, ig_md.d_4_est_2, ig_md.d_4_est_3, ig_md.d_4_est_4, ig_md.d_4_est_5, ig_md.d_5_above_threshold);
        //
