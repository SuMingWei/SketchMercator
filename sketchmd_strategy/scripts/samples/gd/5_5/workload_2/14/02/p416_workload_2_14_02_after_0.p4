...
control SwitchIngress(
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_7_3.apply(SRCIP, DSTIP, SIZE, 1, ig_md.d_7_est_3);
            update_7_4.apply(SRCIP, DSTIP, SIZE, 1, ig_md.d_7_est_4);
            d_10_above_threshold.apply(ig_md.d_7_est_2, ig_md.d_7_est_3, ig_md.d_7_est_4, ig_md.d_10_above_threshold);
        //
