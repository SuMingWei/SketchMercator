...
control SwitchIngress(
    ...
    T1_INIT_5( 1, 110, 262144)
    T1_INIT_4( 2, 110, 131072)
    T1_INIT_4( 3, 110, 524288)
    T4_INIT_1( 4, 110, 16384)
    T2_INIT_5( 5, 110, 4096)
    T2_INIT_3( 6, 110, 8192)
    T2_INIT_2( 7, 110, 8192)
    T2_INIT_HH_5( 8, 110, 4096)
    T3_INIT_HH_4( 9, 110, 8192)
    T3_INIT_HH_5(10, 110, 8192)
    ...
    MRAC_INIT_1(19, 110, 8192, 10,  8)
    UM_INIT_2(20, 110, 11, 32768)
    UM_INIT_5(21, 110, 11, 32768)
    UM_INIT_2(22, 110, 10, 16384)
    ...
    apply {
        ...
        T2_RUN_5_KEY_2( 5, SRCIP, SRCPORT, SIZE)
        T2_RUN_3_KEY_2( 6, SRCIP, SRCPORT, SIZE)
        T2_RUN_2_KEY_2( 7, SRCIP, SRCPORT, SIZE)
        T2_RUN_HH_5_KEY_2( 8, SRCIP, SRCPORT, SIZE)
        T3_RUN_HH_4_KEY_2( 9, SRCIP, SRCPORT, 1)
        T3_RUN_HH_5_KEY_2(10, SRCIP, SRCPORT, SIZE)
        T3_RUN_HH_4_KEY_2(11, SRCIP, SRCPORT, SIZE)
        T2_RUN_HH_5_KEY_2(12, SRCIP, SRCPORT, 1)
        T2_RUN_HH_4_KEY_2(13, SRCIP, SRCPORT, 1)
        T2_RUN_HH_2_KEY_2(14, SRCIP, SRCPORT, 1)
        T2_RUN_HH_2_KEY_2(15, SRCIP, SRCPORT, SIZE)
        T2_RUN_HH_5_KEY_2(16, SRCIP, SRCPORT, SIZE)
        T2_RUN_HH_1_KEY_2(17, SRCIP, SRCPORT, SIZE)
        T2_RUN_HH_5_KEY_2(18, SRCIP, SRCPORT, SIZE)
        MRAC_RUN_1_KEY_2(19, SRCIP, SRCPORT)
        UM_RUN_2_KEY_2(20, SRCIP, SRCPORT, 1)
        UM_RUN_5_KEY_2(21, SRCIP, SRCPORT, 1)
        UM_RUN_2_KEY_2(22, SRCIP, SRCPORT, 1)
        UM_RUN_2_KEY_2(23, SRCIP, SRCPORT, SIZE)
    }
}
