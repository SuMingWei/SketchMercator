...
control SwitchIngress(
    ...
    T2_INIT_HH_4(13, 100, 4096)
    T3_INIT_HH_5(10, 100, 16384)
    T2_INIT_HH_5(12, 100, 8192)
    T2_INIT_HH_5(17, 100, 16384)
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_23_index_hash_call_2;
        T3_T2_INDEX_UPDATE_32768() update_23_2;
        COMPUTE_HASH_100_16_10(32w0x30244f0b) d_23_index_hash_call_3;
        T3_INDEX_UPDATE_16384() update_23_3;
        COMPUTE_HASH_100_16_10(32w0x30244f0b) d_23_index_hash_call_4;
        T3_INDEX_UPDATE_16384() update_23_4;
        COMPUTE_HASH_100_16_10(32w0x30244f0b) d_23_index_hash_call_5;
    ...
    apply {
        ...
        T2_RUN_AFTER_2_KEY_1(15, DSTIP, SIZE)
        ...
        T3_RUN_AFTER_3_KEY_1( 9, DSTIP, 1)

        // apply O2
        T2_RUN_AFTER_4_KEY_1(7, DSTIP, SIZE)
        // 

        T2_RUN_AFTER_4_KEY_1(13, DSTIP, 1)
        T3_RUN_AFTER_5_KEY_1(10, DSTIP, SIZE)
        T2_RUN_AFTER_5_KEY_1(12, DSTIP, 1)
        T2_RUN_AFTER_5_KEY_1(17, DSTIP, SIZE)
