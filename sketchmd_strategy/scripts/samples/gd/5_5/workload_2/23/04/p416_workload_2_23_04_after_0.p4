...
control SwitchIngress(
    ...
    // apply O2
        ...
        T1_KEY_UPDATE_220_262144(32w0x30243f0b) update_2_4;
        T1_KEY_UPDATE_220_262144(32w0x30243f0b) update_2_5;
    // 
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_10_4;
        T2_T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_10_5;
    //
    ...
    apply {
        ...
        // HLL for inst 3
            ...
            update_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_3_level);
        //
        ...
        T3_RUN_AFTER_1_KEY_4(14, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)

        // apply O2
        T2_RUN_AFTER_4_KEY_4(7, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        // 
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_10_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, SIZE, ig_md.d_10_est_1);
            update_10_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, SIZE, ig_md.d_10_est_2);
            update_10_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, SIZE, ig_md.d_10_est_3);
            update_10_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, SIZE, ig_md.d_10_est_4);
            update_10_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, SIZE, ig_md.d_10_est_5);
            d_12_above_threshold.apply(ig_md.d_10_est_1, ig_md.d_10_est_2, ig_md.d_10_est_3, ig_md.d_10_est_4, ig_md.d_10_est_5, ig_md.d_12_above_threshold);
        //
