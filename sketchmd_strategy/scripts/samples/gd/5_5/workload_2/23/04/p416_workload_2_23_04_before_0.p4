...
control SwitchIngress(
    ...
    T5_INIT_1( 5, 220, 8192)
    T2_INIT_3( 6, 220, 8192)
    T2_INIT_2( 7, 220, 8192)
    T2_INIT_1( 8, 220, 8192)
    T2_INIT_5( 9, 220, 16384)
    T2_INIT_5(10, 220, 16384)
    T2_INIT_HH_1(11, 220, 8192)
    T2_INIT_HH_5(12, 220, 16384)
    ...
    apply {
        ...
        T2_RUN_3_KEY_4( 6, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        ...
        T2_RUN_HH_1_KEY_4(11, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_HH_5_KEY_4(12, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_HH_2_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T3_RUN_HH_1_KEY_4(14, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_HH_3_KEY_4(15, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_HH_4_KEY_4(16, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_HH_3_KEY_4(17, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        ...
        UM_RUN_3_KEY_4(23, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
    }
}
