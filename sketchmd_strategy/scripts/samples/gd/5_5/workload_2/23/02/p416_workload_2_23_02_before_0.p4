...
control SwitchIngress(
    ...
    T2_INIT_1( 8, 110, 4096)
    T2_INIT_3( 9, 110, 8192)
    T2_INIT_3(10, 110, 8192)
    ...
    MRAC_INIT_1(20, 110, 16384, 10, 16)
    UM_INIT_4(21, 110, 11, 32768)
    UM_INIT_4(22, 110, 10, 16384)
    ...
    apply {
        ...
        T1_RUN_1_KEY_2( 6, DSTIP, DSTPORT)
        T2_RUN_3_KEY_2( 7, DSTIP, DSTPORT, 1)
        T2_RUN_1_KEY_2( 8, DSTIP, DSTPORT, SIZE)
        T2_RUN_3_KEY_2( 9, DSTIP, DSTPORT, SIZE)
        T2_RUN_3_KEY_2(10, DSTIP, DSTPORT, SIZE)
        T2_RUN_HH_3_KEY_2(11, DSTIP, DSTPORT, SIZE)
        T3_RUN_HH_4_KEY_2(12, DSTIP, DSTPORT, 1)
        T3_RUN_HH_2_KEY_2(13, DSTIP, DSTPORT, SIZE)
        T3_RUN_HH_3_KEY_2(14, DSTIP, DSTPORT, SIZE)
        ...
        UM_RUN_4_KEY_2(21, DSTIP, DSTPORT, 1)
        UM_RUN_4_KEY_2(22, DSTIP, DSTPORT, 1)
        UM_RUN_2_KEY_2(23, DSTIP, DSTPORT, SIZE)
    }
}
