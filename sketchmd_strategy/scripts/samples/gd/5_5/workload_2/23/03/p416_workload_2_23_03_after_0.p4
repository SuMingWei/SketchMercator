...
control SwitchIngress(
    ...
    // apply O2
        ...
        T1_KEY_UPDATE_221_131072(32w0x30243f0b) update_2_4;
    // 

    T1_INIT_5( 1, 221, 131072)
    T1_INIT_5( 3, 221, 262144)
    T4_INIT_1( 5, 221, 32768)
    T2_INIT_HH_1(17, 221, 8192)
    T2_INIT_HH_2(11, 221, 4096)
    T2_INIT_HH_3(14, 221, 8192)

    // apply O2
        T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_10_1;
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_7_4;
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_7_5;
    //


    // apply O2
        T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_8_1;
        T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_8_2;
        T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_8_3;
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_221_16_10(32w0x30244f0b) d_21_index_hash_call_5;
    ...
    apply {
        ...
        T1_RUN_1_KEY_5( 4, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO) if (ig_md.d_4_est1_1 == 0) { /* process_new_flow() */ }
        ...
        T2_RUN_AFTER_1_KEY_5(17, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T2_RUN_AFTER_2_KEY_5(11, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T2_RUN_AFTER_3_KEY_5(14, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)

        // apply O2
        T2_RUN_AFTER_4_KEY_5(10, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        // 

        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_7_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, 1, ig_md.d_7_est_1);
            update_7_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, 1, ig_md.d_7_est_2);
            ...
            update_7_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, 1, ig_md.d_7_est_5);
        ...
        T2_RUN_AFTER_5_KEY_5(13, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        ...
        update_21_1.apply(ig_md.d_21_base_16_1024, ig_md.d_21_index1_16, ig_md.d_21_res_hash[1:1], 1, ig_md.d_21_est_1);
        ...
        update_21_5.apply(ig_md.d_21_base_16_1024, ig_md.d_21_index5_16, ig_md.d_21_res_hash[5:5], 1, ig_md.d_21_est_5);
        ...
        // UnivMon for inst 22
            ...
            UM_RUN_END_5(22, ig_md.d_22_res_hash, SIZE) 
