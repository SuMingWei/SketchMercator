...
control SwitchIngress(
    ...
    T1_INIT_2( 2, 221, 262144)
    T4_INIT_1( 3, 221, 16384)
    T4_INIT_1( 4, 221, 32768)
    T2_INIT_5( 5, 221, 16384)
    T2_INIT_4( 6, 221, 16384)
    T2_INIT_HH_1( 7, 221, 16384)
    T2_INIT_HH_4( 8, 221, 8192)
    T2_INIT_HH_4( 9, 221, 16384)
    T3_INIT_HH_5(10, 221, 16384)
    T3_INIT_HH_2(11, 221, 8192)
    T3_INIT_HH_4(12, 221, 4096)
    ...
    apply {
        ...
        T2_RUN_HH_4_KEY_5( 8, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T2_RUN_HH_4_KEY_5( 9, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T3_RUN_HH_5_KEY_5(10, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T3_RUN_HH_2_KEY_5(11, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T3_RUN_HH_4_KEY_5(12, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
