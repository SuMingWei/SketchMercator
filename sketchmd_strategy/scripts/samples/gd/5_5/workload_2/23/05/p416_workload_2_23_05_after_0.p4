...
control SwitchIngress(
    ...
    // apply SALUMerge; HLL (row1) - HLL (row1) 
        ...
        T4_T4_KEY_UPDATE_221_32768(32w0x30243f0b) update_3_1;
    //
    ...
    apply {
        ...
        T3_RUN_AFTER_2_KEY_5(11, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        ...
        T3_RUN_AFTER_4_KEY_5(12, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        ...
        T3_RUN_AFTER_5_KEY_5(10, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
