...
control SwitchIngress(
    ...
    T2_INIT_4( 8, 100, 16384)
    T2_INIT_1( 9, 100, 4096)
    T3_INIT_HH_1(10, 100, 16384)
    T3_INIT_HH_4(11, 100, 16384)
    T2_INIT_HH_5(12, 100, 16384)
    T2_INIT_HH_1(13, 100, 8192)
    T2_INIT_HH_3(14, 100, 16384)
    T2_INIT_HH_1(15, 100, 8192)
    MRAC_INIT_1(16, 100, 8192, 10,  8)
    UM_INIT_5(17, 100, 10, 16384)
    ...
    apply {
        ...
        T3_RUN_HH_1_KEY_1(10, DSTIP, SIZE)
        T3_RUN_HH_4_KEY_1(11, DSTIP, SIZE)
        ...
        UM_RUN_5_KEY_1(17, DSTIP, 1)
        UM_RUN_1_KEY_1(18, DSTIP, SIZE)
        UM_RUN_1_KEY_1(19, DSTIP, SIZE)
    }
}
