...
control SwitchIngress(
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_200_16_11(32w0x30244f0b) d_19_index_hash_call_3;
        T3_INDEX_UPDATE_32768() update_19_3;
        COMPUTE_HASH_200_16_11(32w0x30244f0b) d_19_index_hash_call_4;
    ...
    apply {
        ...
        T3_RUN_AFTER_5_KEY_2( 9, SRCIP, DSTIP, 1)
        ...
        update_18_5.apply(ig_md.d_18_base_16_2048, ig_md.d_18_index5_16, ig_md.d_18_res_hash[5:5], 1, ig_md.d_18_est_5);
