...
control SwitchIngress(
    ...
    T2_INIT_2( 3, 220, 8192)
    T2_INIT_3( 4, 220, 4096)
    T2_INIT_HH_1( 5, 220, 16384)
    ...
    apply {
        ...
        T2_RUN_2_KEY_4( 3, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_3_KEY_4( 4, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_HH_1_KEY_4( 5, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T3_RUN_HH_1_KEY_4( 6, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T3_RUN_HH_4_KEY_4( 7, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T3_RUN_HH_4_KEY_4( 8, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_HH_5_KEY_4( 9, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_HH_1_KEY_4(10, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_HH_3_KEY_4(11, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_HH_1_KEY_4(12, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_HH_4_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        ...
        UM_RUN_1_KEY_4(17, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
