...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_200_16384(32w0x30243f0b) update_10_4;
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_200_16_11(32w0x30244f0b) d_17_index_hash_call_5;
        T3_INDEX_UPDATE_32768() update_17_5;
    // 
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_10_1.apply(SRCIP, DSTIP, SIZE, ig_md.d_10_res_hash[1:1], 1, ig_md.d_10_est_1);
            update_10_2.apply(SRCIP, DSTIP, SIZE, ig_md.d_10_res_hash[2:2], 1, ig_md.d_10_est_2);
            update_10_3.apply(SRCIP, DSTIP, SIZE, ig_md.d_10_res_hash[3:3], ig_md.d_10_est_3);
            update_10_4.apply(SRCIP, DSTIP, SIZE, ig_md.d_10_res_hash[4:4], ig_md.d_10_est_4);
            update_10_5.apply(SRCIP, DSTIP, SIZE, ig_md.d_10_res_hash[5:5], ig_md.d_10_est_5);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_5(10)
        //

        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_11_1.apply(SRCIP, DSTIP, 1, SIZE, ig_md.d_11_est_1);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_9_1.apply(SRCIP, DSTIP, SIZE, SIZE, ig_md.d_9_est_1);
            update_9_2.apply(SRCIP, DSTIP, SIZE, SIZE, ig_md.d_9_est_2);
            update_9_3.apply(SRCIP, DSTIP, SIZE, SIZE, ig_md.d_9_est_3);
            update_9_4.apply(SRCIP, DSTIP, SIZE, SIZE, ig_md.d_9_est_4);
        ...
        d_17_index_hash_call_5.apply(SRCIP, DSTIP, ig_md.d_17_index5_16);
        update_17_5.apply(ig_md.d_17_base_16_2048, ig_md.d_17_index5_16, ig_md.d_17_res_hash[5:5], 1, ig_md.d_17_est_5);
