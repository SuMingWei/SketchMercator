...
control SwitchIngress(
    ...
    T5_INIT_1( 4, 110, 8192)
    T2_INIT_4( 5, 110, 4096)
    T2_INIT_4( 6, 110, 16384)
    T2_INIT_HH_3( 7, 110, 16384)
    T3_INIT_HH_4( 8, 110, 4096)
    ...
    MRAC_INIT_1(17, 110, 32768, 11, 16)
    ...
    apply {
        ...
        T3_RUN_HH_4_KEY_2( 8, SRCIP, SRCPORT, 1)
        ...
        T2_RUN_HH_3_KEY_2(13, SRCIP, SRCPORT, SIZE)
        ...
        UM_RUN_5_KEY_2(18, SRCIP, SRCPORT, SIZE)
        UM_RUN_3_KEY_2(19, SRCIP, SRCPORT, SIZE)
    }
}
