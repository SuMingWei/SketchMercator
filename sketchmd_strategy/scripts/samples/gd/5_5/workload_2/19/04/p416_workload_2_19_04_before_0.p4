...
control SwitchIngress(
    ...
    T1_INIT_1( 4, 220, 262144)
    MRB_INIT_1( 5, 220, 131072, 14,  8)
    T2_INIT_3( 6, 220, 16384)
    T2_INIT_2( 7, 220, 8192)
    T2_INIT_5( 8, 220, 8192)
    T2_INIT_1( 9, 220, 4096)
    T2_INIT_5(10, 220, 4096)
    ...
    apply {
        ...
        T2_RUN_1_KEY_4( 9, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        ...
        T3_RUN_HH_2_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        ...
        UM_RUN_3_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
    }
}
