...
control SwitchIngress(
    ...
    // apply O2
        T1_KEY_UPDATE_220_262144(32w0x30243f0b) update_3_1;
    // 

    T1_INIT_2( 2, 220, 131072)
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_12_1;
        T3_KEY_UPDATE_220_4096(32w0x30243f0b) update_12_2;
        T3_KEY_UPDATE_220_4096(32w0x30243f0b) update_12_3;
    //

    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ABOVE_THRESHOLD_CONSTANT_5(100) d_8_above_threshold;
        T2_T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_8_1;
        T2_T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_8_2;
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_10_3;
        T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_10_4;
        T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_10_5;
    //
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_220_16_10(32w0x30244f0b) d_19_index_hash_call_1;
        T3_T2_INDEX_UPDATE_16384() update_19_1;
        COMPUTE_HASH_220_16_10(32w0x30244f0b) d_19_index_hash_call_2;
        T3_INDEX_UPDATE_16384() update_19_2;
        COMPUTE_HASH_220_16_10(32w0x30244f0b) d_19_index_hash_call_3;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_12_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_12_res_hash[1:1], 1, ig_md.d_12_est_1);
            update_12_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_12_res_hash[2:2], ig_md.d_12_est_2);
            update_12_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_12_res_hash[3:3], ig_md.d_12_est_3);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_3(12)
        //

        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_8_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_8_est_1);
            update_8_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_8_est_2);
            update_8_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_8_est_3);
            update_8_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_8_est_4);
            update_8_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_8_est_5);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_10_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, 1, ig_md.d_10_est_3);
            update_10_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_10_est_4);
            update_10_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_10_est_5);
