...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T5_T2_KEY_UPDATE_200_16384(32w0x30243f0b) update_6_1;
        ...
        T2_T2_KEY_UPDATE_200_16384(32w0x30243f0b) update_6_5;
    //
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T2_KEY_UPDATE_200_8192(32w0x30243f0b) update_7_4;
        T3_T2_KEY_UPDATE_200_8192(32w0x30243f0b) update_7_5;
    //
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_200_16_10(32w0x30244f0b) d_17_index_hash_call_1;
        T3_T2_INDEX_UPDATE_16384() update_17_1;
        COMPUTE_HASH_200_16_10(32w0x30244f0b) d_17_index_hash_call_2;
        T3_T2_INDEX_UPDATE_16384() update_17_2;
        COMPUTE_HASH_200_16_10(32w0x30244f0b) d_17_index_hash_call_3;
        T3_T2_INDEX_UPDATE_16384() update_17_3;
        COMPUTE_HASH_200_16_10(32w0x30244f0b) d_17_index_hash_call_4;
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_200_16_10(32w0x30244f0b) d_18_index_hash_call_1;
        T3_T2_INDEX_UPDATE_16384() update_18_1;
        COMPUTE_HASH_200_16_10(32w0x30244f0b) d_18_index_hash_call_2;
        T3_INDEX_UPDATE_16384() update_18_2;
        COMPUTE_HASH_200_16_10(32w0x30244f0b) d_18_index_hash_call_3;
        T3_INDEX_UPDATE_16384() update_18_3;
        COMPUTE_HASH_200_16_10(32w0x30244f0b) d_18_index_hash_call_4;
        T3_INDEX_UPDATE_16384() update_18_4;
        COMPUTE_HASH_200_16_10(32w0x30244f0b) d_18_index_hash_call_5;
        T3_INDEX_UPDATE_16384() update_18_5;
    // 

    UM_INIT_1(19, 200, 11, 32768)
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_6_2.apply(SRCIP, DSTIP, SIZE, SIZE, ig_md.d_6_est_2);
            update_6_3.apply(SRCIP, DSTIP, SIZE, SIZE, ig_md.d_6_est_3);
            update_6_4.apply(SRCIP, DSTIP, SIZE, SIZE, ig_md.d_6_est_4);
            update_6_5.apply(SRCIP, DSTIP, SIZE, SIZE, ig_md.d_6_est_5);
            d_12_above_threshold.apply(ig_md.d_6_est_2, ig_md.d_6_est_3, ig_md.d_6_est_4, ig_md.d_6_est_5, ig_md.d_12_above_threshold);
        //
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_7_3.apply(SRCIP, DSTIP, SIZE, ig_md.d_7_res_hash[3:3], SIZE, ig_md.d_7_est_3);
            update_7_4.apply(SRCIP, DSTIP, SIZE, ig_md.d_7_res_hash[4:4], SIZE, ig_md.d_7_est_4);
            update_7_5.apply(SRCIP, DSTIP, SIZE, ig_md.d_7_res_hash[5:5], SIZE, ig_md.d_7_est_5);
            d_9_above_threshold.apply(ig_md.d_7_est_1, ig_md.d_7_est_2, ig_md.d_7_est_3, ig_md.d_7_est_4, ig_md.d_7_est_5, ig_md.d_9_above_threshold);
        //
        ...
        update_18_3.apply(ig_md.d_18_base_16_1024, ig_md.d_18_index3_16, ig_md.d_18_res_hash[3:3], 1, ig_md.d_18_est_3);
        d_18_index_hash_call_4.apply(SRCIP, DSTIP, ig_md.d_18_index4_16);
        update_18_4.apply(ig_md.d_18_base_16_1024, ig_md.d_18_index4_16, ig_md.d_18_res_hash[4:4], 1, ig_md.d_18_est_4);
        d_18_index_hash_call_5.apply(SRCIP, DSTIP, ig_md.d_18_index5_16);
        update_18_5.apply(ig_md.d_18_base_16_1024, ig_md.d_18_index5_16, ig_md.d_18_res_hash[5:5], 1, ig_md.d_18_est_5);
