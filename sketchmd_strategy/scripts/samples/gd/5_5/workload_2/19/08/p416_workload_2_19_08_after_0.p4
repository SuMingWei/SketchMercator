...
control SwitchIngress(
    ...
    // apply O2
        ...
        T1_KEY_UPDATE_221_262144(32w0x30243f0b) update_1_2;
        T1_KEY_UPDATE_221_262144(32w0x30243f0b) update_1_3;
    // 

    T1_INIT_5( 2, 221, 131072)
    MRB_INIT_1( 5, 221, 262144, 15,  8)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_7_3;
        T2_T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_7_4;
    //

    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        COMPUTE_HASH_221_16_16(32w0x30244f0b) d_9_res_hash_call;
        ABOVE_THRESHOLD_CONSTANT_3(100) d_11_above_threshold;
        T3_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_9_1;
        T3_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_9_2;
        T3_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_9_3;
    //
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_8_3;
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_8_4;
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_8_5;
    //
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_221_16_10(32w0x30244f0b) d_19_index_hash_call_2;
        T3_T2_INDEX_UPDATE_16384() update_19_2;
        COMPUTE_HASH_221_16_10(32w0x30244f0b) d_19_index_hash_call_3;
        T3_T2_INDEX_UPDATE_16384() update_19_3;
        COMPUTE_HASH_221_16_10(32w0x30244f0b) d_19_index_hash_call_4;
        T3_T2_INDEX_UPDATE_16384() update_19_4;
        COMPUTE_HASH_221_16_10(32w0x30244f0b) d_19_index_hash_call_5;
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            d_6_above_threshold.apply(ig_md.d_7_est_1, ig_md.d_7_est_2, ig_md.d_6_above_threshold);
            update_7_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, 1, ig_md.d_7_est_3);
            update_7_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, 1, ig_md.d_7_est_4);
            d_13_above_threshold.apply(ig_md.d_7_est_3, ig_md.d_7_est_4, ig_md.d_13_above_threshold);
        //

        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            d_9_res_hash_call.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_9_res_hash);
            update_9_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_9_res_hash[1:1], SIZE, ig_md.d_9_est_1);
            update_9_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_9_res_hash[2:2], SIZE, ig_md.d_9_est_2);
            update_9_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_9_res_hash[3:3], SIZE, ig_md.d_9_est_3);
            d_11_above_threshold.apply(ig_md.d_9_est_1, ig_md.d_9_est_2, ig_md.d_9_est_3, ig_md.d_11_above_threshold);
        //
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_8_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, 1, ig_md.d_8_est_3);
            update_8_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, 1, ig_md.d_8_est_4);
            update_8_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, 1, ig_md.d_8_est_5);
            d_10_above_threshold.apply(ig_md.d_8_est_1, ig_md.d_8_est_2, ig_md.d_8_est_3, ig_md.d_8_est_4, ig_md.d_8_est_5, ig_md.d_10_above_threshold);
        //
