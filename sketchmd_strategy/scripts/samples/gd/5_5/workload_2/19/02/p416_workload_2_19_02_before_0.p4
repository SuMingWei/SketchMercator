...
control SwitchIngress(
    ...
    apply {
        ...
        T5_RUN_1_KEY_2( 2, SRCIP, SRCPORT)
        T2_RUN_2_KEY_2( 3, SRCIP, SRCPORT, 1)
        T2_RUN_2_KEY_2( 4, SRCIP, SRCPORT, SIZE)
        ...
        UM_RUN_5_KEY_2(16, SRCIP, SRCPORT, 1)
        UM_RUN_3_KEY_2(17, SRCIP, SRCPORT, 1)
        UM_RUN_3_KEY_2(18, SRCIP, SRCPORT, SIZE)
        UM_RUN_2_KEY_2(19, SRCIP, SRCPORT, SIZE)
    }
}
