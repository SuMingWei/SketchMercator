...
control SwitchIngress(
    ...
    // O1 hash init
        COMPUTE_HASH_221_32_32(32w0x30244f0b) d_1_auto_sampling_hash_call;
    ...
    T3_INIT_HH_3( 5, 221, 8192)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ABOVE_THRESHOLD_CONSTANT_4(100) d_4_above_threshold;
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_3_1;
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_3_2;
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_3_3;
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_3_4;
    //


    // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row) 
        COMPUTE_HASH_221_16_16(32w0x30244f0b) d_8_sampling_hash_call;
        COMPUTE_HASH_221_16_11(32w0x30244f0b) d_8_index_hash_call_1;
    ...
    apply {
        // O1 hash run
            d_1_auto_sampling_hash_call.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_1_sampling_hash_32);
        ...
        // HLL for inst 1
            ...
            update_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_1_level);
        //

        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_6_tcam_lpm.apply(ig_md.d_2_sampling_hash_32, ig_md.d_6_level);
        ...
        T3_RUN_AFTER_3_KEY_5( 5, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_3_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, SIZE, ig_md.d_3_est_1);
            update_3_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, SIZE, ig_md.d_3_est_2);
            update_3_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, SIZE, ig_md.d_3_est_3);
            update_3_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, SIZE, ig_md.d_3_est_4);
