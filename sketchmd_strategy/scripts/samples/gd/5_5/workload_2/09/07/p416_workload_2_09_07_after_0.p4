...
control SwitchIngress(
    ...
    T4_INIT_1( 1, 220, 32768)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        COMPUTE_HASH_220_16_16(32w0x30244f0b) d_2_res_hash_call;
        ABOVE_THRESHOLD_CONSTANT_1(100) d_3_above_threshold;
        T2_T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_2_1;
        ABOVE_THRESHOLD_CONSTANT_1(100) d_5_above_threshold;
        T3_T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_2_2;
        ABOVE_THRESHOLD_CONSTANT_1(100) d_6_above_threshold;
        T2_T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_2_3;
        ABOVE_THRESHOLD_CONSTANT_2(100) d_4_above_threshold;
        T3_T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_2_4;
        T3_T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_2_5;
    //

    T2_INIT_HH_2( 7, 220, 4096)
    T2_INIT_HH_5( 8, 220, 16384)
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_2_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, SIZE, ig_md.d_2_est_1);
            d_3_above_threshold.apply(ig_md.d_2_est_1, ig_md.d_3_above_threshold);
            update_2_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_2_res_hash[2:2], SIZE, ig_md.d_2_est_2);
            d_5_above_threshold.apply(ig_md.d_2_est_2, ig_md.d_5_above_threshold);
            update_2_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, SIZE, ig_md.d_2_est_3);
            d_6_above_threshold.apply(ig_md.d_2_est_3, ig_md.d_6_above_threshold);
            update_2_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_2_res_hash[4:4], SIZE, ig_md.d_2_est_4);
            update_2_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_2_res_hash[5:5], SIZE, ig_md.d_2_est_5);
            d_4_above_threshold.apply(ig_md.d_2_est_4, ig_md.d_2_est_5, ig_md.d_4_above_threshold);
        //
