...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_2_KEY_2( 4, SRCIP, SRCPORT, 1)
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            d_5_res_hash_call.apply(SRCIP, SRCPORT, ig_md.d_5_res_hash);
            update_5_1.apply(SRCIP, SRCPORT, SIZE, ig_md.d_5_res_hash[1:1], SIZE, ig_md.d_5_est_1);
            update_5_2.apply(SRCIP, SRCPORT, SIZE, ig_md.d_5_res_hash[2:2], SIZE, ig_md.d_5_est_2);
            update_5_3.apply(SRCIP, SRCPORT, SIZE, ig_md.d_5_res_hash[3:3], SIZE, ig_md.d_5_est_3);
            update_5_4.apply(SRCIP, SRCPORT, SIZE, ig_md.d_5_res_hash[4:4], SIZE, ig_md.d_5_est_4);
        ...
        // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row)
        d_8_tcam_lpm_2.apply(ig_md.d_3_sampling_hash_16, ig_md.d_8_base_16_1024, ig_md.d_8_base_16_2048);
        d_8_index_hash_call_1.apply(SRCIP, SRCPORT, ig_md.d_8_index1_16);
        update_8.apply(ig_md.d_8_base_16_1024, ig_md.d_8_index1_16);
        // 

        if(ig_md.d_6_above_threshold == 1) {
