...
control SwitchIngress(
    ...
    T3_INIT_HH_2( 5, 110, 16384)
    T3_INIT_HH_5( 6, 110, 8192)
    T3_INIT_HH_1( 7, 110, 16384)
    ...
    apply {
        ...
        T3_RUN_HH_2_KEY_2( 4, DSTIP, DSTPORT, 1)
        T3_RUN_HH_2_KEY_2( 5, DSTIP, DSTPORT, SIZE)
        T3_RUN_HH_5_KEY_2( 6, DSTIP, DSTPORT, SIZE)
