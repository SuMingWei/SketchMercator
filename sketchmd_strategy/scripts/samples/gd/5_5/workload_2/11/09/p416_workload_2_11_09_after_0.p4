...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T5_KEY_UPDATE_110_4096(32w0x30243f0b) update_8_1;
        T3_T2_KEY_UPDATE_110_4096(32w0x30243f0b) update_8_2;
        T3_T2_KEY_UPDATE_110_4096(32w0x30243f0b) update_8_3;
        T3_T2_KEY_UPDATE_110_4096(32w0x30243f0b) update_8_4;
        T3_KEY_UPDATE_110_4096(32w0x30243f0b) update_8_5;
    //
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_7_4;
    ...
    // apply SALUMerge; big - MRAC (1 row) / small - UnivMon (1 row) 
        ...
        COMPUTE_HASH_110_16_10(32w0x30244f0b) d_10_index_hash_call_1;
    ...
    apply {
        // O1 hash run
            ...
            d_2_auto_sampling_hash_call.apply(DSTIP, DSTPORT, ig_md.d_2_sampling_hash_32);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_8_1.apply(DSTIP, DSTPORT, 1, ig_md.d_8_res_hash[1:1], ig_md.d_8_bitmask, ig_md.d_8_est_1);
            update_8_2.apply(DSTIP, DSTPORT, 1, ig_md.d_8_res_hash[2:2], 1, ig_md.d_8_est_2);
            update_8_3.apply(DSTIP, DSTPORT, 1, ig_md.d_8_res_hash[3:3], 1, ig_md.d_8_est_3);
            update_8_4.apply(DSTIP, DSTPORT, 1, ig_md.d_8_res_hash[4:4], 1, ig_md.d_8_est_4);
            update_8_5.apply(DSTIP, DSTPORT, 1, ig_md.d_8_res_hash[5:5], ig_md.d_8_est_5);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_5(8)
        //

        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_9_res_hash_call.apply(DSTIP, DSTPORT, ig_md.d_9_res_hash);
            update_9_1.apply(DSTIP, DSTPORT, SIZE, ig_md.d_9_res_hash[1:1], 1, ig_md.d_9_est_1);
            update_9_2.apply(DSTIP, DSTPORT, SIZE, ig_md.d_9_res_hash[2:2], 1, ig_md.d_9_est_2);
            update_9_3.apply(DSTIP, DSTPORT, SIZE, ig_md.d_9_res_hash[3:3], SIZE, ig_md.d_9_est_3);
            update_9_4.apply(DSTIP, DSTPORT, SIZE, ig_md.d_9_res_hash[4:4], SIZE, ig_md.d_9_est_4);
            update_9_5.apply(DSTIP, DSTPORT, SIZE, ig_md.d_9_res_hash[5:5], ig_md.d_9_est_5);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_7_4.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_7_est_4);
            update_7_5.apply(DSTIP, DSTPORT, SIZE, ig_md.d_7_est_5);
