...
control SwitchIngress(
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_8_1.apply(DSTIP, 1, 1, ig_md.d_8_est_1);
            update_8_2.apply(DSTIP, 1, 1, ig_md.d_8_est_2);
            update_8_3.apply(DSTIP, 1, 1, ig_md.d_8_est_3);
            update_8_4.apply(DSTIP, 1, ig_md.d_8_est_4);
            update_8_5.apply(DSTIP, 1, ig_md.d_8_est_5);
