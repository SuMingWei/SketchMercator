...
control SwitchIngress(
    ...
    T5_INIT_1( 3, 220, 16384)
    T2_INIT_1( 4, 220, 16384)
    T2_INIT_5( 5, 220, 8192)
    T2_INIT_HH_5( 6, 220, 4096)
    T2_INIT_HH_1( 7, 220, 4096)
    ...
    apply {
        ...
        T2_RUN_5_KEY_4( 5, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        ...
        UM_RUN_1_KEY_4(11, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
    }
}
