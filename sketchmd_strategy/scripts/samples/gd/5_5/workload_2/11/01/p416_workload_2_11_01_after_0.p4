...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T5_T2_KEY_UPDATE_110_16384(32w0x30243f0b) update_3_1;
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        T3_T2_INDEX_UPDATE_32768() update_10_3;
    // 
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_3_1.apply(DSTIP, DSTPORT, 1, ig_md.d_3_bitmask, ig_md.d_3_est_1);
            update_3_2.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_3_est_2);
            update_3_3.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_3_est_3);
            update_3_4.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_3_est_4);
            d_4_above_threshold.apply(ig_md.d_3_est_2, ig_md.d_3_est_3, ig_md.d_3_est_4, ig_md.d_4_above_threshold);
        //

        T2_RUN_2_KEY_2( 2, DSTIP, DSTPORT, 1)
