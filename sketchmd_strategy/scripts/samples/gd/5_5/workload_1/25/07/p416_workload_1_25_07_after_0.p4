...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_AFTER_2_KEY_1( 8, DSTIP, SIZE)
        ...
        T2_RUN_AFTER_5_KEY_2(11, SRCIP, DSTIP, SIZE)
        ...
        T2_RUN_AFTER_3_KEY_4(18, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_AFTER_3_KEY_4(21, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_AFTER_4_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_AFTER_5_KEY_4(23, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
