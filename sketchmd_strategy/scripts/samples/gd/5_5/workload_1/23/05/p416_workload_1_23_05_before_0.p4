...
control SwitchIngress(
    ...
    T2_INIT_HH_3(16, 220, 4096)
    T2_INIT_HH_4(17, 220, 16384)
    ...
    apply {
        ...
        T2_RUN_HH_5_KEY_2(12, SRCIP, SRCPORT, SIZE)
        ...
        T2_RUN_HH_4_KEY_4(17, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        ...
        T2_RUN_HH_1_KEY_5(21, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
