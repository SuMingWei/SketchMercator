...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_AFTER_3_KEY_2( 3, SRCIP, DSTIP, SIZE)
        T2_RUN_AFTER_5_KEY_2( 4, SRCIP, DSTIP, SIZE)
        T2_RUN_AFTER_2_KEY_2( 5, SRCIP, SRCPORT, SIZE)
        T2_RUN_AFTER_2_KEY_2( 8, DSTIP, DSTPORT, SIZE)
        T2_RUN_AFTER_3_KEY_2( 6, DSTIP, DSTPORT, SIZE)
        T2_RUN_AFTER_5_KEY_2( 7, DSTIP, DSTPORT, SIZE)
