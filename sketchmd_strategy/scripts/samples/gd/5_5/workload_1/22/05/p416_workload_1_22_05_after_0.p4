...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_AFTER_3_KEY_2(13, SRCIP, DSTIP, 1)
        T2_RUN_AFTER_4_KEY_2(10, SRCIP, DSTIP, 1)
        T2_RUN_AFTER_4_KEY_2(12, SRCIP, DSTIP, 1)
        T2_RUN_AFTER_4_KEY_2(14, SRCIP, DSTIP, SIZE)
        T2_RUN_AFTER_1_KEY_2(15, SRCIP, SRCPORT, 1)
