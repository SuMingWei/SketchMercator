...
control SwitchIngress(
    ...
    T2_INIT_HH_4(21, 221, 8192)
    T2_INIT_HH_1(22, 221, 8192)
    apply {
        ...
        T2_RUN_HH_4_KEY_2(13, DSTIP, DSTPORT, SIZE)
        T2_RUN_HH_4_KEY_2(14, DSTIP, DSTPORT, SIZE)
        T2_RUN_HH_2_KEY_2(15, DSTIP, DSTPORT, SIZE)
        ...
        T2_RUN_HH_1_KEY_5(22, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
    }
}
