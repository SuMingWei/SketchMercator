...
control SwitchIngress(
    ...
    T2_INIT_HH_1(19, 220, 8192)
    T2_INIT_HH_2(20, 221, 8192)
    ...
    apply {
        ...
        T2_RUN_HH_1_KEY_2(12, SRCIP, SRCPORT, SIZE)
        T2_RUN_HH_1_KEY_2(13, SRCIP, SRCPORT, SIZE)
        T2_RUN_HH_1_KEY_2(14, DSTIP, DSTPORT, 1)
        ...
        T2_RUN_HH_1_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
