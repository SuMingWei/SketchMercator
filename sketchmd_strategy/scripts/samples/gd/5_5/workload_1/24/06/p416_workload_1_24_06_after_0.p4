...
INIT_HEAVY_FLOWKEY_STORAGE_CONFIG_221(65536, 16, 49152)
...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_AFTER_2_KEY_2( 9, SRCIP, SRCPORT, SIZE)
        ...
        T2_RUN_AFTER_2_KEY_2(15, DSTIP, DSTPORT, SIZE)
        T2_RUN_AFTER_5_KEY_2(13, DSTIP, DSTPORT, 1)
        T2_RUN_AFTER_1_KEY_4(18, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_AFTER_2_KEY_4(16, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_AFTER_3_KEY_4(17, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_AFTER_3_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_AFTER_3_KEY_4(20, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_AFTER_2_KEY_5(21, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T2_RUN_AFTER_2_KEY_5(22, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T2_RUN_AFTER_4_KEY_5(24, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
