...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_100_16384(32w0x30243f0b) update_3_2;
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T5_KEY_UPDATE_200_16384(32w0x30243f0b) update_9_1;
    ...
    T5_INIT_1(10, 220, 16384)
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ABOVE_THRESHOLD_CONSTANT_5(100) d_12_above_threshold;
        COMPUTE_HASH_220_16_16(32w0x30244f0b) d_12_res_hash_call;
        T3_T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_12_1;
        T3_T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_12_2;
        T3_KEY_UPDATE_220_16384(32w0x30243f0b) update_12_3;
        T3_KEY_UPDATE_220_16384(32w0x30243f0b) update_12_4;
        T3_KEY_UPDATE_220_16384(32w0x30243f0b) update_12_5;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_3_2.apply(DSTIP, SIZE, ig_md.d_3_bitmask, ig_md.d_3_est_2);
            update_3_3.apply(DSTIP, SIZE, SIZE, ig_md.d_3_est_3);
            update_3_4.apply(DSTIP, SIZE, SIZE, ig_md.d_3_est_4);
            update_3_5.apply(DSTIP, SIZE, ig_md.d_3_est_5);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_9_1.apply(SRCIP, DSTIP, 1, ig_md.d_9_res_hash[1:1], ig_md.d_9_bitmask, ig_md.d_9_est_1);
            update_9_2.apply(SRCIP, DSTIP, 1, ig_md.d_9_res_hash[2:2], SIZE, ig_md.d_9_est_2);
            update_9_3.apply(SRCIP, DSTIP, 1, ig_md.d_9_res_hash[3:3], SIZE, ig_md.d_9_est_3);
        ...
        // PCSA for inst 10
            ...
            update_10.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_10_bitmask);
        //

        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_12_res_hash_call.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_12_res_hash);
            update_12_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_12_res_hash[1:1], SIZE, ig_md.d_12_est_1);
            update_12_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_12_res_hash[2:2], SIZE, ig_md.d_12_est_2);
            update_12_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_12_res_hash[3:3], ig_md.d_12_est_3);
            update_12_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_12_res_hash[4:4], ig_md.d_12_est_4);
            update_12_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_12_res_hash[5:5], ig_md.d_12_est_5);
