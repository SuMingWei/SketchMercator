...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_13_1;
        T2_T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_13_2;
        T2_T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_13_3;
        T2_T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_13_4;
        T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_13_5;
    //
    ...
    T5_INIT_1(19, 221, 8192)
    UM_INIT_2(20, 221, 11, 32768)
    ...
    apply {
        ...
        T2_RUN_AFTER_2_KEY_2(10, DSTIP, DSTPORT, SIZE)
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_13_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, 1, ig_md.d_13_est_1);
            update_13_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, 1, ig_md.d_13_est_2);
            update_13_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, 1, ig_md.d_13_est_3);
            update_13_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, 1, ig_md.d_13_est_4);
            update_13_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_13_est_5);
        ...
        // PCSA for inst 19
            ...
            update_19.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_19_bitmask);
        //
