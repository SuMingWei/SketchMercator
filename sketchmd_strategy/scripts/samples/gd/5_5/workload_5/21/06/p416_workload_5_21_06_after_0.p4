...
control SwitchIngress(
    ...
    // apply O2
        ...
        T1_KEY_UPDATE_220_524288(32w0x30243f0b) update_14_5;
    // 
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_16_5;
    //

    MRAC_INIT_1(18, 220, 16384, 11,  8)
    T1_INIT_1(19, 221, 131072)
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_9_1.apply(SRCIP, SRCPORT, SIZE, 1, ig_md.d_9_est_1);
            update_9_2.apply(SRCIP, SRCPORT, SIZE, 1, ig_md.d_9_est_2);
            update_9_3.apply(SRCIP, SRCPORT, SIZE, ig_md.d_9_est_3);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            d_17_above_threshold.apply(ig_md.d_16_est_1, ig_md.d_17_above_threshold);
