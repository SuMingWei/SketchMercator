...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_110_8192(32w0x30243f0b) update_15_2;
        T2_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_15_3;
        T2_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_15_4;
        T2_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_15_5;
    //

    T1_INIT_1(17, 110, 262144)
    T1_INIT_3(16, 110, 524288)
    T5_INIT_1(18, 110, 16384)
    T3_INIT_HH_4(19, 110, 16384)
    T3_INIT_HH_1(20, 221, 4096)
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_3_1.apply(SRCIP, SIZE, ig_md.d_3_res_hash[1:1], 1, ig_md.d_3_est_1);
            ...
            update_3_5.apply(SRCIP, SIZE, ig_md.d_3_est_5);
        //
        ...
        T3_RUN_AFTER_5_KEY_1( 6, DSTIP, SIZE)
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_15_tcam_lpm.apply(ig_md.d_12_sampling_hash_32, ig_md.d_15_level);
            d_15_get_bitmask.apply(ig_md.d_15_level, ig_md.d_15_bitmask);
            update_15_1.apply(SRCIP, SRCPORT, SIZE, ig_md.d_15_bitmask, ig_md.d_15_est_1);
            update_15_2.apply(SRCIP, SRCPORT, SIZE, ig_md.d_15_bitmask, ig_md.d_15_est_2);
            update_15_3.apply(SRCIP, SRCPORT, SIZE, 1, ig_md.d_15_est_3);
            update_15_4.apply(SRCIP, SRCPORT, SIZE, 1, ig_md.d_15_est_4);
            update_15_5.apply(SRCIP, SRCPORT, SIZE, 1, ig_md.d_15_est_5);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_5(15)
        //

        T1_RUN_1_KEY_2(17, DSTIP, DSTPORT) if (ig_md.d_17_est1_1 == 0) { /* process_new_flow() */ }
        ...
        // PCSA for inst 18
            ...
            update_18.apply(DSTIP, DSTPORT, ig_md.d_18_bitmask);
        //

        T3_RUN_AFTER_4_KEY_2(19, DSTIP, DSTPORT, SIZE)
        T3_RUN_AFTER_1_KEY_5(20, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        // UnivMon for inst 21
            ...
            UM_RUN_END_1(21, ig_md.d_21_res_hash, 1) 
