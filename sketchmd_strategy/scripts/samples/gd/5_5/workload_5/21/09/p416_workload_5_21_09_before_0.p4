...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_3_KEY_2(14, SRCIP, SRCPORT, 1)
        T2_RUN_HH_5_KEY_2(15, SRCIP, SRCPORT, SIZE)
        ...
        T3_RUN_HH_4_KEY_2(19, DSTIP, DSTPORT, SIZE)
        T3_RUN_HH_1_KEY_5(20, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
