...
control SwitchIngress(
    ...
    // O1 hash init
        ...
        action d_11_xor_construction() { ig_md.d_11_sampling_hash_16 = ig_md.d_7_sampling_hash_16 ^ ig_md.d_8_sampling_hash_16; }
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_12_2;
        T3_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_12_3;
    ...
    apply {
        ...
        T1_RUN_3_KEY_4(10, SRCIP, DSTIP, SRCPORT, DSTPORT) if (ig_md.d_10_est1_1 == 0 || ig_md.d_10_est1_2 == 0 || ig_md.d_10_est1_3 == 0) { /* process_new_flow() */ }
        // MRAC for inst 11
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_12_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_12_res_hash[1:1], SIZE, ig_md.d_12_est_1);
            update_12_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_12_res_hash[2:2], SIZE, ig_md.d_12_est_2);
            update_12_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_12_res_hash[3:3], SIZE, ig_md.d_12_est_3);
