...
control SwitchIngress(
    ...
    T4_INIT_1(10, 220, 65536)
    UM_INIT_2(11, 220, 11, 32768)

    // apply O2
        T1_KEY_UPDATE_221_524288(32w0x30243f0b) update_12_1;
        T1_KEY_UPDATE_221_524288(32w0x30243f0b) update_12_2;
        T1_KEY_UPDATE_221_524288(32w0x30243f0b) update_12_3;
    // 
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_7_1.apply(SRCIP, SRCPORT, SIZE, 1, ig_md.d_7_est_1);
