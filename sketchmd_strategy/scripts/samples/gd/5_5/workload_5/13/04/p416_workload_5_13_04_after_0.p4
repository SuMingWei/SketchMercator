...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_AFTER_1_KEY_2( 9, DSTIP, DSTPORT, 1)
        // UnivMon for inst 10
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_13_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_13_bitmask, ig_md.d_13_est_1);
            ...
            update_13_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_13_est_4);
        //
