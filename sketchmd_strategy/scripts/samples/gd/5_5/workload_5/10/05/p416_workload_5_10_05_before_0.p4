...
control SwitchIngress(
    ...
    apply {
        ...
        T1_RUN_1_KEY_2( 5, DSTIP, DSTPORT) if (ig_md.d_5_est1_1 == 0) { /* process_new_flow() */ }
        UM_RUN_2_KEY_2( 6, DSTIP, DSTPORT, 1)
