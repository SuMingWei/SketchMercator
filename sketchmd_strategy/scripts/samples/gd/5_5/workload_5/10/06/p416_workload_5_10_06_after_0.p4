...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T5_T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_8_1;
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_8_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_8_bitmask, ig_md.d_8_est_1);
            update_8_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_8_res_hash[2:2], SIZE, ig_md.d_8_est_2);
            update_8_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_8_res_hash[3:3], SIZE, ig_md.d_8_est_3);
            d_9_above_threshold.apply(ig_md.d_8_est_2, ig_md.d_8_est_3, ig_md.d_9_above_threshold);
