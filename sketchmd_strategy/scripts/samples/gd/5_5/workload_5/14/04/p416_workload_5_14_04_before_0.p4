...
control SwitchIngress(
    ...
    apply {
        ...
        UM_RUN_2_KEY_2( 7, SRCIP, SRCPORT, SIZE)
        UM_RUN_4_KEY_2( 8, SRCIP, SRCPORT, SIZE)
        T1_RUN_1_KEY_2( 9, DSTIP, DSTPORT) if (ig_md.d_9_est1_1 == 0) { /* process_new_flow() */ }
        ...
        UM_RUN_1_KEY_4(12, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
