...
control SwitchIngress(
    ...
    UM_INIT_5(15, 110, 11, 32768)
    MRB_INIT_1(16, 221, 131072, 14,  8)
    apply {
        T3_RUN_HH_1_KEY_1( 1, DSTIP, 1)
        ...
        T3_RUN_HH_4_KEY_2( 8, SRCIP, SRCPORT, SIZE)
        UM_RUN_4_KEY_2( 9, SRCIP, SRCPORT, 1)
        UM_RUN_4_KEY_2(10, SRCIP, SRCPORT, SIZE)
        UM_RUN_3_KEY_2(11, SRCIP, SRCPORT, SIZE)
        T4_RUN_1_KEY_2(12, DSTIP, DSTPORT)
        T3_RUN_HH_1_KEY_2(13, DSTIP, DSTPORT, 1)
        MRAC_RUN_1_KEY_2(14, DSTIP, DSTPORT)
        UM_RUN_5_KEY_2(15, DSTIP, DSTPORT, SIZE)
        MRB_RUN_1_KEY_5(16, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
    }
}
