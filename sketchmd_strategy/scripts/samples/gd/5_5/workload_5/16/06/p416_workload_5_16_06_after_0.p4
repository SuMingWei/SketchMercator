...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_11_2;
    ...
    // apply O2
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_12_1;
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_12_2;
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_5_1.apply(SRCIP, SRCPORT, SIZE, SIZE, ig_md.d_5_est_1);
            update_5_2.apply(SRCIP, SRCPORT, SIZE, SIZE, ig_md.d_5_est_2);
        //
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_8_1.apply(DSTIP, DSTPORT, SIZE, ig_md.d_8_res_hash[1:1], SIZE, ig_md.d_8_est_1);
            update_8_2.apply(DSTIP, DSTPORT, SIZE, ig_md.d_8_res_hash[2:2], SIZE, ig_md.d_8_est_2);
