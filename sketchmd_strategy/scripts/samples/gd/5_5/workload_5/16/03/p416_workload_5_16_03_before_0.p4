...
control SwitchIngress(
    ...
    T2_INIT_3(15, 221, 16384)
    T3_INIT_HH_5(16, 221, 4096)
    apply {
        ...
        T3_RUN_HH_5_KEY_2( 5, SRCIP, DSTIP, 1)
        T3_RUN_HH_5_KEY_2( 6, SRCIP, DSTIP, SIZE)
        ...
        T3_RUN_HH_5_KEY_5(16, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
    }
}
