...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_100_8192(32w0x30243f0b) update_1_1;
        T2_T2_KEY_UPDATE_100_8192(32w0x30243f0b) update_1_2;
        T2_T2_KEY_UPDATE_100_8192(32w0x30243f0b) update_1_3;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_1_1.apply(DSTIP, SIZE, SIZE, ig_md.d_1_est_1);
            update_1_2.apply(DSTIP, SIZE, SIZE, ig_md.d_1_est_2);
            update_1_3.apply(DSTIP, SIZE, SIZE, ig_md.d_1_est_3);
