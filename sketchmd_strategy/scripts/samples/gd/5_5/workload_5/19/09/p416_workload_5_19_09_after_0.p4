...
control SwitchIngress(
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_200_16_10(32w0x30244f0b) d_11_index_hash_call_3;
        T3_INDEX_UPDATE_16384() update_11_3;
        COMPUTE_HASH_200_16_10(32w0x30244f0b) d_11_index_hash_call_4;
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_18_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_18_est_2);
