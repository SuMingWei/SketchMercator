...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_200_16384(32w0x30243f0b) update_2_1;
        T2_KEY_UPDATE_200_16384(32w0x30243f0b) update_2_2;
        T2_KEY_UPDATE_200_16384(32w0x30243f0b) update_2_3;
    //
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_200_16_11(32w0x30244f0b) d_4_index_hash_call_1;
        T3_T2_INDEX_UPDATE_32768() update_4_1;
        COMPUTE_HASH_200_16_11(32w0x30244f0b) d_4_index_hash_call_2;
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T5_KEY_UPDATE_110_16384(32w0x30243f0b) update_6_1;
    //

    T2_INIT_HH_2( 7, 110, 16384)
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_2_1.apply(SRCIP, DSTIP, 1, ig_md.d_2_bitmask, ig_md.d_2_est_1);
            update_2_2.apply(SRCIP, DSTIP, 1, ig_md.d_2_est_2);
            update_2_3.apply(SRCIP, DSTIP, 1, ig_md.d_2_est_3);
        ...
        update_4_2.apply(ig_md.d_4_base_16_2048, ig_md.d_4_index2_16, ig_md.d_4_res_hash[2:2], SIZE, ig_md.d_4_est_2);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            d_8_above_threshold.apply(ig_md.d_6_est_1, ig_md.d_8_above_threshold);
        //
        ...
        // PCSA for inst 16
            ...
            update_16.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_16_bitmask);
        //
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_18_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_18_bitmask, ig_md.d_18_est_1);
