...
control SwitchIngress(
    ...
    T2_INIT_1(12, 220, 8192)
    T2_INIT_3(13, 220, 8192)
    ...
    apply {
        ...
        T3_RUN_HH_3_KEY_2(10, DSTIP, DSTPORT, 1)
        T5_RUN_1_KEY_4(11, SRCIP, DSTIP, SRCPORT, DSTPORT)
        T2_RUN_1_KEY_4(12, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_3_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        ...
        UM_RUN_1_KEY_5(19, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
    }
}
