...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_AFTER_5_KEY_1( 2, DSTIP, 1)
        // UnivMon for inst 4
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_5_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_5_res_hash[1:1], 1, ig_md.d_5_est_1);
            update_5_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_5_res_hash[2:2], 1, ig_md.d_5_est_2);
            update_5_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_5_res_hash[3:3], 1, ig_md.d_5_est_3);
