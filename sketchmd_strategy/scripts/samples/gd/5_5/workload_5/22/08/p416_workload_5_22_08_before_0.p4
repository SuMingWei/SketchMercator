...
control SwitchIngress(
    ...
    T5_INIT_1(15, 110, 16384)
    T2_INIT_5(16, 220, 8192)
    T2_INIT_HH_5(17, 220, 16384)
    UM_INIT_1(18, 220, 10, 16384)
    UM_INIT_4(19, 220, 11, 32768)
    MRB_INIT_1(20, 221, 131072, 14,  8)
    T2_INIT_4(21, 221, 8192)
    UM_INIT_4(22, 221, 10, 16384)
    apply {
        T3_RUN_HH_1_KEY_1( 1, SRCIP, SIZE)
        MRB_RUN_1_KEY_1( 2, DSTIP)
        T2_RUN_4_KEY_1( 3, DSTIP, 1)
        T2_RUN_HH_3_KEY_1( 4, DSTIP, 1)
        MRAC_RUN_1_KEY_1( 5, DSTIP)
        UM_RUN_1_KEY_1( 6, DSTIP, SIZE)
        ...
        T5_RUN_1_KEY_2(15, DSTIP, DSTPORT)
        ...
        MRB_RUN_1_KEY_5(20, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        T2_RUN_4_KEY_5(21, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
