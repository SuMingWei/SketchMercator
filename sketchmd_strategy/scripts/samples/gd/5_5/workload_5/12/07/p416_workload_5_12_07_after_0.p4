...
control SwitchIngress(
    ...
    UM_INIT_5( 3, 200, 11, 32768)
    T2_INIT_3( 4, 110, 4096)
    T1_INIT_1( 6, 110, 131072)
    T1_INIT_5( 5, 110, 524288)
    ...
    apply {
        ...
        // UnivMon for inst 3
            ...
            d_3_index_hash_call_5.apply(SRCIP, DSTIP, ig_md.d_3_index5_16); 
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_7_1.apply(DSTIP, DSTPORT, 1, SIZE, ig_md.d_7_est_1);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_12_tcam_lpm.apply(ig_md.d_10_sampling_hash_32, ig_md.d_12_level);
            ...
            update_12_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_12_est_2);
