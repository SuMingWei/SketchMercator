...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_200_16384(32w0x30243f0b) update_5_2;
        ...
        T3_T2_KEY_UPDATE_200_16384(32w0x30243f0b) update_5_5;
    //
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_110_16_10(32w0x30244f0b) d_10_index_hash_call_4;
        T3_INDEX_UPDATE_16384() update_10_4;
    // 

    UM_INIT_1(11, 220, 11, 32768)
    T1_INIT_4(12, 221, 262144)
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_5_5.apply(SRCIP, DSTIP, 1, ig_md.d_5_res_hash[5:5], 1, ig_md.d_5_est_5);
            d_7_above_threshold.apply(ig_md.d_5_est_3, ig_md.d_5_est_4, ig_md.d_5_est_5, ig_md.d_7_above_threshold);
        //
        ...
        T1_RUN_4_KEY_5(12, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO) if (ig_md.d_12_est1_1 == 0 || ig_md.d_12_est1_2 == 0 || ig_md.d_12_est1_3 == 0 || ig_md.d_12_est1_4 == 0) { /* process_new_flow() */ }
        if(
