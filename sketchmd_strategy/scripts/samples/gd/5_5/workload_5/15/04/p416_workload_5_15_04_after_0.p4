...
control SwitchIngress(
    ...
    apply {
        ...
        // UnivMon for inst 12
            ...
            UM_RUN_END_2(12, ig_md.d_12_res_hash, SIZE) 
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_14_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, SIZE, ig_md.d_14_est_1);
            update_14_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, SIZE, ig_md.d_14_est_2);
