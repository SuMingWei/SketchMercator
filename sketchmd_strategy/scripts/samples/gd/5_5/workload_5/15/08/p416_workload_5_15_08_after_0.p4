...
control SwitchIngress(
    ...
    T1_INIT_4( 5, 110, 262144)
    T2_INIT_3( 6, 110, 16384)
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_2_1.apply(SRCIP, SIZE, SIZE, ig_md.d_2_est_1);
        ...
        T1_RUN_4_KEY_2( 5, SRCIP, SRCPORT) if (ig_md.d_5_est1_1 == 0 || ig_md.d_5_est1_2 == 0 || ig_md.d_5_est1_3 == 0 || ig_md.d_5_est1_4 == 0) { /* process_new_flow() */ }
        T2_RUN_3_KEY_2( 6, SRCIP, SRCPORT, SIZE)
        // MRAC for inst 7
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_8_1.apply(DSTIP, DSTPORT, 1, ig_md.d_8_res_hash[1:1], SIZE, ig_md.d_8_est_1);
            update_8_2.apply(DSTIP, DSTPORT, 1, ig_md.d_8_res_hash[2:2], SIZE, ig_md.d_8_est_2);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_12_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, 1, ig_md.d_12_est_1);
            update_12_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, 1, ig_md.d_12_est_2);
            update_12_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, 1, ig_md.d_12_est_3);
