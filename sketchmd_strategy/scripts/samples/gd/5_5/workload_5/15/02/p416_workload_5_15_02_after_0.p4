...
control SwitchIngress(
    ...
    apply {
        ...
        T3_RUN_AFTER_4_KEY_2( 8, SRCIP, SRCPORT, SIZE)
        // UnivMon for inst 9
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_10_1.apply(DSTIP, DSTPORT, SIZE, SIZE, ig_md.d_10_est_1);
            update_10_2.apply(DSTIP, DSTPORT, SIZE, ig_md.d_10_est_2);
            update_10_3.apply(DSTIP, DSTPORT, SIZE, ig_md.d_10_est_3);
        //
