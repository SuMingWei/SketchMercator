...
control SwitchIngress(
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_9_2.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_9_est_2);
            update_9_3.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_9_est_3);
            update_9_4.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_9_est_4);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_4(9)
        //

        T3_RUN_AFTER_5_KEY_2( 8, SRCIP, SRCPORT, 1)
        // MRB for inst 10
