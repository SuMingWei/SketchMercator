...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_100_16384(32w0x30243f0b) update_5_2;
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_220_16384(32w0x30243f0b) update_14_3;
        T3_KEY_UPDATE_220_16384(32w0x30243f0b) update_14_4;
    //

    T3_INIT_HH_2(13, 220, 16384)
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_5_1.apply(DSTIP, 1, SIZE, ig_md.d_5_est_1);
            update_5_2.apply(DSTIP, 1, SIZE, ig_md.d_5_est_2);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_14_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_14_res_hash[1:1], SIZE, ig_md.d_14_est_1);
            update_14_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_14_res_hash[2:2], SIZE, ig_md.d_14_est_2);
            update_14_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_14_res_hash[3:3], ig_md.d_14_est_3);
            update_14_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_14_res_hash[4:4], ig_md.d_14_est_4);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_4(14)
        //

        T3_RUN_AFTER_2_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_AFTER_3_KEY_5(15, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        if(
