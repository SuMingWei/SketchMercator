...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T2_KEY_UPDATE_200_8192(32w0x30243f0b) update_8_2;
        T2_T2_KEY_UPDATE_200_8192(32w0x30243f0b) update_8_3;
        T2_T2_KEY_UPDATE_200_8192(32w0x30243f0b) update_8_4;
    ...
    T1_INIT_2(20, 220, 131072)
    MRB_INIT_1(21, 220, 524288, 15, 16)
    UM_INIT_2(22, 220, 11, 32768)
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_8_3.apply(SRCIP, DSTIP, 1, 1, ig_md.d_8_est_3);
            update_8_4.apply(SRCIP, DSTIP, 1, 1, ig_md.d_8_est_4);
            update_8_5.apply(SRCIP, DSTIP, 1, ig_md.d_8_est_5);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_12_1.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_12_est_1);
            update_12_2.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_12_est_2);
            update_12_3.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_12_est_3);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            d_14_above_threshold.apply(ig_md.d_11_est_1, ig_md.d_11_est_2, ig_md.d_11_est_3, ig_md.d_14_above_threshold);
        ...
        T1_RUN_2_KEY_4(20, SRCIP, DSTIP, SRCPORT, DSTPORT) if (ig_md.d_20_est1_1 == 0 || ig_md.d_20_est1_2 == 0) { /* process_new_flow() */ }
        // MRB for inst 21
        ...
        // UnivMon for inst 22
            ...
            UM_RUN_END_2(22, ig_md.d_22_res_hash, SIZE) 
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_3(24)
        //

        T3_RUN_AFTER_2_KEY_5(25, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        if(
