...
control SwitchIngress(
    ...
    T2_INIT_5(23, 221, 8192)
    T2_INIT_1(24, 221, 16384)
    T2_INIT_HH_3(25, 221, 16384)
    apply {
        T1_RUN_1_KEY_1( 1, SRCIP) if (ig_md.d_1_est1_1 == 0) { /* process_new_flow() */ }
        T1_RUN_1_KEY_1( 2, SRCIP)
        T3_RUN_HH_4_KEY_1( 3, SRCIP, 1)
        UM_RUN_5_KEY_1( 4, SRCIP, 1)
        UM_RUN_2_KEY_1( 5, SRCIP, SIZE)
        UM_RUN_1_KEY_1( 6, SRCIP, SIZE)
        ...
        T3_RUN_HH_4_KEY_2(13, SRCIP, SRCPORT, 1)
        MRAC_RUN_1_KEY_2(14, SRCIP, SRCPORT)
        MRAC_RUN_1_KEY_2(15, SRCIP, SRCPORT)
        ...
        T3_RUN_HH_5_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        UM_RUN_3_KEY_4(20, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        UM_RUN_4_KEY_4(21, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        MRB_RUN_1_KEY_5(22, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        T2_RUN_5_KEY_5(23, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T2_RUN_1_KEY_5(24, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
