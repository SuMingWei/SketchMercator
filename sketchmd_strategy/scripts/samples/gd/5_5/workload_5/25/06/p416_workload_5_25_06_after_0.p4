...
control SwitchIngress(
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_8_index_hash_call_5;
    ...
    T1_INIT_5(16, 110, 524288)
    MRB_INIT_1(17, 220, 262144, 15,  8)
    T2_INIT_HH_5(18, 220, 16384)
    T3_INIT_HH_5(19, 220, 4096)
    UM_INIT_3(20, 220, 11, 32768)
    UM_INIT_4(21, 220, 11, 32768)
    MRB_INIT_1(22, 221, 524288, 15, 16)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_23_3;
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_23_4;
        T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_23_5;
    //
    ...
    apply {
        ...
        // UnivMon for inst 6
            ...
            UM_RUN_END_1(6, ig_md.d_6_res_hash, SIZE) 
        ...
        update_8_5.apply(ig_md.d_8_base_16_2048, ig_md.d_8_index5_16, ig_md.d_8_res_hash[5:5], 1, ig_md.d_8_est_5);
        ...
        T3_RUN_AFTER_4_KEY_2(13, SRCIP, SRCPORT, 1)
        ...
        T1_RUN_5_KEY_2(16, DSTIP, DSTPORT) if (ig_md.d_16_est1_1 == 0 || ig_md.d_16_est1_2 == 0 || ig_md.d_16_est1_3 == 0 || ig_md.d_16_est1_4 == 0 || ig_md.d_16_est1_5 == 0) { /* process_new_flow() */ }
        // MRB for inst 17
        ...
        T3_RUN_AFTER_5_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        // UnivMon for inst 20
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_23_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, 1, ig_md.d_23_est_4);
            d_25_above_threshold.apply(ig_md.d_23_est_2, ig_md.d_23_est_3, ig_md.d_23_est_4, ig_md.d_25_above_threshold);
