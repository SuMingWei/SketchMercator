...
control SwitchIngress(
    ...
    apply {
        ...
        UM_RUN_4_KEY_1( 6, SRCIP, SIZE)
        T1_RUN_1_KEY_1( 7, DSTIP)
        T2_RUN_2_KEY_1( 8, DSTIP, SIZE)
        T3_RUN_HH_2_KEY_1( 9, DSTIP, 1)
        T2_RUN_2_KEY_2(10, SRCIP, DSTIP, SIZE)
        T3_RUN_HH_2_KEY_2(11, SRCIP, DSTIP, 1)
        T3_RUN_HH_1_KEY_2(12, SRCIP, DSTIP, SIZE)
        UM_RUN_5_KEY_2(13, SRCIP, DSTIP, 1)
        ...
        T2_RUN_1_KEY_2(17, DSTIP, DSTPORT, 1)
        ...
        T3_RUN_HH_5_KEY_4(20, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        MRAC_RUN_1_KEY_4(21, SRCIP, DSTIP, SRCPORT, DSTPORT)
        UM_RUN_1_KEY_4(22, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        UM_RUN_1_KEY_4(23, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
