...
control SwitchIngress(
    ...
    apply {
        ...
        MRB_RUN_1_KEY_2(12, SRCIP, SRCPORT)
        T2_RUN_HH_2_KEY_2(13, SRCIP, SRCPORT, 1)
        MRAC_RUN_1_KEY_2(14, SRCIP, SRCPORT)
        UM_RUN_2_KEY_2(15, SRCIP, SRCPORT, SIZE)
        T5_RUN_1_KEY_2(16, DSTIP, DSTPORT)
        T2_RUN_3_KEY_2(17, DSTIP, DSTPORT, 1)
        T2_RUN_2_KEY_2(18, DSTIP, DSTPORT, 1)
        ...
        T2_RUN_HH_5_KEY_5(24, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
