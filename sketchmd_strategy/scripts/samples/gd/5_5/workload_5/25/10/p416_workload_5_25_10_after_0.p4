...
control SwitchIngress(
    ...
    T3_INIT_HH_5( 4, 100, 4096)
    T1_INIT_1( 6, 100, 262144)
    T3_INIT_HH_4( 7, 100, 16384)
    ...
    T2_INIT_3(18, 110, 8192)
    T1_INIT_4(19, 220, 524288)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        TCAM_LPM_HLLPCSA() d_21_tcam_lpm;
        GET_BITMASK() d_21_get_bitmask;
        T5_T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_21_1;
        T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_21_2;
    //

    UM_INIT_5(22, 220, 11, 32768)
    T1_INIT_1(23, 221, 131072)
    T2_INIT_4(24, 221, 8192)
    ...
    apply {
        ...
        T3_RUN_AFTER_5_KEY_1( 4, SRCIP, SIZE)
        T1_RUN_1_KEY_1( 6, DSTIP)
        T3_RUN_AFTER_4_KEY_1( 7, DSTIP, SIZE)
        ...
        T1_RUN_1_KEY_2(13, SRCIP, SRCPORT)
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_15_1.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_15_est_1);
            update_15_2.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_15_est_2);
            update_15_3.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_15_est_3);
            d_16_above_threshold.apply(ig_md.d_15_est_1, ig_md.d_15_est_2, ig_md.d_15_est_3, ig_md.d_16_above_threshold);
            update_15_4.apply(SRCIP, SRCPORT, 1, ig_md.d_15_est_4);
            update_15_5.apply(SRCIP, SRCPORT, 1, ig_md.d_15_est_5);
        //
        ...
        T1_RUN_4_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT) if (ig_md.d_19_est1_1 == 0 || ig_md.d_19_est1_2 == 0 || ig_md.d_19_est1_3 == 0 || ig_md.d_19_est1_4 == 0) { /* process_new_flow() */ }
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_21_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_21_bitmask, ig_md.d_21_est_1);
        ...
        T2_RUN_4_KEY_5(24, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        // UnivMon for inst 25
