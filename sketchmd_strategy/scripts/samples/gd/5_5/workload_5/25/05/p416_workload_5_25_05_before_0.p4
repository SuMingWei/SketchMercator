...
control SwitchIngress(
    ...
    T5_INIT_1(10, 200, 16384)
    T5_INIT_1(11, 200, 16384)
    T2_INIT_1(12, 200, 16384)
    T2_INIT_4(13, 200, 16384)
    T2_INIT_HH_3(14, 200, 4096)
    T4_INIT_1(15, 110, 32768)
    T2_INIT_2(16, 110, 8192)
    T3_INIT_HH_3(17, 110, 4096)
    T3_INIT_HH_5(18, 110, 16384)
    T3_INIT_HH_3(19, 110, 4096)
    ...
    apply {
        ...
        UM_RUN_2_KEY_1( 6, DSTIP, 1)
        UM_RUN_4_KEY_1( 7, DSTIP, SIZE)
        ...
        T2_RUN_1_KEY_2(12, SRCIP, DSTIP, SIZE)
        T2_RUN_4_KEY_2(13, SRCIP, DSTIP, SIZE)
        T2_RUN_HH_3_KEY_2(14, SRCIP, DSTIP, 1)
        T4_RUN_1_KEY_2(15, SRCIP, SRCPORT)
        T2_RUN_2_KEY_2(16, SRCIP, SRCPORT, SIZE)
        T3_RUN_HH_3_KEY_2(17, SRCIP, SRCPORT, 1)
        T3_RUN_HH_5_KEY_2(18, SRCIP, SRCPORT, SIZE)
        T3_RUN_HH_3_KEY_2(19, SRCIP, SRCPORT, SIZE)
        UM_RUN_2_KEY_2(20, SRCIP, SRCPORT, 1)
        T2_RUN_5_KEY_2(21, DSTIP, DSTPORT, 1)
        UM_RUN_3_KEY_2(22, DSTIP, DSTPORT, 1)
        UM_RUN_4_KEY_2(23, DSTIP, DSTPORT, SIZE)
