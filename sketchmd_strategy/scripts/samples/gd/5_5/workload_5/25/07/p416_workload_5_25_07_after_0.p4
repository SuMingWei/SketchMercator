...
control SwitchIngress(
    ...
    UM_INIT_1( 4, 100, 10, 16384)
    T1_INIT_1( 5, 200, 131072)
    T2_INIT_HH_1( 6, 200, 16384)
    UM_INIT_3( 7, 200, 10, 16384)
    T1_INIT_2( 8, 110, 262144)
    UM_INIT_2( 9, 110, 11, 32768)
    ...
    MRB_INIT_1(15, 220, 524288, 15, 16)
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_16_4;
        T2_T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_16_5;
    //

    MRAC_INIT_1(19, 220, 8192, 10,  8)
    T1_INIT_2(20, 221, 131072)
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_23_1;
        T3_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_23_2;
        T3_KEY_UPDATE_221_16384(32w0x30243f0b) update_23_3;
    //

    T2_INIT_HH_2(24, 221, 4096)
    UM_INIT_3(25, 221, 11, 32768)
    ...
    apply {
        ...
        // PCSA for inst 3
            ...
            update_3.apply(DSTIP, ig_md.d_3_bitmask);
        //
        ...
        // UnivMon for inst 4
            ...
            UM_RUN_END_1(4, ig_md.d_4_res_hash, SIZE) 
        ...
        T1_RUN_1_KEY_4(14, SRCIP, DSTIP, SRCPORT, DSTPORT)
        // MRB for inst 15
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_16_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, 1, ig_md.d_16_est_3);
            update_16_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, 1, ig_md.d_16_est_4);
            update_16_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, 1, ig_md.d_16_est_5);
        //
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_23_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_23_res_hash[3:3], ig_md.d_23_est_3);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_3(23)
        //

        T2_RUN_AFTER_2_KEY_5(24, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        // UnivMon for inst 25
            ...
            UM_RUN_END_3(25, ig_md.d_25_res_hash, 1) 
