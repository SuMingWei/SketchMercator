...
control SwitchIngress(
    ...
    apply {
        ...
        T5_RUN_1_KEY_1( 3, DSTIP)
        UM_RUN_1_KEY_1( 4, DSTIP, SIZE)
        T1_RUN_1_KEY_2( 5, SRCIP, DSTIP)
        T2_RUN_HH_1_KEY_2( 6, SRCIP, DSTIP, 1)
        UM_RUN_3_KEY_2( 7, SRCIP, DSTIP, SIZE)
        T1_RUN_2_KEY_2( 8, SRCIP, SRCPORT) if (ig_md.d_8_est1_1 == 0 || ig_md.d_8_est1_2 == 0) { /* process_new_flow() */ }
        UM_RUN_2_KEY_2( 9, SRCIP, SRCPORT, 1)
        UM_RUN_5_KEY_2(10, SRCIP, SRCPORT, SIZE)
        ...
        T2_RUN_5_KEY_4(17, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T3_RUN_HH_3_KEY_4(18, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        ...
        T4_RUN_1_KEY_5(21, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        T2_RUN_2_KEY_5(22, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T3_RUN_HH_3_KEY_5(23, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T2_RUN_HH_2_KEY_5(24, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        UM_RUN_3_KEY_5(25, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
    }
}
