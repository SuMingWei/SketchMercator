...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_110_8192(32w0x30243f0b) update_12_1;
        T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_12_2;
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T5_T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_14_1;
    ...
    apply {
        ...
        // UnivMon for inst 1
            ...
            UM_RUN_END_2(1, ig_md.d_1_res_hash, 1) 
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_12_tcam_lpm.apply(ig_md.d_9_sampling_hash_32, ig_md.d_12_level);
            ...
            update_12_2.apply(SRCIP, SRCPORT, SIZE, ig_md.d_12_est_2);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_14_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, SIZE, ig_md.d_14_est_2);
            d_15_above_threshold.apply(ig_md.d_14_est_2, ig_md.d_15_above_threshold);
        ...
        T2_RUN_4_KEY_5(18, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        if(
