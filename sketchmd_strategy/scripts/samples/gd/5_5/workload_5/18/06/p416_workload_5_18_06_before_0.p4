...
control SwitchIngress(
    ...
    apply {
        ...
        T5_RUN_1_KEY_2( 7, DSTIP, DSTPORT)
        T2_RUN_3_KEY_2( 8, DSTIP, DSTPORT, 1)
        T2_RUN_HH_3_KEY_2( 9, DSTIP, DSTPORT, 1)
        T2_RUN_HH_3_KEY_2(10, DSTIP, DSTPORT, 1)
        MRB_RUN_1_KEY_4(11, SRCIP, DSTIP, SRCPORT, DSTPORT)
        ...
        MRB_RUN_1_KEY_5(15, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
