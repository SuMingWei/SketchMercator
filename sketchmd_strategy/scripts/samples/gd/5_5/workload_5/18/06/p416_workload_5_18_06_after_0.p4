...
control SwitchIngress(
    ...
    T4_INIT_1( 3, 200, 32768)
    T4_INIT_1( 4, 110, 32768)
    T2_INIT_HH_5( 5, 110, 8192)
    MRAC_INIT_1( 6, 110, 32768, 11, 16)
    T5_INIT_1( 7, 110, 16384)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ABOVE_THRESHOLD_CONSTANT_3(100) d_9_above_threshold;
        T2_T2_KEY_UPDATE_110_4096(32w0x30243f0b) update_8_1;
        T2_T2_KEY_UPDATE_110_4096(32w0x30243f0b) update_8_2;
        T2_T2_KEY_UPDATE_110_4096(32w0x30243f0b) update_8_3;
    //

    MRB_INIT_1(11, 220, 131072, 14,  8)
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            d_9_above_threshold.apply(ig_md.d_8_est_1, ig_md.d_8_est_2, ig_md.d_8_est_3, ig_md.d_9_above_threshold);
        //
