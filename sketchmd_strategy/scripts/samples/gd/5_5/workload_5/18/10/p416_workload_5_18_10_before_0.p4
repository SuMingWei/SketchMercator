...
control SwitchIngress(
    ...
    T5_INIT_1(13, 220, 16384)
    MRB_INIT_1(14, 221, 131072, 14,  8)
    ...
    apply {
        ...
        T3_RUN_HH_3_KEY_2( 9, SRCIP, SRCPORT, SIZE)
        UM_RUN_4_KEY_2(10, SRCIP, SRCPORT, 1)
        T3_RUN_HH_2_KEY_2(11, DSTIP, DSTPORT, SIZE)
        T2_RUN_HH_3_KEY_2(12, DSTIP, DSTPORT, 1)
        T5_RUN_1_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT)
        MRB_RUN_1_KEY_5(14, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        T2_RUN_3_KEY_5(15, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
