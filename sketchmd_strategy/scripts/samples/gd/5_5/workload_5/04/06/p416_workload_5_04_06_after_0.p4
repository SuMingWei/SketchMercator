...
control SwitchIngress(
    ...
    T2_INIT_HH_5( 1, 110, 16384)
    T1_INIT_2( 2, 220, 131072)
    T3_INIT_HH_5( 3, 220, 4096)
    UM_INIT_4( 4, 221, 10, 16384)
    ...
    apply {
        ...
        // UnivMon for inst 4
            ...
            d_4_index_hash_call_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_4_index4_16); 
