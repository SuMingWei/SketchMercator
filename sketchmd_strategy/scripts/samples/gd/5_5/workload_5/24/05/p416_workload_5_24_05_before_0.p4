...
control SwitchIngress(
    ...
    apply {
        ...
        UM_RUN_4_KEY_2( 7, SRCIP, DSTIP, SIZE)
        UM_RUN_1_KEY_2( 8, SRCIP, DSTIP, SIZE)
        UM_RUN_1_KEY_2( 9, SRCIP, DSTIP, SIZE)
        ...
        T3_RUN_HH_3_KEY_2(15, DSTIP, DSTPORT, 1)
