...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T5_KEY_UPDATE_110_8192(32w0x30243f0b) update_15_1;
        T3_KEY_UPDATE_110_8192(32w0x30243f0b) update_15_2;
        T3_KEY_UPDATE_110_8192(32w0x30243f0b) update_15_3;
    //
    ...
    // apply O2
        T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_17_1;
        T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_17_2;
    ...
    T1_INIT_2(22, 221, 262144)
    T5_INIT_1(23, 221, 4096)
    ...
    apply {
        ...
        // UnivMon for inst 8
            ...
            UM_RUN_END_1(8, ig_md.d_8_res_hash, SIZE) 
        ...
        // PCSA for inst 11
            ...
            update_11.apply(SRCIP, SRCPORT, ig_md.d_11_bitmask);
        //
        ...
        // PCSA for inst 23
            ...
            update_23.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_23_bitmask);
        //
