...
control SwitchIngress(
    ...
    apply {
        ...
        T3_RUN_HH_4_KEY_2(15, SRCIP, SRCPORT, 1)
        T3_RUN_HH_3_KEY_2(16, SRCIP, SRCPORT, 1)
        T1_RUN_3_KEY_2(17, DSTIP, DSTPORT) if (ig_md.d_17_est1_1 == 0 || ig_md.d_17_est1_2 == 0 || ig_md.d_17_est1_3 == 0) { /* process_new_flow() */ }
        T2_RUN_5_KEY_2(18, DSTIP, DSTPORT, 1)
        T2_RUN_HH_1_KEY_2(19, DSTIP, DSTPORT, 1)
