...
control SwitchIngress(
    ...
    // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row) 
        COMPUTE_HASH_221_16_8(32w0x30244f0b) d_22_sampling_hash_call;
    ...
    apply {
        ...
        // PCSA for inst 9
            ...
            update_9.apply(SRCIP, DSTIP, ig_md.d_9_bitmask);
        //
        ...
        T2_RUN_AFTER_3_KEY_4(17, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        // UnivMon for inst 18
