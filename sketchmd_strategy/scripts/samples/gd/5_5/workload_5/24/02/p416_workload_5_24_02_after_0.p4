...
control SwitchIngress(
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_100_16_10(32w0x30244f0b) d_8_index_hash_call_5;
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T2_KEY_UPDATE_200_4096(32w0x30243f0b) update_10_1;
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_10_5.apply(SRCIP, DSTIP, SIZE, ig_md.d_10_est_5);
        //
        ...
        T3_RUN_AFTER_1_KEY_2(17, SRCIP, SRCPORT, 1)
        T2_RUN_AFTER_5_KEY_2(16, SRCIP, SRCPORT, 1)
        ...
        T2_RUN_AFTER_2_KEY_2(19, DSTIP, DSTPORT, 1)
        ...
        T2_RUN_AFTER_5_KEY_4(22, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        // UnivMon for inst 23
        ...
        // MRB for inst 24
            d_24_tcam_lpm.apply(ig_md.d_24_sampling_hash_16, ig_md.d_24_base_32);
            d_24_index_hash_call_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_24_index1_16);
            update_24.apply(ig_md.d_24_base_32, ig_md.d_24_index1_16);
        //
