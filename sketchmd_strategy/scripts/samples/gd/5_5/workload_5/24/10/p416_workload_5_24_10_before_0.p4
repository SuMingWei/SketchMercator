...
control SwitchIngress(
    ...
    apply {
        ...
        UM_RUN_2_KEY_2(11, SRCIP, DSTIP, 1)
        UM_RUN_1_KEY_2(12, SRCIP, DSTIP, SIZE)
        T2_RUN_3_KEY_2(13, SRCIP, SRCPORT, SIZE)
        T3_RUN_HH_5_KEY_2(14, SRCIP, SRCPORT, 1)
        ...
        T2_RUN_3_KEY_5(23, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
