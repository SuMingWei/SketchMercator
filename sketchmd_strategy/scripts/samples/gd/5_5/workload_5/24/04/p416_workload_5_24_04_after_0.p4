...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_100_8192(32w0x30243f0b) update_8_1;
        T2_T5_KEY_UPDATE_100_8192(32w0x30243f0b) update_8_2;
    //
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_16_5;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_8_tcam_lpm.apply(ig_md.d_6_sampling_hash_32, ig_md.d_8_level);
            d_8_get_bitmask.apply(ig_md.d_8_level, ig_md.d_8_bitmask);
            update_8_1.apply(DSTIP, 1, ig_md.d_8_bitmask, ig_md.d_8_est_1);
            update_8_2.apply(DSTIP, 1, ig_md.d_8_bitmask, ig_md.d_8_est_2);
        ...
        // PCSA for inst 15
            ...
            update_15.apply(DSTIP, DSTPORT, ig_md.d_15_bitmask);
        //

        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_16_1.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_16_est_1);
            update_16_2.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_16_est_2);
            update_16_3.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_16_est_3);
            update_16_4.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_16_est_4);
            update_16_5.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_16_est_5);
            d_17_above_threshold.apply(ig_md.d_16_est_1, ig_md.d_16_est_2, ig_md.d_16_est_3, ig_md.d_16_est_4, ig_md.d_16_est_5, ig_md.d_17_above_threshold);
        //
