...
control SwitchIngress(
    ...
    apply {
        ...
        T3_RUN_HH_2_KEY_1( 2, DSTIP, 1)
        T3_RUN_HH_3_KEY_1( 3, DSTIP, SIZE)
        ...
        T2_RUN_5_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
