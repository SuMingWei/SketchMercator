...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T5_T2_KEY_UPDATE_110_4096(32w0x30243f0b) update_6_1;
    ...
    apply {
        ...
        // MRAC for inst 7
            d_7_tcam_lpm.apply(ig_md.d_4_sampling_hash_16, ig_md.d_7_base_16);
            d_7_index_hash_call_1.apply(SRCIP, SRCPORT, ig_md.d_7_index1_16);
            update_7.apply(ig_md.d_7_base_16, ig_md.d_7_index1_16);
        //

        T3_RUN_AFTER_3_KEY_2( 8, DSTIP, DSTPORT, SIZE)
        T1_RUN_1_KEY_4( 9, SRCIP, DSTIP, SRCPORT, DSTPORT) if (ig_md.d_9_est1_1 == 0) { /* process_new_flow() */ }
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_12_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, SIZE, ig_md.d_12_est_1);
            update_12_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_12_est_2);
