...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_200_8192(32w0x30243f0b) update_8_2;
        T3_KEY_UPDATE_200_8192(32w0x30243f0b) update_8_3;
        T3_KEY_UPDATE_200_8192(32w0x30243f0b) update_8_4;
    //


    // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row) 
        COMPUTE_HASH_200_16_16(32w0x30244f0b) d_9_sampling_hash_call;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_3_2.apply(SRCIP, SIZE, 1, ig_md.d_3_est_2);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_6_2.apply(DSTIP, SIZE, SIZE, ig_md.d_6_est_2);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_8_3.apply(SRCIP, DSTIP, 1, ig_md.d_8_res_hash[3:3], ig_md.d_8_est_3);
            update_8_4.apply(SRCIP, DSTIP, 1, ig_md.d_8_res_hash[4:4], ig_md.d_8_est_4);
