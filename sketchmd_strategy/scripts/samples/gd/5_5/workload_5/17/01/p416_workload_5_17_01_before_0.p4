...
control SwitchIngress(
    ...
    T2_INIT_5(13, 221, 4096)
    T2_INIT_HH_4(14, 221, 16384)
    T3_INIT_HH_2(15, 221, 4096)
    T3_INIT_HH_2(16, 221, 4096)
    ...
    apply {
        ...
        T3_RUN_HH_5_KEY_2( 9, SRCIP, SRCPORT, SIZE)
        ...
        T3_RUN_HH_2_KEY_5(15, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T3_RUN_HH_2_KEY_5(16, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
