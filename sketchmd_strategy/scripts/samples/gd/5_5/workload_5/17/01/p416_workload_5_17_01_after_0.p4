...
control SwitchIngress(
    ...
    T2_INIT_2( 7, 200, 8192)
    MRAC_INIT_1( 8, 200, 16384, 11,  8)
    T3_INIT_HH_5( 9, 110, 4096)
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_11_4;
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_13_1;
        T3_T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_13_2;
        ABOVE_THRESHOLD_CONSTANT_2(100) d_16_above_threshold;
        T3_T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_13_3;
        T3_T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_13_4;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_11_3.apply(DSTIP, DSTPORT, SIZE, ig_md.d_11_est_3);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_13_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_13_res_hash[2:2], SIZE, ig_md.d_13_est_2);
            d_15_above_threshold.apply(ig_md.d_13_est_1, ig_md.d_13_est_2, ig_md.d_15_above_threshold);
            update_13_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_13_res_hash[3:3], SIZE, ig_md.d_13_est_3);
            update_13_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_13_res_hash[4:4], SIZE, ig_md.d_13_est_4);
            d_16_above_threshold.apply(ig_md.d_13_est_3, ig_md.d_13_est_4, ig_md.d_16_above_threshold);
            update_13_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_13_est_5);
        //

        T2_RUN_AFTER_4_KEY_5(14, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        // MRAC for inst 17
