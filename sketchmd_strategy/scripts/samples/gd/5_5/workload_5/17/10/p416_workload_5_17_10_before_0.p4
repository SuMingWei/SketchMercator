...
control SwitchIngress(
    ...
    T2_INIT_2(13, 220, 4096)
    T1_INIT_5(14, 221, 131072)
    ...
    apply {
        ...
        T3_RUN_HH_5_KEY_1( 5, DSTIP, SIZE)
        UM_RUN_2_KEY_2( 6, SRCIP, DSTIP, SIZE)
        T1_RUN_1_KEY_2( 7, SRCIP, SRCPORT) if (ig_md.d_7_est1_1 == 0) { /* process_new_flow() */ }
        MRAC_RUN_1_KEY_2( 8, SRCIP, SRCPORT)
        T4_RUN_1_KEY_2( 9, DSTIP, DSTPORT)
        T2_RUN_HH_3_KEY_2(10, DSTIP, DSTPORT, SIZE)
        UM_RUN_2_KEY_2(11, DSTIP, DSTPORT, SIZE)
        UM_RUN_3_KEY_2(12, DSTIP, DSTPORT, SIZE)
        T2_RUN_2_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
