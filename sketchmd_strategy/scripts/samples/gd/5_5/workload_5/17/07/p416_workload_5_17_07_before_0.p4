...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_5_KEY_2(12, SRCIP, SRCPORT, SIZE)
        UM_RUN_2_KEY_2(13, SRCIP, SRCPORT, 1)
        UM_RUN_4_KEY_2(14, SRCIP, SRCPORT, SIZE)
        T3_RUN_HH_4_KEY_2(15, DSTIP, DSTPORT, 1)
        T2_RUN_HH_4_KEY_4(16, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        UM_RUN_3_KEY_4(17, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
    }
}
