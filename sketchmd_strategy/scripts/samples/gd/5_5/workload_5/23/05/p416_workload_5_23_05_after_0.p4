...
control SwitchIngress(
    ...
    // O1 hash init
        ...
        action d_13_xor_construction() { ig_md.d_13_sampling_hash_16 = ig_md.d_4_sampling_hash_16 ^ ig_md.d_9_sampling_hash_16; }
    ...
    MRAC_INIT_1( 9, 100, 16384, 10, 16)
    T1_INIT_1(10, 200, 131072)
    T3_INIT_HH_1(11, 200, 8192)
    ...
    // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row) 
        ...
        COMPUTE_HASH_221_16_10(32w0x30244f0b) d_20_index_hash_call_1;
    ...
    // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row) 
        COMPUTE_HASH_221_16_8(32w0x30244f0b) d_21_sampling_hash_call;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_8_2.apply(DSTIP, 1, ig_md.d_8_est_2);
            update_8_3.apply(DSTIP, 1, ig_md.d_8_est_3);
        ...
        T2_RUN_AFTER_3_KEY_2(12, SRCIP, DSTIP, SIZE)
        // MRAC for inst 13
