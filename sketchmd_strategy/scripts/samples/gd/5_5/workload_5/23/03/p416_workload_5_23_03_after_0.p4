...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_100_8192(32w0x30243f0b) update_3_1;
        T2_T5_KEY_UPDATE_100_8192(32w0x30243f0b) update_3_2;
        T2_KEY_UPDATE_100_8192(32w0x30243f0b) update_3_3;
    //

    UM_INIT_1( 4, 100, 11, 32768)
    UM_INIT_2( 5, 100, 10, 16384)
    T1_INIT_5( 6, 100, 262144)
    MRB_INIT_1( 7, 100, 131072, 14,  8)
    T3_INIT_HH_4( 8, 100, 4096)
    UM_INIT_5( 9, 100, 11, 32768)
    T1_INIT_3(10, 200, 524288)
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_21_4;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_3_2.apply(SRCIP, SIZE, ig_md.d_3_bitmask, ig_md.d_3_est_2);
        ...
        T3_RUN_AFTER_4_KEY_1( 8, DSTIP, SIZE)
        // UnivMon for inst 9
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            d_22_above_threshold.apply(ig_md.d_20_est_1, ig_md.d_22_above_threshold);
            update_20_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_20_est_2);
            update_20_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_20_est_3);
            update_20_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_20_est_4);
        //

        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_21_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_21_est_1);
            update_21_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_21_est_2);
            update_21_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_21_est_3);
            update_21_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, 1, ig_md.d_21_est_4);
