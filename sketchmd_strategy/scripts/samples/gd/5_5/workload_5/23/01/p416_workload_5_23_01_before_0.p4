...
control SwitchIngress(
    ...
    apply {
        ...
        UM_RUN_2_KEY_2(10, SRCIP, DSTIP, SIZE)
        ...
        T2_RUN_2_KEY_2(14, DSTIP, DSTPORT, SIZE)
        T2_RUN_2_KEY_2(15, DSTIP, DSTPORT, SIZE)
        T3_RUN_HH_5_KEY_2(16, DSTIP, DSTPORT, SIZE)
        T3_RUN_HH_4_KEY_2(17, DSTIP, DSTPORT, SIZE)
        T2_RUN_HH_2_KEY_2(18, DSTIP, DSTPORT, 1)
        UM_RUN_5_KEY_2(19, DSTIP, DSTPORT, 1)
        T1_RUN_1_KEY_4(20, SRCIP, DSTIP, SRCPORT, DSTPORT)
        UM_RUN_3_KEY_4(21, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
