...
control SwitchIngress(
    ...
    apply {
        ...
        UM_RUN_4_KEY_1( 6, DSTIP, 1)
        UM_RUN_2_KEY_1( 7, DSTIP, SIZE)
        T4_RUN_1_KEY_2( 8, SRCIP, DSTIP)
        T5_RUN_1_KEY_2( 9, SRCIP, DSTIP)
        ...
        UM_RUN_4_KEY_2(14, SRCIP, SRCPORT, 1)
        UM_RUN_1_KEY_2(15, DSTIP, DSTPORT, 1)
        T2_RUN_1_KEY_4(16, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
