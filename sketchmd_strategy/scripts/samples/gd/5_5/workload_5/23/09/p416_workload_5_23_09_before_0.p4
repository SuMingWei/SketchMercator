...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_1_KEY_1( 5, DSTIP, SIZE)
        T2_RUN_HH_3_KEY_1( 6, DSTIP, SIZE)
        UM_RUN_4_KEY_1( 7, DSTIP, 1)
        ...
        UM_RUN_3_KEY_2(14, SRCIP, SRCPORT, 1)
        T2_RUN_3_KEY_2(15, DSTIP, DSTPORT, SIZE)
        T2_RUN_5_KEY_2(16, DSTIP, DSTPORT, SIZE)
