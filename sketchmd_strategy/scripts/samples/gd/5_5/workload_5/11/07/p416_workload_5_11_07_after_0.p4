...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_4_1;
        T3_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_4_2;
        T3_KEY_UPDATE_100_4096(32w0x30243f0b) update_4_3;
    //
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T5_T2_KEY_UPDATE_100_8192(32w0x30243f0b) update_7_1;
    ...
    T4_INIT_1(10, 221, 16384)
    T2_INIT_4(11, 221, 4096)
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_4_3.apply(SRCIP, SIZE, ig_md.d_4_res_hash[3:3], ig_md.d_4_est_3);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_7_2.apply(DSTIP, SIZE, SIZE, ig_md.d_7_est_2);
            update_7_3.apply(DSTIP, SIZE, SIZE, ig_md.d_7_est_3);
            update_7_4.apply(DSTIP, SIZE, SIZE, ig_md.d_7_est_4);
        ...
        T2_RUN_4_KEY_5(11, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        if(
