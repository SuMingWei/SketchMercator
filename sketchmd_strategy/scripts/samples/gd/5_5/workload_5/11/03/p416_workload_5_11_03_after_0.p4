...
control SwitchIngress(
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_200_16_11(32w0x30244f0b) d_4_index_hash_call_3;
        T3_INDEX_UPDATE_32768() update_4_3;
    // 

    T2_INIT_HH_2( 6, 110, 8192)
    T2_INIT_HH_3( 5, 110, 4096)
    T2_INIT_2( 7, 110, 4096)
    MRAC_INIT_1( 8, 110, 16384, 11,  8)
    UM_INIT_5( 9, 220, 11, 32768)
    T2_INIT_HH_4(10, 221, 4096)
    ...
    apply {
        ...
        T2_RUN_2_KEY_2( 7, DSTIP, DSTPORT, 1)
        // MRAC for inst 8
        ...
        // UnivMon for inst 9
            ...
            d_9_index_hash_call_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_9_index4_16); 
            d_9_index_hash_call_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_9_index5_16); 
