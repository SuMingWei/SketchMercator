...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_100_4096(32w0x30243f0b) update_9_2;
        T3_KEY_UPDATE_100_4096(32w0x30243f0b) update_9_3;
        T3_KEY_UPDATE_100_4096(32w0x30243f0b) update_9_4;
        T3_KEY_UPDATE_100_4096(32w0x30243f0b) update_9_5;
    //

    UM_INIT_1(10, 100, 10, 16384)
    T1_INIT_5(11, 200, 524288)
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_200_8192(32w0x30243f0b) update_14_1;
        T2_KEY_UPDATE_200_8192(32w0x30243f0b) update_14_2;
        T2_KEY_UPDATE_200_8192(32w0x30243f0b) update_14_3;
    //

    T2_INIT_HH_1(13, 200, 8192)
    T1_INIT_3(15, 110, 131072)
    T2_INIT_HH_3(16, 110, 4096)
    UM_INIT_1(17, 110, 10, 16384)
    UM_INIT_5(18, 110, 10, 16384)
    T2_INIT_HH_5(19, 220, 16384)
    T1_INIT_4(20, 221, 262144)
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_14_tcam_lpm.apply(ig_md.d_12_sampling_hash_32, ig_md.d_14_level);
        ...
        T1_RUN_3_KEY_2(15, SRCIP, SRCPORT) if (ig_md.d_15_est1_1 == 0 || ig_md.d_15_est1_2 == 0 || ig_md.d_15_est1_3 == 0) { /* process_new_flow() */ }
