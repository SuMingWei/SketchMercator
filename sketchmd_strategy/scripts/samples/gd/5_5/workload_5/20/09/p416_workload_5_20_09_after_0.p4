...
control SwitchIngress(
    ...
    // O1 hash init
        ...
        action d_8_xor_construction() { ig_md.d_8_sampling_hash_16 = ig_md.d_2_sampling_hash_16 ^ ig_md.d_5_sampling_hash_16; }
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_100_8192(32w0x30243f0b) update_6_4;
        T2_T2_KEY_UPDATE_100_8192(32w0x30243f0b) update_6_5;
    //
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_11_5;
    //

    MRAC_INIT_1(14, 110, 32768, 11, 16)
    T1_INIT_2(15, 220, 262144)
    UM_INIT_4(16, 220, 10, 16384)
    T4_INIT_1(17, 221, 16384)
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_6_4.apply(DSTIP, 1, SIZE, ig_md.d_6_est_4);
            update_6_5.apply(DSTIP, 1, SIZE, ig_md.d_6_est_5);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_11_3.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_11_est_3);
            update_11_4.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_11_est_4);
            update_11_5.apply(DSTIP, DSTPORT, 1, 1, ig_md.d_11_est_5);
            d_13_above_threshold.apply(ig_md.d_11_est_1, ig_md.d_11_est_2, ig_md.d_11_est_3, ig_md.d_11_est_4, ig_md.d_11_est_5, ig_md.d_13_above_threshold);
        //
        ...
        T2_RUN_AFTER_3_KEY_5(19, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        // MRAC for inst 20
