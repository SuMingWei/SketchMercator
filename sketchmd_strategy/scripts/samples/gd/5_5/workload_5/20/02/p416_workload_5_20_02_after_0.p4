...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T5_T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_19_1;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_1_1.apply(SRCIP, 1, SIZE, ig_md.d_1_est_1);
            update_1_2.apply(SRCIP, 1, SIZE, ig_md.d_1_est_2);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_2(1)
        //
        ...
        T2_RUN_AFTER_4_KEY_2(14, DSTIP, DSTPORT, SIZE)
        T2_RUN_AFTER_5_KEY_2(11, DSTIP, DSTPORT, SIZE)
        T3_RUN_AFTER_5_KEY_2(12, DSTIP, DSTPORT, 1)
        // MRAC for inst 15
            d_15_tcam_lpm.apply(ig_md.d_10_sampling_hash_16, ig_md.d_15_base_16);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            d_17_above_threshold.apply(ig_md.d_16_est_1, ig_md.d_16_est_2, ig_md.d_16_est_3, ig_md.d_16_est_4, ig_md.d_17_above_threshold);
        //
