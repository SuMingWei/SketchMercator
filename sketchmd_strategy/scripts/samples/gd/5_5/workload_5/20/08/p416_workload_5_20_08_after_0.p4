...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_100_8192(32w0x30243f0b) update_3_2;
        T3_KEY_UPDATE_100_8192(32w0x30243f0b) update_3_3;
        T3_KEY_UPDATE_100_8192(32w0x30243f0b) update_3_4;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_3_2.apply(SRCIP, 1, ig_md.d_3_res_hash[2:2], ig_md.d_3_est_2);
        ...
        T3_RUN_AFTER_1_KEY_2(14, DSTIP, DSTPORT, SIZE)
