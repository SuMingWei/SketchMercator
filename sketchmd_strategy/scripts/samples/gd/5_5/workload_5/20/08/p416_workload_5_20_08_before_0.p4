...
control SwitchIngress(
    ...
    T3_INIT_HH_1(14, 110, 8192)
    T3_INIT_HH_4(15, 110, 8192)
    UM_INIT_3(16, 110, 10, 16384)
    T2_INIT_3(17, 220, 8192)
    ...
    apply {
        ...
        T2_RUN_1_KEY_2( 9, SRCIP, DSTIP, SIZE)
        T2_RUN_HH_1_KEY_2(10, SRCIP, SRCPORT, SIZE)
        MRAC_RUN_1_KEY_2(11, SRCIP, SRCPORT)
        UM_RUN_3_KEY_2(12, SRCIP, SRCPORT, SIZE)
        MRB_RUN_1_KEY_2(13, DSTIP, DSTPORT)
        T3_RUN_HH_1_KEY_2(14, DSTIP, DSTPORT, SIZE)
        T3_RUN_HH_4_KEY_2(15, DSTIP, DSTPORT, SIZE)
        UM_RUN_3_KEY_2(16, DSTIP, DSTPORT, 1)
        T2_RUN_3_KEY_4(17, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        ...
        MRB_RUN_1_KEY_5(19, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        UM_RUN_2_KEY_5(20, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
    }
}
