...
control SwitchIngress(
    ...
    // O1 hash init
        ...
        COMPUTE_HASH_010_32_32(32w0x30244f0b) d_4_auto_sampling_hash_call;

    //

    T2_INIT_HH_1( 1, 100, 16384)
    T5_INIT_1( 2, 110, 4096)
    T2_INIT_2( 3, 110, 4096)
    T5_INIT_1( 4, 010, 16384)
    ...
    apply {
        // O1 hash run
            ...
            d_4_auto_sampling_hash_call.apply(DSTPORT, ig_md.d_4_sampling_hash_32);
        ...
        // PCSA for inst 2
            ...
            update_2.apply(SRCIP, SRCPORT, ig_md.d_2_bitmask);
        //
        ...
        // PCSA for inst 4
            ...
            update_4.apply(DSTPORT, ig_md.d_4_bitmask);
        //
