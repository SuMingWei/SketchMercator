...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_KEY_UPDATE_200_16384(32w0x30243f0b) update_3_4;
        T2_KEY_UPDATE_200_16384(32w0x30243f0b) update_3_5;
    //

    T5_INIT_1( 5, 110, 4096)
    UM_INIT_2( 6, 110, 11, 32768)
    T1_INIT_4( 7, 220, 524288)
    T1_INIT_5( 8, 221, 262144)
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_221_16384(32w0x30243f0b) update_10_4;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_3_1.apply(SRCIP, DSTIP, SIZE, 1, ig_md.d_3_est_1);
            update_3_2.apply(SRCIP, DSTIP, SIZE, 1, ig_md.d_3_est_2);
            update_3_3.apply(SRCIP, DSTIP, SIZE, 1, ig_md.d_3_est_3);
            update_3_4.apply(SRCIP, DSTIP, SIZE, ig_md.d_3_est_4);
            update_3_5.apply(SRCIP, DSTIP, SIZE, ig_md.d_3_est_5);
        //
        ...
        T1_RUN_4_KEY_4( 7, SRCIP, DSTIP, SRCPORT, DSTPORT) if (ig_md.d_7_est1_1 == 0 || ig_md.d_7_est1_2 == 0 || ig_md.d_7_est1_3 == 0 || ig_md.d_7_est1_4 == 0) { /* process_new_flow() */ }
        T1_RUN_5_KEY_5( 8, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO) if (ig_md.d_8_est1_1 == 0 || ig_md.d_8_est1_2 == 0 || ig_md.d_8_est1_3 == 0 || ig_md.d_8_est1_4 == 0 || ig_md.d_8_est1_5 == 0) { /* process_new_flow() */ }
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_10_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_10_res_hash[2:2], SIZE, ig_md.d_10_est_2);
            update_10_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_10_res_hash[3:3], SIZE, ig_md.d_10_est_3);
            update_10_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_10_res_hash[4:4], ig_md.d_10_est_4);
