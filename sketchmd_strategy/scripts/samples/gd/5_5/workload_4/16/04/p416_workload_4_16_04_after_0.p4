...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_100_8192(32w0x30243f0b) update_4_4;
    //
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T5_T2_KEY_UPDATE_110_16384(32w0x30243f0b) update_13_1;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_4_1.apply(SRCIP, 1, ig_md.d_4_res_hash[1:1], 1, ig_md.d_4_est_1);
            update_4_2.apply(SRCIP, 1, ig_md.d_4_res_hash[2:2], 1, ig_md.d_4_est_2);
            update_4_3.apply(SRCIP, 1, ig_md.d_4_res_hash[3:3], 1, ig_md.d_4_est_3);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_13_1.apply(DSTIP, DSTPORT, SIZE, ig_md.d_13_bitmask, ig_md.d_13_est_1);
