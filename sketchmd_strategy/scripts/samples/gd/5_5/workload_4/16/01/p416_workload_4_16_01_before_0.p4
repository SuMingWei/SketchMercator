...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_5_KEY_2( 7, SRCIP, SRCPORT, 1)
        MRAC_RUN_1_KEY_2( 8, SRCIP, SRCPORT)
        UM_RUN_1_KEY_2( 9, SRCIP, SRCPORT, SIZE)
        T2_RUN_4_KEY_2(10, DSTIP, DSTPORT, 1)
