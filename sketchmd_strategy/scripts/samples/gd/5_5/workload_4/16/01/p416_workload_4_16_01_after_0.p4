...
control SwitchIngress(
    ...
    // apply O2
        ...
        T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_13_3;
        T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_13_4;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_11_1.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_11_est_1);
            update_11_2.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_11_est_2);
            update_11_3.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_11_est_3);
            update_11_4.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_11_est_4);
