...
control SwitchIngress(
    ...
    T3_INIT_HH_2(12, 220, 16384)
    T2_INIT_HH_1(13, 220, 8192)
    T2_INIT_4(14, 221, 16384)
    ...
    apply {
        ...
        T2_RUN_2_KEY_2( 8, SRCIP, SRCPORT, SIZE)
        UM_RUN_3_KEY_2( 9, DSTIP, DSTPORT, 1)
        UM_RUN_2_KEY_2(10, DSTIP, DSTPORT, SIZE)
        T4_RUN_1_KEY_4(11, SRCIP, DSTIP, SRCPORT, DSTPORT)
        T3_RUN_HH_2_KEY_4(12, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_HH_1_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_4_KEY_5(14, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
