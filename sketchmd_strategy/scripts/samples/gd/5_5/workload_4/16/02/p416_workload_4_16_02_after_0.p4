...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_2_4;
        T2_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_2_5;
    //
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_220_16_11(32w0x30244f0b) d_16_index_hash_call_5;
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_2_2.apply(DSTIP, SIZE, 1, ig_md.d_2_est_2);
            update_2_3.apply(DSTIP, SIZE, 1, ig_md.d_2_est_3);
            update_2_4.apply(DSTIP, SIZE, 1, ig_md.d_2_est_4);
            update_2_5.apply(DSTIP, SIZE, 1, ig_md.d_2_est_5);
        ...
        update_16_5.apply(ig_md.d_16_base_16_2048, ig_md.d_16_index5_16, ig_md.d_16_res_hash[5:5], SIZE, ig_md.d_16_est_5);
