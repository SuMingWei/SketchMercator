...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_100_8192(32w0x30243f0b) update_6_1;
    ...
    // apply O2
        ...
        T1_KEY_UPDATE_110_524288(32w0x30243f0b) update_11_4;
        T1_KEY_UPDATE_110_524288(32w0x30243f0b) update_11_5;
    // 
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_6_1.apply(DSTIP, SIZE, ig_md.d_6_bitmask, ig_md.d_6_est_1);
        ...
        update_10_4.apply(ig_md.d_10_base_16_1024, ig_md.d_10_index4_16, ig_md.d_10_res_hash[4:4], SIZE, ig_md.d_10_est_4);
        d_10_index_hash_call_5.apply(SRCIP, DSTIP, ig_md.d_10_index5_16);
        update_10_5.apply(ig_md.d_10_base_16_1024, ig_md.d_10_index5_16, ig_md.d_10_res_hash[5:5], SIZE, ig_md.d_10_est_5);
        ...
        // HLL for inst 19
            ...
            update_19.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_19_level);
        //
