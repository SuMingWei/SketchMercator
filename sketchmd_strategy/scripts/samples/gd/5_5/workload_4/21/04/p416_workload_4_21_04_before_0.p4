...
control SwitchIngress(
    ...
    apply {
        ...
        T3_RUN_HH_2_KEY_1( 3, SRCIP, SIZE)
        ...
        T3_RUN_HH_5_KEY_2(10, SRCIP, SRCPORT, 1)
        ...
        T2_RUN_5_KEY_4(15, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
