...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T5_KEY_UPDATE_100_8192(32w0x30243f0b) update_5_1;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_5_2.apply(SRCIP, 1, ig_md.d_5_res_hash[2:2], ig_md.d_5_est_2);
            update_5_3.apply(SRCIP, 1, ig_md.d_5_res_hash[3:3], ig_md.d_5_est_3);
