...
control SwitchIngress(
    ...
    // O1 hash init
        ...
        action d_10_xor_construction() { ig_md.d_10_sampling_hash_16 = ig_md.d_4_sampling_hash_16 ^ ig_md.d_3_sampling_hash_16; }
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T5_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_12_1;
    ...
    UM_INIT_3(16, 110, 11, 32768)
    T3_INIT_HH_2(17, 220, 4096)
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_220_16_10(32w0x30244f0b) d_19_index_hash_call_4;
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_12_1.apply(SRCIP, SRCPORT, SIZE, ig_md.d_12_bitmask, ig_md.d_12_est_1);
            update_12_2.apply(SRCIP, SRCPORT, 1, ig_md.d_12_est_2);
            update_12_3.apply(SRCIP, SRCPORT, 1, ig_md.d_12_est_3);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_14_2.apply(DSTIP, DSTPORT, SIZE, ig_md.d_14_est_2);
            update_14_3.apply(DSTIP, DSTPORT, SIZE, ig_md.d_14_est_3);
            update_14_4.apply(DSTIP, DSTPORT, SIZE, ig_md.d_14_est_4);
            update_14_5.apply(DSTIP, DSTPORT, SIZE, ig_md.d_14_est_5);
        //
