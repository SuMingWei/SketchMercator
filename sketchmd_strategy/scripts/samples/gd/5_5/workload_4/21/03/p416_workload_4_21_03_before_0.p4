...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_5_KEY_2(14, DSTIP, DSTPORT, SIZE)
        ...
        UM_RUN_4_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        MRAC_RUN_1_KEY_5(20, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        UM_RUN_4_KEY_5(21, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
    }
}
