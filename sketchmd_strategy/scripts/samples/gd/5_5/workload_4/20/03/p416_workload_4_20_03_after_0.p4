...
control SwitchIngress(
    ...
    // apply O2
        T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_15_1;
    ...
    // apply SALUMerge; big - MRAC (1 row) / small - UnivMon (1 row) 
        ...
        COMPUTE_HASH_220_16_10(32w0x30244f0b) d_17_index_hash_call_1;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_3_1.apply(SRCIP, 1, ig_md.d_3_res_hash[1:1], ig_md.d_3_bitmask, ig_md.d_3_est_1);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_13_4.apply(DSTIP, DSTPORT, 1, ig_md.d_13_est_4);
            update_13_5.apply(DSTIP, DSTPORT, 1, ig_md.d_13_est_5);
        //
