...
control SwitchIngress(
    ...
    UM_INIT_4(18, 220, 11, 32768)
    T1_INIT_5(19, 221, 131072)
    ...
    apply {
        ...
        T3_RUN_AFTER_2_KEY_2( 9, SRCIP, SRCPORT, SIZE)
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_13_1.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_13_est_1);
            update_13_2.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_13_est_2);
            update_13_3.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_13_est_3);
            d_14_above_threshold.apply(ig_md.d_13_est_1, ig_md.d_13_est_2, ig_md.d_13_est_3, ig_md.d_14_above_threshold);
            update_13_4.apply(DSTIP, DSTPORT, SIZE, ig_md.d_13_est_4);
        //
        ...
        // UnivMon for inst 18
            ...
            UM_RUN_END_4(18, ig_md.d_18_res_hash, SIZE) 
        ...
        T2_RUN_AFTER_3_KEY_5(20, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        if(
