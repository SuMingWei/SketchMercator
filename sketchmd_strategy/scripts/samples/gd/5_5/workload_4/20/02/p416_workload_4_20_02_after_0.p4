...
control SwitchIngress(
    ...
    // apply O2
        T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_5_1;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_11_1.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_11_est_1);
            update_11_2.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_11_est_2);
        ...
        T2_RUN_AFTER_1_KEY_4(17, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
