...
control SwitchIngress(
    ...
    UM_INIT_5( 1, 110, 11, 32768)
    T1_INIT_1( 2, 110, 131072)
    UM_INIT_4( 3, 110, 11, 32768)
    T2_INIT_3( 4, 221, 8192)
    ...
    apply {
        ...
        // UnivMon for inst 1
            d_1_res_hash_call.apply(SRCIP, SRCPORT, ig_md.d_1_res_hash); 
            ...
            d_1_index_hash_call_2.apply(SRCIP, SRCPORT, ig_md.d_1_index2_16); 
            d_1_index_hash_call_3.apply(SRCIP, SRCPORT, ig_md.d_1_index3_16); 
            d_1_index_hash_call_4.apply(SRCIP, SRCPORT, ig_md.d_1_index4_16); 
            d_1_index_hash_call_5.apply(SRCIP, SRCPORT, ig_md.d_1_index5_16); 
            UM_RUN_END_5(1, ig_md.d_1_res_hash, SIZE) 
            RUN_HEAVY_FLOWKEY_NOIF_5(1) 
        //

        T1_RUN_1_KEY_2( 2, DSTIP, DSTPORT) if (ig_md.d_2_est1_1 == 0) { /* process_new_flow() */ }
        // UnivMon for inst 3
            d_3_res_hash_call.apply(DSTIP, DSTPORT, ig_md.d_3_res_hash); 
            ...
            d_3_index_hash_call_2.apply(DSTIP, DSTPORT, ig_md.d_3_index2_16); 
            d_3_index_hash_call_3.apply(DSTIP, DSTPORT, ig_md.d_3_index3_16); 
            d_3_index_hash_call_4.apply(DSTIP, DSTPORT, ig_md.d_3_index4_16); 
            UM_RUN_END_4(3, ig_md.d_3_res_hash, 1) 
            RUN_HEAVY_FLOWKEY_NOIF_4(3) 
        //

        T2_RUN_3_KEY_5( 4, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        if(
