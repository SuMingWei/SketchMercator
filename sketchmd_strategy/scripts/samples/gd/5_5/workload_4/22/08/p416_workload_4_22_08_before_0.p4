...
control SwitchIngress(
    ...
    T1_INIT_5(11, 200, 131072)
    T1_INIT_1(12, 200, 524288)
    ...
    apply {
        ...
        T2_RUN_2_KEY_1( 7, DSTIP, 1)
        T2_RUN_1_KEY_1( 8, DSTIP, SIZE)
        T2_RUN_HH_1_KEY_1( 9, DSTIP, 1)
        T2_RUN_HH_3_KEY_1(10, DSTIP, 1)
        ...
        T2_RUN_HH_3_KEY_2(18, DSTIP, DSTPORT, 1)
        T2_RUN_4_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T3_RUN_HH_3_KEY_4(20, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
