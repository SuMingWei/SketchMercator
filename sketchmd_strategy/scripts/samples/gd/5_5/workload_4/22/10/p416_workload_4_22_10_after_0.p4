...
control SwitchIngress(
    ...
    // apply O2
        ...
        T2_KEY_UPDATE_200_8192(32w0x30243f0b) update_6_5;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_17_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, SIZE, ig_md.d_17_est_2);
            update_17_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_17_est_3);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_3(17)
        //

        T3_RUN_AFTER_2_KEY_5(21, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        // UnivMon for inst 22
