...
control SwitchIngress(
    ...
    apply {
        ...
        T3_RUN_AFTER_4_KEY_1( 1, SRCIP, SIZE)
        // UnivMon for inst 3
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_14_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, 1, ig_md.d_14_est_1);
            update_14_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_14_est_2);
