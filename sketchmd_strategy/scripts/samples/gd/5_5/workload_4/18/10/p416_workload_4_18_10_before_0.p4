...
control SwitchIngress(
    ...
    T5_INIT_1(16, 221, 16384)
    T3_INIT_HH_5(17, 221, 16384)
    ...
    apply {
        ...
        MRB_RUN_1_KEY_2( 4, SRCIP, DSTIP)
        T2_RUN_HH_1_KEY_2( 5, SRCIP, DSTIP, SIZE)
        T2_RUN_1_KEY_2( 6, SRCIP, SRCPORT, 1)
        T3_RUN_HH_3_KEY_2( 7, SRCIP, SRCPORT, 1)
        T3_RUN_HH_5_KEY_2( 8, SRCIP, SRCPORT, SIZE)
        ...
        T2_RUN_HH_2_KEY_2(12, DSTIP, DSTPORT, SIZE)
        UM_RUN_3_KEY_2(13, DSTIP, DSTPORT, 1)
        ...
        T3_RUN_HH_5_KEY_5(17, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
