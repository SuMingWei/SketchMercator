...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_110_16384(32w0x30243f0b) update_8_2;
        T3_KEY_UPDATE_110_16384(32w0x30243f0b) update_8_3;
        T3_KEY_UPDATE_110_16384(32w0x30243f0b) update_8_4;
        T3_KEY_UPDATE_110_16384(32w0x30243f0b) update_8_5;
    //

    T3_INIT_HH_3( 7, 110, 4096)
    MRAC_INIT_1( 9, 110, 16384, 10, 16)
    T1_INIT_4(10, 110, 524288)
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        COMPUTE_HASH_221_32_32(32w0x30244f0b) d_17_hash_call;
        TCAM_LPM_HLLPCSA() d_17_tcam_lpm;
        GET_BITMASK() d_17_get_bitmask;
        COMPUTE_HASH_221_16_16(32w0x30244f0b) d_17_res_hash_call;
        T3_T5_KEY_UPDATE_221_16384(32w0x30243f0b) update_17_1;
        T3_KEY_UPDATE_221_16384(32w0x30243f0b) update_17_2;
        T3_KEY_UPDATE_221_16384(32w0x30243f0b) update_17_3;
        T3_KEY_UPDATE_221_16384(32w0x30243f0b) update_17_4;
        T3_KEY_UPDATE_221_16384(32w0x30243f0b) update_17_5;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_2_1.apply(DSTIP, 1, SIZE, ig_md.d_2_est_1);
            update_2_2.apply(DSTIP, 1, SIZE, ig_md.d_2_est_2);
            update_2_3.apply(DSTIP, 1, SIZE, ig_md.d_2_est_3);
            d_3_above_threshold.apply(ig_md.d_2_est_1, ig_md.d_2_est_2, ig_md.d_2_est_3, ig_md.d_3_above_threshold);
            update_2_4.apply(DSTIP, 1, ig_md.d_2_est_4);
        //
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_8_2.apply(SRCIP, SRCPORT, SIZE, ig_md.d_8_res_hash[2:2], ig_md.d_8_est_2);
            update_8_3.apply(SRCIP, SRCPORT, SIZE, ig_md.d_8_res_hash[3:3], ig_md.d_8_est_3);
            update_8_4.apply(SRCIP, SRCPORT, SIZE, ig_md.d_8_res_hash[4:4], ig_md.d_8_est_4);
            update_8_5.apply(SRCIP, SRCPORT, SIZE, ig_md.d_8_res_hash[5:5], ig_md.d_8_est_5);
        ...
        T1_RUN_4_KEY_2(10, DSTIP, DSTPORT) if (ig_md.d_10_est1_1 == 0 || ig_md.d_10_est1_2 == 0 || ig_md.d_10_est1_3 == 0 || ig_md.d_10_est1_4 == 0) { /* process_new_flow() */ }
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_17_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_17_res_hash[1:1], ig_md.d_17_bitmask, ig_md.d_17_est_1);
            update_17_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_17_res_hash[2:2], ig_md.d_17_est_2);
            update_17_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_17_res_hash[3:3], ig_md.d_17_est_3);
            update_17_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_17_res_hash[4:4], ig_md.d_17_est_4);
            update_17_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_17_res_hash[5:5], ig_md.d_17_est_5);
