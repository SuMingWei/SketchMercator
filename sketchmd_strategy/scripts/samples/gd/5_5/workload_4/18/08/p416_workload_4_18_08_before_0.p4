...
control SwitchIngress(
    ...
    apply {
        ...
        UM_RUN_5_KEY_2( 8, SRCIP, DSTIP, SIZE)
        T2_RUN_1_KEY_2( 9, SRCIP, SRCPORT, 1)
        T3_RUN_HH_4_KEY_2(10, DSTIP, DSTPORT, SIZE)
        ...
        T3_RUN_HH_2_KEY_5(17, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
