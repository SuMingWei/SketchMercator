...
control SwitchIngress(
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_220_16_11(32w0x30244f0b) d_17_index_hash_call_3;
        T3_INDEX_UPDATE_32768() update_17_3;
        COMPUTE_HASH_220_16_11(32w0x30244f0b) d_17_index_hash_call_4;
        T3_INDEX_UPDATE_32768() update_17_4;
        COMPUTE_HASH_220_16_11(32w0x30244f0b) d_17_index_hash_call_5;
        T3_INDEX_UPDATE_32768() update_17_5;
    // 

    T1_INIT_1(18, 221, 131072)
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_12_1.apply(DSTIP, DSTPORT, 1, SIZE, ig_md.d_12_est_1);
            update_12_2.apply(DSTIP, DSTPORT, 1, SIZE, ig_md.d_12_est_2);
        ...
        // MRAC for inst 13
            d_13_tcam_lpm.apply(ig_md.d_10_sampling_hash_16, ig_md.d_13_base_16);
