...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_100_8192(32w0x30243f0b) update_2_3;
        T3_KEY_UPDATE_100_8192(32w0x30243f0b) update_2_4;
        T3_KEY_UPDATE_100_8192(32w0x30243f0b) update_2_5;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_2_1.apply(SRCIP, 1, ig_md.d_2_res_hash[1:1], SIZE, ig_md.d_2_est_1);
            update_2_2.apply(SRCIP, 1, ig_md.d_2_res_hash[2:2], ig_md.d_2_est_2);
            update_2_3.apply(SRCIP, 1, ig_md.d_2_res_hash[3:3], ig_md.d_2_est_3);
            update_2_4.apply(SRCIP, 1, ig_md.d_2_res_hash[4:4], ig_md.d_2_est_4);
            update_2_5.apply(SRCIP, 1, ig_md.d_2_res_hash[5:5], ig_md.d_2_est_5);
