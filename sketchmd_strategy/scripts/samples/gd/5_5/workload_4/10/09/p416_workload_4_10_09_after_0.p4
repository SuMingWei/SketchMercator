...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_220_8192(32w0x30243f0b) update_10_1;
    ...
    apply {
        ...
        T3_RUN_AFTER_3_KEY_1( 2, SRCIP, SIZE)
        // HLL for inst 3
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_10_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_10_bitmask, ig_md.d_10_est_1);
            update_10_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_10_est_2);
