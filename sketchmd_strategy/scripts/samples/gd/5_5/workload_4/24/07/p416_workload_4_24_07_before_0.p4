...
control SwitchIngress(
    ...
    T2_INIT_2(18, 220, 16384)
    T3_INIT_HH_4(19, 220, 16384)
    T5_INIT_1(20, 221, 4096)
    T2_INIT_2(21, 221, 8192)
    T2_INIT_3(22, 221, 4096)
    T3_INIT_HH_2(23, 221, 8192)
    ...
    apply {
        ...
        UM_RUN_2_KEY_2( 9, SRCIP, DSTIP, SIZE)
        T2_RUN_HH_4_KEY_2(10, SRCIP, SRCPORT, 1)
        MRAC_RUN_1_KEY_2(11, SRCIP, SRCPORT)
        UM_RUN_5_KEY_2(12, SRCIP, SRCPORT, 1)
        T2_RUN_HH_5_KEY_2(13, DSTIP, DSTPORT, 1)
        T2_RUN_HH_3_KEY_2(14, DSTIP, DSTPORT, SIZE)
        MRAC_RUN_1_KEY_2(15, DSTIP, DSTPORT)
        UM_RUN_5_KEY_2(16, DSTIP, DSTPORT, 1)
        T4_RUN_1_KEY_4(17, SRCIP, DSTIP, SRCPORT, DSTPORT)
        T2_RUN_2_KEY_4(18, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T3_RUN_HH_4_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T5_RUN_1_KEY_5(20, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        T2_RUN_2_KEY_5(21, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T2_RUN_3_KEY_5(22, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
