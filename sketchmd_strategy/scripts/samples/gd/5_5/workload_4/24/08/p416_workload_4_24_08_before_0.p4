...
control SwitchIngress(
    ...
    T2_INIT_4(17, 110, 16384)
    T3_INIT_HH_4(18, 110, 4096)
    ...
    apply {
        ...
        T3_RUN_HH_5_KEY_1( 7, DSTIP, 1)
        MRAC_RUN_1_KEY_2( 8, SRCIP, DSTIP)
        UM_RUN_2_KEY_2( 9, SRCIP, DSTIP, 1)
        UM_RUN_4_KEY_2(10, SRCIP, DSTIP, SIZE)
        ...
        T2_RUN_4_KEY_2(17, DSTIP, DSTPORT, SIZE)
        T3_RUN_HH_4_KEY_2(18, DSTIP, DSTPORT, 1)
        ...
        UM_RUN_4_KEY_5(23, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
