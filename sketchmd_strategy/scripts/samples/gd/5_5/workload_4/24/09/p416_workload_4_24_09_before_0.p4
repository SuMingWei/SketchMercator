...
control SwitchIngress(
    ...
    apply {
        ...
        UM_RUN_2_KEY_2(10, SRCIP, DSTIP, 1)
        UM_RUN_1_KEY_2(11, SRCIP, DSTIP, SIZE)
        ...
        T2_RUN_5_KEY_2(17, DSTIP, DSTPORT, SIZE)
        T2_RUN_HH_2_KEY_2(18, DSTIP, DSTPORT, 1)
        T2_RUN_HH_3_KEY_2(19, DSTIP, DSTPORT, SIZE)
        MRB_RUN_1_KEY_4(20, SRCIP, DSTIP, SRCPORT, DSTPORT)
        T2_RUN_4_KEY_4(21, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_HH_3_KEY_4(22, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_HH_3_KEY_4(23, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T5_RUN_1_KEY_5(24, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
    }
}
