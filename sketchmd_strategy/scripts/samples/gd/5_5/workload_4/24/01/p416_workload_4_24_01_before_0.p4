...
control SwitchIngress(
    ...
    T2_INIT_3(21, 220, 16384)
    T3_INIT_HH_2(22, 220, 4096)
    ...
    apply {
        ...
        T3_RUN_HH_3_KEY_2(14, SRCIP, SRCPORT, SIZE)
        ...
        UM_RUN_2_KEY_2(18, DSTIP, DSTPORT, 1)
        UM_RUN_5_KEY_2(19, DSTIP, DSTPORT, SIZE)
        T1_RUN_1_KEY_4(20, SRCIP, DSTIP, SRCPORT, DSTPORT) if (ig_md.d_20_est1_1 == 0) { /* process_new_flow() */ }
        T2_RUN_3_KEY_4(21, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T3_RUN_HH_2_KEY_4(22, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
