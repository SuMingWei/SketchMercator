...
control SwitchIngress(
    ...
    apply {
        ...
        UM_RUN_4_KEY_2(12, SRCIP, SRCPORT, SIZE)
        T2_RUN_3_KEY_2(13, DSTIP, DSTPORT, 1)
        T2_RUN_HH_4_KEY_2(14, DSTIP, DSTPORT, SIZE)
        MRAC_RUN_1_KEY_2(15, DSTIP, DSTPORT)
        UM_RUN_2_KEY_2(16, DSTIP, DSTPORT, SIZE)
        T1_RUN_1_KEY_4(17, SRCIP, DSTIP, SRCPORT, DSTPORT)
        T2_RUN_5_KEY_4(18, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T3_RUN_HH_4_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
