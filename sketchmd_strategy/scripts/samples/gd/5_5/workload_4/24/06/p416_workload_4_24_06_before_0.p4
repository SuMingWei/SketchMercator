...
control SwitchIngress(
    ...
    T1_INIT_2( 7, 200, 262144)
    T1_INIT_1( 8, 200, 262144)
    T2_INIT_5( 9, 200, 16384)
    T3_INIT_HH_4(10, 200, 8192)
    ...
    apply {
        ...
        T3_RUN_HH_4_KEY_2(10, SRCIP, DSTIP, SIZE)
        T2_RUN_5_KEY_2(11, SRCIP, SRCPORT, 1)
        T2_RUN_3_KEY_2(12, SRCIP, SRCPORT, SIZE)
        T2_RUN_HH_1_KEY_2(13, SRCIP, SRCPORT, 1)
        T3_RUN_HH_4_KEY_2(14, SRCIP, SRCPORT, SIZE)
        T2_RUN_HH_3_KEY_2(15, SRCIP, SRCPORT, SIZE)
        MRB_RUN_1_KEY_2(16, DSTIP, DSTPORT)
        T2_RUN_2_KEY_2(17, DSTIP, DSTPORT, 1)
        T2_RUN_2_KEY_2(18, DSTIP, DSTPORT, SIZE)
        T3_RUN_HH_1_KEY_2(19, DSTIP, DSTPORT, SIZE)
        T2_RUN_HH_2_KEY_4(20, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        MRAC_RUN_1_KEY_4(21, SRCIP, DSTIP, SRCPORT, DSTPORT)
        UM_RUN_5_KEY_4(22, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T3_RUN_HH_5_KEY_5(23, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        UM_RUN_1_KEY_5(24, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
    }
}
