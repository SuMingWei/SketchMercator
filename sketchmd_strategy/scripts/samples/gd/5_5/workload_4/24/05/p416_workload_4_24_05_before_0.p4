...
control SwitchIngress(
    ...
    T2_INIT_2(22, 221, 8192)
    T2_INIT_3(23, 221, 8192)
    ...
    apply {
        ...
        UM_RUN_4_KEY_1( 4, DSTIP, 1)
        UM_RUN_1_KEY_1( 5, DSTIP, SIZE)
        MRB_RUN_1_KEY_2( 6, SRCIP, DSTIP)
        T2_RUN_4_KEY_2( 7, SRCIP, DSTIP, 1)
        T2_RUN_3_KEY_2( 8, SRCIP, DSTIP, SIZE)
        T3_RUN_HH_3_KEY_2( 9, SRCIP, DSTIP, 1)
        T4_RUN_1_KEY_2(10, SRCIP, SRCPORT)
        T3_RUN_HH_5_KEY_2(11, SRCIP, SRCPORT, 1)
        T2_RUN_HH_3_KEY_2(12, SRCIP, SRCPORT, SIZE)
        MRAC_RUN_1_KEY_2(13, SRCIP, SRCPORT)
        T2_RUN_HH_2_KEY_2(14, DSTIP, DSTPORT, 1)
        MRAC_RUN_1_KEY_2(15, DSTIP, DSTPORT)
        UM_RUN_1_KEY_2(16, DSTIP, DSTPORT, 1)
        UM_RUN_5_KEY_2(17, DSTIP, DSTPORT, SIZE)
        ...
        UM_RUN_2_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        ...
        MRB_RUN_1_KEY_5(21, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        T2_RUN_2_KEY_5(22, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T2_RUN_3_KEY_5(23, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
