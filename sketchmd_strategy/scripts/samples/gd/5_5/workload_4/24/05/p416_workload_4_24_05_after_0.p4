...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T2_KEY_UPDATE_100_16384(32w0x30243f0b) update_1_4;
    ...
    T1_INIT_3(20, 221, 131072)
    MRB_INIT_1(21, 221, 131072, 14,  8)
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_23_3;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_1_1.apply(SRCIP, SIZE, ig_md.d_1_res_hash[1:1], SIZE, ig_md.d_1_est_1);
            update_1_2.apply(SRCIP, SIZE, ig_md.d_1_res_hash[2:2], SIZE, ig_md.d_1_est_2);
            update_1_3.apply(SRCIP, SIZE, ig_md.d_1_res_hash[3:3], SIZE, ig_md.d_1_est_3);
            update_1_4.apply(SRCIP, SIZE, ig_md.d_1_res_hash[4:4], SIZE, ig_md.d_1_est_4);
        ...
        T2_RUN_3_KEY_2( 8, SRCIP, DSTIP, SIZE)
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            d_9_above_threshold.apply(ig_md.d_7_est_1, ig_md.d_7_est_2, ig_md.d_7_est_3, ig_md.d_9_above_threshold);
        ...
        T2_RUN_AFTER_2_KEY_2(14, DSTIP, DSTPORT, 1)
        ...
        T1_RUN_3_KEY_5(20, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO) if (ig_md.d_20_est1_1 == 0 || ig_md.d_20_est1_2 == 0 || ig_md.d_20_est1_3 == 0) { /* process_new_flow() */ }
        // MRB for inst 21
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_23_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, 1, ig_md.d_23_est_1);
            update_23_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, 1, ig_md.d_23_est_2);
            update_23_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_23_est_3);
