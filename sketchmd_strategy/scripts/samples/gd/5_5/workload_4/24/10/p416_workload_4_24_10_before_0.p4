...
control SwitchIngress(
    ...
    MRB_INIT_1(11, 110, 524288, 15, 16)
    T2_INIT_HH_3(12, 110, 16384)
    T1_INIT_5(13, 110, 131072)
    T4_INIT_1(14, 110, 65536)
    T2_INIT_2(15, 110, 8192)
    T2_INIT_HH_3(16, 110, 8192)
    T1_INIT_1(17, 220, 524288)
    MRB_INIT_1(18, 220, 524288, 15, 16)
    T2_INIT_HH_4(19, 220, 16384)
    T3_INIT_HH_1(20, 220, 4096)
    T2_INIT_3(21, 221, 8192)
    T2_INIT_HH_1(22, 221, 4096)
    T2_INIT_HH_2(23, 221, 16384)
    ...
    apply {
        ...
        UM_RUN_5_KEY_2(10, SRCIP, DSTIP, 1)
        MRB_RUN_1_KEY_2(11, SRCIP, SRCPORT)
        ...
        T4_RUN_1_KEY_2(14, DSTIP, DSTPORT)
        ...
        T2_RUN_3_KEY_5(21, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
