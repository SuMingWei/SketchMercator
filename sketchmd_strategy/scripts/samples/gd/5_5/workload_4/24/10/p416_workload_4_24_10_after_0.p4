...
control SwitchIngress(
    ...
    // apply O2
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_21_1;
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_21_2;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            update_16_1.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_16_est_1);
            update_16_2.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_16_est_2);
