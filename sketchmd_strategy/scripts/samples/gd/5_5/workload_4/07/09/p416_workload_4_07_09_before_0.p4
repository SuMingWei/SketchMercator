...
control SwitchIngress(
    ...
    T1_INIT_3( 3, 110, 131072)
    T1_INIT_5( 4, 110, 524288)
    T2_INIT_2( 5, 110, 8192)
    T1_INIT_3( 6, 220, 131072)
    T1_INIT_3( 7, 221, 262144)
    apply {
        ...
        T1_RUN_3_KEY_4( 6, SRCIP, DSTIP, SRCPORT, DSTPORT) if (ig_md.d_6_est1_1 == 0 || ig_md.d_6_est1_2 == 0 || ig_md.d_6_est1_3 == 0) { /* process_new_flow() */ }
        T1_RUN_3_KEY_5( 7, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO) if (ig_md.d_7_est1_1 == 0 || ig_md.d_7_est1_2 == 0 || ig_md.d_7_est1_3 == 0) { /* process_new_flow() */ }
    }
}
