...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T2_KEY_UPDATE_100_8192(32w0x30243f0b) update_1_3;
        T2_KEY_UPDATE_100_8192(32w0x30243f0b) update_1_4;
    //

    T2_INIT_4( 3, 200, 8192)
    UM_INIT_4( 4, 200, 10, 16384)
    T3_INIT_HH_4( 5, 110, 8192)
    MRB_INIT_1( 6, 110, 524288, 15, 16)
    T2_INIT_5( 7, 220, 8192)
    UM_INIT_4( 8, 220, 10, 16384)
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_1_1.apply(DSTIP, SIZE, ig_md.d_1_res_hash[1:1], SIZE, ig_md.d_1_est_1);
            update_1_2.apply(DSTIP, SIZE, ig_md.d_1_res_hash[2:2], SIZE, ig_md.d_1_est_2);
            update_1_3.apply(DSTIP, SIZE, ig_md.d_1_res_hash[3:3], SIZE, ig_md.d_1_est_3);
        ...
        T2_RUN_4_KEY_2( 3, SRCIP, DSTIP, SIZE)
        // UnivMon for inst 4
        ...
        T3_RUN_AFTER_4_KEY_2( 5, SRCIP, SRCPORT, SIZE)
        // MRB for inst 6
