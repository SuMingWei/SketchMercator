...
control SwitchIngress(
    ...
    apply {
        ...
        // UnivMon for inst 1
            d_1_res_hash_call.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_1_res_hash); 
            ...
            d_1_index_hash_call_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_1_index2_16); 
