...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_20_1;
        T3_KEY_UPDATE_220_4096(32w0x30243f0b) update_20_2;
    //

    T3_INIT_HH_3(19, 220, 16384)
    ...
    apply {
        ...
        update_6_4.apply(ig_md.d_6_base_16_2048, ig_md.d_6_index4_16, ig_md.d_6_res_hash[4:4], SIZE, ig_md.d_6_est_4);
        d_6_index_hash_call_5.apply(DSTIP, ig_md.d_6_index5_16);
        update_6_5.apply(ig_md.d_6_base_16_2048, ig_md.d_6_index5_16, ig_md.d_6_res_hash[5:5], SIZE, ig_md.d_6_est_5);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_14_2.apply(DSTIP, DSTPORT, SIZE, ig_md.d_14_res_hash[2:2], SIZE, ig_md.d_14_est_2);
            update_14_3.apply(DSTIP, DSTPORT, SIZE, ig_md.d_14_res_hash[3:3], SIZE, ig_md.d_14_est_3);
            d_15_above_threshold.apply(ig_md.d_14_est_2, ig_md.d_14_est_3, ig_md.d_15_above_threshold);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_20_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_20_res_hash[2:2], ig_md.d_20_est_2);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_2(20)
        //

        T3_RUN_AFTER_3_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
