...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_4_KEY_2(14, DSTIP, DSTPORT, SIZE)
        ...
        T2_RUN_1_KEY_4(18, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T3_RUN_HH_3_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T3_RUN_HH_2_KEY_4(20, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
