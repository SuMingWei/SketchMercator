...
control SwitchIngress(
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_220_16_10(32w0x30244f0b) d_18_index_hash_call_3;
        T3_INDEX_UPDATE_16384() update_18_3;
        COMPUTE_HASH_220_16_10(32w0x30244f0b) d_18_index_hash_call_4;
        T3_INDEX_UPDATE_16384() update_18_4;
        COMPUTE_HASH_220_16_10(32w0x30244f0b) d_18_index_hash_call_5;
        T3_INDEX_UPDATE_16384() update_18_5;
    // 

    UM_INIT_2(19, 220, 11, 32768)
    ...
    // apply O2
        ...
        ABOVE_THRESHOLD_CONSTANT_4(100) d_22_above_threshold;
    // 
    ...
    apply {
        ...
        T2_RUN_3_KEY_2(12, SRCIP, SRCPORT, SIZE)
        T2_RUN_AFTER_4_KEY_2(13, DSTIP, DSTPORT, SIZE)
