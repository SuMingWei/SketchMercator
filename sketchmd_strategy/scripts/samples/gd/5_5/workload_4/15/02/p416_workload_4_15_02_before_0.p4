...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_HH_2_KEY_2( 6, SRCIP, SRCPORT, 1)
        MRAC_RUN_1_KEY_2( 7, SRCIP, SRCPORT)
        UM_RUN_5_KEY_2( 8, SRCIP, SRCPORT, 1)
        MRAC_RUN_1_KEY_2( 9, DSTIP, DSTPORT)
        T2_RUN_5_KEY_4(10, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T3_RUN_HH_1_KEY_4(11, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        MRAC_RUN_1_KEY_4(12, SRCIP, DSTIP, SRCPORT, DSTPORT)
        UM_RUN_3_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
