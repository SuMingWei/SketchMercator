...
control SwitchIngress(
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_110_16_10(32w0x30244f0b) d_8_index_hash_call_5;
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T2_KEY_UPDATE_220_16384(32w0x30243f0b) update_10_1;
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_220_16_11(32w0x30244f0b) d_13_index_hash_call_3;
    ...
    apply {
        ...
        update_8_5.apply(ig_md.d_8_base_16_1024, ig_md.d_8_index5_16, ig_md.d_8_res_hash[5:5], 1, ig_md.d_8_est_5);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_10_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_10_res_hash[1:1], SIZE, ig_md.d_10_est_1);
