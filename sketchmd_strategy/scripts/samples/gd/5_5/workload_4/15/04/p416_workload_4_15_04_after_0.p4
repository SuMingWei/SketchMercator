...
control SwitchIngress(
    ...
    // apply O2
        ...
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_13_2;
    ...
    apply {
        ...
        // UnivMon for inst 3
            ...
            UM_RUN_END_2(3, ig_md.d_3_res_hash, SIZE) 
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_5_3.apply(SRCIP, DSTIP, SIZE, ig_md.d_5_est_3);
            update_5_4.apply(SRCIP, DSTIP, SIZE, ig_md.d_5_est_4);
        //
