...
control SwitchIngress(
    ...
    // apply O2
        T1_KEY_UPDATE_220_524288(32w0x30243f0b) update_9_1;
    // 

    T1_INIT_2(11, 221, 131072)
    ...
    apply {
        ...
        T2_RUN_AFTER_2_KEY_1( 3, DSTIP, SIZE)
        ...
        T1_RUN_5_KEY_2( 7, DSTIP, DSTPORT) if (ig_md.d_7_est1_1 == 0 || ig_md.d_7_est1_2 == 0 || ig_md.d_7_est1_3 == 0 || ig_md.d_7_est1_4 == 0 || ig_md.d_7_est1_5 == 0) { /* process_new_flow() */ }
        T2_RUN_AFTER_1_KEY_2( 8, DSTIP, DSTPORT, SIZE)
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_12_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, 1, ig_md.d_12_est_1);
            update_12_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, 1, ig_md.d_12_est_2);
            d_13_above_threshold.apply(ig_md.d_12_est_1, ig_md.d_12_est_2, ig_md.d_13_above_threshold);
            update_12_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_12_est_3);
            update_12_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_12_est_4);
        //
