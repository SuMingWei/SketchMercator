...
control SwitchIngress(
    ...
    apply {
        ...
        UM_RUN_2_KEY_2( 5, SRCIP, DSTIP, SIZE)
        ...
        UM_RUN_3_KEY_5(15, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
    }
}
