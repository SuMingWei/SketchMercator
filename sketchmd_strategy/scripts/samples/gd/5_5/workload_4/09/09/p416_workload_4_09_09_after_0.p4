...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        COMPUTE_HASH_220_32_32(32w0x30244f0b) d_8_hash_call;
        TCAM_LPM_HLLPCSA() d_8_tcam_lpm;
        GET_BITMASK() d_8_get_bitmask;
        COMPUTE_HASH_220_16_16(32w0x30244f0b) d_8_res_hash_call;
        T3_T5_KEY_UPDATE_220_8192(32w0x30243f0b) update_8_1;
        T3_KEY_UPDATE_220_8192(32w0x30243f0b) update_8_2;
        T3_KEY_UPDATE_220_8192(32w0x30243f0b) update_8_3;
        T3_KEY_UPDATE_220_8192(32w0x30243f0b) update_8_4;
        T3_KEY_UPDATE_220_8192(32w0x30243f0b) update_8_5;
    //

    T2_INIT_5( 9, 221, 4096)
    ...
    apply {
        ...
        T2_RUN_AFTER_1_KEY_2( 6, DSTIP, DSTPORT, 1)
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_8_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_8_res_hash[1:1], ig_md.d_8_bitmask, ig_md.d_8_est_1);
            update_8_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_8_res_hash[2:2], ig_md.d_8_est_2);
            update_8_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_8_res_hash[3:3], ig_md.d_8_est_3);
            update_8_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_8_res_hash[4:4], ig_md.d_8_est_4);
            update_8_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_8_res_hash[5:5], ig_md.d_8_est_5);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_5(8)
        //

        T2_RUN_5_KEY_5( 9, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        if(
