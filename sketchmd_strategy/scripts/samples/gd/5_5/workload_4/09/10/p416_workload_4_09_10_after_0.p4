...
control SwitchIngress(
    ...
    T2_INIT_HH_4( 4, 110, 8192)
    T1_INIT_1( 5, 110, 262144)
    T1_INIT_2( 6, 220, 262144)
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_221_8192(32w0x30243f0b) update_8_1;
    ...
    apply {
        ...
        T1_RUN_2_KEY_4( 6, SRCIP, DSTIP, SRCPORT, DSTPORT) if (ig_md.d_6_est1_1 == 0 || ig_md.d_6_est1_2 == 0) { /* process_new_flow() */ }
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
