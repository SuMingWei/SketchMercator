...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_100_4096(32w0x30243f0b) update_5_1;
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_100_16384(32w0x30243f0b) update_4_5;
    //

    T2_INIT_3( 6, 200, 4096)
    T2_INIT_5( 7, 110, 4096)
    UM_INIT_1( 8, 110, 11, 32768)
    T3_INIT_HH_2( 9, 110, 8192)
    T2_INIT_HH_2(10, 110, 16384)
    T1_INIT_3(11, 220, 262144)
    T2_INIT_2(12, 220, 4096)
    UM_INIT_3(13, 221, 10, 16384)
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_5_1.apply(SRCIP, 1, ig_md.d_5_bitmask, ig_md.d_5_est_1);
            update_5_2.apply(SRCIP, 1, ig_md.d_5_est_2);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_4_5.apply(SRCIP, SIZE, ig_md.d_4_res_hash[5:5], ig_md.d_4_est_5);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_5(4)
        //

        T2_RUN_3_KEY_2( 6, SRCIP, DSTIP, SIZE)
        ...
        T3_RUN_AFTER_2_KEY_2( 9, DSTIP, DSTPORT, SIZE)
