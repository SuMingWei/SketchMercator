...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_15_1;
        T3_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_15_2;
        T3_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_15_3;
        T3_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_15_4;
        T3_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_15_5;
    //

    UM_INIT_4(19, 221, 11, 32768)
    ...
    apply {
        ...
        T3_RUN_AFTER_5_KEY_1( 2, SRCIP, SIZE)
        ...
        T3_RUN_AFTER_2_KEY_2( 6, SRCIP, DSTIP, SIZE)
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_17_tcam_lpm.apply(ig_md.d_14_sampling_hash_32, ig_md.d_17_level);
            d_17_get_bitmask.apply(ig_md.d_17_level, ig_md.d_17_bitmask);
            update_17_1.apply(DSTIP, DSTPORT, SIZE, ig_md.d_17_bitmask, ig_md.d_17_est_1);
            update_17_2.apply(DSTIP, DSTPORT, SIZE, ig_md.d_17_est_2);
            update_17_3.apply(DSTIP, DSTPORT, SIZE, ig_md.d_17_est_3);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_3(17)
        //

        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            d_15_res_hash_call.apply(DSTIP, DSTPORT, ig_md.d_15_res_hash);
            update_15_1.apply(DSTIP, DSTPORT, SIZE, ig_md.d_15_res_hash[1:1], 1, ig_md.d_15_est_1);
            update_15_2.apply(DSTIP, DSTPORT, SIZE, ig_md.d_15_res_hash[2:2], 1, ig_md.d_15_est_2);
            update_15_3.apply(DSTIP, DSTPORT, SIZE, ig_md.d_15_res_hash[3:3], 1, ig_md.d_15_est_3);
            update_15_4.apply(DSTIP, DSTPORT, SIZE, ig_md.d_15_res_hash[4:4], 1, ig_md.d_15_est_4);
            update_15_5.apply(DSTIP, DSTPORT, SIZE, ig_md.d_15_res_hash[5:5], 1, ig_md.d_15_est_5);
            d_16_above_threshold.apply(ig_md.d_15_est_1, ig_md.d_15_est_2, ig_md.d_15_est_3, ig_md.d_15_est_4, ig_md.d_15_est_5, ig_md.d_16_above_threshold);
        //
