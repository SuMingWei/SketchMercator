...
control SwitchIngress(
    ...
    T3_INIT_HH_4(17, 220, 16384)
    T3_INIT_HH_2(18, 220, 16384)
    ...
    apply {
        ...
        T3_RUN_HH_3_KEY_1( 4, DSTIP, SIZE)
        ...
        UM_RUN_2_KEY_2(10, SRCIP, SRCPORT, SIZE)
        ...
        T3_RUN_HH_4_KEY_4(17, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T3_RUN_HH_2_KEY_4(18, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
