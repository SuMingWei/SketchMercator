...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_110_8192(32w0x30243f0b) update_5_4;
        T3_KEY_UPDATE_110_8192(32w0x30243f0b) update_5_5;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_5_1.apply(SRCIP, SRCPORT, 1, ig_md.d_5_res_hash[1:1], SIZE, ig_md.d_5_est_1);
            update_5_2.apply(SRCIP, SRCPORT, 1, ig_md.d_5_res_hash[2:2], SIZE, ig_md.d_5_est_2);
            update_5_3.apply(SRCIP, SRCPORT, 1, ig_md.d_5_res_hash[3:3], SIZE, ig_md.d_5_est_3);
            update_5_4.apply(SRCIP, SRCPORT, 1, ig_md.d_5_res_hash[4:4], ig_md.d_5_est_4);
            update_5_5.apply(SRCIP, SRCPORT, 1, ig_md.d_5_res_hash[5:5], ig_md.d_5_est_5);
