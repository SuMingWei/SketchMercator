...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_221_8192(32w0x30243f0b) update_17_1;
        T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_17_2;
        T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_17_3;
    //
    ...
    apply {
        ...
        // PCSA for inst 15
            ...
            update_15.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_15_bitmask);
        //
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_17_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_17_bitmask, ig_md.d_17_est_1);
