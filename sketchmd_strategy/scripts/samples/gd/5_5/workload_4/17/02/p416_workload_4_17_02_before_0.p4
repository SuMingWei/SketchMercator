...
control SwitchIngress(
    ...
    T5_INIT_1(15, 221, 8192)
    T2_INIT_4(16, 221, 16384)
    T3_INIT_HH_1(17, 221, 4096)
    apply {
        ...
        T5_RUN_1_KEY_5(15, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        T2_RUN_4_KEY_5(16, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
