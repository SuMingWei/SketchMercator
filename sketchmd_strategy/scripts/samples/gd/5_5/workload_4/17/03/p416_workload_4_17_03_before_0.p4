...
control SwitchIngress(
    ...
    apply {
        ...
        T5_RUN_1_KEY_2(10, DSTIP, DSTPORT)
        ...
        UM_RUN_2_KEY_4(14, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        ...
        T3_RUN_HH_5_KEY_5(16, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        UM_RUN_4_KEY_5(17, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
    }
}
