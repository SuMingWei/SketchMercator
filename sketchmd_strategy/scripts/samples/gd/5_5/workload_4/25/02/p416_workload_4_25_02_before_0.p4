...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_5_KEY_2(11, SRCIP, DSTIP, 1)
        T2_RUN_2_KEY_2(12, SRCIP, DSTIP, SIZE)
        T4_RUN_1_KEY_2(13, SRCIP, SRCPORT)
        T2_RUN_4_KEY_2(14, SRCIP, SRCPORT, 1)
        ...
        T2_RUN_5_KEY_4(21, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        ...
        T2_RUN_HH_2_KEY_5(24, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        UM_RUN_4_KEY_5(25, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
    }
}
