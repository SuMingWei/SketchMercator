...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_100_8192(32w0x30243f0b) update_2_1;
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_KEY_UPDATE_200_16384(32w0x30243f0b) update_11_4;
        T2_KEY_UPDATE_200_16384(32w0x30243f0b) update_11_5;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_11_3.apply(SRCIP, DSTIP, SIZE, 1, ig_md.d_11_est_3);
        ...
        T2_RUN_AFTER_2_KEY_5(24, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        // UnivMon for inst 25
            ...
            UM_RUN_END_4(25, ig_md.d_25_res_hash, SIZE) 
