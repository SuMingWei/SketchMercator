...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_HH_4_KEY_1( 4, SRCIP, 1)
        UM_RUN_2_KEY_1( 5, DSTIP, 1)
        ...
        T5_RUN_1_KEY_2( 8, SRCIP, DSTIP)
        T3_RUN_HH_1_KEY_2( 9, SRCIP, DSTIP, 1)
        ...
        UM_RUN_5_KEY_2(14, SRCIP, SRCPORT, SIZE)
        ...
        T3_RUN_HH_3_KEY_2(17, DSTIP, DSTPORT, 1)
        ...
        T2_RUN_5_KEY_5(24, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
