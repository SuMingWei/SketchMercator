...
control SwitchIngress(
    ...
    apply {
        ...
        T3_RUN_HH_1_KEY_1( 2, SRCIP, SIZE)
        ...
        UM_RUN_5_KEY_2( 9, SRCIP, DSTIP, 1)
        ...
        UM_RUN_3_KEY_4(21, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        ...
        T3_RUN_HH_4_KEY_5(24, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
