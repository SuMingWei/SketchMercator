...
control SwitchIngress(
    ...
    apply {
        ...
        T4_RUN_1_KEY_4(19, SRCIP, DSTIP, SRCPORT, DSTPORT)
        T2_RUN_5_KEY_4(20, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        ...
        T4_RUN_1_KEY_5(23, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        T2_RUN_2_KEY_5(24, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
