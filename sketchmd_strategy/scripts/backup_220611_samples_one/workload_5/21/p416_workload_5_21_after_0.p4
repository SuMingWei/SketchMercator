...
control SwitchIngress(
    ...
    // apply O2
        ...
        T2_KEY_UPDATE_220_8192(32w0x30243f0b) update_16_4;
        ABOVE_THRESHOLD_CONSTANT_4(100) d_16_above_threshold;
    // 

    T3_INIT_HH_5(17, 220, 8192)
    ...
    // apply O3; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_21_3;
    ...
    apply {
        ...
        T5_RUN_1_KEY_2( 9, SRCIP, SRCPORT)
        UM_RUN_AFTER_1_KEY_2(10, SRCIP, SRCPORT, SIZE)
        T3_RUN_AFTER_2_KEY_2(11, DSTIP, DSTPORT, 1)
        T3_RUN_AFTER_3_KEY_2(12, DSTIP, DSTPORT, SIZE)
        UM_RUN_AFTER_3_KEY_2(13, DSTIP, DSTPORT, SIZE)
        ...
        T3_RUN_AFTER_5_KEY_4(17, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        ...
        // apply O3; big - CM/Kary/CS / small - Ent/PCSA 
            update_21_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, SIZE, ig_md.d_21_est_1);
            update_21_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, SIZE, ig_md.d_21_est_2);
            update_21_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, SIZE, ig_md.d_21_est_3);
