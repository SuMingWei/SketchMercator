...
control SwitchIngress(
    ...
    apply {
        ...
        UM_RUN_2_KEY_2( 8, SRCIP, DSTIP, 1)
        T5_RUN_1_KEY_2( 9, SRCIP, SRCPORT)
        UM_RUN_1_KEY_2(10, SRCIP, SRCPORT, SIZE)
        T3_RUN_HH_2_KEY_2(11, DSTIP, DSTPORT, 1)
        T3_RUN_HH_3_KEY_2(12, DSTIP, DSTPORT, SIZE)
        ...
        T3_RUN_HH_5_KEY_4(17, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
