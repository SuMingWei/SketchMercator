...
control SwitchIngress(
    ...
    UM_INIT_4(18, 110, 10, 16384)
    T1_INIT_2(19, 110, 524288)
    T3_INIT_HH_3(20, 220, 16384)

    // apply O3; big - MRAC (1 row) / small - MRAC (1 row) 
        COMPUTE_HASH_220_16_16(32w0x30244f0b) d_21_sampling_hash_call;
    ...
    apply {
        ...
        //
        T2_RUN_AFTER_4_KEY_1( 5, SRCIP, SIZE)
        ...
        // apply O3; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_8_1.apply(DSTIP, SIZE, 1, ig_md.d_8_est_1);
            update_8_2.apply(DSTIP, SIZE, 1, ig_md.d_8_est_2);
        ...
        //
        UM_RUN_AFTER_2_KEY_1(10, DSTIP, 1)
        T4_RUN_1_KEY_2(11, SRCIP, DSTIP)
        T2_RUN_AFTER_2_KEY_2(13, SRCIP, DSTIP, SIZE)
        T3_RUN_AFTER_5_KEY_2(12, SRCIP, DSTIP, 1)
        MRAC_RUN_1_KEY_2(14, SRCIP, DSTIP)
        ...
        UM_RUN_AFTER_4_KEY_2(18, SRCIP, SRCPORT, SIZE)
        T1_RUN_2_KEY_2(19, DSTIP, DSTPORT) if (ig_md.d_19_est1_1 == 0 || ig_md.d_19_est1_2 == 0) { /* process_new_flow() */ }
        T3_RUN_AFTER_3_KEY_4(20, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
