...
control SwitchIngress(
    ...
    // apply O3; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_KEY_UPDATE_110_4096(32w0x30243f0b) update_8_2;
    ...
    apply {
        ...
        UM_RUN_AFTER_3_KEY_4(10, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_2_KEY_5(11, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        UM_RUN_AFTER_5_KEY_5(12, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        if(
