...
control SwitchIngress(
    ...
    T1_INIT_2(18, 110, 524288)
    T2_INIT_1(19, 110, 16384)

    // apply O3; big - CM/Kary/CS / small - Ent/PCSA 
        ABOVE_THRESHOLD_CONSTANT_4(100) d_21_above_threshold;
        COMPUTE_HASH_220_16_16(32w0x30244f0b) d_21_res_hash_call;
        T3_T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_21_1;
        T3_T2_KEY_UPDATE_220_4096(32w0x30243f0b) update_21_2;
        T3_KEY_UPDATE_220_4096(32w0x30243f0b) update_21_3;
        T3_KEY_UPDATE_220_4096(32w0x30243f0b) update_21_4;
    //
    UM_INIT_3(22, 220, 11, 32768)
    T2_INIT_2(23, 221, 16384)
    UM_INIT_1(24, 221, 10, 16384)
    ...
    apply {
        ...
        // apply O3; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_6_5.apply(DSTIP, SIZE, ig_md.d_6_est_5);
        ...
        T3_RUN_AFTER_2_KEY_2(12, SRCIP, DSTIP, SIZE)
        ...
        T3_RUN_AFTER_5_KEY_2(14, SRCIP, SRCPORT, SIZE)
        ...
        d_17_index_hash_call_5.apply(SRCIP, SRCPORT, ig_md.d_17_index5_16);
        ...
        T1_RUN_2_KEY_2(18, DSTIP, DSTPORT) if (ig_md.d_18_est1_1 == 0 || ig_md.d_18_est1_2 == 0) { /* process_new_flow() */ }
        T2_RUN_1_KEY_2(19, DSTIP, DSTPORT, SIZE)

        // apply O3; big - CM/Kary/CS / small - Ent/PCSA 
            d_21_res_hash_call.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_21_res_hash);
            update_21_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_21_res_hash[1:1], 1, ig_md.d_21_est_1);
            update_21_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_21_res_hash[2:2], 1, ig_md.d_21_est_2);
            update_21_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_21_res_hash[3:3], ig_md.d_21_est_3);
            update_21_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE, ig_md.d_21_res_hash[4:4], ig_md.d_21_est_4);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_4(21)
        //
        UM_RUN_AFTER_3_KEY_4(22, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_2_KEY_5(23, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        UM_RUN_AFTER_1_KEY_5(24, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        if(
