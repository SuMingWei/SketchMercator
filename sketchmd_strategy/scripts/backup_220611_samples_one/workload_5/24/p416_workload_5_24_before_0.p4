...
control SwitchIngress(
    ...
    MRAC_INIT_1(16, 110, 16384, 11,  8)
    UM_INIT_5(17, 110, 10, 16384)
    T1_INIT_2(18, 110, 524288)
    T2_INIT_1(19, 110, 16384)
    T2_INIT_2(20, 220, 4096)
    T3_INIT_HH_4(21, 220, 4096)
    ...
    apply {
        ...
        T2_RUN_HH_5_KEY_1( 6, DSTIP, SIZE)
        ...
        T2_RUN_2_KEY_2(10, SRCIP, DSTIP, SIZE)
        T2_RUN_HH_1_KEY_2(11, SRCIP, DSTIP, SIZE)
        T3_RUN_HH_2_KEY_2(12, SRCIP, DSTIP, SIZE)
        ...
        T3_RUN_HH_5_KEY_2(14, SRCIP, SRCPORT, SIZE)
        T2_RUN_HH_2_KEY_2(15, SRCIP, SRCPORT, 1)
        MRAC_RUN_1_KEY_2(16, SRCIP, SRCPORT)
        UM_RUN_5_KEY_2(17, SRCIP, SRCPORT, 1)
        ...
        T2_RUN_2_KEY_4(20, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T3_RUN_HH_4_KEY_4(21, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        UM_RUN_3_KEY_4(22, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_2_KEY_5(23, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        UM_RUN_1_KEY_5(24, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
    }
}
