...
control SwitchIngress(
    ...
    // apply O3; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T2_KEY_UPDATE_100_8192(32w0x30243f0b) update_3_3;
    ...
    MRAC_INIT_1( 7, 200, 16384, 10, 16)
    T1_INIT_5( 8, 110, 524288)
    T4_INIT_1( 9, 110, 65536)
    T2_INIT_HH_5(10, 110, 4096)
    MRAC_INIT_1(11, 110, 16384, 10, 16)
    T1_INIT_3(12, 220, 131072)
    MRB_INIT_1(13, 220, 262144, 15,  8)
    T2_INIT_HH_4(14, 220, 8192)
    UM_INIT_1(15, 220, 10, 16384)
    T4_INIT_1(16, 221, 32768)
    T2_INIT_HH_1(17, 221, 16384)
    ...
    apply {
        ...
        // apply O3; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_3_1.apply(DSTIP, SIZE, ig_md.d_3_res_hash[1:1], 1, ig_md.d_3_est_1);
            update_3_2.apply(DSTIP, SIZE, ig_md.d_3_res_hash[2:2], 1, ig_md.d_3_est_2);
            update_3_3.apply(DSTIP, SIZE, ig_md.d_3_res_hash[3:3], 1, ig_md.d_3_est_3);
        ...
        // apply O3; big - UnivMon / small - many MRACs 
        d_6_sampling_hash_call.apply(DSTIP, ig_md.d_6_sampling_hash_16);
        ...
        T2_RUN_AFTER_5_KEY_2(10, DSTIP, DSTPORT, 1)
        ...
        UM_RUN_AFTER_1_KEY_4(15, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T4_RUN_1_KEY_5(16, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        T2_RUN_AFTER_1_KEY_5(17, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        if(
