...
control SwitchIngress(
    ...
    T2_INIT_2(14, 220, 8192)
    T2_INIT_1(15, 220, 4096)
    T3_INIT_HH_2(16, 220, 4096)
    ...
    apply {
        ...
        T3_RUN_HH_1_KEY_2( 9, SRCIP, SRCPORT, SIZE)
        T2_RUN_4_KEY_2(10, DSTIP, DSTPORT, SIZE)
        UM_RUN_4_KEY_2(11, DSTIP, DSTPORT, 1)
        ...
        T2_RUN_2_KEY_4(14, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_1_KEY_4(15, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T3_RUN_HH_2_KEY_4(16, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T3_RUN_HH_3_KEY_4(17, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
