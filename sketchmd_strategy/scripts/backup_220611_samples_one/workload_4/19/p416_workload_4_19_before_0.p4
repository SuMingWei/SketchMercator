...
control SwitchIngress(
    ...
    UM_INIT_4( 6, 200, 10, 16384)
    UM_INIT_2( 7, 200, 11, 32768)
    T2_INIT_1( 8, 110, 8192)
    T1_INIT_4( 9, 110, 131072)
    T4_INIT_1(10, 110, 32768)
    MRAC_INIT_1(11, 110, 16384, 11,  8)
    T1_INIT_5(12, 220, 131072)
    T4_INIT_1(13, 220, 65536)
    T3_INIT_HH_2(14, 220, 4096)
    T1_INIT_4(15, 221, 524288)
    T4_INIT_1(16, 221, 65536)
    T2_INIT_2(17, 221, 8192)
    T2_INIT_HH_1(18, 221, 16384)
    ...
    apply {
        ...
        UM_RUN_1_KEY_1( 2, SRCIP, SIZE)
        T2_RUN_4_KEY_1( 3, DSTIP, 1)
        T2_RUN_HH_3_KEY_1( 4, DSTIP, SIZE)
        T2_RUN_HH_3_KEY_2( 5, SRCIP, DSTIP, 1)
        UM_RUN_4_KEY_2( 6, SRCIP, DSTIP, 1)
        UM_RUN_2_KEY_2( 7, SRCIP, DSTIP, SIZE)
        T2_RUN_1_KEY_2( 8, SRCIP, SRCPORT, 1)
        ...
        T4_RUN_1_KEY_2(10, DSTIP, DSTPORT)
        ...
        T4_RUN_1_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT)
        T3_RUN_HH_2_KEY_4(14, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T1_RUN_4_KEY_5(15, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO) if (ig_md.d_15_est1_1 == 0 || ig_md.d_15_est1_2 == 0 || ig_md.d_15_est1_3 == 0 || ig_md.d_15_est1_4 == 0) { /* process_new_flow() */ }
        T4_RUN_1_KEY_5(16, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        T2_RUN_2_KEY_5(17, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T2_RUN_HH_1_KEY_5(18, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
