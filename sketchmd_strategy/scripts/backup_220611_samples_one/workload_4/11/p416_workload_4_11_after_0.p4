...
control SwitchIngress(
    ...
    T2_INIT_HH_5( 5, 200, 16384)
    T1_INIT_1( 6, 110, 262144)
    T4_INIT_1( 7, 110, 32768)
    T2_INIT_2( 8, 110, 16384)
    MRB_INIT_1( 9, 220, 262144, 15,  8)
    T2_INIT_HH_1(10, 221, 4096)
    UM_INIT_3(11, 221, 10, 16384)
    ...
    apply {
        ...
        // apply O3; big - UnivMon / small - many MRACs 
        d_4_sampling_hash_call.apply(DSTIP, ig_md.d_4_sampling_hash_16);
        ...
        update_4_3.apply(ig_md.d_4_base_16_2048, ig_md.d_4_index3_16, ig_md.d_4_res_hash[3:3], SIZE, ig_md.d_4_est_3);
        d_4_index_hash_call_4.apply(DSTIP, ig_md.d_4_index4_16);
        update_4_4.apply(ig_md.d_4_base_16_2048, ig_md.d_4_index4_16, ig_md.d_4_res_hash[4:4], SIZE, ig_md.d_4_est_4);
        RUN_HEAVY_FLOWKEY_NOIF_4(4)
        // 

        T2_RUN_AFTER_5_KEY_2( 5, SRCIP, DSTIP, SIZE)
        T1_RUN_1_KEY_2( 6, SRCIP, SRCPORT) if (ig_md.d_6_est1_1 == 0) { /* process_new_flow() */ }
        T4_RUN_1_KEY_2( 7, DSTIP, DSTPORT)
        T2_RUN_2_KEY_2( 8, DSTIP, DSTPORT, SIZE)
        MRB_RUN_1_KEY_4( 9, SRCIP, DSTIP, SRCPORT, DSTPORT)
        T2_RUN_AFTER_1_KEY_5(10, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        UM_RUN_AFTER_3_KEY_5(11, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        if(
