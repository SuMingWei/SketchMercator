...
control SwitchIngress(
    ...
    //
    T4_INIT_1( 8, 110, 16384)
    T3_INIT_HH_4( 9, 110, 4096)
    MRB_INIT_1(10, 110, 131072, 14,  8)
    ...
    apply {
        UM_RUN_AFTER_2_KEY_1( 1, SRCIP, SIZE)
        ...
        // apply O3; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_7_2.apply(SRCIP, DSTIP, SIZE, ig_md.d_7_est_2);
        ...
        T3_RUN_AFTER_4_KEY_2( 9, SRCIP, SRCPORT, SIZE)
        MRB_RUN_1_KEY_2(10, DSTIP, DSTPORT)
        ...
        MRB_RUN_1_KEY_5(18, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
