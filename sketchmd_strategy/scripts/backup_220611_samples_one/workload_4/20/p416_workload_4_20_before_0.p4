...
control SwitchIngress(
    ...
    apply {
        ...
        T3_RUN_HH_2_KEY_1( 4, SRCIP, 1)
        T3_RUN_HH_4_KEY_1( 5, SRCIP, SIZE)
        T2_RUN_HH_2_KEY_1( 6, SRCIP, SIZE)
        ...
        UM_RUN_1_KEY_4(17, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        ...
        UM_RUN_1_KEY_5(20, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
    }
}
