...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_2_KEY_2(13, DSTIP, DSTPORT, 1)
        T2_RUN_1_KEY_2(14, DSTIP, DSTPORT, 1)
        UM_RUN_2_KEY_2(15, DSTIP, DSTPORT, 1)
        MRB_RUN_1_KEY_4(16, SRCIP, DSTIP, SRCPORT, DSTPORT)
        T2_RUN_5_KEY_4(17, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
