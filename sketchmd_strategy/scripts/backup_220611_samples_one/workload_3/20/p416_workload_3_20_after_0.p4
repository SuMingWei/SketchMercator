...
control SwitchIngress(
    ...
    // apply O3; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_221_16_10(32w0x30244f0b) d_20_index_hash_call_3;
        T3_INDEX_UPDATE_16384() update_20_3;
        COMPUTE_HASH_221_16_10(32w0x30244f0b) d_20_index_hash_call_4;
        T3_INDEX_UPDATE_16384() update_20_4;
        COMPUTE_HASH_221_16_10(32w0x30244f0b) d_20_index_hash_call_5;
        T3_INDEX_UPDATE_16384() update_20_5;
    // 
    ...
    apply {
        ...
        T3_RUN_AFTER_3_KEY_1( 2, DSTIP, 1)
        UM_RUN_AFTER_4_KEY_1( 3, DSTIP, 1)
        ...
        T4_RUN_1_KEY_2(13, DSTIP, DSTPORT)
        MRAC_RUN_1_KEY_2(14, DSTIP, DSTPORT)
        T2_RUN_AFTER_2_KEY_4(16, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        ...
        // apply O3; big - UnivMon / small - many MRACs 
        d_20_sampling_hash_call.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_20_sampling_hash_16);
        ...
        update_20_5.apply(ig_md.d_20_base_16_1024, ig_md.d_20_index5_16, ig_md.d_20_res_hash[5:5], 1, ig_md.d_20_est_5);
