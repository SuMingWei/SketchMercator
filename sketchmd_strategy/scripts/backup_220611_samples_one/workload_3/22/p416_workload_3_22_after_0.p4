...
control SwitchIngress(
    ...
    // apply O3; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_5_1;
        T3_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_5_2;
        T3_KEY_UPDATE_100_4096(32w0x30243f0b) update_5_3;
        T3_KEY_UPDATE_100_4096(32w0x30243f0b) update_5_4;
        T3_KEY_UPDATE_100_4096(32w0x30243f0b) update_5_5;
    //
    T2_INIT_HH_2( 6, 100, 16384)
    T3_INIT_HH_5( 7, 200, 16384)
    ...
    T3_INIT_HH_1(11, 110, 4096)
    UM_INIT_1(13, 110, 10, 16384)
    UM_INIT_4(12, 110, 10, 16384)
    T1_INIT_4(14, 110, 262144)
    T1_INIT_4(15, 110, 262144)
    T5_INIT_1(16, 220, 8192)
    T1_INIT_1(20, 221, 262144)
    T1_INIT_4(17, 221, 131072)

    // apply O2
        T1_KEY_UPDATE_221_524288(32w0x30243f0b) update_18_1;
        T1_KEY_UPDATE_221_524288(32w0x30243f0b) update_18_2;
        T1_KEY_UPDATE_221_524288(32w0x30243f0b) update_18_3;
        T1_KEY_UPDATE_221_524288(32w0x30243f0b) update_18_4;
    // 

    T2_INIT_HH_1(21, 221, 16384)
    ...
    apply {
        ...
        // apply O3; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_5_1.apply(DSTIP, 1, ig_md.d_5_res_hash[1:1], 1, ig_md.d_5_est_1);
            update_5_2.apply(DSTIP, 1, ig_md.d_5_res_hash[2:2], 1, ig_md.d_5_est_2);
        ...
        // apply O3; big - UnivMon / small - many MRACs 
        d_10_sampling_hash_call.apply(SRCIP, DSTIP, ig_md.d_10_sampling_hash_16);
        ...
        T3_RUN_AFTER_1_KEY_2(11, SRCIP, SRCPORT, 1)
        UM_RUN_AFTER_1_KEY_2(13, SRCIP, SRCPORT, 1)
        UM_RUN_AFTER_4_KEY_2(12, SRCIP, SRCPORT, 1)
        ...
        T5_RUN_1_KEY_4(16, SRCIP, DSTIP, SRCPORT, DSTPORT)
        ...
        T2_RUN_AFTER_1_KEY_5(21, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        UM_RUN_AFTER_2_KEY_5(22, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        if(
