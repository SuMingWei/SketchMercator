...
control SwitchIngress(
    ...
    // apply O3; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_KEY_UPDATE_110_4096(32w0x30243f0b) update_4_2;
    ...
    T4_INIT_1( 8, 221, 32768)
    UM_INIT_1( 9, 221, 11, 32768)
    ...
    apply {
        ...
        UM_RUN_AFTER_4_KEY_1( 2, SRCIP, 1)
        ...
        // apply O3; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_4_1.apply(SRCIP, SRCPORT, 1, ig_md.d_4_res_hash[1:1], 1, ig_md.d_4_est_1);
            d_5_above_threshold.apply(ig_md.d_4_est_1, ig_md.d_5_above_threshold);
            update_4_2.apply(SRCIP, SRCPORT, 1, ig_md.d_4_est_2);
            update_4_3.apply(SRCIP, SRCPORT, 1, ig_md.d_4_est_3);
            update_4_4.apply(SRCIP, SRCPORT, 1, ig_md.d_4_est_4);
            update_4_5.apply(SRCIP, SRCPORT, 1, ig_md.d_4_est_5);
        //
        T1_RUN_1_KEY_2( 6, DSTIP, DSTPORT)
        T2_RUN_AFTER_3_KEY_2( 7, DSTIP, DSTPORT, 1)
        T4_RUN_1_KEY_5( 8, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        UM_RUN_AFTER_1_KEY_5( 9, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        if(
