...
control SwitchIngress(
    ...
    // apply O3; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_100_16384(32w0x30243f0b) update_4_1;
    ...
    MRB_INIT_1(11, 221, 262144, 14, 16)
    ...
    apply {
        ...
        // apply O3; big - CM/Kary/CS / small - Ent/PCSA 
            d_4_hash_call.apply(DSTIP, ig_md.d_4_sampling_hash_32);
            d_4_tcam_lpm.apply(ig_md.d_4_sampling_hash_32, ig_md.d_4_level);
            d_4_get_bitmask.apply(ig_md.d_4_level, ig_md.d_4_bitmask);
            update_4_1.apply(DSTIP, 1, ig_md.d_4_bitmask, ig_md.d_4_est_1);
            update_4_2.apply(DSTIP, 1, ig_md.d_4_est_2);
            update_4_3.apply(DSTIP, 1, ig_md.d_4_est_3);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_3(4)
        //
        T5_RUN_1_KEY_2( 5, SRCIP, DSTIP)
        MRAC_RUN_1_KEY_2( 6, SRCIP, DSTIP)
        T1_RUN_4_KEY_2( 7, DSTIP, DSTPORT) if (ig_md.d_7_est1_1 == 0 || ig_md.d_7_est1_2 == 0 || ig_md.d_7_est1_3 == 0 || ig_md.d_7_est1_4 == 0) { /* process_new_flow() */ }
        ...
        UM_RUN_AFTER_3_KEY_4(10, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
