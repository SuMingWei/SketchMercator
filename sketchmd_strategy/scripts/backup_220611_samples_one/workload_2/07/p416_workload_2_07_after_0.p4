...
control SwitchIngress(
    ...
    T4_INIT_1( 2, 221, 16384)

    // apply O3; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_4_1;
        ABOVE_THRESHOLD_CONSTANT_1(100) d_5_above_threshold;
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_4_2;
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_4_3;
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_4_4;
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_4_5;
    //

    // apply O3; big - UnivMon / small - many MRACs 
        UM_INIT_SETUP(7, 221)
        ABOVE_THRESHOLD_3() d_7_above_threshold;
        COMPUTE_HASH_221_16_11(32w0x30244f0b) d_7_index_hash_call_1;
        T3_T2_INDEX_UPDATE_32768() update_7_1;
        COMPUTE_HASH_221_16_11(32w0x30244f0b) d_7_index_hash_call_2;
        T3_INDEX_UPDATE_32768() update_7_2;
        COMPUTE_HASH_221_16_11(32w0x30244f0b) d_7_index_hash_call_3;
    ...
    apply {
        ...
        T4_RUN_1_KEY_5( 2, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)

        // apply O3; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_4_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, SIZE, ig_md.d_4_est_1);
            update_4_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, SIZE, ig_md.d_4_est_2);
            d_5_above_threshold.apply(ig_md.d_4_est_2, ig_md.d_5_above_threshold);
            update_4_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_4_est_3);
            update_4_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_4_est_4);
            update_4_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_4_est_5);
        //

        // apply O3; big - UnivMon / small - many MRACs 
        d_7_sampling_hash_call.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_7_sampling_hash_16);
        ...
        d_7_index_hash_call_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_7_index3_16);
