...
control SwitchIngress(
    ...
    apply {
        ...
        // apply O3; big - CM/Kary/CS / small - Ent/PCSA 
            d_2_hash_call.apply(SRCIP, SRCPORT, ig_md.d_2_sampling_hash_32);
            d_2_tcam_lpm.apply(ig_md.d_2_sampling_hash_32, ig_md.d_2_level);
            d_2_get_bitmask.apply(ig_md.d_2_level, ig_md.d_2_bitmask);
            update_2_1.apply(SRCIP, SRCPORT, 1, ig_md.d_2_bitmask, ig_md.d_2_est_1);
            update_2_2.apply(SRCIP, SRCPORT, 1, ig_md.d_2_est_2);
            update_2_3.apply(SRCIP, SRCPORT, 1, ig_md.d_2_est_3);
            update_2_4.apply(SRCIP, SRCPORT, 1, ig_md.d_2_est_4);
            update_2_5.apply(SRCIP, SRCPORT, 1, ig_md.d_2_est_5);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_5(2)
        //
        T3_RUN_AFTER_1_KEY_2( 3, SRCIP, SRCPORT, SIZE)
        if(
