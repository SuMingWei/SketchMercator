...
control SwitchIngress(
    ...
    // apply O3; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_200_16384(32w0x30243f0b) update_4_3;
    //
    T3_INIT_HH_5( 3, 200, 4096)
    ...
    apply {
        T4_RUN_1_KEY_2( 1, SRCIP, DSTIP)

        // apply O3; big - CM/Kary/CS / small - Ent/PCSA 
            d_4_res_hash_call.apply(SRCIP, DSTIP, ig_md.d_4_res_hash);
            update_4_1.apply(SRCIP, DSTIP, SIZE, ig_md.d_4_res_hash[1:1], 1, ig_md.d_4_est_1);
            update_4_2.apply(SRCIP, DSTIP, SIZE, ig_md.d_4_res_hash[2:2], 1, ig_md.d_4_est_2);
            update_4_3.apply(SRCIP, DSTIP, SIZE, ig_md.d_4_res_hash[3:3], ig_md.d_4_est_3);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_3(4)
        //
        T3_RUN_AFTER_5_KEY_2( 3, SRCIP, DSTIP, 1)
        if(
