...
control SwitchIngress(
    ...
    T4_INIT_1( 2, 200, 16384)
    T4_INIT_1( 3, 200, 65536)
    T2_INIT_5( 4, 200, 4096)
    T2_INIT_4( 5, 200, 4096)
    ...
    UM_INIT_4(19, 200, 10, 16384)
    UM_INIT_1(20, 200, 10, 16384)
    apply {
        ...
        T2_RUN_HH_5_KEY_2(14, SRCIP, DSTIP, SIZE)
        ...
        UM_RUN_1_KEY_2(20, SRCIP, DSTIP, SIZE)
    }
}
