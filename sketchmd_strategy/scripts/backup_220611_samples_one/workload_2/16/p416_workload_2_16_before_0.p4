...
control SwitchIngress(
    ...
    T2_INIT_1( 2, 110, 8192)
    T2_INIT_3( 3, 110, 4096)
    ...
    apply {
        ...
        T2_RUN_1_KEY_2( 2, SRCIP, SRCPORT, 1)
        T2_RUN_3_KEY_2( 3, SRCIP, SRCPORT, SIZE)
        T2_RUN_HH_3_KEY_2( 4, SRCIP, SRCPORT, 1)
        T2_RUN_HH_4_KEY_2( 5, SRCIP, SRCPORT, SIZE)
        T3_RUN_HH_2_KEY_2( 6, SRCIP, SRCPORT, SIZE)
        T3_RUN_HH_3_KEY_2( 7, SRCIP, SRCPORT, SIZE)
        ...
        UM_RUN_1_KEY_2(14, SRCIP, SRCPORT, 1)
        UM_RUN_1_KEY_2(15, SRCIP, SRCPORT, 1)
        UM_RUN_2_KEY_2(16, SRCIP, SRCPORT, SIZE)
    }
}
