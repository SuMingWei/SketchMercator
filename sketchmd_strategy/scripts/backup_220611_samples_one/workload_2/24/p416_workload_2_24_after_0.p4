...
control SwitchIngress(
    ...
    // apply O3; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_110_16_11(32w0x30244f0b) d_24_index_hash_call_1;
        T3_T2_INDEX_UPDATE_32768() update_24_1;
        COMPUTE_HASH_110_16_11(32w0x30244f0b) d_24_index_hash_call_2;
        T3_T2_INDEX_UPDATE_32768() update_24_2;
        COMPUTE_HASH_110_16_11(32w0x30244f0b) d_24_index_hash_call_3;
    ...
    apply {
        ...
        T2_RUN_AFTER_5_KEY_2(20, SRCIP, SRCPORT, SIZE)

        // apply O3; big - UnivMon / small - many MRACs 
        d_24_sampling_hash_call.apply(SRCIP, SRCPORT, ig_md.d_24_sampling_hash_16);
        d_24_res_hash_call.apply(SRCIP, SRCPORT, ig_md.d_24_res_hash);
        d_24_tcam_lpm_2.apply(ig_md.d_24_sampling_hash_16, ig_md.d_24_base_16_1024, ig_md.d_24_base_16_2048, ig_md.d_24_threshold);
        d_24_index_hash_call_1.apply(SRCIP, SRCPORT, ig_md.d_24_index1_16);
        update_24_1.apply(ig_md.d_24_base_16_2048, ig_md.d_24_index1_16, ig_md.d_24_res_hash[1:1], SIZE, ig_md.d_24_est_1);
        d_24_index_hash_call_2.apply(SRCIP, SRCPORT, ig_md.d_24_index2_16);
        update_24_2.apply(ig_md.d_24_base_16_2048, ig_md.d_24_index2_16, ig_md.d_24_res_hash[2:2], SIZE, ig_md.d_24_est_2);
        d_24_index_hash_call_3.apply(SRCIP, SRCPORT, ig_md.d_24_index3_16);
        ...
        UM_RUN_AFTER_2_KEY_2(23, SRCIP, SRCPORT, 1)
        if(
