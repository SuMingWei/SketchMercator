...
control SwitchIngress(
    ...
    MRAC_INIT_1(23, 110, 8192, 10,  8)
    UM_INIT_1(24, 110, 10, 16384)
    UM_INIT_5(25, 110, 11, 32768)
    apply {
        ...
        T2_RUN_3_KEY_2( 7, SRCIP, SRCPORT, SIZE)
        T2_RUN_3_KEY_2( 8, SRCIP, SRCPORT, SIZE)
        T2_RUN_HH_3_KEY_2( 9, SRCIP, SRCPORT, 1)
        T3_RUN_HH_1_KEY_2(10, SRCIP, SRCPORT, 1)
        T3_RUN_HH_5_KEY_2(11, SRCIP, SRCPORT, SIZE)
        T3_RUN_HH_4_KEY_2(12, SRCIP, SRCPORT, SIZE)
        ...
        T2_RUN_HH_4_KEY_2(17, SRCIP, SRCPORT, SIZE)
        T2_RUN_HH_2_KEY_2(18, SRCIP, SRCPORT, SIZE)
        T2_RUN_HH_2_KEY_2(19, SRCIP, SRCPORT, SIZE)
        MRAC_RUN_1_KEY_2(20, SRCIP, SRCPORT)
        MRAC_RUN_1_KEY_2(21, SRCIP, SRCPORT)
        MRAC_RUN_1_KEY_2(22, SRCIP, SRCPORT)
        MRAC_RUN_1_KEY_2(23, SRCIP, SRCPORT)
        UM_RUN_1_KEY_2(24, SRCIP, SRCPORT, 1)
        UM_RUN_5_KEY_2(25, SRCIP, SRCPORT, 1)
    }
}
