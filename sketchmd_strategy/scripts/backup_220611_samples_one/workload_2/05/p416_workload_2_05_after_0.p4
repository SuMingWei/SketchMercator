...
control SwitchIngress(
    ...
    // apply O3; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_220_16_10(32w0x30244f0b) d_5_index_hash_call_2;
    ...
    apply {
        ...
        T2_RUN_AFTER_5_KEY_4( 3, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)

        // apply O3; big - UnivMon / small - many MRACs 
        d_5_sampling_hash_call.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_5_sampling_hash_16);
