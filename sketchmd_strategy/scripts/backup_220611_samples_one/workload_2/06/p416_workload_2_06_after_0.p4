...
control SwitchIngress(
    ...
    // apply O3; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T2_KEY_UPDATE_110_4096(32w0x30243f0b) update_4_1;
        T3_T2_KEY_UPDATE_110_4096(32w0x30243f0b) update_4_2;
        T3_KEY_UPDATE_110_4096(32w0x30243f0b) update_4_3;
        T3_KEY_UPDATE_110_4096(32w0x30243f0b) update_4_4;
        T3_KEY_UPDATE_110_4096(32w0x30243f0b) update_4_5;
    //
    T2_INIT_HH_4( 3, 110, 16384)
    ...
    apply {
        T1_RUN_1_KEY_2( 1, SRCIP, SRCPORT)

        // apply O3; big - CM/Kary/CS / small - Ent/PCSA 
            d_4_res_hash_call.apply(SRCIP, SRCPORT, ig_md.d_4_res_hash);
            update_4_1.apply(SRCIP, SRCPORT, SIZE, ig_md.d_4_res_hash[1:1], 1, ig_md.d_4_est_1);
            update_4_2.apply(SRCIP, SRCPORT, SIZE, ig_md.d_4_res_hash[2:2], 1, ig_md.d_4_est_2);
            update_4_3.apply(SRCIP, SRCPORT, SIZE, ig_md.d_4_res_hash[3:3], ig_md.d_4_est_3);
            update_4_4.apply(SRCIP, SRCPORT, SIZE, ig_md.d_4_res_hash[4:4], ig_md.d_4_est_4);
            update_4_5.apply(SRCIP, SRCPORT, SIZE, ig_md.d_4_res_hash[5:5], ig_md.d_4_est_5);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_5(4)
        //
        T2_RUN_AFTER_4_KEY_2( 3, SRCIP, SRCPORT, 1)

        // apply O3; big - UnivMon / small - many MRACs 
        d_6_sampling_hash_call.apply(SRCIP, SRCPORT, ig_md.d_6_sampling_hash_16);
