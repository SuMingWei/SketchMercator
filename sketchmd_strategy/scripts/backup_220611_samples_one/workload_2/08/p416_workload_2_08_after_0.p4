...
control SwitchIngress(
    ...
    // apply O2
        ...
        T1_KEY_UPDATE_221_262144(32w0x30243f0b) update_1_5;
    // 
    ...
    // apply O3; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_5_2;
        T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_5_3;
    ...
    // apply O3; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_221_16_11(32w0x30244f0b) d_8_index_hash_call_2;
        T3_INDEX_UPDATE_32768() update_8_2;
        COMPUTE_HASH_221_16_11(32w0x30244f0b) d_8_index_hash_call_3;
        T3_INDEX_UPDATE_32768() update_8_3;
        COMPUTE_HASH_221_16_11(32w0x30244f0b) d_8_index_hash_call_4;
    ...
    apply {
        ...
        // apply O3; big - UnivMon / small - many MRACs 
        d_8_sampling_hash_call.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_8_sampling_hash_16);
