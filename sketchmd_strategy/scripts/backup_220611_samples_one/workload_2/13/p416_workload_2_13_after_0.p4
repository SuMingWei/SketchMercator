...
control SwitchIngress(
    ...
    // apply O3; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_10_3;
        T2_T2_KEY_UPDATE_110_8192(32w0x30243f0b) update_10_4;
    //
    ...
    // apply O2
        ...
        T2_KEY_UPDATE_110_16384(32w0x30243f0b) update_5_4;
        T2_KEY_UPDATE_110_16384(32w0x30243f0b) update_5_5;
    ...
    apply {
        ...
        // apply O3; big - CM/Kary/CS / small - Ent/PCSA 
            d_10_hash_call.apply(DSTIP, DSTPORT, ig_md.d_10_sampling_hash_32);
            ...
            update_10_2.apply(DSTIP, DSTPORT, SIZE, SIZE, ig_md.d_10_est_2);
            update_10_3.apply(DSTIP, DSTPORT, SIZE, SIZE, ig_md.d_10_est_3);
            update_10_4.apply(DSTIP, DSTPORT, SIZE, SIZE, ig_md.d_10_est_4);
        ...
        UM_RUN_AFTER_5_KEY_2(12, DSTIP, DSTPORT, 1)
        if(
