...
control SwitchIngress(
    ...
    apply {
        ...
        //
        T3_RUN_AFTER_3_KEY_2(12, SRCIP, DSTIP, 1)
        T3_RUN_AFTER_3_KEY_2(14, SRCIP, DSTIP, SIZE)
        ...
        T2_RUN_AFTER_5_KEY_2(17, SRCIP, DSTIP, 1)

        // apply O3; big - UnivMon / small - many MRACs 
        d_23_sampling_hash_call.apply(SRCIP, DSTIP, ig_md.d_23_sampling_hash_16);
        ...
        UM_RUN_AFTER_4_KEY_2(22, SRCIP, DSTIP, 1)
        if(
