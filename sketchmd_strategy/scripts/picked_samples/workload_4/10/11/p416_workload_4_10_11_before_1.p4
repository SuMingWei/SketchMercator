...
control SwitchIngress(
    ...
    T2_INIT_5_WITH_POLY( 7, 220, 4096, 32w0x30243f0b, 32w0x0f79f523, 32w0x6b8cb0c5, 32w0x00390fc3, 32w0x298ac673)
    T3_INIT_HH_3_WITH_POLY( 8, 220, 8192, 32w0x5b445b31, 32w0x30243f0b, 32w0x0f79f523, 32w0x6b8cb0c5, 32w0x00390fc3)
    ...
    apply {
        if (hdr.tcp.isValid() || hdr.udp.isValid()) {
            ...
            T4_RUN_1_KEY_5(10, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
            ...
            T5_RUN_1_KEY_4( 9, SRCIP, DSTIP, SRCPORT, DSTPORT)
        }
    }
}
...
control SwitchIngressDeparserDigest(packet_out pkt,
    ...
    apply {
        if (ig_dprsr_md.digest_type == SKETCHMD_HEAVY_FLOWKEY_DIGEST_TYPE) {
            heavy_flowkey_digest.pack({ig_md.epoch_index, ig_md.epoch_count, SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_8_above_threshold});
        }
        pkt.emit(hdr);
    }
}
