...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_110_4096(32w0x30243f0b) update_4_2;
        T2_T2_KEY_UPDATE_110_4096(32w0x30243f0b) update_4_3;
        T2_KEY_UPDATE_110_4096(32w0x30243f0b) update_4_4;
    //


    // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row) 
        COMPUTE_HASH_110_16_8(32w0x30244f0b) d_9_sampling_hash_call;
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            d_7_above_threshold.apply(ig_md.d_5_est_1, ig_md.d_5_est_2, ig_md.d_5_est_3, ig_md.d_7_above_threshold);
        //
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_4_4.apply(DSTIP, DSTPORT, SIZE, ig_md.d_4_est_4);
        //


        // apply SALUMerge; big - MRAC (1 row) / small - MRAC (1 row)
        d_9_tcam_lpm_2.apply(ig_md.d_2_sampling_hash_16, ig_md.d_9_base_16_1024, ig_md.d_9_base_16_2048);
