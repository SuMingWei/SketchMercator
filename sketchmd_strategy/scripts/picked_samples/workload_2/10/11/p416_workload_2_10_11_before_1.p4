...
control SwitchIngress(
    ...
    T2_INIT_3_WITH_POLY( 1, 110, 16384, 32w0x30243f0b, 32w0x0f79f523, 32w0x6b8cb0c5)
    T3_INIT_HH_3_WITH_POLY( 2, 110, 16384, 32w0x5b445b31, 32w0x30243f0b, 32w0x0f79f523, 32w0x6b8cb0c5, 32w0x00390fc3)
    ...
    T2_INIT_4_WITH_POLY( 7, 110, 4096, 32w0x30243f0b, 32w0x0f79f523, 32w0x6b8cb0c5, 32w0x00390fc3)
    T2_INIT_HH_3_THRESHOLD( 8, 110, 4096, 32w0x30243f0b, 32w0x0f79f523, 32w0x6b8cb0c5, 32w0x00390fc3)
    T2_INIT_HH_1_THRESHOLD( 9, 110, 4096, 32w0x30243f0b, 32w0x0f79f523)
    ...
    apply {
        if (hdr.tcp.isValid() || hdr.udp.isValid()) {
            ...
            MRB_RUN_1_KEY_2( 6, DSTIP, DSTPORT)

            T2_RUN_4_KEY_2( 7, DSTIP, DSTPORT, 1)
            T2_RUN_3_KEY_2( 1, DSTIP, DSTPORT, 1)

            T2_RUN_HH_3_KEY_2( 8, DSTIP, DSTPORT, SIZE)
            T3_RUN_HH_3_KEY_2( 2, DSTIP, DSTPORT, 1)
            T2_RUN_HH_1_KEY_2( 9, DSTIP, DSTPORT, SIZE)

            d_4_sampling_hash_call.apply(DSTIP, DSTPORT, ig_md.d_4_sampling_hash_16);
            ...
            update_10_1.apply(ig_md.d_4_base_16, ig_md.d_4_index1_16);
        }
    }
}
...
control SwitchIngressDeparserDigest(packet_out pkt,
    ...
    apply {
        if (ig_dprsr_md.digest_type == SKETCHMD_HEAVY_FLOWKEY_DIGEST_TYPE) {
            heavy_flowkey_digest.pack({ig_md.epoch_index, ig_md.epoch_count, DSTIP, DSTPORT, ig_md.d_2_above_threshold, ig_md.d_8_above_threshold, ig_md.d_9_above_threshold});
        }
        pkt.emit(hdr);
    }
}
