...
// "32w0x60180d91"]
    ...
    MRAC_INIT_1_WITH_POLY( 3, 200, 16384, 11,  16, 32w0x790900f3, 32w0x30243f0b)
    UM_INIT_3_WITH_POLY( 4, 200, 11, 32768, 32w0x790900f3, 32w0x5b445b31, 32w0x30243f0b, 32w0x0f79f523, 32w0x6b8cb0c5, 32w0x00390fc3)
    ...
    T5_INIT_1_WITH_POLY( 6, 110, 8192, 32w0x790900f3, 32w0x30243f0b)
    T2_INIT_2_WITH_POLY( 7, 110, 16384, 32w0x30243f0b, 32w0x0f79f523)
    T1_INIT_3_WITH_POLY( 8, 220, 131072, 32w0x30243f0b, 32w0x0f79f523, 32w0x6b8cb0c5)
    T1_INIT_1_WITH_POLY( 9, 220, 131072, 32w0x30243f0b)
    ...
    apply {
        if (hdr.tcp.isValid() || hdr.udp.isValid()) {
            ...
            UM_RUN_3_KEY_2( 4, SRCIP, DSTIP, 1)
            UM_RUN_4_KEY_2( 5, SRCIP, SRCPORT, 1)
...
control SwitchIngressDeparserDigest(packet_out pkt,
    ...
    apply {
        if (ig_dprsr_md.digest_type == SKETCHMD_HEAVY_FLOWKEY_DIGEST_TYPE) {
            heavy_flowkey_digest.pack({ig_md.epoch_index, ig_md.epoch_count, SRCIP, DSTIP, SRCPORT, ig_md.d_4_above_threshold, ig_md.d_5_above_threshold});
        }
        pkt.emit(hdr);
    }
}
