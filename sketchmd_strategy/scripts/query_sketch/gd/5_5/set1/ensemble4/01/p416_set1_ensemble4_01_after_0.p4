...
control SwitchIngress(
    ...
    T2_INIT_HH_2( 1, 110, 16384)

    // apply SALUMerge; big - UnivMon / small - many MRACs 
        UM_INIT_SETUP(3, 110)
        ABOVE_THRESHOLD_2() d_3_above_threshold;
        COMPUTE_HASH_110_16_12(32w0x30244f0b) d_3_index_hash_call_1;
        T3_T2_INDEX_UPDATE_65536() update_3_1;
        COMPUTE_HASH_110_16_10(32w0x30244f0b) d_3_index_hash_call_2;
    ...
    apply {
        ...
        T2_RUN_AFTER_2_KEY_2( 1, DSTIP, DSTPORT, 1)
        ...
        update_3_2.apply(ig_md.d_3_base_16_1024, ig_md.d_3_index2_16, ig_md.d_3_res_hash[1:1], 1, ig_md.d_3_est_2);
