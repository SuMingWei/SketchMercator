...
control SwitchIngress(
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_110_16_11(32w0x30244f0b) d_7_index_hash_call_4;
        T3_INDEX_UPDATE_32768() update_7_4;
        COMPUTE_HASH_110_16_11(32w0x30244f0b) d_7_index_hash_call_5;
    ...
    apply {
        ...
        T2_RUN_AFTER_3_KEY_2( 1, SRCIP, DSTIP, SIZE)
        // MRAC for inst 2
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_3_1.apply(SRCIP, SRCPORT, 1, ig_md.d_3_bitmask, ig_md.d_3_est_1);
        //

        T2_RUN_1_KEY_2( 5, SRCIP, SRCPORT, SIZE)
