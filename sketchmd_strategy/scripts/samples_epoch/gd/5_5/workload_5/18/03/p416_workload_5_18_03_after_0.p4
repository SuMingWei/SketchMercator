...
control SwitchIngress(
    ...
    // O1 hash init
        ...
        action d_14_xor_construction() { ig_md.d_14_sampling_hash_16 = ig_md.d_7_sampling_hash_16 ^ ig_md.d_10_sampling_hash_16; }
    ...
    apply {
        ...
        // PCSA for inst 9
            ...
            update_9_1.apply(DSTIP, DSTPORT, ig_md.d_9_bitmask);
        //
        ...
        T2_RUN_AFTER_2_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        // MRAC for inst 14
