...
control SwitchIngress(
    ...
    apply {
        ...
        T3_RUN_HH_5_KEY_2( 9, SRCIP, SRCPORT, 1)
        T3_RUN_HH_4_KEY_2(10, SRCIP, SRCPORT, SIZE)
        T3_RUN_HH_1_KEY_2(11, SRCIP, SRCPORT, SIZE)
        MRAC_RUN_1_KEY_2(12, SRCIP, SRCPORT)
        UM_RUN_4_KEY_2(13, SRCIP, SRCPORT, SIZE)
        ...
        T3_RUN_HH_3_KEY_5(17, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
