...
control SwitchIngress(
    ...
    // apply O2
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_11_1;
    ...
    apply {
        ...
        T2_RUN_AFTER_1_KEY_2( 6, SRCIP, SRCPORT, SIZE)
        T2_RUN_AFTER_2_KEY_2( 5, SRCIP, SRCPORT, 1)
        T3_RUN_AFTER_4_KEY_2( 7, DSTIP, DSTPORT, SIZE)
        // MRAC for inst 8
        ...
        // apply O2
        T2_RUN_AFTER_3_KEY_5(11, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        // 
