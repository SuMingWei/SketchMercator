...
control SwitchIngress(
    ...
    apply {
        ...
        update_5_1.apply(ig_md.d_5_base_16_2048, ig_md.d_5_index1_16, ig_md.d_5_res_hash[0:0], SIZE, ig_md.d_5_est_1);
        d_5_index_hash_call_2.apply(DSTIP, DSTPORT, ig_md.d_5_index2_16);
        update_5_2.apply(ig_md.d_5_base_16_2048, ig_md.d_5_index2_16, ig_md.d_5_res_hash[1:1], SIZE, ig_md.d_5_est_2);
        d_5_index_hash_call_3.apply(DSTIP, DSTPORT, ig_md.d_5_index3_16);
        update_5_3.apply(ig_md.d_5_base_16_2048, ig_md.d_5_index3_16, ig_md.d_5_res_hash[2:2], SIZE, ig_md.d_5_est_3);
        d_5_index_hash_call_4.apply(DSTIP, DSTPORT, ig_md.d_5_index4_16);
        update_5_4.apply(ig_md.d_5_base_16_2048, ig_md.d_5_index4_16, ig_md.d_5_res_hash[3:3], SIZE, ig_md.d_5_est_4);
