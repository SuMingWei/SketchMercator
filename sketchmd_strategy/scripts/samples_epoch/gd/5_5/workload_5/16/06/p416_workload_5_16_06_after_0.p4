...
INIT_HEAVY_FLOWKEY_STORAGE_CONFIG_210(32768, 15, 12288)
...
control SwitchIngress(
    ...
    // O1 hash init
        ...
        action d_14_xor_construction() { ig_md.d_14_sampling_hash_16 = ig_md.d_8_sampling_hash_16 ^ ig_md.d_12_sampling_hash_16; }
    ...
    apply {
        ...
        T2_RUN_4_KEY_2(11, DSTIP, DSTPORT, SIZE)
        // MRAC for inst 12
        ...
        T2_RUN_4_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        // MRAC for inst 14
        ...
        T2_RUN_1_KEY_5(15, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
