...
control SwitchIngress(
    ...
    // O1 hash init
        ...
        action d_16_xor_construction() { ig_md.d_16_sampling_hash_16 = ig_md.d_11_sampling_hash_16 ^ ig_md.d_13_sampling_hash_16; }
    ...
    apply {
        ...
        T3_RUN_AFTER_1_KEY_4(14, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        ...
        T3_RUN_AFTER_4_KEY_5(18, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        // MRAC for inst 19
