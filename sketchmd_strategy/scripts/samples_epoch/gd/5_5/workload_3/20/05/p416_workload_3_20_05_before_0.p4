...
control SwitchIngress(
    ...
    apply {
        ...
        UM_RUN_3_KEY_2(13, SRCIP, SRCPORT, 1)
        UM_RUN_3_KEY_2(14, DSTIP, DSTPORT, 1)
        UM_RUN_4_KEY_2(15, DSTIP, DSTPORT, 1)
        ...
        T3_RUN_HH_1_KEY_5(20, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
    }
}
