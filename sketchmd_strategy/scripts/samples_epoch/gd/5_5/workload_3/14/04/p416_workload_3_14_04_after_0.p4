...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_100_8192(32w0x30243f0b) update_2_2;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_2_1.apply(SRCIP, 1, ig_md.d_2_res_hash[0:0], 1, ig_md.d_2_est_1);
            update_2_2.apply(SRCIP, 1, ig_md.d_2_res_hash[1:1], ig_md.d_2_est_2);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_2(2)
        //
        ...
        T2_RUN_4_KEY_2( 8, SRCIP, SRCPORT, 1)
        T3_RUN_AFTER_4_KEY_2( 9, DSTIP, DSTPORT, 1)
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_12_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_12_res_hash[1:1], 1, ig_md.d_12_est_2);
            d_13_above_threshold.apply(ig_md.d_12_est_2, ig_md.d_13_above_threshold);
            update_12_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_12_est_3);
        //
