...
control SwitchIngress(
    ...
    apply {
        ...
        UM_RUN_4_KEY_2( 5, DSTIP, DSTPORT, 1)
        T1_RUN_4_KEY_4( 6, SRCIP, DSTIP, SRCPORT, DSTPORT) if (ig_md.d_6_est1_1 == 0 || ig_md.d_6_est1_2 == 0 || ig_md.d_6_est1_3 == 0 || ig_md.d_6_est1_4 == 0) { /* process_new_flow() */ }
