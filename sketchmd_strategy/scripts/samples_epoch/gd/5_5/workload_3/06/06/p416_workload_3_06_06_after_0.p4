...
control SwitchIngress(
    ...
    // apply O2
        ...
        T1_KEY_UPDATE_200_524288(32w0x30243f0b) update_2_2;
        T1_KEY_UPDATE_200_524288(32w0x30243f0b) update_2_3;
    // 

    UM_INIT_3( 4, 110, 11, 32768)
    T2_INIT_4( 5, 110, 4096)
    T5_INIT_1( 6, 221, 8192)
    ...
    apply {
        ...
        // PCSA for inst 6
            ...
            update_6_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_6_bitmask);
        //
