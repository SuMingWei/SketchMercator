...
control SwitchIngress(
    ...
    T2_INIT_3(10, 220, 16384)
    T3_INIT_HH_5(11, 220, 16384)
    ...
    apply {
        ...
        UM_RUN_3_KEY_2( 3, SRCIP, DSTIP, 1)
        UM_RUN_5_KEY_2( 4, SRCIP, DSTIP, SIZE)
        ...
        T2_RUN_3_KEY_4(10, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
