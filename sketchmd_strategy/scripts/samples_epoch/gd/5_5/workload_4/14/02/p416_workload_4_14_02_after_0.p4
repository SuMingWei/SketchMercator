...
control SwitchIngress(
    ...
    T1_INIT_5(11, 221, 524288)
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ABOVE_THRESHOLD_CONSTANT_5(100) d_13_above_threshold;
        COMPUTE_HASH_221_32_32(32w0x30244f0b) d_13_hash_call;
        TCAM_LPM_HLLPCSA() d_13_tcam_lpm;
        GET_BITMASK() d_13_get_bitmask;
        COMPUTE_HASH_221_16_16(32w0x30244f0b) d_13_res_hash_call;
        T3_T5_KEY_UPDATE_221_16384(32w0x30243f0b) update_13_1;
        T3_KEY_UPDATE_221_16384(32w0x30243f0b) update_13_2;
        T3_KEY_UPDATE_221_16384(32w0x30243f0b) update_13_3;
        T3_KEY_UPDATE_221_16384(32w0x30243f0b) update_13_4;
        T3_KEY_UPDATE_221_16384(32w0x30243f0b) update_13_5;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_2_4.apply(DSTIP, 1, SIZE, ig_md.d_2_est_4);
            update_2_5.apply(DSTIP, 1, SIZE, ig_md.d_2_est_5);
        ...
        T2_RUN_1_KEY_2( 5, SRCIP, SRCPORT, 1)
        ...
        update_7_1.apply(ig_md.d_7_base_16_2048, ig_md.d_7_index1_16, ig_md.d_7_res_hash[0:0], SIZE, ig_md.d_7_est_1);
        d_7_index_hash_call_2.apply(DSTIP, DSTPORT, ig_md.d_7_index2_16);
        update_7_2.apply(ig_md.d_7_base_16_2048, ig_md.d_7_index2_16, ig_md.d_7_res_hash[1:1], SIZE, ig_md.d_7_est_2);
        d_7_index_hash_call_3.apply(DSTIP, DSTPORT, ig_md.d_7_index3_16);
        update_7_3.apply(ig_md.d_7_base_16_2048, ig_md.d_7_index3_16, ig_md.d_7_res_hash[2:2], SIZE, ig_md.d_7_est_3);
        ...
        T1_RUN_5_KEY_5(11, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO) if (ig_md.d_11_est1_1 == 0 || ig_md.d_11_est1_2 == 0 || ig_md.d_11_est1_3 == 0 || ig_md.d_11_est1_4 == 0 || ig_md.d_11_est1_5 == 0) { /* process_new_flow() */ }
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_13_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_13_res_hash[0:0], ig_md.d_13_bitmask, ig_md.d_13_est_1);
            update_13_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_13_res_hash[1:1], ig_md.d_13_est_2);
            update_13_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_13_res_hash[2:2], ig_md.d_13_est_3);
            update_13_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_13_res_hash[3:3], ig_md.d_13_est_4);
            update_13_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_13_res_hash[4:4], ig_md.d_13_est_5);
