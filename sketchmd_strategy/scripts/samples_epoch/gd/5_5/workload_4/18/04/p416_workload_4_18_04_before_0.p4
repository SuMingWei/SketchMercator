...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_4_KEY_2( 6, SRCIP, DSTIP, SIZE)
        ...
        T2_RUN_1_KEY_2(11, SRCIP, SRCPORT, SIZE)
        UM_RUN_5_KEY_2(12, DSTIP, DSTPORT, 1)
        T2_RUN_HH_4_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_HH_3_KEY_4(14, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        UM_RUN_3_KEY_4(15, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        ...
        T3_RUN_HH_4_KEY_5(17, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        UM_RUN_4_KEY_5(18, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
    }
}
