...
control SwitchIngress(
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_221_16_11(32w0x30244f0b) d_18_index_hash_call_5;
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_1_1.apply(SRCIP, 1, ig_md.d_1_res_hash[0:0], 1, ig_md.d_1_est_1);
            update_1_2.apply(SRCIP, 1, ig_md.d_1_res_hash[1:1], 1, ig_md.d_1_est_2);
            d_3_above_threshold.apply(ig_md.d_1_est_1, ig_md.d_1_est_2, ig_md.d_3_above_threshold);
        //
        ...
        T3_RUN_AFTER_3_KEY_2(13, DSTIP, DSTPORT, SIZE)
        // MRAC for inst 14
        ...
        update_18_5.apply(ig_md.d_18_base_16_2048, ig_md.d_18_index5_16, ig_md.d_18_res_hash[4:4], SIZE, ig_md.d_18_est_5);
