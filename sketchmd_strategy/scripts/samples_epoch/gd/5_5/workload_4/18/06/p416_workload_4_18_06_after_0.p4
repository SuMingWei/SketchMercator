...
control SwitchIngress(
    ...
    apply {
        ...
        update_11_1.apply(ig_md.d_11_base_16_2048, ig_md.d_11_index1_16, ig_md.d_11_res_hash[0:0], SIZE, ig_md.d_11_est_1);
        d_11_index_hash_call_2.apply(SRCIP, SRCPORT, ig_md.d_11_index2_16);
        update_11_2.apply(ig_md.d_11_base_16_2048, ig_md.d_11_index2_16, ig_md.d_11_res_hash[1:1], SIZE, ig_md.d_11_est_2);
        d_11_index_hash_call_3.apply(SRCIP, SRCPORT, ig_md.d_11_index3_16);
        update_11_3.apply(ig_md.d_11_base_16_2048, ig_md.d_11_index3_16, ig_md.d_11_res_hash[2:2], SIZE, ig_md.d_11_est_3);
        d_11_index_hash_call_4.apply(SRCIP, SRCPORT, ig_md.d_11_index4_16);
        update_11_4.apply(ig_md.d_11_base_16_2048, ig_md.d_11_index4_16, ig_md.d_11_res_hash[3:3], SIZE, ig_md.d_11_est_4);
        ...
        update_13_5.apply(ig_md.d_13_base_16_2048, ig_md.d_13_index5_16, ig_md.d_13_res_hash[4:4], 1, ig_md.d_13_est_5);
        ...
        // HLL for inst 16
            ...
            update_16_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_16_level);
        //
