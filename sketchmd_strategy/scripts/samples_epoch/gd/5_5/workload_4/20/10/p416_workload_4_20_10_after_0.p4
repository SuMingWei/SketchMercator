...
control SwitchIngress(
    ...
    // apply O2
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_18_1;
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_18_2;
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_4_1.apply(DSTIP, SIZE, ig_md.d_4_res_hash[0:0], SIZE, ig_md.d_4_est_1);
            update_4_2.apply(DSTIP, SIZE, ig_md.d_4_res_hash[1:1], SIZE, ig_md.d_4_est_2);
            update_4_3.apply(DSTIP, SIZE, ig_md.d_4_res_hash[2:2], SIZE, ig_md.d_4_est_3);
            d_5_above_threshold.apply(ig_md.d_4_est_1, ig_md.d_4_est_2, ig_md.d_4_est_3, ig_md.d_5_above_threshold);
        //
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_10_1.apply(SRCIP, SRCPORT, SIZE, ig_md.d_10_res_hash[0:0], SIZE, ig_md.d_10_est_1);
            update_10_2.apply(SRCIP, SRCPORT, SIZE, ig_md.d_10_res_hash[1:1], SIZE, ig_md.d_10_est_2);
            update_10_3.apply(SRCIP, SRCPORT, SIZE, ig_md.d_10_res_hash[2:2], SIZE, ig_md.d_10_est_3);
        ...
        T2_RUN_AFTER_5_KEY_2(14, DSTIP, DSTPORT, SIZE)
        // UnivMon for inst 15
