...
control SwitchIngress(
    ...
    apply {
        ...
        T3_RUN_HH_1_KEY_1( 7, DSTIP, SIZE)
        MRAC_RUN_1_KEY_1( 8, DSTIP)
        UM_RUN_5_KEY_1( 9, DSTIP, 1)
        ...
        UM_RUN_5_KEY_2(13, SRCIP, DSTIP, SIZE)
        T3_RUN_HH_2_KEY_2(14, SRCIP, SRCPORT, 1)
        UM_RUN_3_KEY_2(15, SRCIP, SRCPORT, SIZE)
        T2_RUN_HH_5_KEY_2(16, DSTIP, DSTPORT, SIZE)
        UM_RUN_4_KEY_4(17, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        ...
        T5_RUN_1_KEY_5(19, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        T2_RUN_4_KEY_5(20, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
    }
}
