...
INIT_HEAVY_FLOWKEY_STORAGE_CONFIG_220(65536, 16, 22528)
...
control SwitchIngress(
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_9_index_hash_call_5;
        T3_INDEX_UPDATE_32768() update_9_5;
    // 

    T1_INIT_1(10, 200, 262144)
    T2_INIT_HH_2(11, 200, 16384)
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_200_16_11(32w0x30244f0b) d_13_index_hash_call_5;
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_20_4;
    //
    ...
    apply {
        ...
        T3_RUN_AFTER_1_KEY_1( 7, DSTIP, SIZE)
        ...
        T2_RUN_AFTER_2_KEY_2(11, SRCIP, DSTIP, SIZE)
        ...
        update_13_1.apply(ig_md.d_13_base_16_2048, ig_md.d_13_index1_16, ig_md.d_13_res_hash[0:0], SIZE, ig_md.d_13_est_1);
        d_13_index_hash_call_2.apply(SRCIP, DSTIP, ig_md.d_13_index2_16);
        update_13_2.apply(ig_md.d_13_base_16_2048, ig_md.d_13_index2_16, ig_md.d_13_res_hash[1:1], SIZE, ig_md.d_13_est_2);
        d_13_index_hash_call_3.apply(SRCIP, DSTIP, ig_md.d_13_index3_16);
        update_13_3.apply(ig_md.d_13_base_16_2048, ig_md.d_13_index3_16, ig_md.d_13_res_hash[2:2], SIZE, ig_md.d_13_est_3);
        d_13_index_hash_call_4.apply(SRCIP, DSTIP, ig_md.d_13_index4_16);
        update_13_4.apply(ig_md.d_13_base_16_2048, ig_md.d_13_index4_16, ig_md.d_13_res_hash[3:3], SIZE, ig_md.d_13_est_4);
        d_13_index_hash_call_5.apply(SRCIP, DSTIP, ig_md.d_13_index5_16);
        update_13_5.apply(ig_md.d_13_base_16_2048, ig_md.d_13_index5_16, ig_md.d_13_res_hash[4:4], SIZE, ig_md.d_13_est_5);
        RUN_HEAVY_FLOWKEY_NOIF_5(13)
        // 

        T3_RUN_AFTER_2_KEY_2(14, SRCIP, SRCPORT, 1)
        // UnivMon for inst 15
