...
control SwitchIngress(
    ...
    T2_INIT_2(16, 220, 16384)
    UM_INIT_4(17, 220, 11, 32768)
    T1_INIT_4(18, 221, 262144)
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_2_2.apply(DSTIP, 1, ig_md.d_2_est_2);
            update_2_3.apply(DSTIP, 1, ig_md.d_2_est_3);
        //
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_8_1.apply(SRCIP, SRCPORT, SIZE, ig_md.d_8_bitmask, ig_md.d_8_est_1);
        ...
        // MRB for inst 11
            ...
            update_11_1.apply(ig_md.d_11_base_32, ig_md.d_11_index1_16);
        //

        T2_RUN_AFTER_1_KEY_2(13, DSTIP, DSTPORT, SIZE)
        T2_RUN_AFTER_2_KEY_2(12, DSTIP, DSTPORT, 1)
        // MRAC for inst 14
            d_14_tcam_lpm.apply(ig_md.d_11_sampling_hash_16, ig_md.d_14_base_16);
