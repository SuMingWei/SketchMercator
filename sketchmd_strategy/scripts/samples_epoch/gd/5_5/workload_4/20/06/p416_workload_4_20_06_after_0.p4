...
control SwitchIngress(
    ...
    T1_INIT_2( 6, 200, 262144)
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ABOVE_THRESHOLD_CONSTANT_4(100) d_8_above_threshold;
        COMPUTE_HASH_200_16_16(32w0x30244f0b) d_8_res_hash_call;
        T3_T2_KEY_UPDATE_200_16384(32w0x30243f0b) update_8_1;
        T3_T2_KEY_UPDATE_200_16384(32w0x30243f0b) update_8_2;
        T3_T2_KEY_UPDATE_200_16384(32w0x30243f0b) update_8_3;
        T3_KEY_UPDATE_200_16384(32w0x30243f0b) update_8_4;
    //
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_18_3;
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_18_4;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_8_1.apply(SRCIP, DSTIP, SIZE, ig_md.d_8_res_hash[0:0], 1, ig_md.d_8_est_1);
            update_8_2.apply(SRCIP, DSTIP, SIZE, ig_md.d_8_res_hash[1:1], 1, ig_md.d_8_est_2);
            update_8_3.apply(SRCIP, DSTIP, SIZE, ig_md.d_8_res_hash[2:2], 1, ig_md.d_8_est_3);
            update_8_4.apply(SRCIP, DSTIP, SIZE, ig_md.d_8_res_hash[3:3], ig_md.d_8_est_4);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_18_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, SIZE, ig_md.d_18_est_3);
            update_18_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, SIZE, ig_md.d_18_est_4);
