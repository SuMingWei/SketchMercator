...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T2_KEY_UPDATE_100_8192(32w0x30243f0b) update_1_2;
    ...
    T2_INIT_3( 3, 200, 16384)
    T2_INIT_HH_3( 4, 110, 16384)
    T2_INIT_HH_4( 6, 220, 8192)
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_221_16_11(32w0x30244f0b) d_8_index_hash_call_5;
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_1_1.apply(DSTIP, SIZE, ig_md.d_1_res_hash[0:0], SIZE, ig_md.d_1_est_1);
            update_1_2.apply(DSTIP, SIZE, ig_md.d_1_res_hash[1:1], SIZE, ig_md.d_1_est_2);
            ...
            update_1_5.apply(DSTIP, SIZE, ig_md.d_1_est_5);
        //

        T2_RUN_3_KEY_2( 3, SRCIP, DSTIP, SIZE)
