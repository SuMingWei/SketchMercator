...
control SwitchIngress(
    ...
    T2_INIT_4( 4, 200, 4096)
    UM_INIT_4( 5, 110, 11, 32768)
    T3_INIT_HH_3( 6, 220, 8192)
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T5_KEY_UPDATE_221_8192(32w0x30243f0b) update_8_1;
        T3_KEY_UPDATE_221_4096(32w0x30243f0b) update_8_2;
        T3_KEY_UPDATE_221_4096(32w0x30243f0b) update_8_3;
        T3_KEY_UPDATE_221_4096(32w0x30243f0b) update_8_4;
        T3_KEY_UPDATE_221_4096(32w0x30243f0b) update_8_5;
    //
    ...
    apply {
        ...
        T3_RUN_AFTER_3_KEY_4( 6, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_8_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_8_res_hash[0:0], ig_md.d_8_bitmask, ig_md.d_8_est_1);
            update_8_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_8_res_hash[1:1], ig_md.d_8_est_2);
            update_8_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_8_res_hash[2:2], ig_md.d_8_est_3);
            update_8_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_8_res_hash[3:3], ig_md.d_8_est_4);
            update_8_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_8_res_hash[4:4], ig_md.d_8_est_5);
