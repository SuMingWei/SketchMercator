...
control SwitchIngress(
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_6_index_hash_call_5;
    ...
    T2_INIT_HH_3(12, 220, 16384)
    MRAC_INIT_1(13, 220, 32768, 11, 16)
    T1_INIT_2(14, 221, 262144)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_15_4;
    //
    ...
    apply {
        ...
        T2_RUN_AFTER_5_KEY_1( 4, DSTIP, SIZE)
        ...
        update_6_1.apply(ig_md.d_6_base_16_2048, ig_md.d_6_index1_16, ig_md.d_6_res_hash[0:0], SIZE, ig_md.d_6_est_1);
        d_6_index_hash_call_2.apply(DSTIP, ig_md.d_6_index2_16);
        update_6_2.apply(ig_md.d_6_base_16_2048, ig_md.d_6_index2_16, ig_md.d_6_res_hash[1:1], SIZE, ig_md.d_6_est_2);
        d_6_index_hash_call_3.apply(DSTIP, ig_md.d_6_index3_16);
        update_6_3.apply(ig_md.d_6_base_16_2048, ig_md.d_6_index3_16, ig_md.d_6_res_hash[2:2], SIZE, ig_md.d_6_est_3);
        d_6_index_hash_call_4.apply(DSTIP, ig_md.d_6_index4_16);
        update_6_4.apply(ig_md.d_6_base_16_2048, ig_md.d_6_index4_16, ig_md.d_6_res_hash[3:3], SIZE, ig_md.d_6_est_4);
        d_6_index_hash_call_5.apply(DSTIP, ig_md.d_6_index5_16);
        update_6_5.apply(ig_md.d_6_base_16_2048, ig_md.d_6_index5_16, ig_md.d_6_res_hash[4:4], SIZE, ig_md.d_6_est_5);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_15_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, 1, ig_md.d_15_est_4);
            d_16_above_threshold.apply(ig_md.d_15_est_1, ig_md.d_15_est_2, ig_md.d_15_est_3, ig_md.d_15_est_4, ig_md.d_16_above_threshold);
        //
