...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_T2_KEY_UPDATE_110_16384(32w0x30243f0b) update_8_5;
    //

    MRAC_INIT_1(10, 110, 32768, 11, 16)
    T1_INIT_2(11, 220, 262144)
    T2_INIT_HH_1(13, 220, 16384)
    T3_INIT_HH_5(12, 220, 4096)

    // apply O2
        T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_14_1;
        T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_14_2;
    ...
    apply {
        ...
        update_2_1.apply(ig_md.d_2_base_16_2048, ig_md.d_2_index1_16, ig_md.d_2_res_hash[0:0], 1, ig_md.d_2_est_1);
        d_2_index_hash_call_2.apply(SRCIP, ig_md.d_2_index2_16);
        update_2_2.apply(ig_md.d_2_base_16_2048, ig_md.d_2_index2_16, ig_md.d_2_res_hash[1:1], 1, ig_md.d_2_est_2);
        d_2_index_hash_call_3.apply(SRCIP, ig_md.d_2_index3_16);
        update_2_3.apply(ig_md.d_2_base_16_2048, ig_md.d_2_index3_16, ig_md.d_2_res_hash[2:2], 1, ig_md.d_2_est_3);
        d_2_index_hash_call_4.apply(SRCIP, ig_md.d_2_index4_16);
        update_2_4.apply(ig_md.d_2_base_16_2048, ig_md.d_2_index4_16, ig_md.d_2_res_hash[3:3], 1, ig_md.d_2_est_4);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_8_1.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_8_est_1);
            update_8_2.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_8_est_2);
            update_8_3.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_8_est_3);
            update_8_4.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_8_est_4);
            update_8_5.apply(DSTIP, DSTPORT, SIZE, 1, ig_md.d_8_est_5);
        ...
        T3_RUN_AFTER_5_KEY_4(12, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)

        // apply O2
        T2_RUN_AFTER_3_KEY_5(14, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        // 

        T3_RUN_AFTER_5_KEY_5(15, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        if(
