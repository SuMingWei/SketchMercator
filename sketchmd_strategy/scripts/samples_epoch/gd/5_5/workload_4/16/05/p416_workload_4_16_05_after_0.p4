...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_220_4096(32w0x30243f0b) update_11_1;
    ...
    apply {
        ...
        T3_RUN_AFTER_2_KEY_2( 6, SRCIP, SRCPORT, 1)
        // UnivMon for inst 7
            ...
            d_7_index_hash_call_5.apply(SRCIP, SRCPORT, ig_md.d_7_index5_16); 
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_11_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, 1, ig_md.d_11_est_2);
        ...
        T3_RUN_AFTER_5_KEY_5(14, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        // UnivMon for inst 16
