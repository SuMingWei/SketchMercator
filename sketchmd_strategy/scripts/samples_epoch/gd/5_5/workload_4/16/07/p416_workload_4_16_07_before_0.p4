...
control SwitchIngress(
    ...
    T2_INIT_2( 3, 200, 16384)
    T2_INIT_HH_2( 4, 200, 16384)
    T2_INIT_3( 5, 110, 16384)
    ...
    apply {
        ...
        T2_RUN_2_KEY_2( 3, SRCIP, DSTIP, 1)
        T2_RUN_HH_2_KEY_2( 4, SRCIP, DSTIP, 1)
        T2_RUN_3_KEY_2( 5, SRCIP, SRCPORT, SIZE)
        T2_RUN_HH_1_KEY_2( 6, SRCIP, SRCPORT, 1)
        MRAC_RUN_1_KEY_2( 7, SRCIP, SRCPORT)
        MRAC_RUN_1_KEY_2( 8, DSTIP, DSTPORT)
        UM_RUN_5_KEY_2( 9, DSTIP, DSTPORT, 1)
        UM_RUN_4_KEY_2(10, DSTIP, DSTPORT, SIZE)
