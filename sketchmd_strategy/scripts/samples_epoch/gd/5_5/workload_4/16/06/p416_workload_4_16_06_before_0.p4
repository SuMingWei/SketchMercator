...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_1_KEY_1( 3, DSTIP, 1)
        T2_RUN_HH_2_KEY_1( 4, DSTIP, SIZE)
        T2_RUN_HH_2_KEY_2( 5, SRCIP, DSTIP, 1)
        T3_RUN_HH_3_KEY_2( 6, SRCIP, SRCPORT, SIZE)
        UM_RUN_3_KEY_2( 7, SRCIP, SRCPORT, 1)
        ...
        T2_RUN_HH_3_KEY_5(14, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
