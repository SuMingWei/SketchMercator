...
control SwitchIngress(
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_221_16_11(32w0x30244f0b) d_16_index_hash_call_4;
        T3_INDEX_UPDATE_32768() update_16_4;
        COMPUTE_HASH_221_16_11(32w0x30244f0b) d_16_index_hash_call_5;
    ...
    apply {
        ...
        T3_RUN_AFTER_1_KEY_2( 6, SRCIP, DSTIP, 1)
        ...
        T2_RUN_4_KEY_4(14, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        ...
        update_16_4.apply(ig_md.d_16_base_16_2048, ig_md.d_16_index4_16, ig_md.d_16_res_hash[3:3], 1, ig_md.d_16_est_4);
        d_16_index_hash_call_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_16_index5_16);
        update_16_5.apply(ig_md.d_16_base_16_2048, ig_md.d_16_index5_16, ig_md.d_16_res_hash[4:4], 1, ig_md.d_16_est_5);
