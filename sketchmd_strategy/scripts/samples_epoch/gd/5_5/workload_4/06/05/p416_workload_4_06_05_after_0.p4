...
control SwitchIngress(
    ...
    apply {
        ...
        // HLL for inst 3
            ...
            update_3_1.apply(SRCIP, DSTIP, ig_md.d_3_level);
        //

        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_4_1.apply(SRCIP, DSTIP, SIZE, 1, ig_md.d_4_est_1);
            update_4_2.apply(SRCIP, DSTIP, SIZE, 1, ig_md.d_4_est_2);
