...
control SwitchIngress(
    ...
    apply {
        ...
        T3_RUN_AFTER_3_KEY_4( 9, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_AFTER_4_KEY_4(12, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_AFTER_1_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_AFTER_2_KEY_4(16, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T3_RUN_AFTER_3_KEY_4(10, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T3_RUN_AFTER_5_KEY_4(11, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        // MRAC for inst 17
