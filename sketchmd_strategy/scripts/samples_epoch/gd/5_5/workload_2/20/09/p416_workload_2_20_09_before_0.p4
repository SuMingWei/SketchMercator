...
control SwitchIngress(
    ...
    apply {
        ...
        T3_RUN_HH_1_KEY_4(12, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T3_RUN_HH_4_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T3_RUN_HH_3_KEY_4(14, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_HH_5_KEY_4(15, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        ...
        UM_RUN_5_KEY_4(20, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
    }
}
