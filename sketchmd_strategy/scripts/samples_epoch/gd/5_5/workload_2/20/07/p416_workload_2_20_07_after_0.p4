...
INIT_HEAVY_FLOWKEY_STORAGE_CONFIG_110(65536, 16, 20480)
...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T5_KEY_UPDATE_110_16384(32w0x30243f0b) update_8_1;
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_110_16_11(32w0x30244f0b) d_19_index_hash_call_2;
        T3_INDEX_UPDATE_32768() update_19_2;
        COMPUTE_HASH_110_16_11(32w0x30244f0b) d_19_index_hash_call_3;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_8_tcam_lpm.apply(ig_md.d_3_sampling_hash_32, ig_md.d_8_level);
            d_8_get_bitmask.apply(ig_md.d_8_level, ig_md.d_8_bitmask);
            d_8_res_hash_call.apply(DSTIP, DSTPORT, ig_md.d_8_res_hash);
            update_8_1.apply(DSTIP, DSTPORT, 1, ig_md.d_8_res_hash[0:0], ig_md.d_8_bitmask, ig_md.d_8_est_1);
            update_8_2.apply(DSTIP, DSTPORT, 1, ig_md.d_8_res_hash[1:1], SIZE, ig_md.d_8_est_2);
            update_8_3.apply(DSTIP, DSTPORT, 1, ig_md.d_8_res_hash[2:2], SIZE, ig_md.d_8_est_3);
            update_8_4.apply(DSTIP, DSTPORT, 1, ig_md.d_8_res_hash[3:3], ig_md.d_8_est_4);
        ...
        T2_RUN_AFTER_4_KEY_2(13, DSTIP, DSTPORT, 1)

        // apply O2
        T2_RUN_AFTER_1_KEY_2(5, DSTIP, DSTPORT, 1)
        // 

        T3_RUN_AFTER_2_KEY_2( 9, DSTIP, DSTPORT, 1)
        T2_RUN_AFTER_2_KEY_2(14, DSTIP, DSTPORT, SIZE)
        ...
        update_19_1.apply(ig_md.d_19_base_16_2048, ig_md.d_19_index1_16, ig_md.d_19_res_hash[0:0], 1, ig_md.d_19_est_1);
        d_19_index_hash_call_2.apply(DSTIP, DSTPORT, ig_md.d_19_index2_16);
        update_19_2.apply(ig_md.d_19_base_16_2048, ig_md.d_19_index2_16, ig_md.d_19_res_hash[1:1], 1, ig_md.d_19_est_2);
        d_19_index_hash_call_3.apply(DSTIP, DSTPORT, ig_md.d_19_index3_16);
        update_19_3.apply(ig_md.d_19_base_16_2048, ig_md.d_19_index3_16, ig_md.d_19_res_hash[2:2], 1, ig_md.d_19_est_3);
