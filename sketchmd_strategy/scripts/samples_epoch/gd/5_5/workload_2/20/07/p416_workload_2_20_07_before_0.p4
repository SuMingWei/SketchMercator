...
control SwitchIngress(
    ...
    apply {
        ...
        T5_RUN_1_KEY_2( 3, DSTIP, DSTPORT)
        T5_RUN_1_KEY_2( 4, DSTIP, DSTPORT)
        ...
        T3_RUN_HH_3_KEY_2(10, DSTIP, DSTPORT, SIZE)
        ...
        UM_RUN_4_KEY_2(20, DSTIP, DSTPORT, SIZE)
    }
}
