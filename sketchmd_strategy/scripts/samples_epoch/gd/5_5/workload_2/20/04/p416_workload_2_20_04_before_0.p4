...
control SwitchIngress(
    ...
    apply {
        ...
        T3_RUN_HH_5_KEY_2(10, SRCIP, DSTIP, 1)
        T3_RUN_HH_1_KEY_2(11, SRCIP, DSTIP, SIZE)
        T2_RUN_HH_4_KEY_2(12, SRCIP, DSTIP, 1)
        T2_RUN_HH_2_KEY_2(13, SRCIP, DSTIP, 1)
        T2_RUN_HH_1_KEY_2(14, SRCIP, DSTIP, SIZE)
