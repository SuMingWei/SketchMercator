...
control SwitchIngress(
    ...
    T2_INIT_5( 3, 100, 8192)
    T2_INIT_1( 4, 100, 16384)
    T2_INIT_1( 5, 100, 8192)
    T3_INIT_HH_2( 7, 100, 4096)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        COMPUTE_HASH_100_16_16(32w0x30244f0b) d_6_res_hash_call;
        ABOVE_THRESHOLD_CONSTANT_4(100) d_8_above_threshold;
        T3_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_6_1;
        T3_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_6_2;
        T3_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_6_3;
        T3_T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_6_4;
        T2_KEY_UPDATE_100_4096(32w0x30243f0b) update_6_5;
    //

    MRAC_INIT_1( 9, 100, 16384, 11,  8)
    ...
    // apply SALUMerge; big - UnivMon / small - many MRACs 
        ...
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_12_index_hash_call_3;
        T3_INDEX_UPDATE_32768() update_12_3;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_12_index_hash_call_4;
        T3_INDEX_UPDATE_32768() update_12_4;
    // 

    UM_INIT_3(11, 100, 11, 32768)
    ...
    apply {
        ...
        T2_RUN_1_KEY_1( 4, SRCIP, 1)
        T2_RUN_1_KEY_1( 5, SRCIP, SIZE)
        T3_RUN_AFTER_2_KEY_1( 7, SRCIP, 1)
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            d_6_res_hash_call.apply(SRCIP, ig_md.d_6_res_hash);
            update_6_1.apply(SRCIP, SIZE, ig_md.d_6_res_hash[0:0], SIZE, ig_md.d_6_est_1);
            update_6_2.apply(SRCIP, SIZE, ig_md.d_6_res_hash[1:1], SIZE, ig_md.d_6_est_2);
            update_6_3.apply(SRCIP, SIZE, ig_md.d_6_res_hash[2:2], SIZE, ig_md.d_6_est_3);
            update_6_4.apply(SRCIP, SIZE, ig_md.d_6_res_hash[3:3], SIZE, ig_md.d_6_est_4);
            d_8_above_threshold.apply(ig_md.d_6_est_1, ig_md.d_6_est_2, ig_md.d_6_est_3, ig_md.d_6_est_4, ig_md.d_8_above_threshold);
            update_6_5.apply(SRCIP, SIZE, ig_md.d_6_est_5);
        //
        ...
        // UnivMon for inst 11
            ...
            d_11_index_hash_call_3.apply(SRCIP, ig_md.d_11_index3_16); 
