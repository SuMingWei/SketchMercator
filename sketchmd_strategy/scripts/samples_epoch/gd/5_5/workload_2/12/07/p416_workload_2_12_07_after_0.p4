...
INIT_HEAVY_FLOWKEY_STORAGE_CONFIG_110(32768, 15, 12288)
...
control SwitchIngress(
    ...
    apply {
        ...
        T1_RUN_1_KEY_2( 2, SRCIP, SRCPORT)
        T2_RUN_2_KEY_2( 3, SRCIP, SRCPORT, 1)
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            update_4_1.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_4_est_1);
            update_4_2.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_4_est_2);
            update_4_3.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_4_est_3);
            update_4_4.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_4_est_4);
            update_4_5.apply(SRCIP, SRCPORT, 1, SIZE, ig_md.d_4_est_5);
            d_6_above_threshold.apply(ig_md.d_4_est_1, ig_md.d_4_est_2, ig_md.d_4_est_3, ig_md.d_4_est_4, ig_md.d_4_est_5, ig_md.d_6_above_threshold);
        //
