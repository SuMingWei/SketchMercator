...
control SwitchIngress(
    ...
    apply {
        ...
        // apply O2
        T2_RUN_AFTER_2_KEY_2(5, SRCIP, DSTIP, SIZE)
        // 
        ...
        update_12_4.apply(ig_md.d_12_base_16_2048, ig_md.d_12_index4_16, ig_md.d_12_res_hash[3:3], 1, ig_md.d_12_est_4);
        d_12_index_hash_call_5.apply(SRCIP, DSTIP, ig_md.d_12_index5_16);
        update_12_5.apply(ig_md.d_12_base_16_2048, ig_md.d_12_index5_16, ig_md.d_12_res_hash[4:4], 1, ig_md.d_12_est_5);
        RUN_HEAVY_FLOWKEY_NOIF_5(12)
        // 

        // MRAC for inst 11
            d_11_tcam_lpm.apply(ig_md.d_3_sampling_hash_16, ig_md.d_11_base_16);
