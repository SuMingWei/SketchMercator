...
control SwitchIngress(
    ...
    // apply O2
        T1_KEY_UPDATE_200_131072(32w0x30243f0b) update_3_1;
        ...
        T1_KEY_UPDATE_200_131072(32w0x30243f0b) update_3_5;
    // 

    T1_INIT_5( 4, 200, 524288)
    T3_INIT_HH_3( 9, 200, 8192)
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T2_KEY_UPDATE_200_16384(32w0x30243f0b) update_7_5;
    //

    T2_INIT_HH_5(10, 200, 8192)
    MRAC_INIT_1(12, 200, 32768, 11, 16)
    ...
    apply {
        ...
        T3_RUN_AFTER_3_KEY_2( 9, SRCIP, DSTIP, 1)
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_7_5.apply(SRCIP, DSTIP, 1, SIZE, ig_md.d_7_est_5);
