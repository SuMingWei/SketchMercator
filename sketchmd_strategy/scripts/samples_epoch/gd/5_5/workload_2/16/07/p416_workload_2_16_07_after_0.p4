...
control SwitchIngress(
    ...
    // apply O2
        ...
        T1_KEY_UPDATE_100_524288(32w0x30243f0b) update_2_2;
    // 
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T2_T5_KEY_UPDATE_100_8192(32w0x30243f0b) update_10_1;
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_KEY_UPDATE_100_8192(32w0x30243f0b) update_9_3;
        T3_KEY_UPDATE_100_8192(32w0x30243f0b) update_9_4;
    //
    ...
    T2_INIT_HH_4(12, 100, 16384)
    T2_INIT_HH_5(13, 100, 16384)

    // apply SALUMerge; big - UnivMon / small - many MRACs 
        UM_INIT_SETUP(16, 100)
        ABOVE_THRESHOLD_3() d_16_above_threshold;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_16_index_hash_call_1;
        T3_T2_INDEX_UPDATE_32768() update_16_1;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_16_index_hash_call_2;
        T3_INDEX_UPDATE_32768() update_16_2;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_16_index_hash_call_3;
    ...
    apply {
        // O1 hash run
            ...
            d_6_auto_sampling_hash_call.apply(SRCIP, ig_md.d_6_sampling_hash_32);
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_10_tcam_lpm.apply(ig_md.d_6_sampling_hash_32, ig_md.d_10_level);
            d_10_get_bitmask.apply(ig_md.d_10_level, ig_md.d_10_bitmask);
            update_10_1.apply(SRCIP, 1, ig_md.d_10_bitmask, ig_md.d_10_est_1);
            update_10_2.apply(SRCIP, 1, ig_md.d_10_est_2);
            update_10_3.apply(SRCIP, 1, ig_md.d_10_est_3);
            update_10_4.apply(SRCIP, 1, ig_md.d_10_est_4);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_4(10)
        //

        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            d_9_res_hash_call.apply(SRCIP, ig_md.d_9_res_hash);
            update_9_1.apply(SRCIP, 1, ig_md.d_9_res_hash[0:0], SIZE, ig_md.d_9_est_1);
            update_9_2.apply(SRCIP, 1, ig_md.d_9_res_hash[1:1], SIZE, ig_md.d_9_est_2);
            update_9_3.apply(SRCIP, 1, ig_md.d_9_res_hash[2:2], ig_md.d_9_est_3);
            update_9_4.apply(SRCIP, 1, ig_md.d_9_res_hash[3:3], ig_md.d_9_est_4);
        ...
        T2_RUN_AFTER_4_KEY_1(12, SRCIP, SIZE)
        T2_RUN_AFTER_5_KEY_1(13, SRCIP, SIZE)
