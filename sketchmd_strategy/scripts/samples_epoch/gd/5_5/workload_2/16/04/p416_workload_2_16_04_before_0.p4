...
control SwitchIngress(
    ...
    apply {
        ...
        T3_RUN_HH_5_KEY_4( 7, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        ...
        UM_RUN_4_KEY_4(15, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        UM_RUN_4_KEY_4(16, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
    }
}
