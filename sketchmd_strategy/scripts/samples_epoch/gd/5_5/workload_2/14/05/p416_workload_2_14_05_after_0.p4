...
control SwitchIngress(
    ...
    T2_INIT_HH_3(10, 100, 4096)
    T3_INIT_HH_5( 7, 100, 16384)
    MRAC_INIT_1(11, 100, 16384, 11,  8)
    UM_INIT_4(12, 100, 11, 32768)
    UM_INIT_4(13, 100, 11, 32768)
    ...
    apply {
        ...
        T1_RUN_1_KEY_1( 3, SRCIP) if (ig_md.d_3_est1_1 == 0) { /* process_new_flow() */ }
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            d_4_res_hash_call.apply(SRCIP, ig_md.d_4_res_hash);
            update_4_1.apply(SRCIP, 1, ig_md.d_4_res_hash[0:0], 1, ig_md.d_4_est_1);
            update_4_2.apply(SRCIP, 1, ig_md.d_4_res_hash[1:1], 1, ig_md.d_4_est_2);
            update_4_3.apply(SRCIP, 1, ig_md.d_4_res_hash[2:2], 1, ig_md.d_4_est_3);
            d_6_above_threshold.apply(ig_md.d_4_est_1, ig_md.d_4_est_2, ig_md.d_4_est_3, ig_md.d_6_above_threshold);
        //

        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            d_5_res_hash_call.apply(SRCIP, ig_md.d_5_res_hash);
            update_5_1.apply(SRCIP, 1, ig_md.d_5_res_hash[0:0], SIZE, ig_md.d_5_est_1);
            d_8_above_threshold.apply(ig_md.d_5_est_1, ig_md.d_8_above_threshold);
            update_5_2.apply(SRCIP, SIZE, ig_md.d_5_res_hash[1:1], SIZE, ig_md.d_5_est_2);
            update_5_3.apply(SRCIP, SIZE, ig_md.d_5_res_hash[2:2], SIZE, ig_md.d_5_est_3);
            d_9_above_threshold.apply(ig_md.d_5_est_2, ig_md.d_5_est_3, ig_md.d_9_above_threshold);
            update_5_4.apply(SRCIP, SIZE, ig_md.d_5_est_4);
            update_5_5.apply(SRCIP, SIZE, ig_md.d_5_est_5);
        //

        T2_RUN_AFTER_3_KEY_1(10, SRCIP, 1)
        T3_RUN_AFTER_5_KEY_1( 7, SRCIP, 1)
        // MRAC for inst 11
        ...
        // UnivMon for inst 13
            ...
            d_13_index_hash_call_4.apply(SRCIP, ig_md.d_13_index4_16); 
