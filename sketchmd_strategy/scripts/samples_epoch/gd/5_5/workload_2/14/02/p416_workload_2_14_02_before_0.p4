...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_5_KEY_2( 3, DSTIP, DSTPORT, 1)
        T2_RUN_HH_1_KEY_2( 4, DSTIP, DSTPORT, SIZE)
        T3_RUN_HH_1_KEY_2( 5, DSTIP, DSTPORT, SIZE)
        T2_RUN_HH_2_KEY_2( 6, DSTIP, DSTPORT, 1)
        ...
        UM_RUN_4_KEY_2(12, DSTIP, DSTPORT, 1)
        UM_RUN_3_KEY_2(13, DSTIP, DSTPORT, 1)
        UM_RUN_3_KEY_2(14, DSTIP, DSTPORT, SIZE)
    }
}
