...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_HH_2_KEY_4( 6, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T2_RUN_HH_4_KEY_4( 7, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_HH_4_KEY_4( 8, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        ...
        UM_RUN_5_KEY_4(14, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
    }
}
