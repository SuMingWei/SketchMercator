...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        T3_T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_6_1;
        T3_KEY_UPDATE_221_4096(32w0x30243f0b) update_6_2;
        T3_KEY_UPDATE_221_4096(32w0x30243f0b) update_6_3;
        T3_KEY_UPDATE_221_4096(32w0x30243f0b) update_6_4;
        T3_KEY_UPDATE_221_4096(32w0x30243f0b) update_6_5;
    //
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_6_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_6_res_hash[0:0], 1, ig_md.d_6_est_1);
            update_6_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_6_res_hash[1:1], ig_md.d_6_est_2);
            update_6_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_6_res_hash[2:2], ig_md.d_6_est_3);
            update_6_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_6_res_hash[3:3], ig_md.d_6_est_4);
            update_6_5.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_6_res_hash[4:4], ig_md.d_6_est_5);
            RUN_HEAVY_FLOWKEY_CONSTANT_NOIF_5(6)
        //


        // apply O2
        T2_RUN_AFTER_2_KEY_5(5, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        // 

        T3_RUN_AFTER_2_KEY_5( 7, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
