...
control SwitchIngress(
    ...
    T2_INIT_HH_4( 7, 220, 8192)
    T3_INIT_HH_3( 8, 220, 4096)
    T2_INIT_HH_3( 9, 220, 4096)
    T2_INIT_HH_4(10, 220, 8192)
    MRAC_INIT_1(11, 220, 32768, 11, 16)
    UM_INIT_3(12, 220, 11, 32768)
    ...
    apply {
        ...
        T2_RUN_HH_1_KEY_4( 6, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_HH_4_KEY_4( 7, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T3_RUN_HH_3_KEY_4( 8, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        ...
        UM_RUN_3_KEY_4(12, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        UM_RUN_3_KEY_4(13, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        UM_RUN_4_KEY_4(14, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
    }
}
