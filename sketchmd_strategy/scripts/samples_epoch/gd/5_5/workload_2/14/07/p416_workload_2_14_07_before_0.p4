...
control SwitchIngress(
    ...
    T2_INIT_4( 4, 220, 16384)
    T2_INIT_4( 5, 220, 16384)
    T2_INIT_5( 6, 220, 4096)
    T2_INIT_2( 7, 220, 16384)
    T2_INIT_HH_3( 8, 220, 16384)
    T3_INIT_HH_5( 9, 220, 4096)
    ...
    apply {
        ...
        T2_RUN_2_KEY_4( 7, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        T2_RUN_HH_3_KEY_4( 8, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
        T3_RUN_HH_5_KEY_4( 9, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE)
        ...
        UM_RUN_3_KEY_4(14, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
    }
}
