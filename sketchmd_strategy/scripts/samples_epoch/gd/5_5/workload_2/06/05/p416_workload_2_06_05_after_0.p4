...
control SwitchIngress(
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_2_1.apply(SRCIP, SIZE, ig_md.d_2_res_hash[0:0], 1, ig_md.d_2_est_1);
            update_2_2.apply(SRCIP, SIZE, ig_md.d_2_res_hash[1:1], 1, ig_md.d_2_est_2);
            update_2_3.apply(SRCIP, SIZE, ig_md.d_2_res_hash[2:2], 1, ig_md.d_2_est_3);
            update_2_4.apply(SRCIP, SIZE, ig_md.d_2_res_hash[3:3], 1, ig_md.d_2_est_4);
            update_2_5.apply(SRCIP, SIZE, ig_md.d_2_res_hash[4:4], 1, ig_md.d_2_est_5);
            d_5_above_threshold.apply(ig_md.d_2_est_1, ig_md.d_2_est_2, ig_md.d_2_est_3, ig_md.d_2_est_4, ig_md.d_2_est_5, ig_md.d_5_above_threshold);
        //
