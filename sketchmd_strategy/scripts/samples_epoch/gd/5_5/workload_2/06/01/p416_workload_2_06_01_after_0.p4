...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        COMPUTE_HASH_221_32_32(32w0x30244f0b) d_4_hash_call;
        TCAM_LPM_HLLPCSA() d_4_tcam_lpm;
        GET_BITMASK() d_4_get_bitmask;
        T2_T5_KEY_UPDATE_221_16384(32w0x30243f0b) update_4_1;
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_4_2;
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_4_3;
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_4_4;
    //

    T5_INIT_1( 3, 221, 8192)
    MRAC_INIT_1( 5, 221, 16384, 11,  8)
    UM_INIT_4( 6, 221, 11, 32768)
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_4_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_4_bitmask, ig_md.d_4_est_1);
            update_4_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_4_est_2);
            update_4_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_4_est_3);
            update_4_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_4_est_4);
        ...
        // PCSA for inst 3
            ...
            update_3_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_3_bitmask);
        //
        ...
        // UnivMon for inst 6
            ...
            d_6_index_hash_call_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_6_index3_16); 
            d_6_index_hash_call_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, ig_md.d_6_index4_16); 
