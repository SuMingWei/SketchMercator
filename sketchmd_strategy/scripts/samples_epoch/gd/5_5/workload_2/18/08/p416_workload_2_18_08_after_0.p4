...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T3_T2_KEY_UPDATE_100_8192(32w0x30243f0b) update_6_5;
    //
    ...
    apply {
        ...
        T2_RUN_AFTER_2_KEY_1( 8, SRCIP, 1)
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_6_5.apply(SRCIP, SIZE, ig_md.d_6_res_hash[4:4], SIZE, ig_md.d_6_est_5);
            d_10_above_threshold.apply(ig_md.d_6_est_1, ig_md.d_6_est_2, ig_md.d_6_est_3, ig_md.d_6_est_4, ig_md.d_6_est_5, ig_md.d_10_above_threshold);
        //
        ...
        T2_RUN_AFTER_3_KEY_1( 9, SRCIP, 1)
        ...
        // MRAC for inst 15
            d_15_tcam_lpm.apply(ig_md.d_14_sampling_hash_16, ig_md.d_15_base_16);
