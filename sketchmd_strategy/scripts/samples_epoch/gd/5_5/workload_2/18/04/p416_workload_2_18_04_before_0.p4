...
control SwitchIngress(
    ...
    T2_INIT_4(10, 200, 4096)
    T2_INIT_5(11, 200, 8192)
    T2_INIT_1(12, 200, 8192)
    T2_INIT_HH_1(13, 200, 8192)
    T2_INIT_HH_4(14, 200, 16384)
    MRAC_INIT_1(15, 200, 32768, 11, 16)
    MRAC_INIT_1(16, 200, 32768, 11, 16)
    MRAC_INIT_1(17, 200, 32768, 11, 16)
    UM_INIT_4(18, 200, 11, 32768)
    apply {
        ...
        T2_RUN_4_KEY_2( 8, SRCIP, DSTIP, 1)
