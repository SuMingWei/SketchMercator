...
INIT_HEAVY_FLOWKEY_STORAGE_CONFIG_100(65536, 16, 20480)
...
control SwitchIngress(
    ...
    // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
        ...
        COMPUTE_HASH_100_32_32(32w0x30244f0b) d_12_hash_call;
        TCAM_LPM_HLLPCSA() d_12_tcam_lpm;
        GET_BITMASK() d_12_get_bitmask;
        T2_T5_KEY_UPDATE_100_16384(32w0x30243f0b) update_12_1;
    ...
    T3_INIT_HH_4( 8, 100, 16384)

    // apply SALUMerge; big - UnivMon / small - many MRACs 
        UM_INIT_SETUP(18, 100)
        ABOVE_THRESHOLD_4() d_18_above_threshold;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_18_index_hash_call_1;
        T3_T2_INDEX_UPDATE_32768() update_18_1;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_18_index_hash_call_2;
        T3_INDEX_UPDATE_32768() update_18_2;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_18_index_hash_call_3;
        T3_INDEX_UPDATE_32768() update_18_3;
        COMPUTE_HASH_100_16_11(32w0x30244f0b) d_18_index_hash_call_4;
    ...
    apply {
        ...
        // apply SALUMerge; big - CM/Kary/CS / small - Ent/PCSA 
            ...
            update_12_1.apply(SRCIP, 1, ig_md.d_12_bitmask, ig_md.d_12_est_1);
        ...
        // apply O2
        T2_RUN_AFTER_5_KEY_1(6, SRCIP, 1)
        // 
        ...
        T2_RUN_AFTER_1_KEY_1( 9, SRCIP, 1)
        T3_RUN_AFTER_4_KEY_1( 8, SRCIP, SIZE)
