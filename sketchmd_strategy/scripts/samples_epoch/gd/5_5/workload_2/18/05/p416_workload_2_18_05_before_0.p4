...
control SwitchIngress(
    ...
    apply {
        ...
        T2_RUN_HH_1_KEY_1( 7, SRCIP, SIZE)
        T3_RUN_HH_4_KEY_1( 8, SRCIP, SIZE)
        T2_RUN_HH_1_KEY_1( 9, SRCIP, 1)
        T2_RUN_HH_1_KEY_1(10, SRCIP, 1)
        T2_RUN_HH_4_KEY_1(11, SRCIP, 1)
        T2_RUN_HH_5_KEY_1(12, SRCIP, 1)
        T2_RUN_HH_2_KEY_1(13, SRCIP, SIZE)
        T2_RUN_HH_4_KEY_1(14, SRCIP, SIZE)
        MRAC_RUN_1_KEY_1(15, SRCIP)
        MRAC_RUN_1_KEY_1(16, SRCIP)
        MRAC_RUN_1_KEY_1(17, SRCIP)
        UM_RUN_4_KEY_1(18, SRCIP, 1)
    }
}
