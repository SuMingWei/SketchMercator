...
control SwitchIngress(
    ...
    // apply O2
        ...
        T1_KEY_UPDATE_221_262144(32w0x30243f0b) update_1_4;
    // 
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T2_KEY_UPDATE_221_16384(32w0x30243f0b) update_6_5;
    //
    ...
    apply {
        ...
        // apply O2
        T2_RUN_AFTER_1_KEY_5(7, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        // 

        T3_RUN_AFTER_3_KEY_5(10, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            d_14_above_threshold.apply(ig_md.d_6_est_1, ig_md.d_6_est_2, ig_md.d_14_above_threshold);
        ...
        T2_RUN_AFTER_4_KEY_5(15, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T3_RUN_AFTER_5_KEY_5( 8, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T3_RUN_AFTER_1_KEY_5( 9, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
