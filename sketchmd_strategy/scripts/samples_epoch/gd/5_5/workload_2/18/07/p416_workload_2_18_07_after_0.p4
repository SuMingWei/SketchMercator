...
control SwitchIngress(
    ...
    T4_INIT_1( 2, 221, 4096)
    MRB_INIT_1( 3, 221, 262144, 14, 16)
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        TCAM_LPM_HLLPCSA() d_5_tcam_lpm;
        GET_BITMASK() d_5_get_bitmask;
        T5_T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_5_1;
        ...
        T2_KEY_UPDATE_221_8192(32w0x30243f0b) update_5_4;
    //

    T2_INIT_HH_1(11, 221, 16384)
    T3_INIT_HH_2( 8, 221, 16384)
    ...
    T3_INIT_HH_5( 7, 221, 8192)
    T3_INIT_HH_5( 9, 221, 16384)
    T2_INIT_HH_5(14, 221, 16384)
    T2_INIT_HH_1(12, 221, 16384)
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_5_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE, ig_md.d_5_bitmask, ig_md.d_5_est_1);
            update_5_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, SIZE, ig_md.d_5_est_2);
            update_5_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, SIZE, ig_md.d_5_est_3);
            d_10_above_threshold.apply(ig_md.d_5_est_2, ig_md.d_5_est_3, ig_md.d_10_above_threshold);
            update_5_4.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1, ig_md.d_5_est_4);
        //

        T2_RUN_AFTER_1_KEY_5(11, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T3_RUN_AFTER_2_KEY_5( 8, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)

        // apply O2
        T2_RUN_AFTER_5_KEY_5(6, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        // 

        T3_RUN_AFTER_5_KEY_5( 7, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T3_RUN_AFTER_5_KEY_5( 9, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T2_RUN_AFTER_5_KEY_5(14, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T2_RUN_AFTER_1_KEY_5(12, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        // MRAC for inst 15
            d_15_tcam_lpm.apply(ig_md.d_3_sampling_hash_16, ig_md.d_15_base_16);
        ...
        // MRAC for inst 17
            d_17_tcam_lpm.apply(ig_md.d_3_sampling_hash_16, ig_md.d_17_base_16);
