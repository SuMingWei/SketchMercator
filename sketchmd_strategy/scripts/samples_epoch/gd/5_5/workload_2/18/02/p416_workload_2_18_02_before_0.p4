...
control SwitchIngress(
    ...
    T2_INIT_5(11, 100, 16384)
    T2_INIT_2(12, 100, 8192)
    T2_INIT_HH_5(13, 100, 16384)
    T2_INIT_HH_1(14, 100, 16384)
    T2_INIT_HH_5(15, 100, 16384)
    ...
    apply {
        ...
        T1_RUN_1_KEY_1( 6, SRCIP)
        MRB_RUN_1_KEY_1( 7, SRCIP)
        MRB_RUN_1_KEY_1( 8, SRCIP)
        T2_RUN_1_KEY_1( 9, SRCIP, 1)
        T2_RUN_4_KEY_1(10, SRCIP, 1)
        T2_RUN_5_KEY_1(11, SRCIP, 1)
        T2_RUN_2_KEY_1(12, SRCIP, SIZE)
        T2_RUN_HH_5_KEY_1(13, SRCIP, 1)
        T2_RUN_HH_1_KEY_1(14, SRCIP, SIZE)
        T2_RUN_HH_5_KEY_1(15, SRCIP, SIZE)
