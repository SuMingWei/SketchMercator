...
INIT_HEAVY_FLOWKEY_STORAGE_CONFIG_200(32768, 15, 10240)
...
control SwitchIngress(
    ...
    T3_INIT_HH_4( 4, 200, 16384)
    T3_INIT_HH_3( 5, 200, 16384)
    ...
    apply {
        ...
        T3_RUN_AFTER_3_KEY_2( 5, SRCIP, DSTIP, SIZE)
        ...
        // MRAC for inst 9
            d_9_tcam_lpm.apply(ig_md.d_3_sampling_hash_16, ig_md.d_9_base_16);
