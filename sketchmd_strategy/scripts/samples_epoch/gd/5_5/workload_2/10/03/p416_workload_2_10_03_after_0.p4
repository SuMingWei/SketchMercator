...
control SwitchIngress(
    ...
    // apply O2
        T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_3_1;
        T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_3_2;
        T2_KEY_UPDATE_221_4096(32w0x30243f0b) update_3_3;
    ...
    apply {
        ...
        // apply O2
        T2_RUN_AFTER_3_KEY_5(3, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        // 

        T2_RUN_5_KEY_5( 4, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T2_RUN_AFTER_3_KEY_5( 5, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T3_RUN_AFTER_3_KEY_5( 6, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        // MRAC for inst 9
