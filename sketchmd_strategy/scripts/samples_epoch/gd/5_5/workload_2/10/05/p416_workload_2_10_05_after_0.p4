...
control SwitchIngress(
    ...
    // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
        ...
        T5_T2_KEY_UPDATE_100_16384(32w0x30243f0b) update_5_1;
    ...
    apply {
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_5_2.apply(DSTIP, 1, ig_md.d_5_res_hash[1:1], SIZE, ig_md.d_5_est_2);
            update_5_3.apply(DSTIP, 1, ig_md.d_5_res_hash[2:2], SIZE, ig_md.d_5_est_3);
            update_5_4.apply(DSTIP, 1, ig_md.d_5_res_hash[3:3], SIZE, ig_md.d_5_est_4);
        ...
        // apply SALUMerge; big - PCSA or ENT / small - ENT/CM/Kary, CS, PCSA 
            ...
            update_4_1.apply(DSTIP, 1, ig_md.d_4_res_hash[0:0], 1, ig_md.d_4_est_1);
            update_4_2.apply(DSTIP, 1, ig_md.d_4_res_hash[1:1], 1, ig_md.d_4_est_2);
            update_4_3.apply(DSTIP, 1, ig_md.d_4_res_hash[2:2], 1, ig_md.d_4_est_3);
