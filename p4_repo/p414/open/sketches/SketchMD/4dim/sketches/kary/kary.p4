...
#define KARY_INIT_COMMON(D, FLOWKEY) \
    ...
    table kary_##D##_subtract_table { \
        actions { \
            kary_##D##_subtract_table_act; \
        } \
        default_action: kary_##D##_subtract_table_act; \
    } \
    action kary_##D##_subtract_table_act () { \
        subtract_from_field(kary_md_##D.est_1, kary_md_##D.est_4); \
        subtract_from_field(kary_md_##D.est_2, kary_md_##D.est_5); \
        subtract_from_field(kary_md_##D.est_3, kary_md_##D.est_6); \
    } \


#define KARY_INSTANCE_KEY_1(D, FLOWKEY, KEY_1) \
    KARY_INIT_COMMON(D, FLOWKEY) \
    heavy_flowkey_storage_step1_3_init(kary_##D##_f1, kary_md_##D.est_1, kary_md_##D.est_2, kary_md_##D.est_3, kary_md_##D.res_1, kary_md_##D.res_2, kary_md_##D.res_3, kary_md_##D.threshold, kary_md_##D.above_threshold) \
    heavy_flowkey_storage_step2_3_key_1_init(kary_##D##_f2, kary_md_##D.res_1, kary_md_##D.res_2, kary_md_##D.res_3, kary_md_##D.above_threshold, FLOWKEY, kary_md_##D.match_hit, KEY_1, kary_md_##D.hash_entry_1, 16384) \

#define KARY_INSTANCE_KEY_2(D, FLOWKEY, KEY_1, KEY_2) \
    KARY_INIT_COMMON(D, FLOWKEY) \
    heavy_flowkey_storage_step1_3_init(kary_##D##_f1, kary_md_##D.est_1, kary_md_##D.est_2, kary_md_##D.est_3, kary_md_##D.res_1, kary_md_##D.res_2, kary_md_##D.res_3, kary_md_##D.threshold, kary_md_##D.above_threshold) \
    heavy_flowkey_storage_step2_3_key_2_init(kary_##D##_f2, kary_md_##D.res_1, kary_md_##D.res_2, kary_md_##D.res_3, kary_md_##D.above_threshold, FLOWKEY, kary_md_##D.match_hit, KEY_1, KEY_2, kary_md_##D.hash_entry_1, kary_md_##D.hash_entry_2, 16384) \

#define KARY_INSTANCE_KEY_3(D, FLOWKEY, KEY_1, KEY_2, KEY_3) \
    KARY_INIT_COMMON(D, FLOWKEY) \
    heavy_flowkey_storage_step1_3_init(kary_##D##_f1, kary_md_##D.est_1, kary_md_##D.est_2, kary_md_##D.est_3, kary_md_##D.res_1, kary_md_##D.res_2, kary_md_##D.res_3, kary_md_##D.threshold, kary_md_##D.above_threshold) \
    heavy_flowkey_storage_step2_3_key_3_init(kary_##D##_f2, kary_md_##D.res_1, kary_md_##D.res_2, kary_md_##D.res_3, kary_md_##D.above_threshold, FLOWKEY, kary_md_##D.match_hit, KEY_1, KEY_2, KEY_3, kary_md_##D.hash_entry_1, kary_md_##D.hash_entry_2, kary_md_##D.hash_entry_3, 16384) \
