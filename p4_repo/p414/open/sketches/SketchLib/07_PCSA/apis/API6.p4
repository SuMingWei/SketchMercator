...
#define API6_SUM_HASH_MATCH_TABLE_5_INIT(NAME, C1, C2, C3, C4, C5, ABOVE_THRESHOLD, KEY_FIELDS, KEY, POLY_PARAM, HASH_TABLE_SIZE, HASH_ENTRY, MATCH_HIT) \
...
#define API6_SUM_HASH_MATCH_TABLE_5_CALL(NAME, ABOVE_THRESHOLD, HASH_ENTRY, KEY) \
