...
for i in range(1, 21):
    folder_name = "p414_original_mrb_level_%02d" % i
    print(folder_name)
    if not os.path.exists(folder_name):
        os.makedirs(folder_name)
    # cmd = 'cp original/original_mrb_level_X.p4 %s/%s.p4' % (folder_name, folder_name)
    # os.system(cmd)
