...
heavy_flowkey_storage_step1_2_init(th_1, mdata.est_1, mdata.est_2, mdata.res_1, mdata.res_2, 5000)
heavy_flowkey_storage_step2_2_init(sum_1, mdata.res_1, mdata.res_2, mdata.above_threshold, key_fields, ipv4.srcAddr, 0x11ba20111, 32768, mdata.hash_entry, mdata.match_hit)
...
control ingress {
    if (mdata.do_fcmsketch == 1) { // ipv4
        ...
        heavy_flowkey_storage_step1_2_call(th_1)
        heavy_flowkey_storage_step2_2_call(sum_1, mdata.above_threshold, mdata.hash_entry, ipv4.srcAddr)
    }
}
/** Egress **/
control egress {
