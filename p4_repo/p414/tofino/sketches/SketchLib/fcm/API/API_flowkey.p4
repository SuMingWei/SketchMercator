...
#define heavy_flowkey_storage_step1_2_init(NAME, E1, E2, COMP1, COMP2, THRESHOLD) \
...
#define heavy_flowkey_storage_step1_2_call(NAME) \
    apply(NAME##_subtract_table); \
    apply(NAME##_shift_table);

#define heavy_flowkey_storage_step2_2_init(NAME, C1, C2, ABOVE_THRESHOLD, KEY_FIELDS, KEY, POLY_PARAM, HASH_TABLE_SIZE, HASH_ENTRY, MATCH_HIT) \
...
#define heavy_flowkey_storage_step2_2_call(NAME, ABOVE_THRESHOLD, HASH_ENTRY, KEY) \
