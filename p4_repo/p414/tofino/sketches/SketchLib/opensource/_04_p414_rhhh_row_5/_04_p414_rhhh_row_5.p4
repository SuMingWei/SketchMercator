...
#define RHHH_INIT(D) \
    ...
    heavy_flowkey_storage_step2_5_init(sum_##D, md_##D.res_1, md_##D.res_2, md_##D.res_3, md_##D.res_4, md_##D.res_5, md_##D.above_threshold, key_fields, ipv4.srcAddr, 0x11ba201b1, 65536, md_##D.hash_entry_1, md_##D.hash_entry_2, md_##D.hash_entry_3, md_##D.match_hit)
...
control rhhh {
    ...
    heavy_flowkey_storage_step2_5_call(sum_1, md_1.above_threshold, md_1.hash_entry_1, ipv4.srcAddr)
}
