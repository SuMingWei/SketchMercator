...
#define heavy_flowkey_storage_step2_5_init(NAME, C1, C2, C3, C4, C5, ABOVE_THRESHOLD, KEY_FIELDS, KEY, POLY_PARAM, HASH_TABLE_SIZE, HASH_ENTRY_1, HASH_ENTRY_2, HASH_ENTRY_3, MATCH_HIT) \
