...
#define UNIVMON_INIT(D) \
    hash_init(sampling_##D, key_fields, 0x1##D##98f10d1, md_##D.sampling_hash_value, 65536) \
    ...
    hash_init(cs_index_1_##D, key_fields, 0x1##D##9cf8783, md_##D.index_1, 2048) \
    hash_init(cs_index_2_##D, key_fields, 0x1##D##9cf8785, md_##D.index_2, 2048) \
    hash_init(cs_index_3_##D, key_fields, 0x1##D##9cf8787, md_##D.index_3, 2048) \
    hash_init(cs_index_4_##D, key_fields, 0x1##D##9cf8789, md_##D.index_4, 2048) \
    hash_init(cs_index_5_##D, key_fields, 0x1##D##9cf878b, md_##D.index_5, 2048) \
    ...
    heavy_flowkey_storage_step2_5_init(univmon_sum_##D, md_##D.comp_1, md_##D.comp_2, md_##D.comp_3, md_##D.comp_4, md_##D.comp_5, md_##D.above_threshold, key_fields, ipv4.srcAddr, 0x11ba201b1, 10000, md_##D.hash_entry, md_##D.match_hit)
