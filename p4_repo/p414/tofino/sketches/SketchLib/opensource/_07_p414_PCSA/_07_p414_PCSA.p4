...
API0_HASH_INIT(pcsa_alpha_1, key_fields, 0x1798f10d1, md_1.alpha, 32)
API0_HASH_INIT(pcsa_h_1, key_fields, 0x1798f10d2, md_1.h, 1048576)
API5_INIT(pcsa_tcam_1, md_1.h, 1)
API4_SALU_BITMAP_UPDATE_INIT(pcsa_update_1, md_1.base, md_1.alpha, md_1.est, 32)
