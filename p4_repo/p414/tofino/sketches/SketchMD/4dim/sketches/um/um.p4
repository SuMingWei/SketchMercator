...
#define UM_INIT_COMMON(D, FLOWKEY) \
    ...
    lpm_optimization_init(um_##D##_tcam, um_md_##D.sampling_hash_value, um_md_##D.level) \
...
#define UM_INSTANCE_KEY_1(D, FLOWKEY, KEY_1) \
    ...
    heavy_flowkey_storage_step1_3_init(um_##D##_f1, um_md_##D.est_1, um_md_##D.est_2, um_md_##D.est_3, um_md_##D.res_1, um_md_##D.res_2, um_md_##D.res_3, um_md_##D.threshold) \
    heavy_flowkey_storage_step2_3_key_1_init(um_##D##_f2, um_md_##D.res_1, um_md_##D.res_2, um_md_##D.res_3, um_md_##D.above_threshold, FLOWKEY, um_md_##D.match_hit, KEY_1, um_md_##D.hash_entry_1) \

#define UM_INSTANCE_KEY_2(D, FLOWKEY, KEY_1, KEY_2) \
    UM_INIT_COMMON(D, FLOWKEY) \
    heavy_flowkey_storage_step1_3_init(um_##D##_f1, um_md_##D.est_1, um_md_##D.est_2, um_md_##D.est_3, um_md_##D.res_1, um_md_##D.res_2, um_md_##D.res_3, um_md_##D.threshold) \
    heavy_flowkey_storage_step2_3_key_2_init(um_##D##_f2, um_md_##D.res_1, um_md_##D.res_2, um_md_##D.res_3, um_md_##D.above_threshold, FLOWKEY, um_md_##D.match_hit, KEY_1, KEY_2, um_md_##D.hash_entry_1, um_md_##D.hash_entry_2) \

#define UM_INSTANCE_KEY_3(D, FLOWKEY, KEY_1, KEY_2, KEY_3) \
    UM_INIT_COMMON(D, FLOWKEY) \
    heavy_flowkey_storage_step1_3_init(um_##D##_f1, um_md_##D.est_1, um_md_##D.est_2, um_md_##D.est_3, um_md_##D.res_1, um_md_##D.res_2, um_md_##D.res_3, um_md_##D.threshold) \
    heavy_flowkey_storage_step2_3_key_3_init(um_##D##_f2, um_md_##D.res_1, um_md_##D.res_2, um_md_##D.res_3, um_md_##D.above_threshold, FLOWKEY, um_md_##D.match_hit, KEY_1, KEY_2, KEY_3, um_md_##D.hash_entry_1, um_md_##D.hash_entry_2, um_md_##D.hash_entry_3) \

// #define UM_INSTANCE_NOHH(D, FLOWKEY) \
//     UM_INIT_COMMON(D, FLOWKEY) \
    // apply(th_table); \
