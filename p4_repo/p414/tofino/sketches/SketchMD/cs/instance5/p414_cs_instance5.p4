...
control count_sketch {
    ...
    apply(th_table_4);
    hash_consolidate_and_split_5_call(cs_4)
    HASH_SKETCHING_5(4)
    heavy_flowkey_storage_step1_5_call(th_4)
    heavy_flowkey_storage_step2_5_call(sum_4, md_4.above_threshold, md_4.hash_entry, ipv4.srcAddr)

    apply(th_table_5);
    hash_consolidate_and_split_5_call(cs_5)
    HASH_SKETCHING_5(5)
    heavy_flowkey_storage_step1_5_call(th_5)
    heavy_flowkey_storage_step2_5_call(sum_5, md_5.above_threshold, md_5.hash_entry, ipv4.srcAddr)
}
