...
control ingress {
    ...
    hash_call(sampling_3)
    lpm_optimization_call(logarithmic_3)

    hash_consolidate_and_split_5_call(cs_res_group_3)
    hash_call(cs_index_1_3)
    hash_call(cs_index_2_3)
    hash_call(cs_index_3_3)
    hash_call(cs_index_4_3)
    hash_call(cs_index_5_3)

    consolidate_update_cs_5_call(cs_row_1_3)
    consolidate_update_cs_5_call(cs_row_2_3)
    consolidate_update_cs_5_call(cs_row_3_3)
    consolidate_update_cs_5_call(cs_row_4_3)
    consolidate_update_cs_5_call(cs_row_5_3)

    heavy_flowkey_storage_step1_5_call(univmon_th_3)
    heavy_flowkey_storage_step2_5_call(univmon_sum_3, md_3.above_threshold, md_3.hash_entry, ipv4.srcAddr)

    hash_call(sampling_4)
    lpm_optimization_call(logarithmic_4)

    hash_consolidate_and_split_5_call(cs_res_group_4)
    hash_call(cs_index_1_4)
    hash_call(cs_index_2_4)
    hash_call(cs_index_3_4)
    hash_call(cs_index_4_4)
    hash_call(cs_index_5_4)

    consolidate_update_cs_5_call(cs_row_1_4)
    consolidate_update_cs_5_call(cs_row_2_4)
    consolidate_update_cs_5_call(cs_row_3_4)
    consolidate_update_cs_5_call(cs_row_4_4)
    consolidate_update_cs_5_call(cs_row_5_4)

    heavy_flowkey_storage_step1_5_call(univmon_th_4)
    heavy_flowkey_storage_step2_5_call(univmon_sum_4, md_4.above_threshold, md_4.hash_entry, ipv4.srcAddr)
}
