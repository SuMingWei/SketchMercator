...
control SwitchIngress(
    ...
    // MRAC_INIT_5(1, 010, 16384)
    // CM_INIT_2(2, 100, 8192)
    // CM_INIT_4(3, 100, 4096)
    // CM_INIT_4(4, 100, 4096)
    // CM_INIT_1(5, 110, 8192)
    // CM_INIT_3(6, 110, 8192)
    // CM_INIT_5(7, 110, 4096)
    // CM_INIT_5(8, 200, 16384)
    ...
    apply {
        ...
        // CM_RUN_5_KEY_1(1, DSTPORT_D(1), 1)
        // CM_RUN_2_KEY_1(2, DSTIP_D(2), 1)
        // CM_RUN_4_KEY_1(3, DSTIP_D(3), SIZE_D(3))
        // CM_RUN_4_KEY_1(4, DSTIP_D(4), SIZE_D(4))
        // CM_RUN_1_KEY_2(5, DSTIP_D(5), DSTPORT_D(5), 1)
        // CM_RUN_3_KEY_2(6, DSTIP_D(6), DSTPORT_D(6), SIZE_D(6))
        // CM_RUN_5_KEY_2(7, SRCIP_D(7), SRCPORT_D(7), 1)
        // CM_RUN_5_KEY_2(8, SRCIP_D(8), DSTIP_D(8), SIZE_D(8))
