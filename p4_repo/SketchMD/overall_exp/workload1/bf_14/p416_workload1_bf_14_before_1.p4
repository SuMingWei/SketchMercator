...
// PROTO = 4
    ...
    T1_INIT_3(1,  010, 524288)
    T1_INIT_1(2,  100, 262144)
    T1_INIT_2(3,  100, 524288)
    T1_INIT_5(4,  100, 524288)
    T1_INIT_4(5,  110, 262144)
    T1_INIT_3(6,  110, 524288)
    T1_INIT_2(7,  100, 524288)
    T1_INIT_1(8,  110, 131072)
    T1_INIT_3(9,  110, 262144)
    T1_INIT_4(10, 200, 262144)
    T1_INIT_2(11, 200, 262144)
    T1_INIT_4(12, 221, 524288)
    T1_INIT_4(13, 221, 131072)
    T1_INIT_3(14, 221, 131072)


    apply {
        T1_RUN_3_KEY_1(1, DSTPORT)
        T1_RUN_1_KEY_1(2, DSTIP)
        T1_RUN_2_KEY_1(3, DSTIP)
        T1_RUN_5_KEY_1(4, DSTIP)
        T1_RUN_4_KEY_2(5, DSTIP, DSTPORT)
        T1_RUN_3_KEY_2(6, DSTIP, DSTPORT)
        T1_RUN_2_KEY_1(7, SRCIP)
        T1_RUN_1_KEY_2(8, SRCIP, SRCPORT)
        T1_RUN_3_KEY_2(9, SRCIP, SRCPORT)
        T1_RUN_4_KEY_2(10, SRCIP, DSTIP)
        T1_RUN_2_KEY_2(11, SRCIP, DSTIP)
        T1_RUN_4_KEY_5(12, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        T1_RUN_4_KEY_5(13, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
        T1_RUN_3_KEY_5(14, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO)
    }
}
