...
control SwitchIngress(
    ...
    CM_INIT_2(9, 220, 4096)
    CM_INIT_1(10, 220, 16384)
    CM_INIT_3(11, 220, 8192)
    ...
    apply {
        ...
        CM_RUN_2_KEY_4(9, SRCIP_D(9), DSTIP_D(9), SRCPORT_D(9), DSTPORT_D(9), 1)
        // CM_RUN_1_KEY_4(10, SRCIP_D(10), DSTIP_D(10), SRCPORT_D(10), DSTPORT_D(10), 1)
        // CM_RUN_3_KEY_4(11, SRCIP_D(11), DSTIP_D(11), SRCPORT_D(11), DSTPORT_D(11), SIZE_D(11))
