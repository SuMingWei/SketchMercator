...
// PROTO = 4
    ...
    MRAC_INIT_1(1,  010,  8192, 10,  8)
    MRAC_INIT_1(2,  010, 32768, 11, 16)
    MRAC_INIT_1(3,  010, 16384, 11,  8)
    MRAC_INIT_1(4,  010, 16384, 11,  8)
    ...
    apply {
        MRAC_RUN_1_KEY_1(1, DSTPORT)
        MRAC_RUN_1_KEY_1(2, DSTPORT)
        MRAC_RUN_1_KEY_1(3, DSTPORT)
        MRAC_RUN_1_KEY_1(4, DSTPORT)
