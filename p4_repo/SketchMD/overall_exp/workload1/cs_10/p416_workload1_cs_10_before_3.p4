...
// PROTO = 4
    ...
    T3_INIT_HH_5(1,  010, 16384)
    T3_INIT_HH_5(2,  100, 4096)
    T3_INIT_HH_2(3,  100, 4096)
    T3_INIT_HH_1(4,  100, 16384)
    T3_INIT_HH_2(5,  100, 8192)
    T3_INIT_HH_1(6,  200, 8192)
    T3_INIT_HH_1(7,  200, 8192)
    T3_INIT_HH_1(8,  200, 16384)
    T3_INIT_HH_2(9,  220, 16384)
    T3_INIT_HH_5(10, 221, 16384)

    apply {
        T3_RUN_HH_5_KEY_1(1, DSTPORT, SIZE)
        T3_RUN_HH_5_KEY_1(2, DSTIP, 1)
        T3_RUN_HH_2_KEY_1(3, DSTIP, SIZE)
        T3_RUN_HH_1_KEY_1(4, SRCIP, 1)
        T3_RUN_HH_2_KEY_1(5, SRCIP, SIZE)
        T3_RUN_HH_1_KEY_2(6, SRCIP, DSTIP, SIZE)
        T3_RUN_HH_1_KEY_2(7, SRCIP, DSTIP, SIZE)
        // T3_RUN_HH_1_KEY_2(8, SRCIP, DSTIP, SIZE)
        // T3_RUN_HH_2_KEY_4(9, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)
