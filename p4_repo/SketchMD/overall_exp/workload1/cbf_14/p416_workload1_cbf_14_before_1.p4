...
// PROTO = 4
    ...
    T2_INIT_2(11, 200, 8192)
    T2_INIT_4(12, 221, 16384)
    T2_INIT_4(13, 221, 4096)
    T2_INIT_3(14, 221, 4096)


    apply {
        T2_RUN_3_KEY_1(1, DSTPORT, SIZE)
        T2_RUN_1_KEY_1(2, DSTIP, SIZE)
        ...
        T2_RUN_2_KEY_2(11, SRCIP, DSTIP, SIZE)
        T2_RUN_4_KEY_5(12, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)
        T2_RUN_4_KEY_5(13, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
        T2_RUN_3_KEY_5(14, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE)
    }
}
