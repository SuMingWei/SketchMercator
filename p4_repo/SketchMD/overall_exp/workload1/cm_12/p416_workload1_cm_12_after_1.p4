...
// PROTO = 4
    ...
    T2_INIT_HH_3(12, 221, 8192)

    apply {
        T2_RUN_AFTER_1_KEY_1(1, SRCIP, 1)    // epoch 10s
        T2_RUN_AFTER_2_KEY_1(2, SRCIP, SIZE) // epoch 10s

        T2_RUN_AFTER_3_KEY_2(3, SRCIP, DSTIP, 1)      // epoch 20s
        T2_RUN_AFTER_1_KEY_2(4, SRCIP, DSTIP, SIZE)   // epoch 20s

        T2_RUN_AFTER_2_KEY_1(5, DSTIP, 1)    // epoch 30s
        T2_RUN_AFTER_3_KEY_1(6, DSTIP, SIZE) // epoch 30s

        T2_RUN_AFTER_1_KEY_2(7, DSTIP, DSTPORT, 1)    // epoch 40s
        T2_RUN_AFTER_2_KEY_2(8, DSTIP, DSTPORT, SIZE) // epoch 40s

        T2_RUN_AFTER_3_KEY_4(9, SRCIP, DSTIP, SRCPORT, DSTPORT, 1)    // epoch 10s
        T2_RUN_AFTER_1_KEY_4(10, SRCIP, DSTIP, SRCPORT, DSTPORT, SIZE) // epoch 10s

        T2_RUN_AFTER_2_KEY_5(11, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, 1)    // epoch 20s
        T2_RUN_AFTER_3_KEY_5(12, SRCIP, DSTIP, SRCPORT, DSTPORT, PROTO, SIZE) // epoch 20s
        ...
        if(ig_md.d_9_above_threshold == 1 ||
           ig_md.d_10_above_threshold == 1 ||
           ig_md.d_11_above_threshold == 1 ||
           ig_md.d_12_above_threshold == 1
           ) {
