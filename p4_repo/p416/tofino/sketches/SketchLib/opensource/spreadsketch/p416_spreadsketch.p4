...
control SwitchIngress(
    ...
    apply {
        if(hdr.ethernet.ether_type == ETHERTYPE_IPV4) {
            ...
            update_sketch_1.apply(ig_md.index_1, ig_md.short_level, ig_md.base_1_1, ig_md.base_1_2, ig_md.mem_index_1);
            update_sketch_2.apply(ig_md.index_2, ig_md.short_level, ig_md.base_2_1, ig_md.base_2_2, ig_md.mem_index_2);
            update_sketch_3.apply(ig_md.index_3, ig_md.short_level, ig_md.base_3_1, ig_md.base_3_2, ig_md.mem_index_3);
