    ...
    inout ingress_intrinsic_metadata_for_tm_t ig_tm_md)
{
    ...
    Register<bit<32>, bit<15>>(32w32768) flowkey_hash_table;

    RegisterAction<bit<32>, bit<15>, bit<32>>(flowkey_hash_table) flowkey_action = {
    ...
    action subtract() {
        ...
        ig_md.est_6 = ig_md.est_6 - ig_md.threshold;
        // ig_md.est_7 = ig_md.est_7 - ig_md.threshold;
    }
    ...
    action shift() {
        ...
        ig_md.c_6 = (bit<1>) ig_md.est_6 >> 31;
        // ig_md.c_7 = (bit<1>) ig_md.est_7 >> 31;
    }
    ...
    apply {
        ...
        if(ig_md.c_1 == 0 || ig_md.c_2 == 0 || ig_md.c_3 == 0 || ig_md.c_4 == 0 || ig_md.c_5 == 0 || ig_md.c_6 == 0) {
            bit<32> hash_entry = flowkey_action.execute(ig_md.res_all[14:0]);
