...
#include "API_S5_heavy_storage.p4"
...
control SwitchIngress(
    ...
    apply {
        get_both_port();
        d_1_cm_update_1.apply(SRCIP, DSTIP, BOTHPORT, ig_md.d_1_est_1);
        d_1_cm_update_2.apply(SRCIP, DSTIP, BOTHPORT, ig_md.d_1_est_2);
        d_1_cm_update_3.apply(SRCIP, DSTIP, BOTHPORT, ig_md.d_1_est_3);
