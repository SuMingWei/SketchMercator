...
control SwitchIngress(
    ...
    HASH_COMPUTE_KEY32_32_16(32w0x6b8cb0c6) d_1_hash_call_s;
    HASH_COMPUTE_KEY32_32_16(32w0x30243f0b) d_1_hash_call_1;
    HASH_COMPUTE_KEY32_32_16(32w0x0f79f523) d_1_hash_call_2;
    HASH_COMPUTE_KEY32_32_16(32w0x6b8cb0c5) d_1_hash_call_3;

    HASH_COMPUTE_KEY32_32_16(32w0x6b8cb0c6) d_2_hash_call_s;
    HASH_COMPUTE_KEY32_32_16(32w0x30243f0b) d_2_hash_call_1;
    HASH_COMPUTE_KEY32_32_16(32w0x0f79f523) d_2_hash_call_2;
    HASH_COMPUTE_KEY32_32_16(32w0x6b8cb0c5) d_2_hash_call_3;

    HASH_COMPUTE_KEY32_KEY32_32_16(32w0x6b8cb0c6) d_3_hash_call_s;
    HASH_COMPUTE_KEY32_KEY32_32_16(32w0x30243f0b) d_3_hash_call_1;
    HASH_COMPUTE_KEY32_KEY32_32_16(32w0x0f79f523) d_3_hash_call_2;
    HASH_COMPUTE_KEY32_KEY32_32_16(32w0x6b8cb0c5) d_3_hash_call_3;

    HASH_COMPUTE_KEY32_KEY32_KEY16_KEY16_32_16(32w0x6b8cb0c6) d_4_hash_call_s;
    HASH_COMPUTE_KEY32_KEY32_KEY16_KEY16_32_16(32w0x30243f0b) d_4_hash_call_1;
    HASH_COMPUTE_KEY32_KEY32_KEY16_KEY16_32_16(32w0x0f79f523) d_4_hash_call_2;
    HASH_COMPUTE_KEY32_KEY32_KEY16_KEY16_32_16(32w0x6b8cb0c5) d_4_hash_call_3;
    ...
    bit<32> short_level;
    action tbl_short_level_zero() {
        short_level = 0;
    }
    action tbl_short_level_one() {
        short_level = 1;
    }
    action tbl_short_level_two() {
        short_level = 2;
    }
    action tbl_short_level_three() {
        short_level = 3;
    }
    table tbl_short_level {
        key = {
            ig_md.d_3_level : exact;
        }
        actions = {
            tbl_short_level_zero;
            tbl_short_level_one;
            tbl_short_level_two;
            tbl_short_level_three;
        }
        const entries = {
            (0): tbl_short_level_zero();
            (1): tbl_short_level_one();
            (2): tbl_short_level_two();
        }
        default_action = tbl_short_level_three();
        size = 8;
    }
    ...
    apply {
        if(hdr.ethernet.ether_type == ETHERTYPE_IPV4) {
            ...
            // tbl_short_level.apply();

            // d_1_ss_update_1.apply(ig_md.d_1_hash_1, short_level, ig_md.d_3_hash_s);
            // d_1_ss_update_2.apply(ig_md.d_1_hash_2, short_level, ig_md.d_3_hash_s);
            // d_1_ss_update_3.apply(ig_md.d_1_hash_3, short_level, ig_md.d_3_hash_s);

            // d_2_ss_update_1.apply(ig_md.d_2_hash_1, short_level, ig_md.d_3_hash_s);
            // d_2_ss_update_2.apply(ig_md.d_2_hash_2, short_level, ig_md.d_3_hash_s);
            // d_2_ss_update_3.apply(ig_md.d_2_hash_3, short_level, ig_md.d_3_hash_s);
