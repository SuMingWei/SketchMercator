...
control TC_CM_UPDATE_TYPE1_32_16(
  in bit<32> key1,
  in bit<16> key2,
  in bit<16> size,
  out bit<32> est)(
...
control TC_CM_UPDATE_TYPE1_32_32(
  in bit<32> key1,
  in bit<32> key2,
  in bit<16> size,
  out bit<32> est)(
...
control TC_CM_UPDATE_TYPE1_32_32_16_16(
  in bit<32> key1,
  in bit<32> key2,
  in bit<16> key3,
  in bit<16> key4,
...
control TC_CM_UPDATE_TYPE1_32_32_16_16_8(
  in bit<32> key1,
  in bit<32> key2,
  in bit<16> key3,
  in bit<16> key4,
