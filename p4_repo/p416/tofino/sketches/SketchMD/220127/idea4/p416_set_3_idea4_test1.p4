...
control SwitchIngress(
    ...
    apply {
        ...
        ig_md.ss_hash_1 = (bit<32>)ig_md.um_hash_1[10:0];
        ig_md.um_hash_2 = (bit<32>)ig_md.ss_hash_2[9:0];
        ig_md.um_hash_3 = (bit<32>)ig_md.ss_hash_3[9:0];
        ...
        um_store_flowkey.apply(hdr, ig_md.um_threshold, ig_md.um_est_1, ig_md.um_est_2, ig_md.um_est_3, um_above);

        if (um_above == 1 || kary_above == 1) {
