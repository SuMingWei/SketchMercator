...
control SwitchIngress(
    ...
    apply {
        ...
        // ss_hash_call_1.apply(SRCIP, ig_md.mrac_hash);
        ...
        // stage 2
        ss_update_log_1.apply(SRCIP, (bit<32>)ig_md.mrac_hash[10:0], ig_md.ss_level);
        ...
        ss_update_1.apply((bit<32>)ig_md.mrac_hash[10:0], ig_md.ss_xy_hash, ig_md.ss_short_level);
