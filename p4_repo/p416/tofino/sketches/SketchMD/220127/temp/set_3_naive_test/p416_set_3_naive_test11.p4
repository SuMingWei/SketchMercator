...
control SwitchIngress(
    ...
    apply {
        ...
        um_store_flowkey.apply(hdr, SRCIP, ig_md.um_threshold, ig_md.um_est_1, ig_md.um_est_2, ig_md.um_est_3, ig_md.kary_c_1, ig_md.kary_c_2, ig_md.kary_c_3, ig_md.um_above_threshold, ig_tm_md);
    }
}
