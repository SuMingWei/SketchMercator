...
control SwitchIngress(
    ...
    apply {
        ...
        // cm_store_flowkey.apply(hdr, SRCIP, ig_md.cm_threshold, ig_md.cm_est_1, ig_md.cm_est_2, ig_md.cm_est_3, ig_tm_md);
        ...
        // mrb_update.apply(ig_md.mrb_level, (bit<32>)ig_md.mrb_hash[9:0]);

        // MRAC
        mrac_hash_call.apply(SRCIP, ig_md.mrac_hash);
        mrac_lpm.apply(ig_md.mrac_hash, ig_md.mrac_level);
        mrac_update.apply(ig_md.mrac_level, (bit<32>)ig_md.mrac_hash[9:0]);
        ...
        um_update_1.apply((bit<32>)ig_md.um_hash_1[9:0], ig_md.um_hash_1[10:10], ig_md.um_level, ig_md.um_est_1);
        um_update_2.apply(ig_md.um_hash_2, ig_md.um_hash_1[11:11], ig_md.um_level, ig_md.um_est_2);
        um_update_3.apply(ig_md.um_hash_3, ig_md.um_hash_1[12:12], ig_md.um_level, ig_md.um_est_3);
