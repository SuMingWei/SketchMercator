#define UM_SS_UPDATE_MACRO(A, B, STAGE1, STAGE2) \
control d_##A##_##B##_UM_SS_UPDATE( \
  in bit<16> index, \
  in bit<1> res, \
  in bit<16> um_base, \
  in bit<16> ss_base, \
...
{ \
    ...
    bit<16> ss_mem_index; \
    bit<16> xyhash_mask; \
    Register<bit<32>, bit<16>>(16384) um_ca; \
    ...
    Register<bit<1>, bit<16>>(65536) bitmap; \
    ...
    @pragma stage 5 table ss_sketch_table { \
        actions = { \
            ss_sketch_table_act; \
        } \
...
UM_SS_UPDATE_MACRO(1, 1, 3, 5)


UM_SS_UPDATE_MACRO(d_1_2, 3, 5)
UM_SS_UPDATE_MACRO(d_1_3, 3, 5)

UM_SS_UPDATE_MACRO(d_2_1, 4, 6)
UM_SS_UPDATE_MACRO(d_2_2, 4, 6)
UM_SS_UPDATE_MACRO(d_2_3, 4, 6)
