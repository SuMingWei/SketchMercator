...
control SwitchIngress(
    ...
    apply {
        if(hdr.ethernet.ether_type == ETHERTYPE_IPV4) {
            ...
            ig_md.d_1_ss_hash_1 = (bit<32>)ig_md.d_1_hash_1[UM_BITLEN_MINUS:0];
            ig_md.d_1_ss_hash_2 = (bit<32>)ig_md.d_1_hash_2[UM_BITLEN_MINUS:0];
            ig_md.d_1_ss_hash_3 = (bit<32>)ig_md.d_1_hash_3[UM_BITLEN_MINUS:0];
            ...
            ig_md.d_1_ss_xy_hash = (bit<32>)ig_md.d_3_hash_s;
            ...
            vi.apply();
            d_1_ss_update_1.apply(ig_md.d_1_ss_hash_1, short_level, ig_md.d_1_ss_xy_hash);
