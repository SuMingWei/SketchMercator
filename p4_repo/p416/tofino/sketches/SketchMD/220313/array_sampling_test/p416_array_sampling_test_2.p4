...
control SwitchIngress(
    ...
    HASH_COMPUTE_KEY8_10_10(32w0x30243f0b) hash_call_proto;
    CONTROL_DIM_1(1)
    CONTROL_DIM_2(2)
    ...
    action xor_hash() {
        ig_md.d_1_hash_1 = ig_md.d_2_hash_1 ^ ig_md.hash_proto;
        ig_md.d_1_hash_2 = ig_md.d_2_hash_2 ^ ig_md.hash_proto;
        ig_md.d_1_hash_3 = ig_md.d_2_hash_3 ^ ig_md.hash_proto;
    }
    apply {
        get_both_port();
        get_random();

        hash_call_proto.apply(PROTO, ig_md.hash_proto);
