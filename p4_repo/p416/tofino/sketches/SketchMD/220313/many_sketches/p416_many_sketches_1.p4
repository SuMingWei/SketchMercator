...
#include "counter_update/API_tc.p4"
...
control SwitchIngress(
    ...
    apply {
        ...
        if (ig_md.d_1_is_above_threshold == 1 ||
            ig_md.d_2_is_above_threshold == 1 ||
            ig_md.d_3_is_above_threshold == 1 ||
            ig_md.d_4_is_above_threshold == 1 ||
...
control SwitchIngressDeparserDigest(packet_out pkt,
    ...
    apply {
        if (ig_dprsr_md.digest_type == SKETCHMD_HEAVY_FLOWKEY_DIGEST_TYPE) {
            ...
            ig_md.d_2_is_above_threshold,
            ig_md.d_3_is_above_threshold,
            ig_md.d_4_is_above_threshold,
            ig_md.d_5_is_above_threshold,
            ig_md.d_6_is_above_threshold,
            ig_md.d_7_is_above_threshold,
            ig_md.d_8_is_above_threshold});
        }
        pkt.emit(hdr);
    }
}
