...
control SwitchIngress(
    ...
    CONTROL_DIM_8(11)
    CONTROL_DIM_32_32_16_16(12)

    heavy_flowkey_storage_five_tuple_full(32w0x30243f0b) heavy_flowkey_storage;
    ...
    apply {
        ...
        d_11_hash_call_1.apply(PROTO, ig_md.d_11_hash_4);
        d_11_hash_call_cs.apply(PROTO, ig_md.d_11_hash_cs);
        d_12_hash_call_cs.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_12_hash_cs);
        d_12_hash_call_1.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_12_hash_1);
        d_12_hash_call_2.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_12_hash_2);
        d_12_hash_call_3.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_12_hash_3);
        d_12_hash_call_sampling.apply(SRCIP, DSTIP, SRCPORT, DSTPORT, ig_md.d_12_hash_sampling);
        ...
        d_11_above_threshold.apply(ig_md.d_11_est_1, ig_md.d_11_est_2, ig_md.d_11_est_3, ig_md.d_11_threshold, ig_md.rand, ig_md.d_11_is_above_threshold);
        ...
        if (ig_md.d_11_is_above_threshold == 1) {
...
control SwitchIngressDeparserDigest(packet_out pkt,
    ...
    apply {
        if (ig_dprsr_md.digest_type == SKETCHMD_HEAVY_FLOWKEY_DIGEST_TYPE) {
            heavy_flowkey_digest.pack({ig_md.hf_srcip, ig_md.hf_dstip, ig_md.hf_src_port, ig_md.hf_dst_port, ig_md.hf_proto});
        }
        pkt.emit(hdr);
    }
}
