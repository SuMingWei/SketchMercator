...
control SwitchIngress(
    ...
    CS_UPDATE_32768() update_32768_1_0;
    CS_UPDATE_32768() update_32768_2_0;
    CS_UPDATE_32768() update_32768_3_0;
    CS_UPDATE_32768() update_32768_4_0;

    CS_UPDATE_32768() update_32768_1_1;
    CS_UPDATE_32768() update_32768_2_1;
    CS_UPDATE_32768() update_32768_3_1;
    CS_UPDATE_32768() update_32768_4_1;
        ...
        // if(hdr.ethernet.ether_type == ETHERTYPE_IPV4) {
            ...
            if (ig_md.level <= 16) {
                if (ig_md.epoch_index[0:0] == 0) {
                    update_32768_1_0.apply(ig_md.index_1, ig_md.res_1, ig_md.est_1);
                    update_32768_2_0.apply(ig_md.index_2, ig_md.res_2, ig_md.est_2);
                    update_32768_3_0.apply(ig_md.index_3, ig_md.res_3, ig_md.est_3);
                    update_32768_4_0.apply(ig_md.index_4, ig_md.res_4, ig_md.est_4);
                }
                else {
                    update_32768_1_1.apply(ig_md.index_1, ig_md.res_1, ig_md.est_1);
                    update_32768_2_1.apply(ig_md.index_2, ig_md.res_2, ig_md.est_2);
                    update_32768_3_1.apply(ig_md.index_3, ig_md.res_3, ig_md.est_3);
                    update_32768_4_1.apply(ig_md.index_4, ig_md.res_4, ig_md.est_4);
                }
            }
        }
    }
