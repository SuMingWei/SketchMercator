...
control SwitchIngress(
    ...
    MRB_UPDATE_4096() update_4096_0; // 256 * 16
    MRB_UPDATE_8192() update_8192_0; // 512 * 16
    MRB_UPDATE_16384() update_16384_0; // 1024 * 16
    MRB_UPDATE_32768() update_32768_0; // 2048 * 16
    MRB_UPDATE_65536() update_65536_0; // 4096 * 16

    MRB_UPDATE_4096() update_4096_1; // 256 * 16
    MRB_UPDATE_8192() update_8192_1; // 512 * 16
    MRB_UPDATE_16384() update_16384_1; // 1024 * 16
    MRB_UPDATE_32768() update_32768_1; // 2048 * 16
    MRB_UPDATE_65536() update_65536_1; // 4096 * 16
    ...
    apply {
        ...
        // if(hdr.ethernet.ether_type == ETHERTYPE_IPV4) {
            ...
            if (ig_md.epoch_index[0:0] == 0) {
                update_4096_0.apply(ig_md.index_4096);
                update_8192_0.apply(ig_md.index_8192);
                update_16384_0.apply(ig_md.index_16384);
                update_32768_0.apply(ig_md.index_32768);
                update_65536_0.apply(ig_md.index_65536);
            }
            else {
                update_4096_1.apply(ig_md.index_4096);
                update_8192_1.apply(ig_md.index_8192);
                update_16384_1.apply(ig_md.index_16384);
                update_32768_1.apply(ig_md.index_32768);
                update_65536_1.apply(ig_md.index_65536);
            }
        }
    }
}
