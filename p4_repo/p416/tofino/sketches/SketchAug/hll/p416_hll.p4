...
control SwitchIngress(
    ...
    HLL_UPDATE_512() update_512;
    HLL_UPDATE_1024() update_1024;
    HLL_UPDATE_2048() update_2048;
    HLL_UPDATE_4096() update_4096;
    ...
    apply {
        ...
        // if(hdr.ethernet.ether_type == ETHERTYPE_IPV4) {
            ...
            update_512.apply(ig_md.index, ig_md.level);
            update_1024.apply(ig_md.index, ig_md.level);
            update_2048.apply(ig_md.index, ig_md.level);
            update_4096.apply(ig_md.index, ig_md.level);
        }
    }
}
